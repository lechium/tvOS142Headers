...
- (void).cxx_destruct;	// IMP=0x0000000100129df0
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100129c0c
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001001297f8
- (void)layoutSubviews;	// IMP=0x00000001001297cc
@property(nonatomic, readonly) struct CGRect jet_focusedFrame;
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001001294fc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001001294dc
