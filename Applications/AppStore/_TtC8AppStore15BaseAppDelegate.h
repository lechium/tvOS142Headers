...
- (void).cxx_destruct;	// IMP=0x00000001000f2454
- (id)init;	// IMP=0x00000001000f2404
- (void)performDebugGesture:(id)arg1;	// IMP=0x00000001000f1c28
- (_Bool)application:(id)arg1 openURL:(id)arg2 options:(id)arg3;	// IMP=0x00000001000f1ae4
- (void)applicationDidEnterBackground:(id)arg1;	// IMP=0x00000001000f19c0
- (void)applicationWillEnterForeground:(id)arg1;	// IMP=0x00000001000f1974
- (void)applicationDidBecomeActive:(id)arg1;	// IMP=0x00000001000f1928
- (_Bool)application:(id)arg1 didFinishLaunchingWithOptions:(id)arg2;	// IMP=0x00000001000f178c
