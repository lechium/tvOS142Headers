...
- (void).cxx_destruct;	// IMP=0x00000001000ca5bc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000ca55c
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000001000ca47c
- (void)layoutSubviews;	// IMP=0x00000001000ca0c4
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001000c99dc
- (struct JUMeasurements)measurementsWithFitting:(struct CGSize)arg1 in:(id)arg2;	// IMP=0x00000001000c9938
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000c92b4
