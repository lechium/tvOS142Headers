...
- (void).cxx_destruct;	// IMP=0x00000001000eeb8c
- (void)saveFullScreenAudioSettings;	// IMP=0x00000001000ef990
- (void)restoreFullScreenAudioSettings;	// IMP=0x00000001000ef98c
- (void)updateAutoPlayVideoSettings;	// IMP=0x00000001000ef634
- (void)dealloc;	// IMP=0x00000001000eeae0
- (id)init;	// IMP=0x00000001000eea30
