...
- (void).cxx_destruct;	// IMP=0x000000010009f488
- (id)init;	// IMP=0x000000010009f500
- (void)animateTransition:(id)arg1;	// IMP=0x000000010009eabc
- (double)transitionDuration:(id)arg1;	// IMP=0x000000010009e990
- (id)animationControllerForDismissedController:(id)arg1;	// IMP=0x000000010009e980
- (id)animationControllerForPresentedController:(id)arg1 presentingController:(id)arg2 sourceController:(id)arg3;	// IMP=0x000000010009e8e4
