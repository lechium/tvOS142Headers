...
- (void).cxx_destruct;	// IMP=0x00000001000ae848
...
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000001000ae68c
@property(nonatomic, readonly) struct CGRect jet_focusedFrame;
- (void)prepareForReuse;	// IMP=0x00000001000ae2d8
- (void)layoutSubviews;	// IMP=0x00000001000ae1ec
@property(nonatomic) struct CATransform3D transform3D;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000adc04
