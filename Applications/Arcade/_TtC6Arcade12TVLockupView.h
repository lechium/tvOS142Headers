...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010012b42c
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010012b018
- (void)layoutSubviews;	// IMP=0x000000010012afec
@property(nonatomic, readonly) struct CGRect jet_focusedFrame;
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010012ad1c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010012acfc
