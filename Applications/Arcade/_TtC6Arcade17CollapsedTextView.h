...
- (void).cxx_destruct;	// IMP=0x00000001000137c4
@property(nonatomic, readonly) _TtC6Arcade19DynamicTypeTextView *accessibilityTextView;
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100013664
- (struct JUMeasurements)measurementsWithFitting:(struct CGSize)arg1 in:(id)arg2;	// IMP=0x00000001000125f0
- (void)layoutSubviews;	// IMP=0x00000001000121fc
@property(nonatomic, readonly) _Bool canBecomeFocused;
@property(nonatomic) struct CGRect frame;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100011ac8
