...
- (void)moreFrom:(id)arg1;	// IMP=0x000000010001b48c
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010001b3b8
- (struct JUMeasurements)measurementsWithFitting:(struct CGSize)arg1 in:(id)arg2;	// IMP=0x000000010001b114
- (void)layoutSubviews;	// IMP=0x000000010001ae70
@property(nonatomic) struct CGRect frame;
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010001a898
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010001a878
