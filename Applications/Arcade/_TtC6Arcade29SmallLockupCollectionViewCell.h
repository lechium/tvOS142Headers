...
- (void).cxx_destruct;	// IMP=0x00000001000a6840
...
- (void)prepareForReuse;	// IMP=0x00000001000a6724
@property(nonatomic, readonly) struct CGSize intrinsicContentSize;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001000a6508
- (id)_preferredConfigurationForFocusAnimation:(long long)arg1 inContext:(id)arg2;	// IMP=0x00000001000a6424
- (void)layoutSubviews;	// IMP=0x00000001000a6070
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000a5bf4
