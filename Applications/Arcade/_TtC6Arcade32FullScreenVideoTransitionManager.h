...
- (void).cxx_destruct;	// IMP=0x00000001000a09b8
- (id)init;	// IMP=0x00000001000a0a30
- (void)animateTransition:(id)arg1;	// IMP=0x000000010009ffec
- (double)transitionDuration:(id)arg1;	// IMP=0x000000010009fec0
- (id)animationControllerForDismissedController:(id)arg1;	// IMP=0x000000010009feb0
- (id)animationControllerForPresentedController:(id)arg1 presentingController:(id)arg2 sourceController:(id)arg3;	// IMP=0x000000010009fe14
