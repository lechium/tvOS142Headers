...
+ (id)sharedInstance;	// IMP=0x0000000100185a80
+ (id)new;	// IMP=0x00000001001856f0
- (void).cxx_destruct;	// IMP=0x0000000100187154
...
- (void)_callUpdateHandlerForNotificationName:(id)arg1 notification:(id)arg2;	// IMP=0x0000000100186f10
- (void)_updateAirplayDisplayActiveFromNotification:(id)arg1;	// IMP=0x0000000100186adc
- (void)_rebuildCache;	// IMP=0x0000000100186874
- (void)_initializeCache;	// IMP=0x0000000100186398
- (void)_handleSystemControllerMetadataDidChangeNotification:(id)arg1;	// IMP=0x0000000100185fa4
- (void)_handleSystemControllerServerConnectionDied:(id)arg1;	// IMP=0x0000000100185d0c
...
- (void)dealloc;	// IMP=0x00000001001859ec
- (id)initWithDataProviderInitializer:(CDUnknownBlockType)arg1;	// IMP=0x0000000100185788
- (id)init;	// IMP=0x0000000100185730
