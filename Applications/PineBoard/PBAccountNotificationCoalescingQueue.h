...
- (void).cxx_destruct;	// IMP=0x00000001000910ec
...
- (void)_keepNotification:(id)arg1 forAccountIdentifier:(id)arg2 removingNotification:(id)arg3;	// IMP=0x0000000100090f90
- (id)coalescedNotifications;	// IMP=0x0000000100090874
- (void)addNotification:(id)arg1;	// IMP=0x0000000100090448
- (id)init;	// IMP=0x000000010009032c
