...
+ (_Bool)_isApplicationHiddenWithPreference:(id)arg1;	// IMP=0x0000000100083ebc
+ (id)_whitelistBlacklistExemptBundleIdentifiers;	// IMP=0x0000000100083dc8
+ (id)_provisioningExemptBundleIdentifiers;	// IMP=0x0000000100083c04
+ (_Bool)_isAppRestrictionProfileInstalled;	// IMP=0x0000000100083a4c
+ (_Bool)_checkApplicationIsRestricted:(id)arg1;	// IMP=0x00000001000835d8
- (void).cxx_destruct;	// IMP=0x00000001000843f8
...
- (void)_refreshCachedManagedAppLayout;	// IMP=0x0000000100083460
- (void)_refreshCachedAppWhitelistOptions;	// IMP=0x00000001000832e8
- (void)_setNeedsReload;	// IMP=0x0000000100083278
- (void)_updateCachedPreferences;	// IMP=0x0000000100083008
- (_Bool)_queueUpdateCachedPreferences;	// IMP=0x0000000100082ce8
- (void)programmingGuideDidUpdate:(id)arg1;	// IMP=0x0000000100082c84
- (void)profileConnectionDidReceiveEffectiveSettingsChangedNotification:(id)arg1 userInfo:(id)arg2;	// IMP=0x0000000100082bf0
- (void)profileConnectionDidReceiveAppWhitelistChangedNotification:(id)arg1 userInfo:(id)arg2;	// IMP=0x0000000100082b48
- (void)managedHomeScreenLayoutChanged:(id)arg1;	// IMP=0x0000000100082ad0
- (id)configurationForProposedAppInfos:(id)arg1;	// IMP=0x000000010008127c
- (_Bool)isPlaceholderHidden:(id)arg1;	// IMP=0x0000000100081220
- (_Bool)isApplicationHidden:(id)arg1;	// IMP=0x0000000100080ecc
- (_Bool)isPlaceholderEnabled:(id)arg1 reasons:(unsigned long long *)arg2;	// IMP=0x0000000100080e64
- (_Bool)isApplicationEnabled:(id)arg1 reasons:(unsigned long long *)arg2;	// IMP=0x00000001000801e8
- (void)dealloc;	// IMP=0x0000000100080054
- (id)init;	// IMP=0x000000010007f5c0
