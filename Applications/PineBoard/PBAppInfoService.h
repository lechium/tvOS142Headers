...
- (void).cxx_destruct;	// IMP=0x000000010008a964
...
- (void)appInfoUpdatesWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000100089dd0
- (void)setServiceDelegate:(id)arg1;	// IMP=0x0000000100089d4c
- (void)appInfoController:(id)arg1 didUpdate:(id)arg2;	// IMP=0x0000000100089718
- (void)invalidate;	// IMP=0x0000000100089704
- (id)initWithInfoStore:(id)arg1 remoteConnection:(id)arg2;	// IMP=0x00000001000891e0
- (id)init;	// IMP=0x00000001000891a8
