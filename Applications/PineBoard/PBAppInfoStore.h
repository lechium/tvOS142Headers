...
- (void).cxx_destruct;	// IMP=0x000000010002d9f8
...
- (id)_appInfoWithUpdatedPolicy:(_Bool)arg1 updatedState:(_Bool)arg2 sourceAppInfo:(id)arg3 applicationInfo:(id)arg4;	// IMP=0x000000010002d0ac
- (id)_appInfoWithUpdatedPolicy:(_Bool)arg1 updatedState:(_Bool)arg2 sourceAppInfo:(id)arg3 placeholder:(id)arg4;	// IMP=0x000000010002cd4c
- (void)queue_processUpdates:(id)arg1;	// IMP=0x000000010002af5c
- (void)_extraMultiUserApplicationsDidChange;	// IMP=0x000000010002ab78
- (void)languageDidChange;	// IMP=0x000000010002a770
- (void)applicationIconDidChange:(id)arg1;	// IMP=0x000000010002a360
- (void)placeholderDidChangeSignificantly:(id)arg1;	// IMP=0x000000010002a1b8
- (void)placeholderProgressDidUpdate:(id)arg1;	// IMP=0x000000010002a010
- (void)handleDynamicStateChanged:(id)arg1;	// IMP=0x0000000100029f68
- (void)handlePolicyChanged:(id)arg1;	// IMP=0x0000000100029ec0
- (id)appInfoControllerWithEnabledApps;	// IMP=0x0000000100029e18
- (id)appInfoControllerWithEnabledAndVisibleApps;	// IMP=0x0000000100029d70
- (id)appInfoControllerWithEnabledAndVisibleAppsAndPlaceholders;	// IMP=0x0000000100029cc8
- (id)appInfoControllerWithEverything;	// IMP=0x0000000100029c74
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000100029b64
- (void)_enqueueUpdate:(id)arg1;	// IMP=0x0000000100029994
- (void)removeObserver:(id)arg1;	// IMP=0x000000010002986c
- (id)addObserver:(id)arg1;	// IMP=0x00000001000295a4
- (id)configuration;	// IMP=0x000000010002944c
- (id)appInfos;	// IMP=0x00000001000291ec
- (void)dealloc;	// IMP=0x0000000100028e70
- (id)initWithApplicationLibrary:(id)arg1 policy:(id)arg2 dynamicStateDataSource:(id)arg3;	// IMP=0x0000000100027b9c
