...
- (void).cxx_destruct;	// IMP=0x000000010016d7a4
...
- (void)_setShadowRadius:(double)arg1 alpha:(double)arg2;	// IMP=0x000000010016d37c
- (void)_setDimingAlpha:(double)arg1;	// IMP=0x000000010016d2e0
- (void)_setContentAlpha:(double)arg1;	// IMP=0x000000010016d264
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010016cfb4
- (void)layoutSubviews;	// IMP=0x000000010016c8e8
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x000000010016c398
- (void)dealloc;	// IMP=0x000000010016c32c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010016bc2c
