...
- (void)appTransitioner:(id)arg1 didCompleteAppTransition:(id)arg2;	// IMP=0x000000010010a74c
- (void)_recalculateUpdates:(_Bool)arg1;	// IMP=0x000000010010a078
- (void)_updateWithRemovedItems:(id)arg1;	// IMP=0x0000000100109eb8
- (void)_populateItems:(id)arg1;	// IMP=0x00000001001098e4
- (void)appInfoController:(id)arg1 didUpdate:(id)arg2;	// IMP=0x0000000100108f7c
- (void)applyPendingUpdates;	// IMP=0x0000000100108c74
- (id)indexPathForItem:(id)arg1;	// IMP=0x0000000100108b78
- (void)handleKillRequestForItem:(id)arg1;	// IMP=0x0000000100108a1c
- (void)handleLaunchRequestForItemWithIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010010864c
- (void)handleActivationRequestForItem:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010010845c
- (_Bool)canKillItem:(id)arg1;	// IMP=0x0000000100108324
- (_Bool)canSwitchToItem:(id)arg1;	// IMP=0x00000001001081ec
- (void)dealloc;	// IMP=0x0000000100108158
- (id)initWithFocusedProcessBundleID:(id)arg1;	// IMP=0x0000000100107f64
- (id)init;	// IMP=0x0000000100107f28
