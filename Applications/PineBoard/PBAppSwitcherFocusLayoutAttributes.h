...
- (id)description;	// IMP=0x000000010010f460
- (unsigned long long)hash;	// IMP=0x000000010010f08c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010010ea6c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010010e6a4
