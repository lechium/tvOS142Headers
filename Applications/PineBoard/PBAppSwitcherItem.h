...
- (void).cxx_destruct;	// IMP=0x000000010023bc14
...
- (void)_updateIconImage;	// IMP=0x000000010023b874
- (void)_updateDisplayName;	// IMP=0x000000010023b73c
- (void)_updateForProgressChange;	// IMP=0x000000010023b708
- (id)description;	// IMP=0x000000010023b6ac
- (id)initWithType:(long long)arg1 bundleIdentifier:(id)arg2 appInfo:(id)arg3 dataSource:(id)arg4 live:(_Bool)arg5;	// IMP=0x000000010023b224
