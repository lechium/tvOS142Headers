...
+ (id)defaultManager;	// IMP=0x00000001000d5eb4
- (void).cxx_destruct;	// IMP=0x00000001000d769c
...
- (_Bool)dismissAppSwitcherToBundleIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000d6c90
- (void)presentAppSwitcherWithFocusedBundleIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000d62f8
- (void)invalidateSceneHosting;	// IMP=0x00000001000d62e4
@property(readonly, nonatomic, getter=isActive) _Bool active;
- (_Bool)shouldActivateForProcessWithIdentifier:(id)arg1;	// IMP=0x00000001000d6108
- (id)_init;	// IMP=0x00000001000d6000
- (id)init;	// IMP=0x00000001000d5fc4
