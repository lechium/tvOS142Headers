...
+ (id)insertUpdateWithItem:(id)arg1 indexPath:(id)arg2;	// IMP=0x000000010006e498
+ (id)deleteUpdateWithItem:(id)arg1 indexPath:(id)arg2;	// IMP=0x000000010006e3e0
- (void).cxx_destruct;	// IMP=0x000000010006e614
...
- (id)initWithType:(long long)arg1 item:(id)arg2 fromIndexPath:(id)arg3 toIndexPath:(id)arg4;	// IMP=0x000000010006e250
