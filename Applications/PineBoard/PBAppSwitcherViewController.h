...
- (void).cxx_destruct;	// IMP=0x000000010020cca4
...
- (void)invalidateSceneLayoutElements;	// IMP=0x000000010020cad8
- (void)transitionToSwitcherWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010020c974
- (id)preferredFocusEnvironments;	// IMP=0x000000010020c92c
- (void)viewDidLoad;	// IMP=0x000000010020c678
- (id)initWithDataSource:(id)arg1;	// IMP=0x000000010020c578
