...
+ (_Bool)_isExtraMultiUserApplication:(id)arg1;	// IMP=0x00000001000c00ac
+ (id)_infoPlistKeys;	// IMP=0x00000001000bff14
+ (id)_entitlementKeys;	// IMP=0x00000001000bfdc8
- (void).cxx_destruct;	// IMP=0x00000001000c0838
...
- (void)_refreshRunsAsCurrentUser;	// IMP=0x00000001000bfb6c
- (void)_refreshLocalizedName;	// IMP=0x00000001000bf9e4
- (id)getEntitlementValueUncached:(id)arg1 ofClass:(Class)arg2;	// IMP=0x00000001000bf8d8
- (id)getInfoPlistValueUncached:(id)arg1;	// IMP=0x00000001000bf644
...
- (void)_loadFromProxy:(id)arg1;	// IMP=0x00000001000be0a4
- (void)pb_reportUntrustedLaunchAttempt;	// IMP=0x000000010024b59c
