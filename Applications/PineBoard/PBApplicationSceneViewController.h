...
- (void).cxx_destruct;	// IMP=0x00000001002121e4
...
- (void)applicationSceneView:(id)arg1 didUpdateReadiness:(_Bool)arg2;	// IMP=0x0000000100211fd0
- (void)applicationSceneViewDidUpdatePresentationMode:(id)arg1;	// IMP=0x0000000100211f6c
- (void)applicationSceneView:(id)arg1 willLoadSnapshotWithRequest:(id)arg2;	// IMP=0x0000000100211ebc
...
- (void)_updateDeferralTargetAssertionIfNeeded;	// IMP=0x0000000100211a04
- (id)preferredFocusEnvironments;	// IMP=0x0000000100211944
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000100211878
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) unsigned long long effectivePresentationMode;
@property(nonatomic) unsigned long long presentationMode;
- (void)setPresentationMode:(unsigned long long)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000100211570
@property(readonly, nonatomic) PBApplicationSceneView *sceneView;
- (void)loadView;	// IMP=0x0000000100211364
- (void)dealloc;	// IMP=0x00000001002112ec
- (id)initWithSceneHandle:(id)arg1 layoutLevel:(long long)arg2;	// IMP=0x0000000100211188
