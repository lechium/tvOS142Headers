...
- (void).cxx_destruct;	// IMP=0x000000010008e488
...
- (void)_reloadStatistics;	// IMP=0x000000010008da20
- (void)_signalReloadStatisticsSource;	// IMP=0x000000010008d9d0
- (void)_handleBluetoothManagerNotificationHandler:(id)arg1;	// IMP=0x000000010008d96c
- (void)pairingAgent:(id)arg1 peerDidUnpair:(id)arg2;	// IMP=0x000000010008d8d8
- (void)pairingAgent:(id)arg1 peerDidFailToCompletePairing:(id)arg2 error:(id)arg3;	// IMP=0x000000010008d818
- (void)pairingAgent:(id)arg1 peerDidCompletePairing:(id)arg2;	// IMP=0x000000010008d784
@property(readonly, nonatomic) PBBluetoothDeviceStatistics *pairedDeviceStatistics;
- (void)dealloc;	// IMP=0x000000010008d430
- (id)init;	// IMP=0x000000010008cea0
