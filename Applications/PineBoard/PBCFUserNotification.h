...
- (void).cxx_destruct;	// IMP=0x00000001001bdb48
...
- (long long)_typeForCurrentTemplateKey;	// IMP=0x00000001001bced4
- (id)_safeLocalizedValue:(id)arg1 withBundle:(id)arg2;	// IMP=0x00000001001bca58
- (_Bool)isAlive;	// IMP=0x00000001001bc7e8
- (void)cancel;	// IMP=0x00000001001bc7b0
- (void)didSelectButtonAtIndex:(long long)arg1;	// IMP=0x00000001001bc10c
- (_Bool)isLastTextField:(long long)arg1;	// IMP=0x00000001001bc088
- (long long)keyboardTypeForTextField:(long long)arg1;	// IMP=0x00000001001bbf78
- (_Bool)isSecureTextField:(long long)arg1;	// IMP=0x00000001001bbef4
@property(readonly, nonatomic) long long notificationType;
- (void)updateWithMessage:(id)arg1 requestFlags:(int)arg2;	// IMP=0x00000001001ba1a0
- (id)initWithMessage:(id)arg1 replyPort:(unsigned int)arg2 requestFlags:(int)arg3;	// IMP=0x00000001001ba088
