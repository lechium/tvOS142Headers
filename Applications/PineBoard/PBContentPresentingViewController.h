...
- (void).cxx_destruct;	// IMP=0x0000000100163090
...
- (void)_didDismiss:(id)arg1;	// IMP=0x0000000100162e54
- (void)_willDismiss:(id)arg1;	// IMP=0x0000000100162dac
- (void)dismissContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0000000100162b98
- (void)presentContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x00000001001628e4
@property(readonly, nonatomic) _Bool expectsEventForwarding;
- (_Bool)definesPresentationContext;	// IMP=0x00000001001628a4
- (void)dealloc;	// IMP=0x0000000100162784
- (id)initWithContentViewController:(id)arg1 supportsInterruption:(_Bool)arg2;	// IMP=0x000000010016256c
