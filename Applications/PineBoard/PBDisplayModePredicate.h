...
+ (id)predicatesWithPreferredSDRColorMapping:(long long)arg1 frameRate:(double)arg2;	// IMP=0x00000001000aa708
+ (id)predicatWithDynamicRange:(long long)arg1 frameRate:(double)arg2;	// IMP=0x00000001000aa690
...
- (unsigned long long)hash;	// IMP=0x00000001000aafbc
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000aadbc
- (id)description;	// IMP=0x00000001000aaac4
@property(readonly, nonatomic) double roundedFrameRate;
- (id)initWithDynamicRange:(long long)arg1 SDRColorMapping:(long long)arg2 frameRate:(double)arg3;	// IMP=0x00000001000aa968
