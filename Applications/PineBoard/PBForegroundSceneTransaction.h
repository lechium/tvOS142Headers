...
- (void).cxx_destruct;	// IMP=0x000000010018fb0c
...
- (void)_begin;	// IMP=0x000000010018f530
- (id)initWithSceneIdentity:(id)arg1 backgroundAllOtherScenes:(_Bool)arg2;	// IMP=0x000000010018f40c
