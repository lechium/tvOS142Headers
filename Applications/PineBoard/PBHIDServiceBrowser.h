...
- (void).cxx_destruct;	// IMP=0x00000001001db1bc
...
- (void)_addService:(struct __IOHIDServiceClient *)arg1;	// IMP=0x00000001001db02c
- (void)_copyInitialServices;	// IMP=0x00000001001daf84
- (void)_stopMonitoring;	// IMP=0x00000001001daf14
- (void)_startMonitoring;	// IMP=0x00000001001daeac
- (_Bool)eventSenderMatchesDiscoveredService:(struct __IOHIDEvent *)arg1;	// IMP=0x00000001001dae30
- (void)dealloc;	// IMP=0x00000001001dad84
- (id)init;	// IMP=0x00000001001dacd0
- (id)initWithDeviceMatching:(id)arg1 predicate:(CDUnknownBlockType)arg2;	// IMP=0x00000001001daa10
