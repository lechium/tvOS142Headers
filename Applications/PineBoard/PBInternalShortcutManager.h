...
+ (id)sharedInstance;	// IMP=0x00000001000c6e90
+ (id)dependencyDescription;	// IMP=0x00000001000c6dd8
- (void).cxx_destruct;	// IMP=0x00000001000c755c
@property(retain, nonatomic) NSMutableDictionary *handlers; // @synthesize handlers=_handlers;
@property(retain, nonatomic) PBBulletinService *bulletinService; // @synthesize bulletinService=_bulletinService;
- (void)executeShortcut;	// IMP=0x00000001000c7260
- (void)registerWithOption:(long long)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000c708c
