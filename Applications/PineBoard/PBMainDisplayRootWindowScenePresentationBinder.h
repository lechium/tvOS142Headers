...
+ (id)sharedInstance;	// IMP=0x000000010011f7fc
+ (id)dependencyDescription;	// IMP=0x000000010011f744
- (void).cxx_destruct;	// IMP=0x000000010011fad4
@property(readonly, nonatomic) UIRootSceneWindow *rootWindow; // @synthesize rootWindow=_rootWindow;
- (id)init;	// IMP=0x000000010011f8cc
