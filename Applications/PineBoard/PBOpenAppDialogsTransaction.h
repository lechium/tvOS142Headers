...
- (void).cxx_destruct;	// IMP=0x00000001001cf724
...
- (void)_addLegacyGameDialogTransaction;	// IMP=0x00000001001cf32c
- (void)_addRestrictionDialogTransaction;	// IMP=0x00000001001cef7c
@property(readonly, nonatomic) _Bool shouldContinueLaunch;
- (_Bool)_shouldFailForChildTransaction:(id)arg1;	// IMP=0x00000001001cee90
- (void)_begin;	// IMP=0x00000001001cee2c
- (id)initWithRequest:(id)arg1;	// IMP=0x00000001001ced3c
