...
- (void).cxx_destruct;	// IMP=0x00000001000b2af0
...
- (_Bool)_needsUI;	// IMP=0x00000001000b2804
- (void)_begin;	// IMP=0x00000001000b2210
- (id)initWithRequest:(id)arg1;	// IMP=0x00000001000b1f80
