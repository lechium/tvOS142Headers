...
- (void).cxx_destruct;	// IMP=0x0000000100251294
...
- (void)processManager:(id)arg1 didRemoveProcess:(id)arg2;	// IMP=0x0000000100250e04
- (void)processManager:(id)arg1 didAddProcess:(id)arg2;	// IMP=0x0000000100250d84
- (void)transaction:(id)arg1 willLaunchProcess:(id)arg2;	// IMP=0x0000000100250988
- (_Bool)_canPerformAppLaunch:(id *)arg1;	// IMP=0x00000001002501d8
- (void)_relinquishSystemAnimationDeactivationAssertion;	// IMP=0x0000000100250030
- (void)_beginSceneTransitionInTransaction:(id)arg1;	// IMP=0x000000010024ee48
- (void)_beginSceneUpdateTransactionInTransaction:(id)arg1 withSchedulingPolicy:(unsigned long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000010024e3fc
- (void)_callFrontBoardCompletionIfNeededWithError:(id)arg1;	// IMP=0x000000010024de74
- (void)_didComplete;	// IMP=0x000000010024dbe8
- (_Bool)_shouldFailForChildTransaction:(id)arg1;	// IMP=0x000000010024db8c
- (void)_begin;	// IMP=0x000000010024d394
- (_Bool)_canBeInterrupted;	// IMP=0x000000010024d300
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
- (void)transferSceneDeactivationAssertionFromInterruptedTransition:(id)arg1;	// IMP=0x000000010024cdb0
- (void)removeObserver:(id)arg1;	// IMP=0x000000010024cd04
- (void)addObserver:(id)arg1;	// IMP=0x000000010024cc58
...
- (void)dealloc;	// IMP=0x000000010024caac
- (id)initWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010024bbe8
