...
- (void).cxx_destruct;	// IMP=0x00000001001ab228
...
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x00000001001aae80
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x00000001001aaddc
- (id)succinctDescriptionBuilder;	// IMP=0x00000001001aacf4
- (id)succinctDescription;	// IMP=0x00000001001aac84
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001aac30
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001aa508
...
- (id)initWithElement:(id)arg1;	// IMP=0x00000001001aa060
- (id)initWithElement:(id)arg1 controller:(id)arg2;	// IMP=0x00000001001a9e94
