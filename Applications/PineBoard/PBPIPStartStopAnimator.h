...
- (void).cxx_destruct;	// IMP=0x00000001001a5520
...
- (void)_performReducedMotionAnimation;	// IMP=0x00000001001a4e58
- (void)_performDefaultAnimation;	// IMP=0x00000001001a4b98
- (void)startAnimation;	// IMP=0x00000001001a4b40
- (id)initWithContext:(unsigned long long)arg1 layout:(id)arg2 targetSize:(struct CGSize)arg3 quadrant:(long long)arg4 pipInsets:(struct UIEdgeInsets)arg5;	// IMP=0x00000001001a4958
