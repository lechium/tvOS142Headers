...
- (void).cxx_destruct;	// IMP=0x0000000100033858
...
- (id)description;	// IMP=0x00000001000334b0
- (unsigned long long)hash;	// IMP=0x0000000100033478
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000332f8
- (id)initWithToken:(id)arg1 requestType:(unsigned long long)arg2;	// IMP=0x00000001000331f8
- (id)initWithToken:(id)arg1;	// IMP=0x0000000100033158
- (id)init;	// IMP=0x0000000100033120
