...
- (void).cxx_destruct;	// IMP=0x00000001001d97c4
...
- (void)invalidateImage;	// IMP=0x00000001001d96a4
- (id)fetchImage;	// IMP=0x00000001001d8c7c
- (id)initWithSnapshotPredicate:(id)arg1 sceneID:(id)arg2 bundleIdentifier:(id)arg3 scaleFactor:(double)arg4;	// IMP=0x00000001001d8a58
- (id)init;	// IMP=0x00000001001d8a20
