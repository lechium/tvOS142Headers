...
- (void).cxx_destruct;	// IMP=0x00000001001426e4
...
- (void)invalidateImage;	// IMP=0x0000000100142618
- (id)fetchImage;	// IMP=0x0000000100141ee4
- (id)initWithSceneSnapshot:(id)arg1 scaleFactor:(double)arg2;	// IMP=0x0000000100141c74
- (id)init;	// IMP=0x0000000100141c3c
