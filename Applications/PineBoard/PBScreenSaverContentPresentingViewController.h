...
- (void).cxx_destruct;	// IMP=0x00000001000f90b0
...
- (void)_beginDismissalTransactionAnimated:(_Bool)arg1 shouldUpdateWallpaper:(_Bool)arg2 shouldApplyStartValues:(_Bool)arg3 withCompletion:(CDUnknownBlockType)arg4;	// IMP=0x00000001000f8c4c
- (void)viewServiceDidTerminate;	// IMP=0x00000001000f8b84
- (void)viewServiceDidDismiss:(id)arg1;	// IMP=0x00000001000f8af8
- (void)viewService:(id)arg1 willDismissWithResult:(id)arg2;	// IMP=0x00000001000f8a38
- (void)dismissContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000f85b8
- (void)presentContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000f836c
- (void)screenSaverTransitionUpdatedAcceptEvents:(_Bool)arg1;	// IMP=0x00000001000f7f80
- (void)screenSaverTransitionShowSnapshotImage:(id)arg1;	// IMP=0x00000001000f7da4
@property(readonly, nonatomic) _Bool expectsEventForwarding;
- (void)viewDidLoad;	// IMP=0x00000001000f7a08
- (id)initWithChildViewController:(id)arg1;	// IMP=0x00000001000f7850
