...
- (void).cxx_destruct;	// IMP=0x000000010014fc00
...
- (void)_prepareKioskAnimationInTransaction:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010014f45c
- (id)_defaultAppAnimationTransaction;	// IMP=0x000000010014f29c
- (void)_begin;	// IMP=0x000000010014ebbc
- (_Bool)_canBeInterrupted;	// IMP=0x000000010014eb9c
- (id)initWithScreenSaverViewController:(id)arg1 animated:(_Bool)arg2 updateWallpaper:(_Bool)arg3 applyStartValues:(_Bool)arg4;	// IMP=0x000000010014ea10
