...
- (void).cxx_destruct;	// IMP=0x000000010008f77c
...
- (void)dismissContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x000000010008f218
- (void)presentContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x000000010008ecf8
...
- (id)initWithSiriViewController:(id)arg1;	// IMP=0x000000010008ebc4
