...
- (void)_readAboutText:(id)arg1;	// IMP=0x0000000100088ab0
- (void)_didNotCompleteOptIn;	// IMP=0x0000000100088a54
- (void)_optOut:(id)arg1;	// IMP=0x00000001000889c0
- (void)_optIn:(id)arg1;	// IMP=0x000000010008892c
- (void)_handleHomeButton:(id)arg1;	// IMP=0x0000000100088814
- (void)_handleMenuButton:(id)arg1;	// IMP=0x00000001000886c0
- (id)preferredFocusEnvironments;	// IMP=0x0000000100088610
- (void)viewDidLoad;	// IMP=0x0000000100087e0c
