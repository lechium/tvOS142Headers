...
+ (_Bool)_isSiriEnabled;	// IMP=0x0000000100239394
+ (id)sharedInstance;	// IMP=0x0000000100233ed8
+ (id)dependencyDescription;	// IMP=0x0000000100233c98
- (void).cxx_destruct;	// IMP=0x000000010023af50
...
- (void)_notifyObserversSiriWindowDidUnhide;	// IMP=0x000000010023a9d8
- (void)_notifyObserversSiriWindowDidHide;	// IMP=0x000000010023a83c
- (void)_notifyObserversVisibleStateDidChange:(long long)arg1;	// IMP=0x000000010023a698
- (void)removeObserver:(id)arg1;	// IMP=0x000000010023a630
- (void)addObserver:(id)arg1;	// IMP=0x000000010023a5c8
- (void)_launchApplicationWithBundleIdentifier:(id)arg1 withURL:(id)arg2 launchOverSiri:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000100239bf4
- (void)_stopProvidingScreenActionContext;	// IMP=0x0000000100239b34
- (void)_startProvidingScreenActionContext;	// IMP=0x00000001002398c0
- (void)_updateShouldPreferDictation;	// IMP=0x00000001002395d0
- (void)appTransitioner:(id)arg1 willStartAnimationForAppTransition:(id)arg2;	// IMP=0x00000001002391f4
- (_Bool)siriScreenActionManagerIsSiriContentBeingDisplayed:(id)arg1;	// IMP=0x0000000100239180
- (void)powerManagerDidWakeSystem:(id)arg1;	// IMP=0x0000000100239118
- (void)screenSaverManagerWillDismissScreenSaver:(id)arg1;	// IMP=0x00000001002390b4
- (void)screenSaverManagerDidPresentScreenSaver:(id)arg1;	// IMP=0x0000000100239050
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000100238df8
- (void)_handleAssistantPreferencesDidChangeNotification:(id)arg1;	// IMP=0x0000000100238d60
- (void)siriPresentationDidDeactivateScene:(id)arg1;	// IMP=0x0000000100238bbc
- (void)siriPresentation:(id)arg1 sceneDidActivateWithIdentifier:(id)arg2;	// IMP=0x0000000100238954
- (void)siriPresentation:(id)arg1 didChangePresentationPeekMode:(unsigned long long)arg2;	// IMP=0x00000001002387a0
- (void)siriPresentation:(id)arg1 requestsPunchout:(id)arg2 withHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100238188
- (void)siriPresentation:(id)arg1 isEnabledDidChange:(_Bool)arg2;	// IMP=0x0000000100238074
- (void)siriPresentation:(id)arg1 requestsDismissalWithOptions:(id)arg2 withHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100237a60
- (void)siriPresentation:(id)arg1 requestsPresentationWithOptions:(id)arg2 withHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000001002376c8
- (void)prepareUIForSystemOverlayPresentationWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000100237618
- (_Bool)showAssistantIfNecessaryAfterApplication:(id)arg1;	// IMP=0x0000000100237550
- (void)hideAssistantViewForApplication:(id)arg1;	// IMP=0x00000001002374dc
- (_Bool)_dismissAssistantViewWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010023708c
- (_Bool)dismissAssistant;	// IMP=0x0000000100236fa8
- (void)_unhideSiriWindow;	// IMP=0x0000000100236e80
- (void)_hideSiriWindow;	// IMP=0x0000000100236c28
- (void)_presentAssistantViewWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000100236a04
- (void)setNextAssistantRecognitionStrings:(id)arg1;	// IMP=0x0000000100236998
- (void)setNextVoiceRecognitionAudioInputPaths:(id)arg1;	// IMP=0x000000010023692c
@property(readonly, nonatomic, getter=isListening) _Bool listening;
- (_Bool)stopSiriWithContext:(id)arg1;	// IMP=0x0000000100235f94
- (_Bool)startSiriWithContext:(id)arg1;	// IMP=0x0000000100235800
- (void)_cancelSiriActivation;	// IMP=0x0000000100235728
- (void)_stopSiriActivation;	// IMP=0x000000010023563c
- (void)_cancelPreheating;	// IMP=0x0000000100235564
- (_Bool)prepareSiriWithContext:(id)arg1;	// IMP=0x0000000100235200
- (_Bool)activateSiriWithContext:(id)arg1;	// IMP=0x0000000100234ca4
- (void)preheatIfNecessary;	// IMP=0x00000001002349e4
@property(readonly, nonatomic, getter=isHidden) _Bool hidden;
- (void)setup;	// IMP=0x00000001002345d8
- (void)dealloc;	// IMP=0x00000001002344d0
- (id)_init;	// IMP=0x0000000100234040
- (id)init;	// IMP=0x0000000100233fe8
