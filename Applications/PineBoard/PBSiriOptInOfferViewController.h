...
- (void).cxx_destruct;	// IMP=0x000000010019802c
...
- (void)_readAboutText:(id)arg1;	// IMP=0x00000001001979b4
- (void)_didNotCompleteOptIn;	// IMP=0x0000000100197958
- (void)_optOut:(id)arg1;	// IMP=0x00000001001978c4
- (void)_optIn:(id)arg1;	// IMP=0x0000000100197830
- (void)_handleHomeButton:(id)arg1;	// IMP=0x0000000100197718
- (void)_handleMenuButton:(id)arg1;	// IMP=0x00000001001975c4
- (id)preferredFocusEnvironments;	// IMP=0x0000000100197514
- (void)viewDidLoad;	// IMP=0x0000000100196c48
- (id)initWithOfferDictationOnly:(_Bool)arg1;	// IMP=0x0000000100196b64
