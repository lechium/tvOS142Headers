...
+ (id)requestWithBundleIdentifier:(id)arg1;	// IMP=0x000000010006da74
- (void).cxx_destruct;	// IMP=0x000000010006e200
...
- (unsigned long long)hash;	// IMP=0x000000010006dfb8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010006dc4c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010006db48
