...
+ (id)keyPathsForValuesAffectingHasActivePresentation;	// IMP=0x00000001001061fc
- (void).cxx_destruct;	// IMP=0x00000001001076b4
...
- (void)_checkPendingRequests;	// IMP=0x0000000100106e90
- (void)_callPendingDismissalCompletionHandlersForSession:(id)arg1 success:(_Bool)arg2;	// IMP=0x0000000100106c50
- (void)_callPendingPresentationCompletionHandlersForSession:(id)arg1 success:(_Bool)arg2;	// IMP=0x0000000100106a10
- (void)systemOverlaySessionDidInvalidate:(id)arg1;	// IMP=0x0000000100106758
- (void)systemOverlaySessionDidCancel:(id)arg1 withContext:(id)arg2;	// IMP=0x0000000100106648
- (void)systemOverlaySessionDidDismiss:(id)arg1;	// IMP=0x0000000100106590
- (void)systemOverlaySessionWillDismiss:(id)arg1 withContext:(id)arg2;	// IMP=0x00000001001064a8
- (void)systemOverlaySessionDidPresent:(id)arg1;	// IMP=0x00000001001063f0
- (void)systemOverlaySessionWillPresent:(id)arg1;	// IMP=0x0000000100106368
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000100106258
- (void)resume;	// IMP=0x0000000100105f58
- (void)pauseWithOptions:(long long)arg1;	// IMP=0x0000000100105d50
@property(readonly, nonatomic) _Bool hasActivePresentation;
- (void)dismissWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001001058f4
- (void)presentWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100105490
- (id)initWithName:(id)arg1 layoutLevel:(long long)arg2 presentationHandler:(id)arg3 delegate:(id)arg4;	// IMP=0x0000000100105168
- (id)init;	// IMP=0x0000000100105130
