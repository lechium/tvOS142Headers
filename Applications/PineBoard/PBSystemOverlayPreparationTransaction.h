...
- (void).cxx_destruct;	// IMP=0x00000001000b79cc
...
- (void)_didComplete;	// IMP=0x00000001000b78d0
- (void)_begin;	// IMP=0x00000001000b7460
- (_Bool)_canBeInterrupted;	// IMP=0x00000001000b7440
- (void)interruptWithContext:(id)arg1;	// IMP=0x00000001000b73c4
- (id)initWithUIProvider:(id)arg1;	// IMP=0x00000001000b72d0
- (id)init;	// IMP=0x00000001000b7298
