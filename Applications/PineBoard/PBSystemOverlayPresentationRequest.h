...
- (void).cxx_destruct;	// IMP=0x0000000100107bcc
- (_Bool)_insertAtFrontOfQueue;	// IMP=0x0000000100107ba8
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100107a9c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100107a70
- (id)initWithRequest:(id)arg1;	// IMP=0x0000000100107870
