...
- (void)_machineNotifyDidInvalidate;	// IMP=0x0000000100027790
- (void)_machineNotifyDidCancelWithContext:(id)arg1;	// IMP=0x0000000100027700
- (void)_machineNotifyDidDismiss;	// IMP=0x00000001000276a4
- (void)_machineNotifyWillDismissWithContext:(id)arg1;	// IMP=0x0000000100027614
- (void)_machineNotifyDidPresent;	// IMP=0x00000001000275b8
- (void)_machineNotifyWillPresent;	// IMP=0x000000010002755c
- (void)_machineCleanup;	// IMP=0x00000001000274b8
- (void)_machineAddPendingPresentationRequest:(id)arg1;	// IMP=0x000000010002744c
- (void)_machineDismissUIWithRequest:(id)arg1;	// IMP=0x0000000100026e00
- (void)_machinePresentUIWithRequest:(id)arg1;	// IMP=0x00000001000267b4
- (void)_machinePrepareUIWithProvider:(id)arg1;	// IMP=0x00000001000261ac
- (void)_initializeStateMachine;	// IMP=0x00000001000209c8
- (void)contentPresentingDidDismissContent:(id)arg1;	// IMP=0x00000001000208d4
- (void)contentPresenting:(id)arg1 willDismissContentWithResult:(id)arg2 error:(id)arg3;	// IMP=0x0000000100020614
- (void)makeActive;	// IMP=0x00000001000205bc
- (void)dismissWithRequest:(id)arg1;	// IMP=0x0000000100020430
- (void)presentWithRequest:(id)arg1;	// IMP=0x0000000100020308
- (id)initWithIdentifier:(id)arg1 layoutLevel:(long long)arg2 sceneDeactivationReasons:(unsigned long long)arg3 presentationHandler:(id)arg4 delegate:(id)arg5;	// IMP=0x0000000100020110
- (id)init;	// IMP=0x00000001000200d8
