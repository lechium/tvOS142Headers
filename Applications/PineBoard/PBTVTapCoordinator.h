...
+ (id)sharedInstance;	// IMP=0x00000001000f9180
- (void)handleTVTapEvent:(id)arg1;	// IMP=0x00000001000f94cc
- (void)reset;	// IMP=0x00000001000f949c
- (void)registerTVPressDownTimestamp:(double)arg1;	// IMP=0x00000001000f9318
@property(readonly, nonatomic) _Bool didRecognizeTripleTap;
@property(readonly, nonatomic) _Bool didRecognizeDoubleTap;
- (double)_maxAllowableDeltaBetweenPresses;	// IMP=0x00000001000f9280
