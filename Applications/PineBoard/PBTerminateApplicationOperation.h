...
- (void).cxx_destruct;	// IMP=0x000000010026d6c8
...
- (void)start;	// IMP=0x000000010026cac4
- (_Bool)isFinished;	// IMP=0x000000010026ca54
- (_Bool)isExecuting;	// IMP=0x000000010026c9e4
- (_Bool)isAsynchronous;	// IMP=0x000000010026c9c4
- (id)initWithApplicationProcessIdentity:(id)arg1;	// IMP=0x000000010026c8e4
- (id)initWithProcessManager:(id)arg1 applicationProcessIdentity:(id)arg2;	// IMP=0x000000010026c794
