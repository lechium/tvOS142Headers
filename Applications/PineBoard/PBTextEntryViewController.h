...
- (void).cxx_destruct;	// IMP=0x0000000100178304
...
- (id)_messageStringAttributes;	// IMP=0x0000000100177b54
- (id)_titleStringAttributes;	// IMP=0x00000001001778c4
- (void)_menuButtonPressed:(id)arg1;	// IMP=0x000000010017774c
- (void)textEntryControllerDidFinish:(id)arg1;	// IMP=0x0000000100177630
- (void)buttonView:(id)arg1 didSelectButton:(id)arg2 atIndex:(long long)arg3;	// IMP=0x00000001001774ac
- (void)_synchronizeEnteredValues;	// IMP=0x0000000100177420
- (id)textField;	// IMP=0x0000000100177314
- (void)_showChildViewController:(id)arg1;	// IMP=0x00000001001770bc
- (id)_buttonsForTextField:(long long)arg1 defaultButtonIndex:(long long *)arg2;	// IMP=0x0000000100176d3c
- (void)_showTextEntryViewControllerForTextField:(long long)arg1;	// IMP=0x00000001001765a8
- (void)_configureStateMachine;	// IMP=0x0000000100175b04
- (id)presentationControllerForPresentedViewController:(id)arg1 presentingViewController:(id)arg2 sourceViewController:(id)arg3;	// IMP=0x0000000100175a20
- (id)animationControllerForDismissedController:(id)arg1;	// IMP=0x0000000100175998
- (id)animationControllerForPresentedController:(id)arg1 presentingController:(id)arg2 sourceController:(id)arg3;	// IMP=0x00000001001758b4
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000001001757e8
- (void)viewDidLoad;	// IMP=0x0000000100175784
- (void)loadView;	// IMP=0x0000000100175650
- (unsigned long long)addButtonWithTitle:(id)arg1;	// IMP=0x000000010017559c
- (void)setAlternateTitle:(id)arg1 message:(id)arg2 forTextFieldAtIndex:(unsigned long long)arg3;	// IMP=0x000000010017548c
- (unsigned long long)addTextFieldWithInitialText:(id)arg1 placeholder:(id)arg2 keyboardType:(long long)arg3;	// IMP=0x00000001001752bc
- (id)init;	// IMP=0x0000000100175248
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000100175024
