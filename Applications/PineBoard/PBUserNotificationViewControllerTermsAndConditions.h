...
- (void).cxx_destruct;	// IMP=0x0000000100225b5c
...
- (void)_handleHomeButton:(id)arg1;	// IMP=0x00000001002258bc
- (void)_handleMenuButton;	// IMP=0x00000001002257a0
- (void)viewDidLoad;	// IMP=0x0000000100224a20
- (id)initWithTitle:(id)arg1 text:(id)arg2;	// IMP=0x0000000100224900
