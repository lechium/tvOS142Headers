...
+ (id)_contentApplicationIdentifiers;	// IMP=0x000000010021e570
+ (id)sharedInstance;	// IMP=0x000000010021be8c
+ (id)dependencyDescription;	// IMP=0x000000010021b498
- (void).cxx_destruct;	// IMP=0x000000010021edec
...
- (void)userProfileManagerDidUpdate:(id)arg1;	// IMP=0x000000010021ead0
- (void)appInfoController:(id)arg1 didUpdate:(id)arg2;	// IMP=0x000000010021e6bc
- (void)_workQueue_addNotifyObserversDidUpdateApplicationsOperationsWithApplicationIdentifiers:(id)arg1;	// IMP=0x000000010021e204
- (void)_workQueue_addNotifyObserversWillUpdateApplicationsOperationsWithApplicationIdentifiers:(id)arg1;	// IMP=0x000000010021de98
- (void)_workQueue_addManageApplicationsOperationsWithPersonaApplicationIdentifiers:(id)arg1 updatingApplicationIdentifiers:(id)arg2;	// IMP=0x000000010021d0a8
- (void)_workQueue_didUpdatePersonaEnabledApplicationsWithAddedApplicationIdentifiers:(id)arg1 removedApplicationIdentifiers:(id)arg2;	// IMP=0x000000010021cdb0
- (void)_workQueue_setSelectedUserProfile:(id)arg1;	// IMP=0x000000010021c964
- (void)removeObserver:(id)arg1;	// IMP=0x000000010021c830
- (void)addObserver:(id)arg1;	// IMP=0x000000010021c6fc
...
- (id)_init;	// IMP=0x000000010021bc34
- (id)_initWithAppInfoController:(id)arg1;	// IMP=0x000000010021b640
