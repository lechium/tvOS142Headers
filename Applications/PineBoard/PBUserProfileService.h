...
- (void).cxx_destruct;	// IMP=0x00000001000310c0
...
- (void)_handleUserProfileAccountNotification:(id)arg1;	// IMP=0x0000000100030cd0
- (void)_endIgnoringUserProfileAccountNotifications;	// IMP=0x000000010003099c
- (void)_beginIgnoringUserProfileAccountNotifications;	// IMP=0x00000001000306a4
- (void)removeUserProfileWithIdentifier:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100030304
- (void)updateUserProfileWithIdentifier:(id)arg1 attributes:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010002feb4
- (void)createUserProfileWithAttributes:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010002fa08
- (void)selectUserProfileWithIdentifier:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010002f528
- (void)fetchUserProfilesSnapshotWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010002f07c
- (void)setServiceDelegate:(id)arg1;	// IMP=0x000000010002ef58
- (void)_userProfileManagerDidUpdate;	// IMP=0x000000010002ec2c
- (void)dealloc;	// IMP=0x000000010002e9e4
- (id)initWithRemoteConnection:(id)arg1;	// IMP=0x000000010002e5f4
