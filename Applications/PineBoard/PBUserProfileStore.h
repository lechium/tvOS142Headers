...
- (void).cxx_destruct;	// IMP=0x0000000100098f50
...
- (id)_workQueue_updateUserProfileWithIdentifier:(id)arg1 attributes:(id)arg2 error:(id *)arg3;	// IMP=0x00000001000985d0
- (id)_workQueue_createUserProfileWithAttributes:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100098220
- (void)_workQueue_takeSnapshot;	// IMP=0x0000000100097ff0
- (id)_workQueue_updateUserProfileWithIdentifier:(id)arg1 usingBlock:(CDUnknownBlockType)arg2 error:(id *)arg3;	// IMP=0x0000000100097c14
- (void)_workQueue_removeUserProfileWithIdentifier:(id)arg1;	// IMP=0x0000000100097558
- (void)_workQueue_insertOrUpdateUserProfile:(id)arg1 removedSelectedUserProfile:(id)arg2;	// IMP=0x0000000100096dd4
- (void)_workQueue_insertOrUpdateUserProfile:(id)arg1;	// IMP=0x0000000100096d5c
- (_Bool)_workQueue_addUserProfile:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000965b8
- (void)_workQueue_writeUserProfilesArchive;	// IMP=0x00000001000962a4
- (void)_workQueue_initializeUserProfileStorage;	// IMP=0x0000000100095b74
- (void)save;	// IMP=0x0000000100095a98
- (void)performBatchUpdatesUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000010009546c
- (void)updateUserProfileWithIdentifier:(id)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000010009524c
- (void)removeUserProfileWithIdentifier:(id)arg1;	// IMP=0x0000000100095114
- (void)addUserProfile:(id)arg1;	// IMP=0x0000000100094fa8
...
- (id)initWithType:(long long)arg1;	// IMP=0x0000000100094ca4
