...
- (void).cxx_destruct;	// IMP=0x00000001001644a4
...
- (void)installAppWithMetadata:(id)arg1;	// IMP=0x000000010016320c
- (id)initWithRemoteConnection:(id)arg1;	// IMP=0x0000000100163124
- (id)init;	// IMP=0x00000001001630ec
