...
- (void).cxx_destruct;	// IMP=0x00000001000aeb30
@property(readonly, nonatomic) PBVolumeSlider *sliderView; // @synthesize sliderView=_sliderView;
- (void)_setContinuousCornerRadius:(double)arg1;	// IMP=0x00000001000aea0c
- (void)layoutSubviews;	// IMP=0x00000001000ae8f0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000ae00c
