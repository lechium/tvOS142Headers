...
- (void).cxx_destruct;	// IMP=0x00000001000902ac
...
- (void)sceneManager:(id)arg1 willDestroyScene:(id)arg2;	// IMP=0x00000001000900f8
- (void)sceneManager:(id)arg1 didCreateScene:(id)arg2;	// IMP=0x000000010009000c
- (void)sceneContentStateDidChange:(id)arg1;	// IMP=0x000000010008ff90
- (void)_didComplete;	// IMP=0x000000010008ff18
- (void)_begin;	// IMP=0x000000010008fc84
- (_Bool)_canBeInterrupted;	// IMP=0x000000010008fc64
@property(readonly, nonatomic) FBScene *readyDefaultKioskScene;
- (void)dealloc;	// IMP=0x000000010008fa0c
- (id)init;	// IMP=0x000000010008f7d8
