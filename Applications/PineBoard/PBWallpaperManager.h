...
+ (id)sharedInstance;	// IMP=0x0000000100168304
+ (id)dependencyDescription;	// IMP=0x0000000100168124
- (void).cxx_destruct;	// IMP=0x0000000100168c3c
...
- (void)prepareUIForSystemOverlayPresentationWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000100168b94
@property(readonly, nonatomic, getter=isPresenting) _Bool presenting;
- (void)updateWallpaperWithTransitionContext:(id)arg1;	// IMP=0x0000000100168ae8
- (void)dismissWallpaperAnimated:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001001689b0
- (void)presentWallpaperAnimated:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010016885c
- (id)init;	// IMP=0x00000001001683d4
