...
- (void).cxx_destruct;	// IMP=0x000000010015f340
...
- (void)sceneManager:(id)arg1 didChangeCurrentApplicationFromSceneHandle:(id)arg2 toSceneHandle:(id)arg3;	// IMP=0x000000010015f0b8
- (void)dismissContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x000000010015ee34
- (void)presentContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x000000010015ebb0
...
- (id)_wallpaperForApplicationSceneHandle:(id)arg1 withVariant:(long long)arg2;	// IMP=0x000000010015e9e0
- (void)_updateWallpaperForApplicationSceneHandle:(id)arg1;	// IMP=0x000000010015e874
- (void)updateWallpaperWithTransitionContext:(id)arg1;	// IMP=0x000000010015e478
- (void)setIdleModeActive:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x000000010015e0dc
- (void)viewDidLoad;	// IMP=0x000000010015e010
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x000000010015deb4
