...
+ (id)sharedInstance;	// IMP=0x00000001000b9358
- (void).cxx_destruct;	// IMP=0x00000001000ba6e4
- (void)_presentWhatsNewDialog;	// IMP=0x00000001000b9f44
- (void)_scheduleWhatsNewCheckTaskWithInterval:(double)arg1;	// IMP=0x00000001000b9b40
- (_Bool)_isHeadBoardAppFocused;	// IMP=0x00000001000b9aa8
@property(nonatomic) double checkTimeInterval;
- (void)noteGoodTimeToShowWhatsNew;	// IMP=0x00000001000b9808
- (void)startWhatsNewMonitoring;	// IMP=0x00000001000b9498
- (void)dealloc;	// IMP=0x00000001000b9428
