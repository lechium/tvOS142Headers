...
- (void).cxx_destruct;	// IMP=0x000000010006e9d0
...
- (void)dropFence;	// IMP=0x000000010006e930
- (id)initWithValue:(id)arg1 animationSettings:(id)arg2 animationFence:(id)arg3;	// IMP=0x000000010006e7c8
- (id)init;	// IMP=0x000000010006e6c4
