...
- (void).cxx_destruct;	// IMP=0x000000010008eb44
...
- (_Bool)_canBeInterrupted;	// IMP=0x000000010008ea58
- (void)_begin;	// IMP=0x000000010008e714
- (id)initWithViewController:(id)arg1 parentViewController:(id)arg2 animated:(_Bool)arg3 transitionBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000010008e554
