...
- (void).cxx_destruct;	// IMP=0x00000001000e2cec
@property(readonly, copy, nonatomic) CDUnknownBlockType generationBlock; // @synthesize generationBlock=_generationBlock;
- (void)cancel;	// IMP=0x00000001000e2c38
- (void)main;	// IMP=0x00000001000e27f0
- (id)initWithGenerationBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000001000e26c4
