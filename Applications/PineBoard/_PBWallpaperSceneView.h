...
+ (_Bool)isWallpaperRequired;	// IMP=0x000000010022ad24
- (void).cxx_destruct;	// IMP=0x000000010022bbf4
...
- (id)_newWallpaperView;	// IMP=0x000000010022b8f0
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010022b2a0
- (void)_setContinuousCornerRadius:(double)arg1;	// IMP=0x000000010022b0d8
- (id)initWithBundleIdentifier:(id)arg1 allowsGroupOpacity:(_Bool)arg2;	// IMP=0x000000010022ad44
