...
- (void).cxx_destruct;	// IMP=0x00000001001483fc
@property(retain, nonatomic) MTColorTheme *colorTheme; // @synthesize colorTheme=_colorTheme;
- (id)createMoreAction;	// IMP=0x00000001001483d8
- (void)setupActions;	// IMP=0x00000001001482d8
- (void)setAvailableActions:(id)arg1;	// IMP=0x0000000100148288
