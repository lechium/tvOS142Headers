...
- (void).cxx_destruct;	// IMP=0x0000000100089b00
...
- (void)layoutSubviews;	// IMP=0x0000000100089668
- (void)_updateGradientColors;	// IMP=0x00000001000894fc
- (id)_blurredImageForImage:(id)arg1;	// IMP=0x0000000100089464
- (id)initWithArtwork:(id)arg1 blendColor:(id)arg2;	// IMP=0x000000010008909c
- (id)init;	// IMP=0x0000000100089088
