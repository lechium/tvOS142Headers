...
- (void).cxx_destruct;	// IMP=0x00000001000f02dc
...
- (void)_updateBarMetricsForArtworkSize:(struct CGSize)arg1;	// IMP=0x00000001000f0030
- (id)_blurredArtworkForArtwork:(id)arg1;	// IMP=0x00000001000eff3c
- (_Bool)canBecomeFocused;	// IMP=0x00000001000eff34
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001000eff1c
- (void)layoutSubviews;	// IMP=0x00000001000efe54
@property(readonly, nonatomic) _Bool playing;
@property(nonatomic) long long playbackState;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000efb0c
