...
- (void).cxx_destruct;	// IMP=0x00000001000d966c
@property(retain, nonatomic) UIView *backgroundView; // @synthesize backgroundView=_backgroundView;
@property(nonatomic) _Bool floating; // @synthesize floating=_floating;
@property(readonly, nonatomic) UIView *contentView; // @synthesize contentView=_contentView;
- (void)layoutSubviews;	// IMP=0x00000001000d9544
- (void)configureSubviews;	// IMP=0x00000001000d94bc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000d9394
