...
- (id)description;	// IMP=0x00000001000423cc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100042318
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100042174
- (unsigned long long)hash;	// IMP=0x00000001000420e0
