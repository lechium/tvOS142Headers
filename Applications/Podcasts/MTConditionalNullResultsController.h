...
- (void)generator:(id)arg1 didChangeObject:(id)arg2 atIndexPath:(id)arg3 forChangeType:(unsigned long long)arg4 newIndexPath:(id)arg5;	// IMP=0x000000010012da94
- (void)controllerDidChangeContent:(id)arg1;	// IMP=0x000000010012d914
- (void)controller:(id)arg1 didChangeObject:(id)arg2 atIndexPath:(id)arg3 forChangeType:(unsigned long long)arg4 newIndexPath:(id)arg5;	// IMP=0x000000010012d910
- (id)_extraObjects;	// IMP=0x000000010012d7f4
- (id)allObjects;	// IMP=0x000000010012d758
- (void)_initializeFrc;	// IMP=0x000000010012d6a8
