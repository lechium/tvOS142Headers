...
+ (id)messageLabelWithFrame:(struct CGRect)arg1;	// IMP=0x000000010002c88c
- (void).cxx_destruct;	// IMP=0x000000010002db14
...
- (void)_sizeCategoryDidChange:(id)arg1;	// IMP=0x000000010002d958
- (void)_buttonClick;	// IMP=0x000000010002d8dc
- (void)layoutSubviews;	// IMP=0x000000010002d504
- (void)dealloc;	// IMP=0x000000010002cc18
- (id)initWithFrame:(struct CGRect)arg1 title:(id)arg2 message:(id)arg3;	// IMP=0x000000010002ca28
- (id)initWithFrame:(struct CGRect)arg1 title:(id)arg2;	// IMP=0x000000010002ca18
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010002ca08
