...
- (void).cxx_destruct;	// IMP=0x000000010011361c
...
- (void)addCallback:(CDUnknownBlockType)arg1;	// IMP=0x0000000100113568
- (id)initWithProperties:(id)arg1;	// IMP=0x000000010011322c
- (id)init;	// IMP=0x000000010011321c
