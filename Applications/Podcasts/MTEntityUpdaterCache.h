...
- (void).cxx_destruct;	// IMP=0x000000010008edf0
@property(copy, nonatomic) CDUnknownBlockType allowKeyForValue; // @synthesize allowKeyForValue=_allowKeyForValue;
- (void)enumerateUnvisitedItemUuids:(CDUnknownBlockType)arg1;	// IMP=0x000000010008ec90
- (void)_addDictionary:(id)arg1;	// IMP=0x000000010008eb78
- (void)addEntityToCache:(id)arg1;	// IMP=0x000000010008eb28
- (void)_buildMap;	// IMP=0x000000010008e890
- (id)propertyDictionaryForSearchItem:(id)arg1;	// IMP=0x000000010008e6e4
- (id)initWithPredicate:(id)arg1 entityName:(id)arg2 ctx:(id)arg3 properties:(id)arg4 fetchProperties:(id)arg5;	// IMP=0x000000010008e5b4
