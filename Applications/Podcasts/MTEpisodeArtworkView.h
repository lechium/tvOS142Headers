...
- (void).cxx_destruct;	// IMP=0x000000010002f08c
...
- (_Bool)canBecomeFocused;	// IMP=0x000000010002f024
- (void)_updateBarMetricsForArtworkSize:(struct CGSize)arg1;	// IMP=0x000000010002edcc
- (id)_blurredArtworkForArtwork:(id)arg1;	// IMP=0x000000010002ecd8
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010002e9cc
- (void)layoutSubviews;	// IMP=0x000000010002e85c
- (void)updatePlaybackState;	// IMP=0x000000010002e7c8
- (void)stopObservingPlaybackState;	// IMP=0x000000010002e768
- (void)startObservingPlaybackState;	// IMP=0x000000010002e700
@property(retain, nonatomic) UIImage *artwork;
- (void)dealloc;	// IMP=0x000000010002e2cc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010002e238
