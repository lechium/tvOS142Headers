...
+ (id)identifierWithPlayerItem:(id)arg1;	// IMP=0x00000001000234a8
+ (id)identifierWithEpisode:(id)arg1;	// IMP=0x0000000100023454
- (void).cxx_destruct;	// IMP=0x0000000100023c5c
...
- (_Bool)_hasFeedURL:(id)arg1;	// IMP=0x0000000100023afc
- (void)_updateWithPodcast:(id)arg1;	// IMP=0x00000001000239ac
- (id)initWithPlayerItem:(id)arg1;	// IMP=0x00000001000236f8
- (id)initWithEpisode:(id)arg1;	// IMP=0x00000001000234fc
