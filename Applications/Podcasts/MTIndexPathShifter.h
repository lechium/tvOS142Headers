...
- (void).cxx_destruct;	// IMP=0x0000000100127d9c
...
- (void)_setIndexPath:(unsigned long long)arg1;	// IMP=0x0000000100127c7c
- (void)_shiftIndexPath:(unsigned long long)arg1;	// IMP=0x0000000100127c18
- (void)processChangeAtIndexPath:(id)arg1 forChangeType:(unsigned long long)arg2 newIndexPath:(id)arg3;	// IMP=0x00000001001279a8
