...
- (void).cxx_destruct;	// IMP=0x0000000100037558
...
- (void)runQueryInContext:(id)arg1;	// IMP=0x0000000100037074
- (void)runQuery;	// IMP=0x0000000100036ff8
- (void)runQueryWithPodcastPredicate:(id)arg1 episodePredicate:(id)arg2;	// IMP=0x0000000100036f70
- (id)init;	// IMP=0x0000000100036f0c
