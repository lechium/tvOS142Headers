...
+ (_Bool)isMediaItemSyncedFromiTunes:(id)arg1;	// IMP=0x00000001000a0458
+ (id)propertiesForMediaItem;	// IMP=0x00000001000a02ac
+ (_Bool)isMissingAssetForItem:(id)arg1;	// IMP=0x00000001000a0134
+ (_Bool)isMissingFilePathForItem:(id)arg1;	// IMP=0x00000001000a00d4
+ (id)itemWithMPMediaItem:(id)arg1 isRestoreDownloadCandidate:(_Bool)arg2;	// IMP=0x000000010009f8e4
+ (id)itemWithMPMediaItem:(id)arg1;	// IMP=0x000000010009f8d4
- (void).cxx_destruct;	// IMP=0x00000001000a0688
...
- (id)description;	// IMP=0x00000001000a01e0
