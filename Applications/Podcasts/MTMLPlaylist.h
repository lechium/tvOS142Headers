...
+ (id)playlistWithMPPlaylist:(id)arg1;	// IMP=0x000000010009a4e4
- (void).cxx_destruct;	// IMP=0x000000010009ab60
...
- (id)description;	// IMP=0x000000010009a9d0
- (_Bool)isEmpty;	// IMP=0x000000010009a834
- (id)children;	// IMP=0x000000010009a82c
- (void)addChild:(id)arg1;	// IMP=0x000000010009a7b8
