...
- (struct _MRSystemAppPlaybackQueue *)createRemotePlaybackQueue;	// IMP=0x00000001000046f0
- (id)initWithContextID:(id)arg1 playbackQueueRef:(struct _MRSystemAppPlaybackQueue *)arg2;	// IMP=0x00000001000046a0
- (id)initWithPlaybackQueueRef:(struct _MRSystemAppPlaybackQueue *)arg1;	// IMP=0x000000010000468c
