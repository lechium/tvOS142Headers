...
- (void).cxx_destruct;	// IMP=0x0000000100050234
...
- (void)controllerDidChangeContent:(id)arg1;	// IMP=0x0000000100050154
- (void)controller:(id)arg1 didChangeObject:(id)arg2 atIndexPath:(id)arg3 forChangeType:(unsigned long long)arg4 newIndexPath:(id)arg5;	// IMP=0x000000010004ffc0
- (void)_updateSortOrder;	// IMP=0x000000010004fdc0
- (void)_processResults:(id)arg1;	// IMP=0x000000010004fba4
- (id)initWithMediaQuery:(id)arg1 initialItem:(id)arg2;	// IMP=0x000000010004f670
