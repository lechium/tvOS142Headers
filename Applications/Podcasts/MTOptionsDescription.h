...
+ (id)optionsWithLongTitles:(id)arg1 shortTitles:(id)arg2 valueList:(id)arg3;	// IMP=0x000000010010c9f4
+ (id)optionsWithLongTitles:(id)arg1 shortTitles:(id)arg2 valueList:(id)arg3 footerTextCallback:(CDUnknownBlockType)arg4 headerTextCallback:(CDUnknownBlockType)arg5;	// IMP=0x000000010010c8e0
- (void).cxx_destruct;	// IMP=0x000000010010cb90
...
- (unsigned long long)valueForIndex:(unsigned long long)arg1;	// IMP=0x000000010010cadc
- (unsigned long long)indexForValue:(unsigned long long)arg1;	// IMP=0x000000010010ca7c
