...
+ (id)eventWithAccessLog:(id)arg1 dataSource:(id)arg2;	// IMP=0x000000010008ce18
- (void).cxx_destruct;	// IMP=0x000000010008da80
...
- (id)description;	// IMP=0x000000010008d934
- (unsigned long long)hash;	// IMP=0x000000010008d8a8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010008d764
- (id)_data;	// IMP=0x000000010008d048
- (void)record;	// IMP=0x000000010008cf74
- (id)initWithAccessLogEvent:(id)arg1 dataSource:(id)arg2;	// IMP=0x000000010008ce90
