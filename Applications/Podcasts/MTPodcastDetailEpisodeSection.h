...
+ (id)dependentPropertyKeys;	// IMP=0x00000001000844b0
- (void).cxx_destruct;	// IMP=0x0000000100084940
...
- (void)controllerDidChangeContent:(id)arg1;	// IMP=0x0000000100084888
- (void)controllerWillChangeContent:(id)arg1;	// IMP=0x0000000100084840
- (void)controller:(id)arg1 didChangeObject:(id)arg2 atIndexPath:(id)arg3 forChangeType:(unsigned long long)arg4 newIndexPath:(id)arg5;	// IMP=0x0000000100084748
- (unsigned long long)indexOfEpisode:(id)arg1;	// IMP=0x00000001000846a0
- (id)episodes;	// IMP=0x000000010008464c
- (void)loadData;	// IMP=0x0000000100084640
- (void)initializeFrc;	// IMP=0x00000001000842f4
