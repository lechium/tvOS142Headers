...
- (void).cxx_destruct;	// IMP=0x00000001000d23a4
@property(nonatomic) _Bool on; // @synthesize on=_on;
@property(copy, nonatomic) CDUnknownBlockType action; // @synthesize action=_action;
- (void)buttonTapped:(id)arg1;	// IMP=0x00000001000d22ac
- (void)layoutSubviews;	// IMP=0x00000001000d1f88
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000d1c7c
