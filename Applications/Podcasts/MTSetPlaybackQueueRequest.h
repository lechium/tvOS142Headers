...
+ (id)requestWithContext:(id)arg1;	// IMP=0x0000000100144c94
- (void).cxx_destruct;	// IMP=0x0000000100144f0c
...
- (void)finishWithStatus:(long long)arg1;	// IMP=0x0000000100144dfc
- (_Bool)validate;	// IMP=0x0000000100144d0c
