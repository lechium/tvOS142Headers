...
+ (double)height;	// IMP=0x000000010014e080
- (void).cxx_destruct;	// IMP=0x000000010014e420
...
- (void)_ensureFocusedFloatingContentView;	// IMP=0x000000010014e2c8
- (void)configureSubviews;	// IMP=0x000000010014e25c
- (void)prepareForReuse;	// IMP=0x000000010014e1f4
- (void)updatePlayStatusForCurrentPlayerItemDidChange;	// IMP=0x000000010014e198
- (void)dealloc;	// IMP=0x000000010014e0f8
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000010014e08c
