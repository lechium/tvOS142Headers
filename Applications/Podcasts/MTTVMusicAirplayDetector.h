...
- (void).cxx_destruct;	// IMP=0x0000000100131f4c
...
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x0000000100131d4c
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000100131bf0
