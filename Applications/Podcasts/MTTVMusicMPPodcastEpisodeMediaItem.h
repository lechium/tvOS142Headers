...
+ (double)_playedThresholdTimeForDuration:(double)arg1;	// IMP=0x000000010007bd00
...
- (void)performMediaItemMetadataTransactionWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000010007bce8
- (void)removeMediaItemMetadataForProperty:(id)arg1;	// IMP=0x000000010007bcd0
- (void)setMediaItemMetadata:(id)arg1 forProperty:(id)arg2;	// IMP=0x000000010007bc78
- (id)reportingDelegate;	// IMP=0x000000010007bc70
- (_Bool)hasTrait:(id)arg1;	// IMP=0x000000010007bbf8
- (_Bool)isEqualToMediaItem:(id)arg1;	// IMP=0x000000010007bb04
- (id)mediaItemURL;	// IMP=0x000000010007bafc
- (id)mediaItemMetadataForProperty:(id)arg1;	// IMP=0x000000010007b404
- (id)initWithPlayerResponseItem:(id)arg1;	// IMP=0x000000010007b3f4
- (id)initWithPlayerResponseItem:(id)arg1 mediaItemMetadata:(id)arg2;	// IMP=0x000000010007b2cc
