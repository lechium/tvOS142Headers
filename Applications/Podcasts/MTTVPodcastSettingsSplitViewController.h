...
+ (double)rightViewControllerTopMargin;	// IMP=0x00000001000ce508
- (void).cxx_destruct;	// IMP=0x00000001000ce78c
...
- (void)_updateTitle;	// IMP=0x00000001000ce514
- (void)viewDidLoad;	// IMP=0x00000001000ce1d4
- (id)initWithPodcast:(id)arg1 delegate:(id)arg2;	// IMP=0x00000001000ce110
- (id)initWithPodcast:(id)arg1;	// IMP=0x00000001000ce100
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000001000ce0f0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000ce0e0
