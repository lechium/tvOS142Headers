...
+ (id)loadingScreen;	// IMP=0x0000000100031f60
- (void).cxx_destruct;	// IMP=0x0000000100033294
...
- (id)_textForUserSwitchState:(long long)arg1;	// IMP=0x00000001000330cc
- (_Bool)isVisible;	// IMP=0x000000010003309c
- (void)hide;	// IMP=0x0000000100032b34
- (void)_timeout;	// IMP=0x0000000100032af0
- (void)showOverKeyWindowUserSwitchState:(long long)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010003201c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100031ed0
