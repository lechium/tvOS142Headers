...
- (void).cxx_destruct;	// IMP=0x00000001000b356c
...
- (void)_lookupEpisodeUuidIfNecessaryFromURLString:(id)arg1;	// IMP=0x00000001000b32a0
- (void)_lookupPodcastUuidIfNecessaryFromURLString:(id)arg1;	// IMP=0x00000001000b3044
- (void)_loadQueryParameterValuesFromString:(id)arg1;	// IMP=0x00000001000b2b04
- (id)copyWithPlayReason:(unsigned long long)arg1;	// IMP=0x00000001000b2ad8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000b298c
- (id)initWithURLString:(id)arg1;	// IMP=0x00000001000b2900
