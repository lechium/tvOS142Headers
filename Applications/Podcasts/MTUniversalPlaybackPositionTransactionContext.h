...
+ (id)UPPDomainVersion;	// IMP=0x000000010007f8f0
+ (void)setUPPDomainVersion:(id)arg1;	// IMP=0x000000010007f84c
- (void).cxx_destruct;	// IMP=0x000000010007f994
...
- (id)lastSyncedDomainVersion;	// IMP=0x000000010007f954
