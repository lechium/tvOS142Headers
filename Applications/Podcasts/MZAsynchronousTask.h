...
- (void).cxx_destruct;	// IMP=0x0000000100044570
...
- (void)invokeTaskCompletionBlocksWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000100043ff8
- (void)addTaskCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000100043f3c
- (void)invalidate;	// IMP=0x0000000100043edc
- (void)_invalidateTaskAssertionForced:(_Bool)arg1;	// IMP=0x0000000100043cf0
- (void)endTaskOperation;	// IMP=0x0000000100043cb4
- (void)finishTaskOperationWithResult:(id)arg1 error:(id)arg2;	// IMP=0x0000000100043aac
- (void)beginTaskOperation;	// IMP=0x000000010004372c
...
- (void)_onQueueFireExpirationHandlerIfNecesary;	// IMP=0x00000001000431cc
...
- (id)description;	// IMP=0x0000000100042c30
- (void)_invalidateAssertionTimer;	// IMP=0x0000000100042b48
- (void)_invalidateTaskTimer;	// IMP=0x0000000100042a60
- (void)dealloc;	// IMP=0x0000000100042984
- (id)initWithHandlerQueue:(id)arg1 taskTimeout:(double)arg2 assertionTimeout:(double)arg3 debugDescription:(id)arg4;	// IMP=0x0000000100042540
