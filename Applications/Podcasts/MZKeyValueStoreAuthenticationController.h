...
- (void).cxx_destruct;	// IMP=0x00000001000582e8
...
- (void)resetAcceptedCredentials;	// IMP=0x0000000100057f3c
- (id)authenticationErrorsForTransaction:(id)arg1;	// IMP=0x0000000100057df8
- (_Bool)shouldForceAuthenticationForTransaction:(id)arg1;	// IMP=0x0000000100057d50
- (_Bool)isAuthenticationValidForTransaction:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100057c40
- (id)init;	// IMP=0x0000000100057bb0
