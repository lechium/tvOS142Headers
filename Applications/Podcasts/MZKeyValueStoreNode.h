...
+ (id)assetIDForKey:(id)arg1 withPrefix:(id)arg2;	// IMP=0x0000000100071ad0
+ (id)keysWithPrefix:(id)arg1 assetIDs:(id)arg2;	// IMP=0x0000000100071914
+ (id)keyWithPrefix:(id)arg1 assetID:(id)arg2;	// IMP=0x0000000100071850
+ (id)keyValueStoreDataFirstRevision;	// IMP=0x00000001000717fc
+ (id)keyValueStoreDataCurrentRevision;	// IMP=0x00000001000717a8
+ (_Bool)isServerRevisionNewerThanClient:(id)arg1;	// IMP=0x00000001000716ec
+ (void)setServerRevisionNewerThanClient:(id)arg1;	// IMP=0x0000000100071618
+ (id)serverRevisionNewerThanClientKeys;	// IMP=0x00000001000715ac
- (void).cxx_destruct;	// IMP=0x00000001000722b4
...
- (id)objectValueMatchingClass:(Class)arg1;	// IMP=0x0000000100071cb4
- (_Bool)hasData;	// IMP=0x0000000100071c64
- (id)description;	// IMP=0x0000000100071b74
- (id)init;	// IMP=0x0000000100071b34
