...
- (void).cxx_destruct;	// IMP=0x000000010007ae40
...
- (void)invalidate;	// IMP=0x000000010007ad6c
- (void)_expireBackgroundTask;	// IMP=0x000000010007ab84
@property(retain, nonatomic) BKSProcessAssertion *bkProcessAssertion; // @synthesize bkProcessAssertion=_bkProcessAssertion;
- (id)_onQueueGetBkProcessAssertion;	// IMP=0x000000010007aa28
- (void)_onQueueSetBkProcessAssertion:(id)arg1;	// IMP=0x000000010007a784
- (void)dealloc;	// IMP=0x000000010007a6f4
- (id)description;	// IMP=0x000000010007a660
- (id)initWithExpirationBlock:(CDUnknownBlockType)arg1 debugDescription:(id)arg2;	// IMP=0x000000010007a264
