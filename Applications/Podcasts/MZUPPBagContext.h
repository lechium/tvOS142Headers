...
+ (void)loadBagContextFromIMURLBag:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000001000515a4
+ (double)defaultPollingInterval;	// IMP=0x000000010005148c
- (void).cxx_destruct;	// IMP=0x000000010005216c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100051498
