...
- (void)_applicationDidBecomeActiveNotification:(id)arg1;	// IMP=0x000000010005726c
- (void)_applicationWillResignActiveNotification:(id)arg1;	// IMP=0x0000000100057214
- (void)setMarqueeRunning:(_Bool)arg1;	// IMP=0x0000000100057208
- (void)setMarqueeEnabled:(_Bool)arg1;	// IMP=0x0000000100057204
- (void)_startMarqueeIfNeeded;	// IMP=0x0000000100055b30
- (_Bool)_shouldCycle;	// IMP=0x0000000100055ae0
- (void)_clearLabelTextContents;	// IMP=0x0000000100055934
- (void)_prepareNextMarquee;	// IMP=0x000000010005591c
- (void)_nextAttributedString;	// IMP=0x000000010005547c
- (id)_imageForText:(_Bool)arg1;	// IMP=0x000000010005526c
- (void)drawTextInRect:(struct CGRect)arg1;	// IMP=0x0000000100055078
- (void)stopAndResetScrollWithDuration:(double)arg1;	// IMP=0x000000010005492c
- (void)stopAnimatingWithoutResetWithDuration:(double)arg1;	// IMP=0x000000010005489c
- (void)stopAnimating;	// IMP=0x00000001000547e0
- (void)setNeedsDisplay;	// IMP=0x000000010005444c
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000100054374
- (void)_clearAttributedStrings;	// IMP=0x00000001000541e0
- (void)setAttributedText:(id)arg1;	// IMP=0x0000000100054120
- (void)setText:(id)arg1;	// IMP=0x00000001000540a0
- (void)dealloc;	// IMP=0x0000000100054028
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100053d84
