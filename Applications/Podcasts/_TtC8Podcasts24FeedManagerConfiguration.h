...
+ (id)watchConfiguration;	// IMP=0x00000001001813dc
+ (id)homepodConfiguration;	// IMP=0x000000010018123c
+ (id)defaultConfiguration;	// IMP=0x00000001001810ac
- (void).cxx_destruct;	// IMP=0x0000000100181504
- (id)init;	// IMP=0x0000000100181554
- (id)initWithTimeoutIntervalForResource:(double)arg1 workQueueConcurrent:(_Bool)arg2 useBackgroundFetchForFeedDownloads:(_Bool)arg3 keepsFeedFileInTempDirAfterDownload:(_Bool)arg4 supportsBatchInsertion:(_Bool)arg5 usesCleanEpisodeTitles:(_Bool)arg6;	// IMP=0x0000000100181434
