...
+ (id)activationEngineWithOverrideActivationURL:(id)arg1 sessionURL:(id)arg2;	// IMP=0x00000001000277e8
- (void).cxx_destruct;	// IMP=0x0000000100029690
...
- (void)URLSession:(id)arg1 task:(id)arg2 willPerformHTTPRedirection:(id)arg3 newRequest:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000001000293a8
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x00000001000290e0
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x0000000100029040
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000100028f70
- (void)makeRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100028e3c
- (void)tryActivateWithOptions:(id)arg1 requestMutator:(CDUnknownBlockType)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000100028a30
- (void)_sendSessionRequest:(id)arg1 withOptions:(id)arg2;	// IMP=0x00000001000280c8
- (id)_newActivationRequestWithOptions:(id)arg1 sessionData:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100027b2c
@property(readonly, nonatomic) NSURLSession *session;
- (void)_cleanup;	// IMP=0x00000001000279d0
- (void)cancel;	// IMP=0x0000000100027900
- (id)initWithOverrideActivationURL:(id)arg1 sessionURL:(id)arg2;	// IMP=0x000000010002785c
