...
- (void).cxx_destruct;	// IMP=0x0000000100070048
...
- (void)_setUpUI;	// IMP=0x000000010006fa78
- (void)_didSelectAuxiliaryButton;	// IMP=0x000000010006fa24
- (void)_didSelectFooterButton;	// IMP=0x000000010006f9d0
- (void)_didSelectButton:(id)arg1;	// IMP=0x000000010006f90c
- (_Bool)_hasAuxiliaryButton;	// IMP=0x000000010006f7fc
- (_Bool)_hasFooterButton;	// IMP=0x000000010006f6ec
- (id)_newFooterButton;	// IMP=0x000000010006f640
- (id)_newDefaultButton;	// IMP=0x000000010006f3a8
- (id)_choiceHeaderButton;	// IMP=0x000000010006f370
- (void)_populateView;	// IMP=0x000000010006ea60
- (struct CGSize)_computeFramesForBounds:(struct CGRect)arg1 forCalculationOnly:(_Bool)arg2;	// IMP=0x000000010006dde8
- (void)setChoice:(unsigned long long)arg1 enabled:(_Bool)arg2;	// IMP=0x000000010006dcb0
- (void)reloadData;	// IMP=0x000000010006dca4
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000010006dac8
- (_Bool)canBecomeFocused;	// IMP=0x000000010006da44
- (id)preferredFocusEnvironments;	// IMP=0x000000010006d8f4
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010006d8d0
- (void)layoutSubviews;	// IMP=0x000000010006d86c
@property(readonly, nonatomic) UIView *buttonContainerView;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010006d808
- (id)initWithChoiceViewStyle:(long long)arg1 frame:(struct CGRect)arg2;	// IMP=0x000000010006d7a0
