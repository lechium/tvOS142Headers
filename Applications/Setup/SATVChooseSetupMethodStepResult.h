...
+ (id)new;	// IMP=0x00000001000084b4
- (void).cxx_destruct;	// IMP=0x00000001000087e4
...
- (id)initWithTapToSetupDeviceInfo:(id)arg1;	// IMP=0x0000000100008510
- (id)init;	// IMP=0x00000001000084d8
