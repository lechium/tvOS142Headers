...
+ (id)labelWithFont:(id)arg1 andColor:(id)arg2;	// IMP=0x00000001000241f8
...
- (void)_addLayoutContraintsForSubviews;	// IMP=0x0000000100023ef4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100023ad0
