...
- (void).cxx_destruct;	// IMP=0x000000010000c0c4
...
- (id)_pairingHelpStringWithString:(id)arg1;	// IMP=0x000000010000bb30
- (id)_orderedLanguageStringsForKey:(id)arg1;	// IMP=0x000000010000b94c
- (void)_generateLanguageCodes;	// IMP=0x000000010000b55c
- (void)_notifyPineBoard;	// IMP=0x000000010000b4f8
- (id)localizedString:(id)arg1 forLanguage:(id)arg2;	// IMP=0x000000010000b220
@property(nonatomic) _Bool localeCommitted;
@property(nonatomic) _Bool languageCommitted;
- (_Bool)commitLanguageWillRestartSystem;	// IMP=0x000000010000aeb4
- (void)commitRegion;	// IMP=0x000000010000adfc
- (_Bool)commitLocaleWillRestartSystem;	// IMP=0x000000010000ac80
- (void)commitLanguage;	// IMP=0x000000010000aabc
- (id)regionOtherStringWithUserSelectedLanguageCode;	// IMP=0x000000010000aa54
- (id)regionHeaderStringWithUserSelectedLanguageCode;	// IMP=0x000000010000a9ec
@property(readonly, nonatomic) NSArray *orderedGreetingLanguageCodes;
- (id)languageCodeWithGuessedRegionForCode:(id)arg1;	// IMP=0x000000010000a834
- (id)languageHeaderStringForLanguageCode:(id)arg1;	// IMP=0x000000010000a81c
