...
- (void).cxx_destruct;	// IMP=0x0000000100074fec
...
- (void)setTitle:(id)arg1 subtitle:(id)arg2 languageCode:(id)arg3 animated:(_Bool)arg4;	// IMP=0x0000000100074714
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001000746a8
- (void)layoutSubviews;	// IMP=0x00000001000745b0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010007446c
