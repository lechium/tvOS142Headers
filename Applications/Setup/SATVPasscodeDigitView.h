...
- (void).cxx_destruct;	// IMP=0x0000000100035aa4
...
- (id)_labelFont;	// IMP=0x00000001000358cc
- (id)hiddenDigitImage;	// IMP=0x0000000100035628
- (id)arrowImage:(_Bool)arg1;	// IMP=0x0000000100035408
- (void)downGesture:(id)arg1;	// IMP=0x00000001000352e0
- (void)upGesture:(id)arg1;	// IMP=0x00000001000351cc
@property(copy, nonatomic) NSString *text;
- (void)setHighlightProgress:(double)arg1;	// IMP=0x00000001000350c0
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000100034f88
- (_Bool)canBecomeFocused;	// IMP=0x0000000100034f80
- (void)layoutSubviews;	// IMP=0x0000000100034d08
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100034708
