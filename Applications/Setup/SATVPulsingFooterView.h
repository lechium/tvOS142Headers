...
- (void).cxx_destruct;	// IMP=0x000000010003edc8
...
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x000000010003ebe4
- (void)pulseAtBeginTime:(double)arg1;	// IMP=0x000000010003e9dc
- (void)layoutSubviews;	// IMP=0x000000010003e8d4
- (id)initWithMode:(unsigned long long)arg1;	// IMP=0x000000010003e874
