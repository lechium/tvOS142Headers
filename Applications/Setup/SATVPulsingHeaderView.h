...
- (void).cxx_destruct;	// IMP=0x000000010003e864
...
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x000000010003e680
- (void)pulseAtBeginTime:(double)arg1;	// IMP=0x000000010003e054
- (void)layoutSubviews;	// IMP=0x000000010003df4c
- (id)initWithMode:(unsigned long long)arg1;	// IMP=0x000000010003deec
