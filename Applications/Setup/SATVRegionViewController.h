...
- (void).cxx_destruct;	// IMP=0x0000000100007300
...
- (id)tableView:(id)arg1 viewForHeaderInSection:(long long)arg2;	// IMP=0x00000001000071cc
- (double)tableView:(id)arg1 heightForHeaderInSection:(long long)arg2;	// IMP=0x00000001000070fc
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x0000000100006df0
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x0000000100006d24
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x0000000100006b84
- (long long)numberOfSectionsInTableView:(id)arg1;	// IMP=0x0000000100006b58
- (long long)tableView:(id)arg1 sectionForSectionIndexTitle:(id)arg2 atIndex:(long long)arg3;	// IMP=0x0000000100006b50
- (id)sectionIndexTitlesForTableView:(id)arg1;	// IMP=0x0000000100006b40
- (void)_configureSectionIndex;	// IMP=0x000000010000666c
- (id)_countryAtSectionIndexPath:(id)arg1;	// IMP=0x0000000100006514
- (void)countryScanCompleted:(id)arg1;	// IMP=0x00000001000063f0
- (id)preferredFocusEnvironments;	// IMP=0x0000000100006368
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000001000062f4
- (void)viewDidLoad;	// IMP=0x0000000100005cc0
- (void)autoAdvance;	// IMP=0x0000000100005bd4
- (void)dealloc;	// IMP=0x0000000100005b5c
- (id)init;	// IMP=0x0000000100005a90
