...
- (void).cxx_destruct;	// IMP=0x00000001000041f4
...
- (void)_submitButtonAction:(id)arg1;	// IMP=0x0000000100004044
- (void)_handleMenuButton:(id)arg1;	// IMP=0x0000000100003fe0
- (void)_textChanged;	// IMP=0x0000000100003f0c
- (id)preferredFocusEnvironments;	// IMP=0x0000000100003e98
- (void)_doneButtonPressed:(id)arg1;	// IMP=0x0000000100003a44
- (_Bool)_enableAutomaticKeyboardPressDone;	// IMP=0x0000000100003a3c
- (_Bool)_disableAutomaticKeyboardUI;	// IMP=0x0000000100003a34
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000001000039c4
- (void)loadView;	// IMP=0x000000010000352c
