...
- (void).cxx_destruct;	// IMP=0x000000010004a778
...
- (void)_gridAlignFrame:(struct CGRect *)arg1;	// IMP=0x000000010004a644
- (void)setSystemInputView:(id)arg1 touchInputEnabled:(_Bool)arg2;	// IMP=0x000000010004a4b8
- (void)layoutSubviews;	// IMP=0x000000010004a0b0
- (void)updateConstraints;	// IMP=0x0000000100049d28
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100049b18
