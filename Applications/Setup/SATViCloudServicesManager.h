...
+ (id)sharedServicesManager;	// IMP=0x0000000100064278
- (void).cxx_destruct;	// IMP=0x000000010006557c
...
- (id)_ckContainerIdentifier;	// IMP=0x0000000100065450
- (void)_cancelFetchingCloudChangesForiCloudUser;	// IMP=0x00000001000653c0
- (void)_cancelRequestTimeoutTimer;	// IMP=0x0000000100065334
- (void)_startRequestTimeoutTimer;	// IMP=0x0000000100064f28
- (id)_desiredZoneIDWithName:(id)arg1 fromMapping:(id)arg2;	// IMP=0x0000000100064d38
- (id)_zoneNameWithiCloudCredentials;	// IMP=0x0000000100064c58
- (void)beginFetchingCloudChangesForiCloudUser;	// IMP=0x000000010006442c
- (void)resetInfo;	// IMP=0x000000010006435c
- (id)init;	// IMP=0x00000001000642e4
