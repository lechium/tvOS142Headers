...
+ (id)configuration;	// IMP=0x00000001000825e4
+ (id)new;	// IMP=0x00000001000825dc
- (void).cxx_destruct;	// IMP=0x0000000100082750
...
- (id)identifierForService:(long long)arg1;	// IMP=0x00000001000826a4
- (id)domainForService:(long long)arg1;	// IMP=0x000000010008265c
- (id)init;	// IMP=0x00000001000825c4
- (id)_init;	// IMP=0x0000000100082504
