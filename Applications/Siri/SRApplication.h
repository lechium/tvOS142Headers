...
+ (id)sharedApplication;	// IMP=0x000000010004b578
- (void).cxx_destruct;	// IMP=0x000000010004b66c
@property(nonatomic) __weak id <SRApplicationDataSource> dataSource; // @synthesize dataSource=_dataSource;
- (void)setFrontMostAppOrientation:(long long)arg1;	// IMP=0x000000010004b628
- (long long)_frontMostAppOrientation;	// IMP=0x000000010004b618
- (long long)launchOrientation;	// IMP=0x000000010004b608
