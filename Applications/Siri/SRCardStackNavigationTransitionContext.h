...
- (void).cxx_destruct;	// IMP=0x0000000100075410
...
- (void)completeTransition:(_Bool)arg1;	// IMP=0x00000001000751ec
@property(readonly, nonatomic) long long semanticContentAttribute;
- (id)init;	// IMP=0x000000010007514c
- (id)initWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000001000750cc
