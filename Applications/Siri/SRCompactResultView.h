...
- (void).cxx_destruct;	// IMP=0x000000010009e850
...
- (id)_snippetRemovalAnimation;	// IMP=0x000000010009e368
- (id)_snippetInsertAnimation;	// IMP=0x000000010009df78
- (void)contentPlatterViewScrolledToContentOffset:(struct CGPoint)arg1;	// IMP=0x000000010009df18
- (void)contentPlatterView:(id)arg1 didScrollWithContentOffset:(struct CGPoint)arg2;	// IMP=0x000000010009dec4
- (void)_overlayButtonWasTouchedUpInside:(id)arg1;	// IMP=0x000000010009de7c
- (struct CGSize)_maxSizeForSnippet;	// IMP=0x000000010009ddc4
- (_Bool)_snippetViewIsLoading;	// IMP=0x000000010009dc14
- (void)relayout;	// IMP=0x000000010009d96c
- (void)layoutSubviews;	// IMP=0x000000010009d7b4
- (void)setNeedsLayout;	// IMP=0x000000010009d744
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000010009d6ec
@property(readonly, nonatomic) struct CGSize portraitContentSize;
- (void)snippetContentDidUpdate;	// IMP=0x000000010009d6a4
- (void)setDarkenIntensity:(double)arg1 animated:(_Bool)arg2;	// IMP=0x000000010009d4b4
- (void)setShowDimmingView:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x000000010009d3e4
- (void)setShowSnippetView:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x000000010009d158
- (void)setSnippetView:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010009cde8
