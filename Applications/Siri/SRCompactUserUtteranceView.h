...
- (void)_setStreamingText:(id)arg1;	// IMP=0x000000010003caac
- (void)_handleTap:(id)arg1;	// IMP=0x000000010003c9b8
- (id)_createStreamingTextViewForEmojisOnly:(_Bool)arg1;	// IMP=0x000000010003c87c
- (void)layoutSubviews;	// IMP=0x000000010003c6e0
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010003c5c4
- (void)setSpeechRecognitionHypothesis:(id)arg1;	// IMP=0x000000010003c458
- (id)initWithContentInsets:(struct UIEdgeInsets)arg1 cornerRadius:(double)arg2;	// IMP=0x000000010003c160
