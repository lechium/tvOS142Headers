...
- (void).cxx_destruct;	// IMP=0x000000010004fc3c
...
- (id)_instrumentationManager;	// IMP=0x000000010004fbc0
@property(readonly, nonatomic) _Bool alwaysShowRecognizedSpeech;
- (void)revealUserUtterance:(id)arg1 backingAceObject:(id)arg2;	// IMP=0x000000010004fa98
- (id)_serverUtterancesToDisplay;	// IMP=0x000000010004f6a0
- (id)_userUtteranceForConversationItem:(id)arg1;	// IMP=0x000000010004f544
- (void)_processInsertedConversationItems:(id)arg1;	// IMP=0x000000010004e818
- (void)_processUpdatedConversationItemsAtIndexPaths:(id)arg1;	// IMP=0x000000010004e120
- (void)conversationDidChangeWithTransaction:(id)arg1;	// IMP=0x000000010004dca8
- (void)_processInitialConversationItems;	// IMP=0x000000010004dbc8
- (unsigned long long)_generateDiffFromViewModel:(id)arg1 toViewModel:(id)arg2;	// IMP=0x000000010004d7c0
- (void)_notifyObserverOfViewModelChangeWithDiff:(unsigned long long)arg1;	// IMP=0x000000010004d740
- (id)initWithConversation:(id)arg1 delegate:(id)arg2;	// IMP=0x000000010004d620
