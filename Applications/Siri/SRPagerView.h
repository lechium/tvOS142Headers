...
- (void).cxx_destruct;	// IMP=0x00000001000889b0
...
- (void)_scrollingDidEnd;	// IMP=0x00000001000888b8
- (id)_activePageViewBasedOnScrollViewPosition;	// IMP=0x000000010008870c
- (_Bool)_multiplePageViewsAreVisible;	// IMP=0x0000000100088570
- (_Bool)_containsPageView:(id)arg1;	// IMP=0x0000000100088520
- (id)_pageViews;	// IMP=0x0000000100088508
- (void)scrollViewDidEndDragging:(id)arg1 willDecelerate:(_Bool)arg2;	// IMP=0x00000001000884f4
- (void)scrollViewDidEndDecelerating:(id)arg1;	// IMP=0x00000001000884e8
- (void)scrollViewWillBeginDragging:(id)arg1;	// IMP=0x00000001000884d8
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x00000001000884a0
- (void)_updateTransitionState;	// IMP=0x00000001000883dc
@property(nonatomic, getter=isPagingEnabled) _Bool pagingEnabled;
- (void)setActivePageView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000100088294
- (void)removePageView:(id)arg1;	// IMP=0x00000001000880dc
- (void)addPageView:(id)arg1;	// IMP=0x000000010008805c
- (void)insertPageView:(id)arg1 atIndex:(long long)arg2;	// IMP=0x0000000100087f04
- (void)reloadData;	// IMP=0x0000000100087d00
- (void)layoutSubviews;	// IMP=0x0000000100087b70
- (void)didMoveToWindow;	// IMP=0x0000000100087b20
- (id)initWithFrame:(struct CGRect)arg1 textInputEnabled:(_Bool)arg2;	// IMP=0x0000000100087a44
