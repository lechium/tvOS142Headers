...
- (void).cxx_destruct;	// IMP=0x0000000100081eb0
...
- (void)speechSynthesizer:(id)arg1 didFinishSynthesisRequest:(id)arg2 withInstrumentMetrics:(id)arg3 error:(id)arg4;	// IMP=0x0000000100081b8c
- (_Bool)handlePreSynthesisCommandWithError:(id *)arg1;	// IMP=0x0000000100081100
- (id)init;	// IMP=0x0000000100080720
