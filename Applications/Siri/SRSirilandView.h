...
+ (id)sirilandView;	// IMP=0x000000010007ff80
- (void).cxx_destruct;	// IMP=0x00000001000806a8
...
- (void)statusBarFrameDidChange;	// IMP=0x0000000100080538
- (_Bool)_keylineIsVisible;	// IMP=0x0000000100080500
- (void)layoutSubviews;	// IMP=0x00000001000801e8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010007ff94
