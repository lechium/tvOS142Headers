...
+ (id)gatekeeperForAceObject:(id)arg1 currentTurnContext:(id)arg2;	// IMP=0x0000000100033738
+ (id)gatekeeperForRequestOptions:(id)arg1 currentTurnContext:(id)arg2;	// IMP=0x00000001000336a4
- (void).cxx_destruct;	// IMP=0x0000000100034764
...
- (_Bool)viewContainsFocusItem:(id)arg1;	// IMP=0x0000000100034638
- (id)updatedFocusItemForCurrentFocusItem:(id)arg1;	// IMP=0x0000000100034580
- (id)preferredFocusEnvironments;	// IMP=0x0000000100034508
- (void)layoutSubviews;	// IMP=0x00000001000342d0
- (unsigned long long)_gatekeeperTypeForBundleIdentifier:(id)arg1;	// IMP=0x000000010003422c
- (void)_logGatekeeperDismissedManually;	// IMP=0x00000001000340e4
- (void)logGatekeeperAppeared;	// IMP=0x0000000100033f9c
- (void)_dismissalButtonTapped:(id)arg1;	// IMP=0x0000000100033d3c
- (void)dealloc;	// IMP=0x0000000100033c28
- (id)initWithAceObject:(id)arg1 currentTurnContext:(id)arg2;	// IMP=0x0000000100033bc8
- (id)initWithRequestOptions:(id)arg1 currentTurnContext:(id)arg2;	// IMP=0x0000000100033b10
- (id)_init;	// IMP=0x0000000100033964
- (void)updateGatekeeperWithCurrentTurnContext:(id)arg1;	// IMP=0x0000000100033958
