...
- (void).cxx_destruct;	// IMP=0x000000010003dc60
@property(nonatomic) __weak id <SRStarkItemControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (unsigned long long)autoDismissalReason;	// IMP=0x000000010003dc10
- (long long)autoDismissalStrategy;	// IMP=0x000000010003dbe0
- (void)viewDidLoad;	// IMP=0x000000010003da40
- (void)loadView;	// IMP=0x000000010003d9cc
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 shouldSynthesizeTitles:(_Bool)arg3;	// IMP=0x000000010003d8d0
