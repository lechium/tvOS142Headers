...
+ (id)cancellationAnimationForTranscriptItem:(id)arg1;	// IMP=0x0000000100021e28
+ (id)confirmationAnimationForTranscriptItem:(id)arg1;	// IMP=0x0000000100021dbc
+ (id)animationForTranscriptItem:(id)arg1 updateType:(long long)arg2 replacedView:(id)arg3;	// IMP=0x0000000100021d40
+ (id)animationForTranscriptItem:(id)arg1 updateType:(long long)arg2;	// IMP=0x0000000100021cdc
- (void).cxx_destruct;	// IMP=0x00000001000224f0
...
- (id)_animationTypeString;	// IMP=0x000000010002231c
- (id)description;	// IMP=0x000000010002224c
- (double)pinMinimumDuration;	// IMP=0x0000000100022210
- (double)animationDelay;	// IMP=0x000000010002219c
- (id)_snippetViewControllerIfExists;	// IMP=0x0000000100022110
- (id)_aceViewControllerIfExists;	// IMP=0x0000000100022084
- (id)initWithTranscriptItem:(id)arg1 replacedView:(id)arg2 updateType:(long long)arg3;	// IMP=0x0000000100021e94
