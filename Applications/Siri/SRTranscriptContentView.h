...
- (void).cxx_destruct;	// IMP=0x00000001000285e0
...
- (void)_setKeylineHidden:(id)arg1 hidden:(_Bool)arg2;	// IMP=0x00000001000284b4
- (void)layoutSubviews;	// IMP=0x0000000100028164
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100028154
- (id)initWithFrame:(struct CGRect)arg1 collectionView:(id)arg2;	// IMP=0x0000000100027f2c
