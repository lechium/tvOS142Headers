...
- (void).cxx_destruct;	// IMP=0x0000000100027ef4
...
- (void)removeElementAtIndex:(long long)arg1;	// IMP=0x0000000100027e08
- (void)shiftInsertionIndexesStartingAtIndex:(unsigned long long)arg1 by:(long long)arg2;	// IMP=0x0000000100027df8
- (void)replaceTranscriptItem:(id)arg1 withTranscriptItem:(id)arg2 cancelPresentationDelay:(_Bool)arg3;	// IMP=0x0000000100027d28
- (unsigned long long)insertionIndexForTranscriptItem:(id)arg1;	// IMP=0x0000000100027b68
- (void)_presentationEligibilityConditionDidChange;	// IMP=0x000000010002785c
- (unsigned long long)countByEnumeratingWithState:(CDStruct_70511ce9 *)arg1 objects:(id *)arg2 count:(unsigned long long)arg3;	// IMP=0x00000001000277f0
@property(readonly, nonatomic) NSIndexSet *insertionIndexes;
@property(readonly, nonatomic) NSArray *transcriptItems;
- (id)description;	// IMP=0x000000010002751c
- (id)init;	// IMP=0x00000001000274a8
- (id)initWithTranscriptItems:(id)arg1 insertionIndexes:(id)arg2 provisional:(_Bool)arg3 waitsForConfirmation:(_Bool)arg4 presentationDelay:(double)arg5;	// IMP=0x00000001000271ec
