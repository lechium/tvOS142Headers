...
- (void).cxx_destruct;	// IMP=0x0000000100005edc
...
- (void)setNextSampleBufferTimestamp:(CDStruct_198678f7)arg1;	// IMP=0x0000000100005d5c
- (struct opaqueCMSampleBuffer *)getNextSampleBuffer;	// IMP=0x0000000100005920
- (void)doGainsAndMixingLogic;	// IMP=0x0000000100005300
- (_Bool)didUpdateIntensities;	// IMP=0x0000000100005218
- (_Bool)startAudioEngine;	// IMP=0x0000000100004b18
- (void)addDelayIfApplicable;	// IMP=0x00000001000049f8
...
- (id)getNextTrack;	// IMP=0x00000001000046c8
- (id)getNextURL;	// IMP=0x00000001000043d8
- (void)updateNextIntensityIndex;	// IMP=0x00000001000042b8
- (void)dealloc;	// IMP=0x0000000100004208
- (id)initWithFormat:(id)arg1 framesPerRender:(unsigned int)arg2 filesDir:(id)arg3 fadeDuration:(float)arg4;	// IMP=0x0000000100003d60
