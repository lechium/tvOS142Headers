...
+ (id)new;	// IMP=0x000000010002c5b4
- (void).cxx_destruct;	// IMP=0x000000010002c950
...
- (id)_mediaEntitiesDataSource;	// IMP=0x000000010002c8b4
...
- (_Bool)updateWithMediaEntitiesDataSourceFetchResult:(id)arg1;	// IMP=0x000000010002c7b0
- (id)initWithTitle:(id)arg1;	// IMP=0x000000010002c678
- (id)init;	// IMP=0x000000010002c5f0
