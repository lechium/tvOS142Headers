...
+ (id)_contentViewWithLockupLayout:(id)arg1;	// IMP=0x0000000100006efc
- (id)_circularContentView;	// IMP=0x0000000100006f54
- (void)setFocusedSizeIncrease:(double)arg1;	// IMP=0x0000000100006e7c
