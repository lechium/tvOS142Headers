...
- (id)initWithCollectionView:(id)arg1 direction:(long long)arg2 properties:(id)arg3;	// IMP=0x000000010009bba4
- (id)initWithCollectionView:(id)arg1 direction:(long long)arg2;	// IMP=0x000000010009bb0c
- (id)init;	// IMP=0x000000010009ba84
