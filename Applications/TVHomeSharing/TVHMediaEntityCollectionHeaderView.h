...
- (void).cxx_destruct;	// IMP=0x0000000100008214
...
- (id)_labelWithTextStyle:(unsigned long long)arg1 fontWeight:(long long)arg2;	// IMP=0x0000000100008090
- (void)layoutSubviews;	// IMP=0x0000000100007f40
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000100007e8c
@property(copy, nonatomic) NSArray *metadataStrings;
@property(copy, nonatomic) NSString *subtitle;
@property(copy, nonatomic) NSString *title;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100007910
