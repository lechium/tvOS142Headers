...
- (void).cxx_destruct;	// IMP=0x00000001000989a0
...
- (id)initWithIdentifier:(id)arg1 mediaLibrary:(id)arg2 fetchRequest:(id)arg3;	// IMP=0x0000000100098884
- (id)init;	// IMP=0x00000001000987fc
