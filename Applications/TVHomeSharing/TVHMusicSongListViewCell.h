...
+ (id)_durationLabelTextColorWithUserInterfaceStyle:(long long)arg1 andFocus:(_Bool)arg2;	// IMP=0x000000010001cd50
+ (id)_titleLabelTextColorWithUserInterfaceStyle:(long long)arg1 andFocus:(_Bool)arg2;	// IMP=0x000000010001ccfc
...
- (id)_floatingContentViewContentView;	// IMP=0x000000010001cf78
- (void)_updateNowPlayingBars:(unsigned long long)arg1;	// IMP=0x000000010001cda4
- (void)_updateColors;	// IMP=0x000000010001cb68
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000010001c9d8
- (void)prepareForReuse;	// IMP=0x000000010001c908
- (void)updateConstraints;	// IMP=0x000000010001c66c
- (void)didMoveToSuperview;	// IMP=0x000000010001c61c
@property(copy, nonatomic) NSString *albumTitle;
@property(copy, nonatomic) NSString *artistTitle;
- (void)setTitle:(id)arg1 hasExplicitLyrics:(_Bool)arg2;	// IMP=0x000000010001c328
@property(retain, nonatomic) UIImage *placeholderImage;
@property(retain, nonatomic) TVImageProxy *imageProxy;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010001b620
