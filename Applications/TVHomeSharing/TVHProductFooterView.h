...
+ (double)_longestLabelWidthInViews:(id)arg1;	// IMP=0x0000000100054ef0
+ (id)_labelWithText:(id)arg1;	// IMP=0x0000000100054d70
- (void).cxx_destruct;	// IMP=0x00000001000550fc
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000100054b84
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100053f1c
