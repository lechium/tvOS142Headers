...
- (void)viewDidLayoutSubviews;	// IMP=0x0000000100056f0c
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000100056d30
- (void)loadView;	// IMP=0x0000000100056acc
- (void)dealloc;	// IMP=0x0000000100056a6c
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000001000569e8
