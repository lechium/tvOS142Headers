...
- (void).cxx_destruct;	// IMP=0x00000001000a287c
...
- (void)_crossfadeToImage:(id)arg1;	// IMP=0x00000001000a2624
- (void)_loadNextImage:(id)arg1;	// IMP=0x00000001000a25c8
- (void)_startTimer;	// IMP=0x00000001000a2510
- (void)layoutSubviews;	// IMP=0x00000001000a1fdc
- (void)didMoveToSuperview;	// IMP=0x00000001000a1f74
- (void)dealloc;	// IMP=0x00000001000a1f1c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000a1e44
