...
- (void)_clearCachedValues;	// IMP=0x0000000100058cac
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000100058bdc
- (struct CGRect)textRectForBounds:(struct CGRect)arg1 limitedToNumberOfLines:(long long)arg2;	// IMP=0x0000000100058aa0
- (_Bool)canBecomeFocused;	// IMP=0x0000000100058a94
- (void)setBaselineAdjustment:(long long)arg1;	// IMP=0x0000000100058a44
- (void)setAdjustsFontSizeToFitWidth:(_Bool)arg1;	// IMP=0x00000001000589f4
- (void)setNumberOfLines:(long long)arg1;	// IMP=0x00000001000589a4
- (void)setLineBreakMode:(long long)arg1;	// IMP=0x0000000100058954
- (void)setFont:(id)arg1;	// IMP=0x0000000100058904
- (void)setText:(id)arg1;	// IMP=0x00000001000588b4
