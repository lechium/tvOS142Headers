...
+ (void)subjectWithSongInPlayQueue:(id)arg1 container:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000843e8
+ (void)subjectWithLibraryObject:(id)arg1 container:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000841f0
+ (void)subjectWithObject:(id)arg1 playbackReportingDictionary:(id)arg2 container:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000100083fd4
- (void).cxx_destruct;	// IMP=0x0000000100084cdc
...
- (id)initWithLibraryObject:(id)arg1 container:(id)arg2;	// IMP=0x0000000100084b28
- (id)initWithObject:(id)arg1 playbackReportingDictionary:(id)arg2 container:(id)arg3;	// IMP=0x00000001000849ac
