...
- (void).cxx_destruct;	// IMP=0x000000010006b598
...
- (void)_modelResponseDidInvalidate:(id)arg1;	// IMP=0x000000010006b33c
- (void)didCompleteDocumentCreationWithStatus:(long long)arg1 errorDictionary:(id)arg2;	// IMP=0x000000010006b24c
- (void)serviceRequest:(id)arg1 didCompleteWithStatus:(long long)arg2 errorDictionary:(id)arg3;	// IMP=0x000000010006af2c
- (void)updateServiceRequest:(id)arg1 documentDidChange:(id)arg2;	// IMP=0x000000010006aecc
- (void)_performRequestForItemDataWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010006ac88
- (void)_updateDocument;	// IMP=0x000000010006aa20
- (void)removeViewController;	// IMP=0x000000010006a7f4
@property(readonly, nonatomic) MPModelGenericObject *representedObject;
- (void)updateWithContextDictionary:(id)arg1 forceUpdate:(_Bool)arg2;	// IMP=0x000000010006a418
- (void)reloadData;	// IMP=0x000000010006a414
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x000000010006a388
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x000000010006a334
- (void)viewDidLoad;	// IMP=0x000000010006a1bc
- (id)songsRequest;	// IMP=0x000000010006a1b4
- (void)dealloc;	// IMP=0x000000010006a0ec
- (id)initWithContextDictionary:(id)arg1 identifier:(id)arg2;	// IMP=0x0000000100069ee4
