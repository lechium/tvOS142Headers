...
- (void).cxx_destruct;	// IMP=0x000000010002cd40
...
- (id)description;	// IMP=0x000000010002cbf8
- (_Bool)hasTrait:(id)arg1;	// IMP=0x000000010002cb34
- (id)mediaItemMetadataForProperty:(id)arg1;	// IMP=0x000000010002bdd0
- (_Bool)useBookmarks;	// IMP=0x000000010002bd1c
@property(readonly, nonatomic) MPModelSong *song;
- (id)initWithStorePlatformDictionary:(id)arg1;	// IMP=0x000000010002bc90
- (id)initWithSong:(id)arg1;	// IMP=0x000000010002bc80
- (id)initWithSong:(id)arg1 mediaItemMetadata:(id)arg2;	// IMP=0x000000010002bc10
