...
+ (id)sharedInstance;	// IMP=0x0000000100097490
- (void).cxx_destruct;	// IMP=0x0000000100098220
...
- (void)_urlWithPath:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100097e98
- (void)performRequestWithURL:(id)arg1 options:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000978dc
- (void)performRequestWithPath:(id)arg1 options:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000977d0
- (id)init;	// IMP=0x00000001000974fc
