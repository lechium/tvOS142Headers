...
+ (void)_configureAudioSessionForPlayer:(id)arg1;	// IMP=0x000000010002f3a8
+ (id)motionViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x000000010002d0e8
- (void).cxx_destruct;	// IMP=0x000000010002ff7c
...
- (void)_avPlayerItemPlayedToEnd:(id)arg1;	// IMP=0x000000010002fca0
- (void)_showMotion;	// IMP=0x000000010002fb28
- (void)_hideMotion;	// IMP=0x000000010002f994
- (void)_destroyVideo;	// IMP=0x000000010002f714
- (void)_createVideo;	// IMP=0x000000010002f4e4
- (void)_animateStillImageToAlpha:(double)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010002f1e4
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010002ee88
- (void)_startVideoPlayback;	// IMP=0x000000010002eb30
- (void)_handleFocusForFocusedView:(id)arg1;	// IMP=0x000000010002ea04
- (void)_ancestorWillUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000010002e964
- (void)_prepareElementForReuse;	// IMP=0x000000010002e7e0
- (void)didMoveToWindow;	// IMP=0x000000010002e5b8
- (void)_updateState:(id)arg1;	// IMP=0x000000010002e0a4
- (void)_configureVideoWithURL:(id)arg1;	// IMP=0x000000010002e004
- (void)_createImageViewsForImageElement:(id)arg1;	// IMP=0x000000010002de28
- (void)_configureStillImageForElement:(id)arg1;	// IMP=0x000000010002dc9c
- (void)dealloc;	// IMP=0x000000010002dbd4
- (void)_configureWithElement:(id)arg1;	// IMP=0x000000010002d444
