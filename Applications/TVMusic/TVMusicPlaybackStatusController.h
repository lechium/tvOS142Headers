...
- (void).cxx_destruct;	// IMP=0x000000010007ee84
...
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x000000010007e930
- (void)_playerPathChanged:(id)arg1;	// IMP=0x000000010007e7a8
- (long long)playbackStateforItemWithIdentifiers:(id)arg1 inContainer:(id)arg2;	// IMP=0x000000010007e600
- (long long)playbackStateforItemWithIdentifiers:(id)arg1;	// IMP=0x000000010007e40c
- (void)dealloc;	// IMP=0x000000010007e370
- (id)init;	// IMP=0x000000010007de10
