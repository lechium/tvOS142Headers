...
- (void).cxx_destruct;	// IMP=0x000000010004ca0c
...
- (void)loadImagesWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010004c214
- (id)identifier;	// IMP=0x000000010004bcd8
- (id)initWithImageProxies:(id)arg1 playlistStyle:(id)arg2;	// IMP=0x000000010004bc18
