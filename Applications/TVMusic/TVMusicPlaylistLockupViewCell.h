...
+ (id)playlistViewFromElement:(id)arg1 existingView:(id)arg2;	// IMP=0x00000001000b6048
- (void).cxx_destruct;	// IMP=0x00000001000b8294
...
- (id)_randomColor;	// IMP=0x00000001000b80f8
- (void)_configureLabel:(id)arg1 withTextElement:(id)arg2 maxWidth:(double)arg3;	// IMP=0x00000001000b7f68
- (struct CGRect)_scaleRect:(struct CGRect)arg1 withStyle:(id)arg2;	// IMP=0x00000001000b7e48
- (void)_setColorsForUserInterfaceStyle:(long long)arg1;	// IMP=0x00000001000b7cf4
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000001000b7c28
- (void)layoutSubviews;	// IMP=0x00000001000b7b44
- (void)layoutWithElement:(id)arg1;	// IMP=0x00000001000b67f0
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000001000b6764
- (void)prepareForReuse;	// IMP=0x00000001000b6710
- (_Bool)canBecomeFocused;	// IMP=0x00000001000b6708
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000b60fc
