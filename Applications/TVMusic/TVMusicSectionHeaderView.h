...
- (void).cxx_destruct;	// IMP=0x0000000100025a7c
...
- (_Bool)visibleContentIntersectsRect:(struct CGRect)arg1;	// IMP=0x0000000100025940
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100025864
- (void)_addHeadingLabel;	// IMP=0x0000000100025700
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000255d8
