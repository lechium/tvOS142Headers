...
+ (id)songCellFromElement:(id)arg1 existingView:(id)arg2;	// IMP=0x000000010001293c
+ (void)registerElements;	// IMP=0x00000001000128a4
- (void).cxx_destruct;	// IMP=0x000000010005e744
...
- (void)floatingContentView:(id)arg1 isTransitioningFromState:(unsigned long long)arg2 toState:(unsigned long long)arg3;	// IMP=0x000000010005e45c
- (void)_updateTitleColor;	// IMP=0x000000010005e1e4
- (id)_decoratedTitleString;	// IMP=0x000000010005e17c
- (void)_layoutMusicBarsView;	// IMP=0x000000010005df94
- (void)_updateMusicBarsView;	// IMP=0x000000010005dc3c
- (void)_updateVideoBadge;	// IMP=0x000000010005da44
- (_Bool)_hasVideoBadge;	// IMP=0x000000010005d9fc
- (_Bool)_hasThumbnail;	// IMP=0x000000010005d98c
- (unsigned long long)_floatingViewControlState;	// IMP=0x000000010005d964
- (_Bool)_shouldShowPlayIcon;	// IMP=0x000000010005d8e8
- (void)_playbackStatusChanged:(id)arg1;	// IMP=0x000000010005d8dc
- (void)_updatePlayingState;	// IMP=0x000000010005d690
@property(readonly, nonatomic) struct CGSize thumbnailSize;
- (void)_setColorsForCurrentUserInterfaceStyle;	// IMP=0x000000010005d384
- (void)_updateColorsForUserInterfaceStyle:(long long)arg1;	// IMP=0x000000010005ce30
- (void)_layoutLabel:(id)arg1;	// IMP=0x000000010005cd40
- (id)_createLabelAtPosition:(double)arg1 width:(double)arg2;	// IMP=0x000000010005cca8
@property(readonly, nonatomic) TVImageView *thumbnailImageView;
@property(retain, nonatomic) UIImage *thumbnailImage;
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000010005ca64
- (void)pressesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000010005c954
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000010005c838
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x000000010005c6d4
- (id)_preferredConfigurationForFocusAnimation:(long long)arg1 inContext:(id)arg2;	// IMP=0x000000010005c674
- (void)setPlayItem:(id)arg1 inContainer:(id)arg2;	// IMP=0x000000010005c524
@property(readonly, nonatomic) _Bool hasPlaylistOrdinal;
- (double)_ordinalWidth;	// IMP=0x000000010005c08c
- (void)_updateOrdinalLabel;	// IMP=0x000000010005be24
- (id)_popularityImageForPopularity:(id)arg1;	// IMP=0x000000010005bcf8
- (void)setTitle:(id)arg1 isExplicit:(_Bool)arg2;	// IMP=0x000000010005b520
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010005b3bc
- (void)_adjustThumbnailForFocusState;	// IMP=0x000000010005b230
- (void)layoutSubviews;	// IMP=0x000000010005a188
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000100059f0c
@property(retain, nonatomic) TVImageProxy *thumbnail;
@property(readonly, nonatomic) double cellHeight;
- (void)prepareForReuse;	// IMP=0x00000001000599f4
- (_Bool)canBecomeFocused;	// IMP=0x00000001000599e8
...
- (void)dealloc;	// IMP=0x00000001000595c4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100058ddc
- (long long)_songCellTypeFromTrackTypeAttribute:(id)arg1;	// IMP=0x0000000100013aac
- (void)_setPlaybackIdentifiersWithAttributes:(id)arg1;	// IMP=0x0000000100013370
- (void)layoutWithElement:(id)arg1;	// IMP=0x00000001000129f0
