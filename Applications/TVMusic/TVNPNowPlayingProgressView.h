...
- (void).cxx_destruct;	// IMP=0x000000010004af00
...
- (struct CGSize)_fillSize;	// IMP=0x000000010004ad64
- (void)setProgress:(float)arg1 animated:(_Bool)arg2;	// IMP=0x000000010004aca4
- (void)tintColorDidChange;	// IMP=0x000000010004aa90
- (void)layoutSubviews;	// IMP=0x000000010004a8f0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010004a6e0
