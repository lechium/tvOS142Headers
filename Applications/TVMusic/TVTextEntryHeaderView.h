...
- (void).cxx_destruct;	// IMP=0x00000001000b08fc
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001000b0718
- (struct CGRect)_messageViewFrameWithBounds:(struct CGRect)arg1;	// IMP=0x00000001000b051c
- (struct CGRect)_imageViewFrameWithBounds:(struct CGRect)arg1;	// IMP=0x00000001000b0498
- (struct CGRect)_titleViewFrameWithBounds:(struct CGRect)arg1;	// IMP=0x00000001000b0394
- (void)layoutSubviews;	// IMP=0x00000001000b02a8
