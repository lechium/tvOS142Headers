...
- (void).cxx_destruct;	// IMP=0x0000000100083f80
...
- (void)_checkForPreloadCompletion;	// IMP=0x0000000100083e70
- (void)_artworkDidFail:(id)arg1;	// IMP=0x0000000100083d74
- (void)_artworkDidLoad:(id)arg1 withImage:(id)arg2;	// IMP=0x0000000100083ca8
- (void)_loadPendingImages;	// IMP=0x0000000100083a5c
- (id)_artworkCatalogToLoadNext;	// IMP=0x00000001000839a8
- (void)_fillQueue;	// IMP=0x00000001000838a4
- (long long)_currentQueueSize;	// IMP=0x0000000100083848
- (id)popNextImage;	// IMP=0x00000001000837a4
- (void)preloadImageCount:(long long)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100083748
- (id)init;	// IMP=0x00000001000835dc
