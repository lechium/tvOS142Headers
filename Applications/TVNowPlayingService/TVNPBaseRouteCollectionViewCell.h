...
+ (id)_volumeImage:(_Bool)arg1;	// IMP=0x00000001000136b8
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x0000000100011c24
...
- (id)_checkmarkImage:(_Bool)arg1;	// IMP=0x000000010001351c
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000100012ea4
- (unsigned long long)_controlStateForCell;	// IMP=0x0000000100012e04
- (void)_addInitialConstraints;	// IMP=0x0000000100011d80
- (void)volumeSliderValueChanged:(id)arg1;	// IMP=0x0000000100011c20
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x0000000100011534
- (id)preferredLayoutAttributesFittingAttributes:(id)arg1;	// IMP=0x00000001000114a8
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000001000113bc
- (void)updateConstraints;	// IMP=0x0000000100010b84
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000100010aa8
- (void)setSelected:(_Bool)arg1;	// IMP=0x0000000100010aa4
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000001000109b8
- (void)prepareForReuse;	// IMP=0x0000000100010920
- (id)preferredFocusEnvironments;	// IMP=0x0000000100010878
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000100b4
