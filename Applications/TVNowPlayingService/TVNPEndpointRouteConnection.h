...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x0000000100025e9c
- (void).cxx_destruct;	// IMP=0x0000000100028690
...
- (id)_preloadArtwork;	// IMP=0x0000000100028480
- (id)_placeholderArtwork;	// IMP=0x00000001000283ac
- (void)_updateState;	// IMP=0x0000000100028218
- (void)_updateAutomaticResponseLoading;	// IMP=0x0000000100028158
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x0000000100027d04
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x0000000100027bfc
- (void)_updateMetadata;	// IMP=0x0000000100026aa0
- (void)_createRequestController;	// IMP=0x0000000100026630
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x00000001000263f4
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x00000001000262e4
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x0000000100026034
- (void)playPause;	// IMP=0x0000000100026020
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x0000000100025fc4
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100025f28
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x0000000100025e48
- (id)playerPath;	// IMP=0x0000000100025d9c
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x0000000100025c5c
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x00000001000259f0
