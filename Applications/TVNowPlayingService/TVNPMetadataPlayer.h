...
- (void)_callElapsedTimeObserversDueToTimeJump:(_Bool)arg1;	// IMP=0x000000010000f5e8
- (void)_fireElapsedTimeUpdate:(id)arg1;	// IMP=0x000000010000f5d8
- (void)_updateElapsedTimeTimer;	// IMP=0x000000010000f4fc
@property(readonly, nonatomic) double elapsedTime;
- (float)_rateForState:(id)arg1;	// IMP=0x000000010000f0dc
...
- (_Bool)currentMediaItemSupportsScrubbingUsingPlayer;	// IMP=0x000000010000ee38
- (void)setSelectedSubtitleOption:(id)arg1 setGlobalPreference:(_Bool)arg2;	// IMP=0x000000010000ee34
- (void)updateSubtitleOptions;	// IMP=0x000000010000ee30
- (void)removeBoundaryTimeObserverWithToken:(id)arg1;	// IMP=0x000000010000ee2c
- (id)addBoundaryTimeObserverForDates:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010000ee24
- (id)addBoundaryTimeObserverForTimes:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010000ee1c
- (void)removeElapsedTimeObserverWithToken:(id)arg1;	// IMP=0x000000010000eda8
- (id)addElapsedTimeObserver:(CDUnknownBlockType)arg1;	// IMP=0x000000010000ece0
- (void)skipToNextChapterInDirection:(long long)arg1;	// IMP=0x000000010000ec8c
- (void)setElapsedTime:(double)arg1 seekPrecision:(CDStruct_198678f7)arg2 ignoreDelegate:(_Bool)arg3;	// IMP=0x000000010000ec80
- (void)setElapsedTime:(double)arg1 seekPrecision:(CDStruct_198678f7)arg2;	// IMP=0x000000010000ec74
- (void)setElapsedTime:(double)arg1 precise:(_Bool)arg2;	// IMP=0x000000010000ec68
- (void)setElapsedTime:(double)arg1;	// IMP=0x000000010000eb68
- (void)stopWithVolumeRampDuration:(double)arg1;	// IMP=0x000000010000eb5c
- (void)stop;	// IMP=0x000000010000eacc
- (void)scanWithRate:(double)arg1;	// IMP=0x000000010000e95c
- (void)togglePlayPause;	// IMP=0x000000010000e914
- (void)pauseIgnoringDelegate:(_Bool)arg1;	// IMP=0x000000010000e908
- (void)pauseWithVolumeRampDuration:(double)arg1;	// IMP=0x000000010000e8fc
- (void)pause;	// IMP=0x000000010000e8b4
- (void)playIgnoringDelegate:(_Bool)arg1;	// IMP=0x000000010000e8a8
- (void)play;	// IMP=0x000000010000e7bc
- (void)continueLoadingCurrentItem;	// IMP=0x000000010000e7b8
- (void)changeMediaInDirection:(long long)arg1 reason:(id)arg2;	// IMP=0x000000010000e74c
- (void)changeMediaInDirection:(long long)arg1;	// IMP=0x000000010000e73c
- (void)setLastElapsedTime:(double)arg1 atTimestamp:(id)arg2;	// IMP=0x000000010000e6c8
- (void)invalidate;	// IMP=0x000000010000e694
- (id)initWithName:(id)arg1;	// IMP=0x000000010000e5ac
- (id)init;	// IMP=0x000000010000e59c
