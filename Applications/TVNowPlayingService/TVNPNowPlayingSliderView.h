...
- (id)_unfocusedProgressColor;	// IMP=0x0000000100003834
- (id)_focusedProgressColor;	// IMP=0x00000001000037b0
- (void)_rightPressed:(id)arg1;	// IMP=0x000000010000374c
- (void)_leftPressed:(id)arg1;	// IMP=0x00000001000036e8
- (void)_panUpdated:(id)arg1;	// IMP=0x0000000100003480
- (void)_menuPressed;	// IMP=0x000000010000347c
- (void)endTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000100003478
- (_Bool)continueTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000100003470
- (_Bool)beginTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000100003468
- (_Bool)shouldTrack;	// IMP=0x0000000100003460
- (double)maxBarWidth;	// IMP=0x0000000100003450
- (void)setMaxBarWidth:(double)arg1;	// IMP=0x0000000100003428
- (void)setValue:(float)arg1 animated:(_Bool)arg2;	// IMP=0x00000001000031e0
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001000031b8
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000001000031a4
- (void)layoutSubviews;	// IMP=0x0000000100002f10
- (_Bool)canBecomeFocused;	// IMP=0x0000000100002f08
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100002960
