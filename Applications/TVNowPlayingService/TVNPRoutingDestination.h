...
- (void).cxx_destruct;	// IMP=0x000000010000e50c
...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x000000010000e3f0
- (void)connectAndPair;	// IMP=0x000000010000e3ec
- (void)togglePlayPause;	// IMP=0x000000010000e3e8
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x000000010000e3b4
- (id)init;	// IMP=0x000000010000e39c
