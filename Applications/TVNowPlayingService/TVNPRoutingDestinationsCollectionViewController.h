...
- (void).cxx_destruct;	// IMP=0x000000010000853c
...
- (id)_indexPathForCurrentDestination;	// IMP=0x00000001000082dc
- (void)_presentVolumeBulletinForDestination:(id)arg1;	// IMP=0x0000000100007bd0
- (void)bulletinService:(id)arg1 didDismissBulletin:(id)arg2 withReason:(unsigned long long)arg3;	// IMP=0x0000000100007af0
- (id)indexPathForPreferredFocusedViewInCollectionView:(id)arg1;	// IMP=0x0000000100007ae4
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x0000000100007554
- (struct CGPoint)collectionView:(id)arg1 targetContentOffsetForProposedContentOffset:(struct CGPoint)arg2;	// IMP=0x00000001000074c0
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x00000001000071d0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000100006ee0
- (_Bool)_ignoreVolumeChangesWhilePendingSelection;	// IMP=0x0000000100006d78
- (void)_showConnectionFailedAlertControllerForRoutingDestination:(id)arg1;	// IMP=0x0000000100006b18
- (void)updateCollectionViewWithDestinations:(id)arg1;	// IMP=0x0000000100006804
- (void)viewDidLayoutSubviews;	// IMP=0x00000001000062bc
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0000000100006228
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000100005eb0
- (void)viewDidLoad;	// IMP=0x0000000100005abc
- (void)dealloc;	// IMP=0x0000000100005a04
- (id)initWithCollectionViewLayout:(id)arg1 routingController:(id)arg2 options:(id)arg3 initialUIDProvider:(CDUnknownBlockType)arg4;	// IMP=0x000000010000581c
