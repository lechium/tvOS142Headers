...
- (void).cxx_destruct;	// IMP=0x000000010001ef44
...
- (void)_relinquishVolumeHUDAssertionForRouteWithUID:(id)arg1;	// IMP=0x000000010001ed0c
- (void)_acquireVolumeHUDAssertionForRouteWithUID:(id)arg1;	// IMP=0x000000010001ebdc
- (void)_calculateVisibleVolumeCells;	// IMP=0x000000010001e8ac
- (void)_cleanupRouteForVolumeIfNeeded;	// IMP=0x000000010001e79c
- (id)_gradientMask;	// IMP=0x000000010001e36c
- (void)viewControllerDidRequestDismissal:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x000000010001e354
- (void)shareAudioSelected;	// IMP=0x000000010001e2c0
- (void)handleEndVolumeControl:(id)arg1;	// IMP=0x000000010001e080
- (void)longPressSelect:(id)arg1;	// IMP=0x000000010001dfc4
- (id)indexPathForVolumeSliderInCollectionView:(id)arg1 layout:(id)arg2;	// IMP=0x000000010001dee8
- (void)collectionView:(id)arg1 didEndDisplayingCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x000000010001ddd0
- (void)collectionView:(id)arg1 willDisplayCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x000000010001dcb8
- (_Bool)collectionView:(id)arg1 shouldUpdateFocusInContext:(id)arg2;	// IMP=0x000000010001dc7c
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x000000010001db44
- (struct CGSize)collectionView:(id)arg1 layout:(id)arg2 sizeForItemAtIndexPath:(id)arg3;	// IMP=0x000000010001da04
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x000000010001d4a4
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010001d3b8
- (void)handleVolumeDown;	// IMP=0x000000010001d060
- (void)handleVolumeUp;	// IMP=0x000000010001cd08
- (void)updateCollectionViewWithRoutes:(id)arg1;	// IMP=0x000000010001c3ac
- (void)viewDidLayoutSubviews;	// IMP=0x000000010001c16c
- (void)viewDidLoad;	// IMP=0x000000010001b7ac
- (void)dealloc;	// IMP=0x000000010001b75c
- (id)initWithCollectionViewLayout:(id)arg1 routingController:(id)arg2;	// IMP=0x000000010001b68c
