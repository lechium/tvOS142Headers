...
- (void).cxx_destruct;	// IMP=0x00000001000115fc
...
- (id)description;	// IMP=0x00000001000115a4
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100011468
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000113a0
- (unsigned long long)hash;	// IMP=0x0000000100011354
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100011298
