...
- (void)_updateCachedAssets;	// IMP=0x0000000100008670
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000100008560
- (id)requestOptions;	// IMP=0x00000001000084fc
- (long long)contentMode;	// IMP=0x00000001000084f4
- (struct CGSize)targetSize;	// IMP=0x0000000100008440
- (void)stopPrefetchingAssets;	// IMP=0x00000001000083cc
- (void)startPrefetchingAssets;	// IMP=0x00000001000083c0
- (void)dealloc;	// IMP=0x000000010000801c
