...
- (void).cxx_destruct;	// IMP=0x000000010002ea5c
...
- (long long)_previousSectionWithItems;	// IMP=0x000000010002e7e8
- (long long)_nextSectionWithItems;	// IMP=0x000000010002e768
- (_Bool)_scrollToPreviousItem;	// IMP=0x000000010002e660
- (_Bool)_scrollToNextItem;	// IMP=0x000000010002e54c
- (_Bool)_performPageScrollByEvaluatingOffset:(double)arg1;	// IMP=0x000000010002e494
- (void)_resetPageScrollOffsets;	// IMP=0x000000010002e44c
- (void)_startPageScroll:(double)arg1;	// IMP=0x000000010002e33c
- (void)_handleDownScrollButtonGesture:(id)arg1;	// IMP=0x000000010002e104
- (void)_handleUpScrollButtonGesture:(id)arg1;	// IMP=0x000000010002df3c
- (id)preferredFocusedView;	// IMP=0x000000010002df38
- (_Bool)canBecomeFocused;	// IMP=0x000000010002df30
- (void)reloadData;	// IMP=0x000000010002de9c
@property(readonly, nonatomic) long long currentSection;
@property(readonly, nonatomic) long long currentIndex;
- (void)setFlowLayoutDefaultAttributes:(id)arg1;	// IMP=0x000000010002de08
- (void)scrollToItemAtIndexPath:(id)arg1 atScrollPosition:(unsigned long long)arg2 animated:(_Bool)arg3;	// IMP=0x000000010002dcd4
- (id)initWithFrame:(struct CGRect)arg1 collectionViewLayout:(id)arg2;	// IMP=0x000000010002d9f0
