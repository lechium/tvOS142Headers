...
- (void).cxx_destruct;	// IMP=0x000000010000663c
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100006520
- (void)layoutSubviews;	// IMP=0x00000001000062c0
- (void)_updateLabels;	// IMP=0x00000001000061d0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100005eb0
