...
- (void).cxx_destruct;	// IMP=0x0000000100032f94
...
- (void)_crossfadeToImage:(id)arg1;	// IMP=0x0000000100032d3c
- (void)_loadNextImage:(id)arg1;	// IMP=0x0000000100032c94
- (void)_startTimer;	// IMP=0x0000000100032bdc
- (void)layoutSubviews;	// IMP=0x0000000100032864
- (void)didMoveToSuperview;	// IMP=0x00000001000327fc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100032724
