...
- (void).cxx_destruct;	// IMP=0x00000001000866e0
...
- (void)_checkForPreloadCompletion;	// IMP=0x00000001000865d0
- (void)_imageProxyDidFail:(id)arg1 withError:(id)arg2;	// IMP=0x00000001000864d8
- (void)_imageProxyDidLoad:(id)arg1 withImage:(id)arg2;	// IMP=0x000000010008640c
- (void)_loadPendingImages;	// IMP=0x0000000100086088
- (id)_imageProxyToLoadNext;	// IMP=0x0000000100085fd4
- (void)_fillQueue;	// IMP=0x0000000100085ed0
- (long long)_currentQueueSize;	// IMP=0x0000000100085e74
- (id)popNextImage;	// IMP=0x0000000100085dd0
- (void)preloadImageCount:(long long)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100085d74
- (void)dealloc;	// IMP=0x0000000100085c74
- (id)init;	// IMP=0x0000000100085b98
