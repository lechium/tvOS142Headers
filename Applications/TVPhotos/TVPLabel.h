...
- (void)_clearCachedValues;	// IMP=0x000000010007f75c
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010007f68c
- (struct CGRect)textRectForBounds:(struct CGRect)arg1 limitedToNumberOfLines:(long long)arg2;	// IMP=0x000000010007f550
- (void)setBaselineAdjustment:(long long)arg1;	// IMP=0x000000010007f500
- (void)setAdjustsFontSizeToFitWidth:(_Bool)arg1;	// IMP=0x000000010007f4b0
- (void)setNumberOfLines:(long long)arg1;	// IMP=0x000000010007f460
- (void)setLineBreakMode:(long long)arg1;	// IMP=0x000000010007f410
- (void)setFont:(id)arg1;	// IMP=0x000000010007f3c0
- (void)setText:(id)arg1;	// IMP=0x000000010007f370
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010007f2a8
