...
- (void).cxx_destruct;	// IMP=0x000000010007f1e0
...
- (_Bool)_isValidIndex:(long long)arg1;	// IMP=0x000000010007eed8
- (void)_performNextEventTransitionIfRequired;	// IMP=0x000000010007ee34
- (void)_performPushTransitionToView:(id)arg1 atNewIndex:(long long)arg2;	// IMP=0x000000010007eac0
- (void)_transitionToItemAtIndex:(long long)arg1;	// IMP=0x000000010007df10
- (void)_addAllSubviews;	// IMP=0x000000010007de50
- (void)_configureSupplementaryView;	// IMP=0x000000010007dcfc
- (void)_configureItemView:(id)arg1 atIndex:(unsigned long long)arg2;	// IMP=0x000000010007dae0
- (void)_transitionToSupplementaryView:(id)arg1 itemView:(id)arg2;	// IMP=0x000000010007d95c
- (void)_transitionToFullScreenMode;	// IMP=0x000000010007d778
- (void)_transitionToCaptionMode;	// IMP=0x000000010007d4d4
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x000000010007d3a0
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x000000010007d280
- (void)_panAction:(id)arg1;	// IMP=0x000000010007cef8
- (void)_longPressAction:(id)arg1;	// IMP=0x000000010007cef4
- (void)_menuAction:(id)arg1;	// IMP=0x000000010007ce40
- (void)_doubleTapAction:(id)arg1;	// IMP=0x000000010007cc78
- (void)_downAction:(id)arg1;	// IMP=0x000000010007cb50
- (void)_upAction:(id)arg1;	// IMP=0x000000010007ca28
- (void)_rightAction:(id)arg1;	// IMP=0x000000010007c87c
- (void)_leftAction:(id)arg1;	// IMP=0x000000010007c6d0
- (void)_playButtonAction:(id)arg1;	// IMP=0x000000010007c654
- (void)_selectButtonAction:(id)arg1;	// IMP=0x000000010007c5d8
- (_Bool)canBecomeFocused;	// IMP=0x000000010007c5d0
- (void)layoutSubviews;	// IMP=0x000000010007c128
- (id)dequeueReusableSupplementaryView;	// IMP=0x000000010007c11c
- (void)registerSupplementaryViewClass:(Class)arg1;	// IMP=0x000000010007c10c
- (id)dequeueReusableItemView;	// IMP=0x000000010007c100
- (void)registerItemViewClass:(Class)arg1;	// IMP=0x000000010007c0f0
@property(readonly, nonatomic) UIView *focusedItemView;
- (void)reloadData;	// IMP=0x000000010007bf4c
- (void)setAdjustedFocusIndex:(long long)arg1;	// IMP=0x000000010007bf3c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010007b858
