...
- (void).cxx_destruct;	// IMP=0x000000010006314c
...
- (void)updateDelegate:(id)arg1;	// IMP=0x0000000100062fcc
- (void)tableView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0000000100062f04
- (_Bool)tableView:(id)arg1 canFocusRowAtIndexPath:(id)arg2;	// IMP=0x0000000100062efc
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x0000000100062cdc
- (id)init;	// IMP=0x0000000100061ff4
- (id)preferredFocusEnvironments;	// IMP=0x0000000100061f7c
