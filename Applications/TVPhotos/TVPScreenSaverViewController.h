...
- (void).cxx_destruct;	// IMP=0x0000000100074f64
- (void)highlightedAlbumChanged;	// IMP=0x0000000100074b24
- (void)viewDidLoad;	// IMP=0x00000001000747dc
- (id)preferredFocusEnvironments;	// IMP=0x0000000100074754
