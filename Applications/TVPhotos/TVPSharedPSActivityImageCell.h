...
- (void).cxx_destruct;	// IMP=0x00000001000811b0
...
- (void)layoutSubviews;	// IMP=0x0000000100080cdc
- (void)setTotalComments:(unsigned long long)arg1 commentBadge:(id)arg2;	// IMP=0x00000001000809b4
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100080900
- (void)_updatePlaceholderImage;	// IMP=0x00000001000807f8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000807a0
