...
- (void).cxx_destruct;	// IMP=0x000000010005d3ec
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010005d2dc
- (void)layoutSubviews;	// IMP=0x000000010005d03c
- (void)_updatePlaceholderImage;	// IMP=0x000000010005cf34
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010005cde4
