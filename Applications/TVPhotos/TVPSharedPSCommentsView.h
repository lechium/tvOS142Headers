...
- (id)_latestCommentIndexPathForCommentsView;	// IMP=0x000000010001836c
- (void)_scrollToLastComment;	// IMP=0x00000001000182ec
- (void)layoutSubviews;	// IMP=0x0000000100017fa0
- (id)preferredFocusEnvironments;	// IMP=0x0000000100017f18
- (id)dequeueReusableViewForIdentifier:(id)arg1;	// IMP=0x0000000100017e74
- (void)reloadCommentsData;	// IMP=0x0000000100017e30
- (void)registerClass:(Class)arg1 forCommentsWithReuseIdentifier:(id)arg2;	// IMP=0x0000000100017d44
- (void)registerClass:(Class)arg1 forSubheaderWithReuseIdentifier:(id)arg2;	// IMP=0x0000000100017c78
- (void)registerClass:(Class)arg1 forHeaderWithReuseIdentifier:(id)arg2;	// IMP=0x0000000100017bac
