...
+ (id)_sharedAlbumSubscribersFromAlbum:(id)arg1;	// IMP=0x000000010004175c
- (void).cxx_destruct;	// IMP=0x0000000100041a2c
...
- (void)_onSelectActionButton:(id)arg1;	// IMP=0x00000001000412ac
- (void)photoLibraryDidChange:(id)arg1;	// IMP=0x00000001000410d0
- (struct CGSize)formSize;	// IMP=0x00000001000410bc
- (void)viewDidLayoutSubviews;	// IMP=0x0000000100040fa4
- (void)viewDidLoad;	// IMP=0x0000000100040b2c
- (void)setMenuGestureRcognizer:(id)arg1;	// IMP=0x0000000100040a30
