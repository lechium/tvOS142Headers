...
- (void).cxx_destruct;	// IMP=0x000000010000f040
...
- (void)configureUIControls;	// IMP=0x000000010000eab4
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010000e89c
- (void)_onSelectSignIn:(id)arg1;	// IMP=0x000000010000e83c
- (void)layoutSubviews;	// IMP=0x000000010000e450
- (id)preferredFocusEnvironments;	// IMP=0x000000010000e2a4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010000e03c
