...
- (void).cxx_destruct;	// IMP=0x000000010001cf78
...
- (void)_initializeSlideshowSettings;	// IMP=0x000000010001bfc8
- (struct CGSize)_getAttributedTextSize:(id)arg1 font:(id)arg2 maxWidth:(double)arg3;	// IMP=0x000000010001bf10
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x000000010001b700
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x000000010001b178
- (id)tableView:(id)arg1 titleForHeaderInSection:(long long)arg2;	// IMP=0x000000010001b0f4
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x000000010001b05c
- (long long)numberOfSectionsInTableView:(id)arg1;	// IMP=0x000000010001b040
- (void)_slideshowThemeChanged:(id)arg1;	// IMP=0x000000010001aaf8
- (id)preferredFocusEnvironments;	// IMP=0x000000010001aa04
- (void)dealloc;	// IMP=0x000000010001a98c
- (void)viewDidLoad;	// IMP=0x000000010001a288
- (void)_handleMenuTap:(id)arg1;	// IMP=0x000000010001a170
- (void)loadView;	// IMP=0x000000010001a0a0
- (void)refreshPhotoAssets:(id)arg1;	// IMP=0x000000010001a060
- (id)init;	// IMP=0x0000000100019fe4
- (id)initWithPhotoAssets:(id)arg1;	// IMP=0x0000000100019f54
