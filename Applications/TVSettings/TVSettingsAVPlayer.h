...
+ (Class)layerClass;	// IMP=0x00000001000d02ac
- (void).cxx_destruct;	// IMP=0x00000001000d0ec8
...
- (void)_removeBoundaryTimeObservers;	// IMP=0x00000001000d0dc0
- (void)_addBoundaryTimeObservers;	// IMP=0x00000001000d06dc
- (void)playInLoopWithRate:(float)arg1 crossfadeDuration:(double)arg2;	// IMP=0x00000001000d0520
- (void)dealloc;	// IMP=0x00000001000d02b8
