...
- (void).cxx_destruct;	// IMP=0x0000000100090304
...
- (void)_setPaidSettingValue:(unsigned long long)arg1 freeSettingValue:(unsigned long long)arg2;	// IMP=0x0000000100090048
- (void)_syncPasswordPaidSetting:(unsigned long long)arg1 freeSetting:(unsigned long long)arg2 originalPaidSetting:(unsigned long long)arg3 originalFreeSetting:(unsigned long long)arg4;	// IMP=0x000000010008fc14
- (void)_updatePaidSetting:(unsigned long long)arg1 freeSetting:(unsigned long long)arg2;	// IMP=0x000000010008fa88
- (void)_refreshAccount;	// IMP=0x000000010008f8e4
- (void)_accountStoreDidChange:(id)arg1;	// IMP=0x000000010008f760
- (void)AMSURLSession:(id)arg1 task:(id)arg2 handleDialogRequest:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000010008f548
- (void)AMSURLSession:(id)arg1 task:(id)arg2 handleAuthenticateRequest:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000010008f2f0
- (void)setAsnFreeSetting:(id)arg1 presentingViewController:(id)arg2;	// IMP=0x000000010008f298
- (void)setAsnPaidSetting:(id)arg1 presentingViewController:(id)arg2;	// IMP=0x000000010008f240
- (void)setAsnFreeSetting:(id)arg1;	// IMP=0x000000010008f1f8
- (void)setAsnPaidSetting:(id)arg1;	// IMP=0x000000010008f1b0
- (void)dealloc;	// IMP=0x000000010008f128
- (id)initWithAccount:(id)arg1 amsBag:(id)arg2;	// IMP=0x000000010008eff8
