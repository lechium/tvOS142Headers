...
- (void).cxx_destruct;	// IMP=0x00000001000b6c78
...
- (void)viewDidLayoutSubviews;	// IMP=0x00000001000b681c
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000001000b6640
- (void)loadView;	// IMP=0x00000001000b63dc
- (void)dealloc;	// IMP=0x00000001000b637c
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000001000b62f8
