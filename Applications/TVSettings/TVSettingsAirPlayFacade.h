...
+ (id)sharedInstance;	// IMP=0x000000010000703c
+ (id)keyPathsForValuesAffectingLocalizedAllowAccessShortDescription;	// IMP=0x0000000100006ff0
+ (id)keyPathsForValuesAffectingRequireCodeEveryTime;	// IMP=0x0000000100006fb0
+ (id)keyPathsForValuesAffectingSecurityMode;	// IMP=0x0000000100006f70
+ (id)keyPathsForValuesAffectingAccessMode;	// IMP=0x0000000100006f30
- (void).cxx_destruct;	// IMP=0x00000001000080b8
