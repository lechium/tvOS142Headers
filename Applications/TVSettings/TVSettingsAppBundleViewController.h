...
- (void).cxx_destruct;	// IMP=0x0000000100026144
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000100025ff4
- (id)previewForItemAtIndexPath:(id)arg1;	// IMP=0x0000000100025ef8
- (id)loadSettingGroups;	// IMP=0x0000000100024168
- (void)dealloc;	// IMP=0x00000001000240d0
