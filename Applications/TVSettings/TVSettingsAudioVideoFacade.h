...
+ (id)sharedInstance;	// IMP=0x000000010003b070
- (void).cxx_destruct;	// IMP=0x000000010003c218
...
- (id)_availableDefaultAudioLanguages;	// IMP=0x000000010003c194
- (id)_availableDefaultSubtitleLanguages;	// IMP=0x000000010003c13c
- (void)_updateSelectedSubtitleOption:(_Bool)arg1;	// IMP=0x000000010003c00c
- (void)_updateAvailableSubtitleLanguageOptions:(_Bool)arg1;	// IMP=0x000000010003be5c
- (void)_updateAvailableAudioLanguageCodes:(_Bool)arg1;	// IMP=0x000000010003bc4c
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010003b988
...
- (void)dealloc;	// IMP=0x000000010003b238
- (id)init;	// IMP=0x000000010003b0dc
