...
- (void).cxx_destruct;	// IMP=0x00000001000217fc
...
- (void)_transitionToViewController:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000010002137c
- (void)_completeWithResult:(_Bool)arg1;	// IMP=0x00000001000212cc
- (void)_showTermText;	// IMP=0x0000000100021180
- (void)_showButtons;	// IMP=0x0000000100020b7c
- (void)_handleMenuButton:(id)arg1;	// IMP=0x0000000100020b28
- (id)presentationControllerForPresentedViewController:(id)arg1 presentingViewController:(id)arg2 sourceViewController:(id)arg3;	// IMP=0x0000000100020ab4
- (id)animationControllerForDismissedController:(id)arg1;	// IMP=0x0000000100020a88
- (id)animationControllerForPresentedController:(id)arg1 presentingController:(id)arg2 sourceController:(id)arg3;	// IMP=0x0000000100020a5c
- (id)preferredFocusEnvironments;	// IMP=0x0000000100020a08
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x000000010002094c
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x0000000100020878
- (void)viewDidLoad;	// IMP=0x0000000100020828
- (id)initWithTerms:(id)arg1;	// IMP=0x0000000100020744
