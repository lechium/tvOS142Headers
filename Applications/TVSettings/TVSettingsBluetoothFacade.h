...
+ (_Bool)isBTKeyboardConnected;	// IMP=0x0000000100009df4
+ (long long)numberOfConnectedDevices;	// IMP=0x0000000100009d78
+ (long long)numberOfConnectedRemotes;	// IMP=0x0000000100009bf4
+ (void)unpairDevice:(id)arg1;	// IMP=0x0000000100009a34
+ (void)disconnectDevice:(id)arg1;	// IMP=0x00000001000099c4
+ (void)connectDevice:(id)arg1;	// IMP=0x0000000100009954
+ (id)deviceStatusFormatterForDeviceType:(long long)arg1 showConnectedState:(_Bool)arg2;	// IMP=0x00000001000080f0
- (void).cxx_destruct;	// IMP=0x000000010000a0c8
...
- (id)_deviceSortDescriptors;	// IMP=0x0000000100009f78
@property(nonatomic) _Bool filterDeviceScan;
- (void)stopScanning;	// IMP=0x0000000100009904
- (void)startScanning;	// IMP=0x00000001000098b4
- (void)_managerDidUpdate:(id)arg1;	// IMP=0x0000000100009680
- (void)_updateConnectedDevicesWithSet:(id)arg1;	// IMP=0x00000001000095a8
- (void)_updateOtherDevicesWithSet:(id)arg1;	// IMP=0x00000001000094d0
- (void)_updateMyDevicesWithSet:(id)arg1;	// IMP=0x00000001000092d8
- (void)_updateRemotesWithSet:(id)arg1;	// IMP=0x00000001000090e0
- (void)_willEnterForeground:(id)arg1;	// IMP=0x00000001000090d4
- (void)_didEnterBackground:(id)arg1;	// IMP=0x00000001000090c8
- (void)dealloc;	// IMP=0x0000000100009010
- (id)init;	// IMP=0x0000000100008928
