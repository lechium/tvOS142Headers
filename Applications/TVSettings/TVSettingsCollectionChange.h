...
- (void).cxx_destruct;	// IMP=0x00000001000450c4
...
- (id)description;	// IMP=0x0000000100044f60
- (id)init;	// IMP=0x0000000100044f48
- (id)initWithChangeKind:(unsigned long long)arg1 sourceIndexes:(id)arg2 destinationIndexes:(id)arg3;	// IMP=0x0000000100044e80
