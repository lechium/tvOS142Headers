...
- (void).cxx_destruct;	// IMP=0x00000001000c24f4
...
- (unsigned long long)_viewTypeForNumberOfImages:(unsigned long long)arg1;	// IMP=0x00000001000c23a8
- (unsigned long long)_paradeThreshold;	// IMP=0x00000001000c2388
- (void)_displayPlaceholderView;	// IMP=0x00000001000c20c4
- (void)_fadeToBlack;	// IMP=0x00000001000c1fcc
- (void)_dissolveToPendingView;	// IMP=0x00000001000c1b94
- (void)setInOrder:(_Bool)arg1;	// IMP=0x00000001000c1ab8
- (void)setShuffled:(_Bool)arg1;	// IMP=0x00000001000c19dc
- (void)resume;	// IMP=0x00000001000c1974
- (_Bool)isPaused;	// IMP=0x00000001000c18fc
- (void)pause;	// IMP=0x00000001000c1894
- (void)_scrollingParadeViewReadyNotification:(id)arg1;	// IMP=0x00000001000c1508
- (void)_paradeViewReadyNotification:(id)arg1;	// IMP=0x00000001000c1430
- (void)_legacyCrossfadeViewReadyNotification:(id)arg1;	// IMP=0x00000001000c135c
- (void)_crossfadeViewReadyNotification:(id)arg1;	// IMP=0x00000001000c1288
- (void)layoutSubviews;	// IMP=0x00000001000c11fc
- (void)dealloc;	// IMP=0x00000001000c1160
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000c0f50
