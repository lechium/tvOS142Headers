...
+ (_Bool)automaticallyNotifiesObserversOfCurrentLocale;	// IMP=0x0000000100037514
+ (id)sharedInstance;	// IMP=0x0000000100036f30
- (void).cxx_destruct;	// IMP=0x0000000100038698
...
- (_Bool)setMyPhotoStreamEnabled:(_Bool)arg1 error:(id *)arg2;	// IMP=0x0000000100038478
- (_Bool)setICloudPhotoLibraryEnabled:(_Bool)arg1 error:(id *)arg2;	// IMP=0x00000001000383e0
- (_Bool)setICloudSharedPhotosEnabled:(_Bool)arg1 error:(id *)arg2;	// IMP=0x0000000100038348
@property(readonly, nonatomic) _Bool myPhotoStreamAvailable;
- (void)iCloudAccountManager:(id)arg1 didModifyActiveAccount:(id)arg2;	// IMP=0x0000000100038220
@property(readonly, nonatomic, getter=isSleepDisabledByProfile) _Bool sleepDisabledByProfile;
- (void)_updateSleepTimeoutValue;	// IMP=0x0000000100037ff8
- (id)cityNameForCityID:(id)arg1;	// IMP=0x0000000100037f18
...
- (void)_updateCurrentLocale;	// IMP=0x0000000100037c3c
...
- (id)internetConfigurationSummary;	// IMP=0x0000000100037848
...
- (id)init;	// IMP=0x0000000100037104
