...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x000000010009cf1c
+ (id)sharedInstance;	// IMP=0x0000000100099fa0
- (void).cxx_destruct;	// IMP=0x000000010009d1f0
...
- (void)displayState:(id)arg1 didChangeWithConnection:(long long)arg2;	// IMP=0x000000010009cce0
- (void)_reloadDataFromCache;	// IMP=0x000000010009ca9c
- (id)_sortedDisplayModesForUserPresentation:(id)arg1;	// IMP=0x000000010009c13c
- (void)presentCableCheckDisplayAssistant;	// IMP=0x000000010009c0bc
- (void)presentUpgradeAttemptDisplayAssistant;	// IMP=0x000000010009c028
- (void)resetVideoSettingsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010009bf08
- (void)updateDisplayManagerWithDisplayMode:(id)arg1 reason:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000010009be80
- (void)updateDisplayManagerWithDisplayMode:(id)arg1 reason:(id)arg2 requestConfiguration:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000010009bc80
- (void)_enumerateValidColorModesFromSortedModes:(id)arg1 existingFiltering:(id)arg2 withBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000010009b6b0
@property(readonly, nonatomic) TVSettingsDisplayAssistantActionInfo *displayAssistantActionInfo;
- (_Bool)shouldShowDisplayAssistant;	// IMP=0x000000010009b3b0
...
- (id)_recalculatedUnverifiedModes;	// IMP=0x000000010009a974
- (id)_recalculatedUserVisibleHDRChromaModes;	// IMP=0x000000010009a798
- (id)_recalculatedUserVisibleSDRChromaModes;	// IMP=0x000000010009a5a4
- (id)_recalculatedUserVisibleSDRColorMappingModes;	// IMP=0x000000010009a23c
- (void)dealloc;	// IMP=0x000000010009a1ac
- (id)init;	// IMP=0x000000010009a03c
