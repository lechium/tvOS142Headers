...
- (void).cxx_destruct;	// IMP=0x00000001000a829c
...
- (void)_editIRConfiguration:(id)arg1;	// IMP=0x00000001000a7438
- (void)_remotePolicyChanged;	// IMP=0x00000001000a742c
- (void)_cacheIRVolumeButtonConfigurations;	// IMP=0x00000001000a7350
- (id)loadSettingGroups;	// IMP=0x00000001000a6ffc
- (void)viewDidLoad;	// IMP=0x00000001000a6f00
- (void)dealloc;	// IMP=0x00000001000a6e88
- (id)init;	// IMP=0x00000001000a6ddc
