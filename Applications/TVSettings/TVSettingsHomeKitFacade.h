...
+ (id)sharedInstance;	// IMP=0x00000001000b4f40
- (void).cxx_destruct;	// IMP=0x00000001000b5970
...
- (void)_updateDoorbellServices;	// IMP=0x00000001000b563c
- (void)_updateResidentDevices;	// IMP=0x00000001000b5368
- (void)_setNeedsResidentDeviceUpdate;	// IMP=0x00000001000b5264
- (void)home:(id)arg1 didRemoveResidentDevice:(id)arg2;	// IMP=0x00000001000b5258
- (void)home:(id)arg1 didAddResidentDevice:(id)arg2;	// IMP=0x00000001000b524c
- (void)homeManagerDidUpdatePrimaryHome:(id)arg1;	// IMP=0x00000001000b5240
- (void)homeManager:(id)arg1 didRemoveHome:(id)arg2;	// IMP=0x00000001000b5234
- (void)homeManager:(id)arg1 didAddHome:(id)arg2;	// IMP=0x00000001000b51f8
- (void)homeManagerDidUpdateHomes:(id)arg1;	// IMP=0x00000001000b51ec
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000001000b5154
- (id)initWithServiceName:(id)arg1;	// IMP=0x00000001000b4ff8
