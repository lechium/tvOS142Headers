...
- (void).cxx_destruct;	// IMP=0x00000001000cd7f0
...
- (void)_updateImageViewWithPlaceholderImageIfNeeded;	// IMP=0x00000001000cd68c
- (void)_setImage:(id)arg1;	// IMP=0x00000001000cd518
- (id)_imageView;	// IMP=0x00000001000cd384
- (void)_loadImage;	// IMP=0x00000001000ccda0
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000001000ccc2c
@property(nonatomic) double cornerRadius;
- (void)setImageProxy:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000cc83c
@property(retain, nonatomic) UIImage *image;
- (void)willMoveToWindow:(id)arg1;	// IMP=0x00000001000cc72c
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001000cc684
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x00000001000cc610
- (void)setContentMode:(long long)arg1;	// IMP=0x00000001000cc5ec
- (void)layoutSubviews;	// IMP=0x00000001000cc580
- (long long)contentMode;	// IMP=0x00000001000cc568
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000001000cc550
- (void)dealloc;	// IMP=0x00000001000cc4e4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000cc400
