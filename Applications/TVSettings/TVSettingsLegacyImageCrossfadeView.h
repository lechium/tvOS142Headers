...
- (void)_crossfadeToImage:(id)arg1;	// IMP=0x000000010001b940
- (void)_loadNextImage:(id)arg1;	// IMP=0x000000010001b898
- (void)_startTimer;	// IMP=0x000000010001b7e0
- (struct CGSize)_maximumImageSize;	// IMP=0x000000010001b7a0
- (void)layoutSubviews;	// IMP=0x000000010001b1ac
- (void)didMoveToSuperview;	// IMP=0x000000010001b144
- (void)dealloc;	// IMP=0x000000010001b0ec
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010001b018
