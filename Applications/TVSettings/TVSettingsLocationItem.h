...
+ (id)_imageForInfo:(id)arg1;	// IMP=0x0000000100084de8
+ (id)_allowedAccessTypesForInfo:(id)arg1;	// IMP=0x0000000100084d0c
+ (unsigned long long)_accessTypeForInfo:(id)arg1;	// IMP=0x0000000100084ccc
+ (unsigned long long)_itemTypeForInfo:(id)arg1;	// IMP=0x0000000100084c84
+ (id)_explanatoryTextForInfo:(id)arg1;	// IMP=0x0000000100084b20
+ (id)_titleForIdentifier:(id)arg1 info:(id)arg2;	// IMP=0x0000000100084894
- (void).cxx_destruct;	// IMP=0x0000000100084e6c
...
- (id)initWithInfo:(id)arg1 identifier:(id)arg2;	// IMP=0x00000001000843fc
