...
- (void).cxx_destruct;	// IMP=0x00000001000a6d88
- (void)_showPrivacy:(id)arg1;	// IMP=0x00000001000a6d1c
- (void)_videoResolutionSelected:(id)arg1;	// IMP=0x00000001000a6c80
- (id)previewForItemAtIndexPath:(id)arg1;	// IMP=0x00000001000a6b30
- (id)loadSettingGroups;	// IMP=0x00000001000a5774
