...
- (void).cxx_destruct;	// IMP=0x00000001000a2758
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000001000a23dc
- (void)layoutSubviews;	// IMP=0x00000001000a2068
@property(copy, nonatomic) NSString *instructionText;
@property(copy, nonatomic) NSString *titleText;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000a1ac0
