...
- (void).cxx_destruct;	// IMP=0x00000001000ca720
...
- (id)hiddenDigitImage;	// IMP=0x00000001000ca2b8
- (id)arrowImage:(_Bool)arg1;	// IMP=0x00000001000ca0a8
- (void)downGesture:(id)arg1;	// IMP=0x00000001000c9f88
- (void)upGesture:(id)arg1;	// IMP=0x00000001000c9e7c
@property(copy, nonatomic) NSString *text;
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000001000c9bd8
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000001000c9aa0
- (_Bool)canBecomeFocused;	// IMP=0x00000001000c9a98
- (void)layoutSubviews;	// IMP=0x00000001000c9820
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000c9124
