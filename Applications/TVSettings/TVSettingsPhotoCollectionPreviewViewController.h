...
- (void).cxx_destruct;	// IMP=0x00000001000c0efc
@property(retain, nonatomic) TVPhotoCollection *photoCollection; // @synthesize photoCollection=_photoCollection;
- (void)_updateViewWithImageProxies:(id)arg1 inCollection:(id)arg2;	// IMP=0x00000001000c0e50
- (void)viewDidLayoutSubviews;	// IMP=0x00000001000c091c
- (void)loadView;	// IMP=0x00000001000c0860
