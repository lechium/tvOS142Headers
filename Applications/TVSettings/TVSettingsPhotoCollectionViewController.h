...
- (void).cxx_destruct;	// IMP=0x00000001000830e4
...
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x0000000100082fcc
- (id)collectionView:(id)arg1 viewForSupplementaryElementOfKind:(id)arg2 atIndexPath:(id)arg3;	// IMP=0x0000000100082e04
- (id)collectionView:(id)arg1 cellForItemAtIndexPath:(id)arg2;	// IMP=0x0000000100082c60
- (long long)collectionView:(id)arg1 numberOfItemsInSection:(long long)arg2;	// IMP=0x0000000100082c48
- (id)preferredFocusEnvironments;	// IMP=0x00000001000828ec
- (void)loadView;	// IMP=0x0000000100082684
- (void)dealloc;	// IMP=0x000000010008260c
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000100082544
