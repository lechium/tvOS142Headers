...
- (void).cxx_destruct;	// IMP=0x00000001000ce830
...
- (void)_deleteItem:(id)arg1;	// IMP=0x00000001000ce388
- (void)_airDropItem:(id)arg1;	// IMP=0x00000001000ce08c
- (void)_viewItem:(id)arg1;	// IMP=0x00000001000cde88
- (id)loadSettingGroups;	// IMP=0x00000001000cd8bc
