...
- (void).cxx_destruct;	// IMP=0x0000000100055cfc
...
- (void)editingController:(id)arg1 didCancelForSettingItem:(id)arg2;	// IMP=0x0000000100055c4c
- (void)editingController:(id)arg1 didProvideValue:(id)arg2 forSettingItem:(id)arg3;	// IMP=0x0000000100055a20
- (void)viewDidLoad;	// IMP=0x0000000100055798
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000100055710
