...
- (void).cxx_destruct;	// IMP=0x000000010003a04c
@property(nonatomic, getter=isPaused) _Bool paused; // @synthesize paused=_paused;
@property(copy, nonatomic) NSArray *imageProxies; // @synthesize imageProxies=_imageProxies;
- (void)_stopAnimations;	// IMP=0x0000000100039e80
- (void)_startAnimations;	// IMP=0x000000010003952c
- (void)_addImageToAnimationContainer:(id)arg1;	// IMP=0x000000010003926c
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x000000010003925c
- (void)layoutSubviews;	// IMP=0x0000000100038ae4
- (void)didMoveToWindow;	// IMP=0x0000000100038a28
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010003897c
