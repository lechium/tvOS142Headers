...
+ (_Bool)automaticallyNotifiesObserversOfAllowAccess;	// IMP=0x00000001000a30c8
+ (id)infoWithFacade:(id)arg1 identifier:(id)arg2 allowed:(_Bool)arg3;	// IMP=0x00000001000a2f34
- (void).cxx_destruct;	// IMP=0x00000001000a3108
