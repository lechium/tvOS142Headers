...
- (void).cxx_destruct;	// IMP=0x00000001000e1e9c
...
- (void)_cancelIfNotConnectedYet;	// IMP=0x00000001000e1cb4
- (void)_cleanUp;	// IMP=0x00000001000e1bb0
- (void)_deletePersonaIfNeeded;	// IMP=0x00000001000e19a4
- (void)_finishWithError:(id)arg1;	// IMP=0x00000001000e1268
- (void)_finish;	// IMP=0x00000001000e0b8c
- (void)_handleSetupServiceProgressEvent:(unsigned int)arg1 info:(id)arg2;	// IMP=0x00000001000e02d0
- (void)_restorePersona;	// IMP=0x00000001000e01b0
- (void)_adoptPersona;	// IMP=0x00000001000dfeb8
- (void)_start;	// IMP=0x00000001000dfa58
- (void)authenticateAccountsService:(id)arg1 didAuthenticateWithAccountInfo:(id)arg2;	// IMP=0x00000001000df9e8
- (void)authenticateAccountsService:(id)arg1 didAttemptSignInWithAccountType:(unsigned int)arg2;	// IMP=0x00000001000df9a0
- (void)authenticateAccountsService:(id)arg1 willAttemptSignInWithAccountType:(unsigned int)arg2;	// IMP=0x00000001000df958
- (_Bool)authenticateAccountsService:(id)arg1 shouldSignInAccounts:(id)arg2;	// IMP=0x00000001000df730
- (void)stop;	// IMP=0x00000001000df544
- (void)start;	// IMP=0x00000001000df170
- (void)dealloc;	// IMP=0x00000001000df124
- (id)initWithUserProfileType:(long long)arg1;	// IMP=0x00000001000df020
