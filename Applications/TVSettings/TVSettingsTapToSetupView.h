...
- (void).cxx_destruct;	// IMP=0x000000010006600c
...
- (void)_setActivityIndicatorIsInProgress:(_Bool)arg1;	// IMP=0x0000000100065ed4
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100065dd8
- (void)stopAnimatingSpinner;	// IMP=0x0000000100065dc8
- (void)startAnimatingSpinner;	// IMP=0x0000000100065db8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100064800
