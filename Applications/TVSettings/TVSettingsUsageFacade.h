...
- (void).cxx_destruct;	// IMP=0x0000000100097ce0
...
- (void)_fetchAppUsageInfo;	// IMP=0x00000001000978e8
- (void)uninstallAppWithProxy:(id)arg1;	// IMP=0x000000010009773c
- (void)dealloc;	// IMP=0x0000000100097668
- (id)init;	// IMP=0x0000000100097538
