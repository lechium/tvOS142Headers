...
- (void).cxx_destruct;	// IMP=0x000000010009745c
...
- (void)_updateWithUserProfile:(id)arg1 postKVONotifications:(_Bool)arg2;	// IMP=0x0000000100096e18
- (unsigned long long)hash;	// IMP=0x0000000100096e08
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100096d64
- (id)description;	// IMP=0x0000000100096ce4
- (void)updateWithUserProfile:(id)arg1;	// IMP=0x000000010009680c
- (id)initWithUserProfile:(id)arg1 amsBag:(id)arg2;	// IMP=0x00000001000966b4
- (id)initWithSystemUser:(id)arg1 amsBag:(id)arg2;	// IMP=0x0000000100096398
