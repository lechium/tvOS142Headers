...
- (void).cxx_destruct;	// IMP=0x00000001000556b0
...
- (unsigned long long)hash;	// IMP=0x0000000100055650
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100055580
@property(readonly, nonatomic) NSString *userProfileIdentifier;
- (id)initWithUserProfile:(id)arg1;	// IMP=0x0000000100055348
