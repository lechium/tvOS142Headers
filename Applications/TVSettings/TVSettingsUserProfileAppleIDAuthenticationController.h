...
- (void).cxx_destruct;	// IMP=0x00000001000853ec
...
- (void)authenticateWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100084f48
- (id)initWithUserProfileAuthenticationType:(long long)arg1;	// IMP=0x0000000100084ecc
