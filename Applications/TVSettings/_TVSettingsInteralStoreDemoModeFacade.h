...
- (_Bool)applyChanges;	// IMP=0x000000010004e034
@property(readonly, getter=isDirty) _Bool dirty;
- (unsigned long long)modeTypeEnum;	// IMP=0x000000010004ddac
- (unsigned long long)modeTypeIndexToEnum:(long long)arg1;	// IMP=0x000000010004dd98
- (id)availableModeTypes;	// IMP=0x000000010004dd8c
...
- (void)restoreDefaults;	// IMP=0x000000010004da20
- (id)init;	// IMP=0x000000010004d9c8
