...
+ (id)_keyValueDictionaryForURL:(id)arg1;	// IMP=0x00000001000e6470
+ (id)configWithPrefsURL:(id)arg1 options:(id)arg2;	// IMP=0x00000001000e5a14
+ (id)configWithTVProviderURL:(id)arg1;	// IMP=0x00000001000e5994
+ (id)configWithAppSettingsURL:(id)arg1;	// IMP=0x00000001000e5874
+ (id)configWithSettingsURL:(id)arg1;	// IMP=0x00000001000e57e0
- (void).cxx_destruct;	// IMP=0x00000001000e6728
