...
- (void).cxx_destruct;	// IMP=0x000000010000efb0
...
- (void)_updateEffect;	// IMP=0x000000010000ebd8
- (void)_updateCameraViewConstraints;	// IMP=0x000000010000e5f0
- (void)_updateAudioStream:(_Bool)arg1;	// IMP=0x000000010000e44c
- (_Bool)_shouldDisplayErrorContent;	// IMP=0x000000010000e30c
- (_Bool)_shouldDisplayAccessModeErrorContent;	// IMP=0x000000010000e19c
- (void)_updateContentViews;	// IMP=0x000000010000de48
- (void)_updateCameraNameLabels;	// IMP=0x000000010000daa8
- (void)cameraStreamControl:(id)arg1 didStopStreamWithError:(id)arg2;	// IMP=0x000000010000d90c
- (void)cameraStreamControlDidStartStream:(id)arg1;	// IMP=0x000000010000d500
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010000d434
- (void)stopStream;	// IMP=0x000000010000d3f4
- (void)startStreamIfNecessary;	// IMP=0x000000010000d308
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010000acd8
