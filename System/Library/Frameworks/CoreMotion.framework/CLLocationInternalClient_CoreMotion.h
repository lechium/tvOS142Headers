...
-(unsigned char)getLocationForBundleID:(const CFStringRef)arg1 orBundlePath:(const CFStringRef)arg2 dynamicAccuracyReductionEnabled:(unsigned char)arg3 allowsAlteredAccessoryLocations:(unsigned char)arg4 location:(SCD_Struct_CL39*)arg5 ;
-(unsigned char)getGroundAltitudeForBundleID:(const CFStringRef)arg1 orBundlePath:(const CFStringRef)arg2 location:(id)arg3 groundAltitude:(SCD_Struct_CL40*)arg4 ;
-(void)setMapMatchingRouteHint:(SCD_Struct_CL41*)arg1 count:(int)arg2 routingType:(int)arg3 stepType:(int)arg4 ;
...
-(unsigned char)compassCalibrationDatabaseGetBias:(SCD_Struct_CL42*)arg1 magneticField:(SCD_Struct_CM1)arg2 acceleration:(SCD_Struct_CM1)arg3 ;
...
-(unsigned char)configure:(SCD_Struct_CL43)arg1 ;
