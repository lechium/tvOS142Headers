...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x000000000000c2b4
- (void).cxx_destruct;	// IMP=0x000000000000ead8
...
- (id)_preloadArtwork;	// IMP=0x000000000000e8c8
- (id)_placeholderArtwork;	// IMP=0x000000000000e7f4
- (void)_updateState;	// IMP=0x000000000000e660
- (void)_updateAutomaticResponseLoading;	// IMP=0x000000000000e5a0
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x000000000000e14c
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x000000000000e044
- (void)_updateMetadata;	// IMP=0x000000000000cee8
- (void)_createRequestController;	// IMP=0x000000000000ca78
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x000000000000c83c
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x000000000000c6fc
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x000000000000c44c
- (void)playPause;	// IMP=0x000000000000c438
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x000000000000c3dc
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000000c340
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x000000000000c260
- (id)playerPath;	// IMP=0x000000000000c1b4
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x000000000000c074
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x000000000000be08
