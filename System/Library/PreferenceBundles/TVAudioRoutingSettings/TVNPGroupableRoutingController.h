...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x00000000000072cc
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000000b8f0
- (void)_updateWithAvailableMediaDestinations:(id)arg1;	// IMP=0x000000000000b07c
- (void)_updateWithAvailableEndpoints:(id)arg1 outputDevices:(id)arg2;	// IMP=0x000000000000973c
- (id)_endpointRoutesWithForcedLocalRoute:(id)arg1;	// IMP=0x00000000000094d0
- (void)_updateAvailableRoutes;	// IMP=0x0000000000008e10
- (void)_setNeedsDisplayedRoutesUpdate;	// IMP=0x0000000000008cbc
- (void)routingController:(id)arg1 pickedRouteDidChange:(id)arg2;	// IMP=0x0000000000008cb0
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x0000000000008ca4
- (void)targetDestination:(id)arg1;	// IMP=0x0000000000008b8c
- (void)selectOdeonDestination:(id)arg1;	// IMP=0x0000000000008798
- (void)unpickRoute:(id)arg1 forDestination:(id)arg2;	// IMP=0x00000000000084a0
- (void)pickRoute:(id)arg1 forDestination:(id)arg2;	// IMP=0x0000000000007bb8
- (void)_updateAllowsDestinationSelection;	// IMP=0x0000000000007b24
- (void)dealloc;	// IMP=0x0000000000007814
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2 initalFetchCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000007370
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2;	// IMP=0x0000000000007360
- (id)init;	// IMP=0x000000000000734c
