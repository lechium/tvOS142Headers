...
- (void).cxx_destruct;	// IMP=0x0000000000010138
...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x000000000001001c
- (void)connectAndPair;	// IMP=0x0000000000010018
- (void)togglePlayPause;	// IMP=0x0000000000010014
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x000000000000ffe0
