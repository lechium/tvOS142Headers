...
@protocol OS_dispatch_queue, AMSUIWebViewPluginInterface;
@class WKWebView, NSObject, NSArray, AMSBinaryPromise, AMSUIWebClientContext, _WKRemoteObjectInterface, DelegateProxy, NSString;
