...
@interface BWFigVideoCaptureDevice : NSObject <BWZoomCompletionDelegate, BWSupplementalPointCloudCaptureDeviceDelegate> {
	...
	SCD_Struct_Fi127 _deviceWhiteBalanceGains;
	SCD_Struct_Fi127 _grayWorldWhiteBalanceGains;
...
-(SCD_Struct_Fi127)deviceWhiteBalanceGains;
-(SCD_Struct_Fi127)grayWorldDeviceWhiteBalanceGains;
...
-(int)setWhiteBalanceModeLockedWithGains:(SCD_Struct_Fi127)arg1 requestID:(int)arg2 ;
