...
typedef struct {
	SCD_Struct_BW102 netInputBufferDesc[3];
	SCD_Struct_BW102 netOutputBufferDescs[3][24];
...
typedef struct {
	SCD_Struct_BW92 field1;
	SCD_Struct_Fi127 field2;
	SCD_Struct_Fi127 field3;
	SCD_Struct_Fi127 field4;
	int field5;
	BOOL field6;
	BOOL field7;
	BOOL field8;
