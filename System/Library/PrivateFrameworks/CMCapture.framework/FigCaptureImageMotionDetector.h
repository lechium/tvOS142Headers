...
@interface FigCaptureImageMotionDetector : NSObject {
	...
	SCD_Struct_Fi134 _motionStatistics;

}

@property (nonatomic,readonly) SCD_Struct_Fi117 motionStatistics;              //@synthesize motionStatistics=_motionStatistics - In the implementation block
...
-(SCD_Struct_Fi117)motionStatistics;
