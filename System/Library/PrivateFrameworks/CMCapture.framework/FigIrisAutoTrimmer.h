...
-(void)_processMotionSample:(const SCD_Struct_BW92*)arg1 gravity:(const SCD_Struct_Fi127*)arg2 motionTimestamp:(double)arg3 frameTimestamp:(SCD_Struct_BW7)arg4 metadata:(id)arg5 ;
