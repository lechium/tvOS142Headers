...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x0000000000016d78
...
- (id)_preloadArtwork;	// IMP=0x00000000000193e4
- (id)_placeholderArtwork;	// IMP=0x0000000000019310
- (void)_updateState;	// IMP=0x000000000001917c
- (void)_updateAutomaticResponseLoading;	// IMP=0x00000000000190bc
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x0000000000018c10
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x0000000000018b08
- (void)_updateMetadata;	// IMP=0x00000000000179ac
- (void)_createRequestController;	// IMP=0x000000000001753c
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x0000000000017300
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x00000000000171c0
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x0000000000016f10
- (void)playPause;	// IMP=0x0000000000016efc
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x0000000000016ea0
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000016e04
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x0000000000016d24
- (id)playerPath;	// IMP=0x0000000000016c78
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x0000000000016b38
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x00000000000168cc
