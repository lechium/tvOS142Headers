...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x0000000000002328
- (void).cxx_destruct;	// IMP=0x0000000000006da0
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000000069c0
- (void)_updateWithAvailableMediaDestinations:(id)arg1;	// IMP=0x000000000000614c
- (void)_updateWithAvailableEndpoints:(id)arg1 outputDevices:(id)arg2;	// IMP=0x000000000000480c
- (id)_endpointRoutesWithForcedLocalRoute:(id)arg1;	// IMP=0x00000000000045a0
- (void)_updateAvailableRoutes;	// IMP=0x0000000000003ee0
- (void)_setNeedsDisplayedRoutesUpdate;	// IMP=0x0000000000003d78
- (void)routingController:(id)arg1 pickedRouteDidChange:(id)arg2;	// IMP=0x0000000000003d6c
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x0000000000003d60
- (void)targetDestination:(id)arg1;	// IMP=0x0000000000003c48
- (void)selectOdeonDestination:(id)arg1;	// IMP=0x0000000000003804
- (void)unpickRoute:(id)arg1 forDestination:(id)arg2;	// IMP=0x000000000000350c
- (void)pickRoute:(id)arg1 forDestination:(id)arg2;	// IMP=0x0000000000002c1c
- (void)_updateAllowsDestinationSelection;	// IMP=0x0000000000002b88
- (void)dealloc;	// IMP=0x0000000000002878
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2 initalFetchCompletion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000023cc
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2;	// IMP=0x00000000000023bc
