...
- (void).cxx_destruct;	// IMP=0x0000000000021588
...
- (id)_unfocusedProgressColor;	// IMP=0x0000000000021428
- (id)_focusedProgressColor;	// IMP=0x00000000000213a4
- (void)_rightPressed:(id)arg1;	// IMP=0x0000000000021340
- (void)_leftPressed:(id)arg1;	// IMP=0x00000000000212dc
- (void)_panUpdated:(id)arg1;	// IMP=0x0000000000021074
- (void)_menuPressed;	// IMP=0x0000000000021070
- (void)endTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000002106c
- (_Bool)continueTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000021064
- (_Bool)beginTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000002105c
- (_Bool)shouldTrack;	// IMP=0x0000000000021054
- (double)maxBarWidth;	// IMP=0x0000000000021044
- (void)setMaxBarWidth:(double)arg1;	// IMP=0x000000000002101c
- (void)setValue:(float)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000020de4
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000020dbc
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000020da8
- (void)layoutSubviews;	// IMP=0x0000000000020b14
- (_Bool)canBecomeFocused;	// IMP=0x0000000000020b0c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000020564
