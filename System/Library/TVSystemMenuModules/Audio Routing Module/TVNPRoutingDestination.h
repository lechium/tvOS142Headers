...
- (void).cxx_destruct;	// IMP=0x000000000001aa6c
...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x000000000001a950
- (void)connectAndPair;	// IMP=0x000000000001a94c
- (void)togglePlayPause;	// IMP=0x000000000001a948
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x000000000001a914
- (id)init;	// IMP=0x000000000001a8fc
