...
- (void).cxx_destruct;	// IMP=0x0000000000020368
@property(retain, nonatomic) TVNPRoutingDestination *destination; // @synthesize destination=_destination;
- (void)_updateNowPlayingInfo;	// IMP=0x0000000000020098
- (void)_updateMusicBarState;	// IMP=0x0000000000020044
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000001ff08
- (void)dealloc;	// IMP=0x000000000001fc68
