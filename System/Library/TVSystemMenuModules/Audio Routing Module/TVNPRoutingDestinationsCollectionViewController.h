...
- (id)_indexPathForCurrentDestination;	// IMP=0x000000000000f3a8
- (void)_presentVolumeBulletinForDestination:(id)arg1;	// IMP=0x000000000000ecfc
- (void)bulletinService:(id)arg1 didDismissBulletin:(id)arg2 withReason:(unsigned long long)arg3;	// IMP=0x000000000000ec44
- (id)indexPathForPreferredFocusedViewInCollectionView:(id)arg1;	// IMP=0x000000000000ec38
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x000000000000e6a8
- (struct CGPoint)collectionView:(id)arg1 targetContentOffsetForProposedContentOffset:(struct CGPoint)arg2;	// IMP=0x000000000000e614
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x000000000000e324
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000000e034
- (_Bool)_ignoreVolumeChangesWhilePendingSelection;	// IMP=0x000000000000decc
- (void)_showConnectionFailedAlertControllerForRoutingDestination:(id)arg1;	// IMP=0x000000000000dc6c
- (void)updateCollectionViewWithDestinations:(id)arg1;	// IMP=0x000000000000d958
- (void)viewDidLayoutSubviews;	// IMP=0x000000000000d410
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x000000000000d37c
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000000d004
- (void)viewDidLoad;	// IMP=0x000000000000cc10
- (void)dealloc;	// IMP=0x000000000000cb58
- (id)initWithCollectionViewLayout:(id)arg1 routingController:(id)arg2 options:(id)arg3 initialUIDProvider:(CDUnknownBlockType)arg4;	// IMP=0x000000000000c970
