...
+ (id)_destinationLayout;	// IMP=0x00000000000093f8
- (void).cxx_destruct;	// IMP=0x000000000000999c
...
- (id)_routesLayout;	// IMP=0x00000000000094f8
- (void)_updateHintText;	// IMP=0x00000000000086a0
- (void)_updateTitleView;	// IMP=0x00000000000085f8
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000000850c
- (void)didPressPlayPause:(id)arg1;	// IMP=0x0000000000008498
- (void)didPressMenu:(id)arg1;	// IMP=0x0000000000008424
- (void)routingViewController:(id)arg1 shareAudioPresentationRequested:(id)arg2;	// IMP=0x000000000000840c
- (void)routingViewControllerWillEndEditingVolume:(id)arg1;	// IMP=0x00000000000083bc
- (void)routingViewControllerWillBeginEditingVolume:(id)arg1;	// IMP=0x0000000000008368
- (void)viewControllerDidRequestDismissal:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x0000000000008310
- (id)preferredFocusEnvironments;	// IMP=0x0000000000008298
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x0000000000008240
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x00000000000081e8
- (void)viewDidLoad;	// IMP=0x00000000000075c4
- (void)dealloc;	// IMP=0x0000000000007478
- (id)initWithRoutingController:(id)arg1 options:(id)arg2;	// IMP=0x0000000000006ed8
