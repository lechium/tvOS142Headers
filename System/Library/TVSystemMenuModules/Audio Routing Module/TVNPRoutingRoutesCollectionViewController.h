...
- (void)_relinquishVolumeHUDAssertionForRouteWithUID:(id)arg1;	// IMP=0x000000000001e2e0
- (void)_acquireVolumeHUDAssertionForRouteWithUID:(id)arg1;	// IMP=0x000000000001e1b0
- (void)_calculateVisibleVolumeCells;	// IMP=0x000000000001de80
- (void)_cleanupRouteForVolumeIfNeeded;	// IMP=0x000000000001dd70
- (id)_gradientMask;	// IMP=0x000000000001d940
- (void)viewControllerDidRequestDismissal:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x000000000001d928
- (void)shareAudioSelected;	// IMP=0x000000000001d894
- (void)handleEndVolumeControl:(id)arg1;	// IMP=0x000000000001d654
- (void)longPressSelect:(id)arg1;	// IMP=0x000000000001d598
- (id)indexPathForVolumeSliderInCollectionView:(id)arg1 layout:(id)arg2;	// IMP=0x000000000001d4bc
- (void)collectionView:(id)arg1 didEndDisplayingCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x000000000001d3a4
- (void)collectionView:(id)arg1 willDisplayCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x000000000001d28c
- (_Bool)collectionView:(id)arg1 shouldUpdateFocusInContext:(id)arg2;	// IMP=0x000000000001d250
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x000000000001d118
- (struct CGSize)collectionView:(id)arg1 layout:(id)arg2 sizeForItemAtIndexPath:(id)arg3;	// IMP=0x000000000001cfd8
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x000000000001ca78
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000001c98c
- (void)handleVolumeDown;	// IMP=0x000000000001c634
- (void)handleVolumeUp;	// IMP=0x000000000001c2dc
- (void)updateCollectionViewWithRoutes:(id)arg1;	// IMP=0x000000000001b980
- (void)viewDidLayoutSubviews;	// IMP=0x000000000001b740
- (void)viewDidLoad;	// IMP=0x000000000001ad80
- (void)dealloc;	// IMP=0x000000000001ad30
- (id)initWithCollectionViewLayout:(id)arg1 routingController:(id)arg2;	// IMP=0x000000000001ac60
