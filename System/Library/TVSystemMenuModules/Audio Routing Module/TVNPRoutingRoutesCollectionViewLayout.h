...
+ (Class)layoutAttributesClass;	// IMP=0x0000000000014c84
- (void).cxx_destruct;	// IMP=0x0000000000015098
...
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x0000000000014f70
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x0000000000014dd8
- (void)prepareLayout;	// IMP=0x0000000000014c90
