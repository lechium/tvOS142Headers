...
- (void).cxx_destruct;	// IMP=0x0000000000012370
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000012340
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000012140
