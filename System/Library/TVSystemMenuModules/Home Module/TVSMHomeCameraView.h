...
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x00000000000117c8
- (void).cxx_destruct;	// IMP=0x0000000000011944
...
- (id)initWithFrame:(struct CGRect)arg1 buttonStyle:(long long)arg2;	// IMP=0x00000000000110ac
