...
- (void).cxx_destruct;	// IMP=0x0000000000010f3c
...
- (void)_updateLayoutElementWithCameraTransition:(unsigned long long)arg1;	// IMP=0x0000000000010b90
- (id)tvsm_synchronizedDrawingFence;	// IMP=0x0000000000010ad0
- (void)viewControllerDidRequestDismissal:(id)arg1 focusedIdentifier:(id)arg2 focusedContentView:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000000103cc
- (id)animationControllerForDismissedController:(id)arg1;	// IMP=0x0000000000010220
- (id)animationControllerForPresentedController:(id)arg1 presentingController:(id)arg2 sourceController:(id)arg3;	// IMP=0x000000000001017c
- (void)contentModuleViewControllerDidTriggerAction:(id)arg1;	// IMP=0x000000000000fa40
- (id)indexPathForPreferredFocusedViewInCollectionView:(id)arg1;	// IMP=0x000000000000f978
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x000000000000f610
- (void)collectionView:(id)arg1 didEndDisplayingCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x000000000000f55c
- (void)collectionView:(id)arg1 willDisplayCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x000000000000f4a4
- (void)itemManager:(id)arg1 didUpdateResultsForItem:(id)arg2 atIndexPath:(id)arg3;	// IMP=0x000000000000f3a0
- (void)itemManager:(id)arg1 performUpdateRequest:(id)arg2;	// IMP=0x000000000000f268
- (id)preferredFocusEnvironments;	// IMP=0x000000000000f1f0
- (id)favoritesLayout;	// IMP=0x000000000000e9f0
- (void)updateCollectionViewAnimated:(_Bool)arg1;	// IMP=0x000000000000e0d4
- (void)_configureCell:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x000000000000df10
- (void)dealloc;	// IMP=0x000000000000dea0
- (void)viewDidLayoutSubviews;	// IMP=0x000000000000de90
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000000dde4
- (void)viewDidLoad;	// IMP=0x000000000000d184
