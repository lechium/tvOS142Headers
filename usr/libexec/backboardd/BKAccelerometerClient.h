...
- (_Bool)_shouldSendSampleEventWithTimestamp:(double)arg1 samplingInterval:(double)arg2;	// IMP=0x000000010004470c
- (_Bool)_passesThresholdForX:(float)arg1 y:(float)arg2 z:(float)arg3;	// IMP=0x0000000100044680
- (void)_queue_invalidate;	// IMP=0x000000010004464c
- (void)handleOrientationEvent:(long long)arg1 orientationLocked:(_Bool)arg2;	// IMP=0x0000000100044648
- (void)handleAccelerometerEventWithTimestamp:(double)arg1 x:(float)arg2 y:(float)arg3 z:(float)arg4 samplingInterval:(double)arg5;	// IMP=0x0000000100044644
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x0000000100044548
