...
- (void).cxx_destruct;	// IMP=0x000000010005fa08
...
- (id)touchStreamClientForReference:(unsigned int)arg1;	// IMP=0x000000010005f9a0
- (unsigned int)addTouchStreamClient:(id)arg1 toDisplayUUID:(id)arg2;	// IMP=0x000000010005f7c0
- (void)enumerateTouchStreamsForAllDisplaysUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000010005f74c
- (void)enumerateDigitizersForAllDisplaysUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000010005f6d8
- (void)enumerateDigitizersForDisplay:(id)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000010005f51c
- (id)touchStreamInfoForDisplayUUID:(id)arg1 createIfNeeded:(_Bool)arg2;	// IMP=0x000000010005f440
- (struct OpaqueBKDigitizerInfo *)infoForDigitizerService:(id)arg1 createIfNeeded:(_Bool)arg2;	// IMP=0x000000010005ef1c
- (id)_displayInfoForDisplay:(id)arg1 createIfNeeded:(_Bool)arg2;	// IMP=0x000000010005ee78
