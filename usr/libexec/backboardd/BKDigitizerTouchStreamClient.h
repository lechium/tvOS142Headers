...
- (void)watchForPortDeathOnQueue:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x0000000100055808
- (id)description;	// IMP=0x0000000100055624
- (void)invalidate;	// IMP=0x00000001000555b0
- (void)dealloc;	// IMP=0x0000000100055514
- (id)init;	// IMP=0x00000001000554d0
