...
+ (id)relativeToBottomMiddleOfSuper:(struct CGPoint)arg1;	// IMP=0x000000010005674c
+ (id)relativeToBottomLeftOfSuper:(struct CGPoint)arg1;	// IMP=0x00000001000566c8
+ (id)relativeToTopLeftOfSuper:(struct CGPoint)arg1;	// IMP=0x0000000100056644
+ (id)centerAtPoint:(struct CGPoint)arg1;	// IMP=0x00000001000565d4
+ (id)controlledBySupernode;	// IMP=0x0000000100056594
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010005646c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100056424
