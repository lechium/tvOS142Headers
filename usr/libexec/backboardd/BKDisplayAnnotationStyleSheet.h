...
- (void).cxx_destruct;	// IMP=0x0000000100017ecc
...
- (id)newLayerForContent:(id)arg1 scale:(double)arg2;	// IMP=0x0000000100017ce4
- (void)sizeLayer:(id)arg1 toFitAtScale:(double)arg2;	// IMP=0x0000000100017c20
- (void)applyToLayer:(id)arg1 forContent:(id)arg2;	// IMP=0x0000000100017b94
