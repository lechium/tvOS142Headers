...
- (void).cxx_destruct;	// IMP=0x000000010001ca10
...
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x000000010001c8e8
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x000000010001c894
- (id)succinctDescriptionBuilder;	// IMP=0x000000010001c828
- (id)succinctDescription;	// IMP=0x000000010001c7d4
@property(readonly, copy) NSString *description;
- (void)_wrapInCATransaction:(CDUnknownBlockType)arg1;	// IMP=0x000000010001c754
- (id)_persistenceData;	// IMP=0x000000010001c6d8
- (void)_cleanup;	// IMP=0x000000010001c6d4
- (void)_freeze;	// IMP=0x000000010001c6d0
- (void)_dismissWithAnimationSettings:(id)arg1;	// IMP=0x000000010001c6cc
- (void)_stopAnimating;	// IMP=0x000000010001c6c8
- (void)_startAnimating;	// IMP=0x000000010001c6c4
- (_Bool)_presentWithAnimationSettings:(id)arg1;	// IMP=0x000000010001c6bc
- (void)dismissWithAnimationSettings:(id)arg1;	// IMP=0x000000010001c564
- (void)freeze;	// IMP=0x000000010001c3d8
- (_Bool)presentWithAnimationSettings:(id)arg1;	// IMP=0x000000010001c1f0
...
- (void)dealloc;	// IMP=0x000000010001c080
- (id)_initWithPersistenceData:(id)arg1;	// IMP=0x000000010001bfc4
- (id)initWithOverlayDescriptor:(id)arg1 level:(float)arg2;	// IMP=0x000000010001be24
