...
+ (id)workQueue;	// IMP=0x0000000100046060
- (void).cxx_destruct;	// IMP=0x0000000100045ad0
@property(copy, nonatomic) NSArray *statistics; // @synthesize statistics=_statistics;
- (void)updateStatistics:(CDUnknownBlockType)arg1;	// IMP=0x0000000100045a38
- (id)beginTransactionForReason:(id)arg1;	// IMP=0x0000000100045a28
- (id)initWithLabel:(id)arg1 logCategory:(id)arg2;	// IMP=0x0000000100045898
