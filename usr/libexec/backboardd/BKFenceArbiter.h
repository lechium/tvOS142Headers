...
+ (id)sharedInstance;	// IMP=0x00000001000072a8
- (void).cxx_destruct;	// IMP=0x0000000100005d60
- (id)_newAssertionForTriggerPort:(unsigned int)arg1;	// IMP=0x0000000100005778
- (id)_newFenceHandle;	// IMP=0x0000000100004ca8
