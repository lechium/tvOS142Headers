...
- (void).cxx_destruct;	// IMP=0x000000010000499c
- (void)queue_handleMessage:(id)arg1 client:(id)arg2;	// IMP=0x00000001000047e4
- (id)initWithServiceName:(id)arg1 onQueue:(id)arg2;	// IMP=0x000000010000469c
