...
+ (id)sharedInstance;	// IMP=0x0000000100031bec
...
- (void)_queue_finishBootingIfNecessaryAndTellObservers:(_Bool)arg1;	// IMP=0x0000000100031778
- (void)_systemAppDidFinishLaunching:(id)arg1;	// IMP=0x0000000100031720
- (void)removeObserver:(id)arg1;	// IMP=0x000000010003169c
- (void)addObserver:(id)arg1;	// IMP=0x0000000100031618
@property(readonly, nonatomic, getter=isFirstBoot) _Bool firstBoot;
- (id)description;	// IMP=0x0000000100031580
- (id)initWithSystemAppSentinel:(id)arg1 firstBootToken:(id)arg2 alternateSystemAppManager:(id)arg3;	// IMP=0x00000001000313fc
