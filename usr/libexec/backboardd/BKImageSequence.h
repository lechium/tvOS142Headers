...
- (void).cxx_destruct;	// IMP=0x0000000100020a0c
...
- (void)_loadAllImages;	// IMP=0x0000000100020950
- (struct CGImage *)_imageAtIndex:(long long)arg1;	// IMP=0x0000000100020754
- (id)_idiomSuffix;	// IMP=0x00000001000206a8
- (struct CGImage *)_createImageForIndex:(unsigned long long)arg1 basename:(id)arg2 scale:(double)arg3 idiom:(id)arg4 bundle:(id)arg5;	// IMP=0x00000001000203ac
- (id)allImages;	// IMP=0x0000000100020378
- (struct CGImage *)imageAtIndex:(long long)arg1;	// IMP=0x000000010002036c
- (id)initWithBasename:(id)arg1 bundle:(id)arg2 imageCount:(long long)arg3 scale:(double)arg4;	// IMP=0x0000000100020234
