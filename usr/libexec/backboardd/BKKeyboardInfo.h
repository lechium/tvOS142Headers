...
+ (id)keyboardInfoWithIOHIDService:(id)arg1;	// IMP=0x000000010004a31c
- (void).cxx_destruct;	// IMP=0x000000010004a150
...
- (void)loadModifierKeyRemapping;	// IMP=0x0000000100049b8c
- (void)setCapsLockDelayOverride:(double)arg1;	// IMP=0x0000000100049a4c
- (void)setCapsLockLEDOn:(_Bool)arg1;	// IMP=0x0000000100049974
...
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x000000010004946c
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000100049408
- (id)initWithService:(id)arg1;	// IMP=0x0000000100049230
