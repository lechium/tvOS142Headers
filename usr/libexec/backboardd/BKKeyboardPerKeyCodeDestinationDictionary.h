...
- (void).cxx_destruct;	// IMP=0x000000010004a7f0
...
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x000000010004a714
- (void)removeDestinationsForKeyCode:(long long)arg1;	// IMP=0x000000010004a648
- (void)addDestination:(id)arg1 forDownKeyCode:(long long)arg2;	// IMP=0x000000010004a4d4
- (void)setDestinations:(id)arg1 forDownKeyCode:(long long)arg2;	// IMP=0x000000010004a38c
- (id)destinationsForDownKeyCode:(long long)arg1;	// IMP=0x000000010004a37c
