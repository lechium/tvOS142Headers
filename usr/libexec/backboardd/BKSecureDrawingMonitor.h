...
+ (id)sharedInstance;	// IMP=0x000000010003fee0
- (void).cxx_destruct;	// IMP=0x000000010003f980
@property(getter=isSecureModeEnabled) _Bool secureModeEnabled; // @synthesize secureModeEnabled=_secureModeEnabled;
- (void)reportAndKillInsecureProcesses;	// IMP=0x000000010003f658
- (void)startMonitoringSecureDrawing;	// IMP=0x000000010003f5f8
- (id)init;	// IMP=0x000000010003f53c
