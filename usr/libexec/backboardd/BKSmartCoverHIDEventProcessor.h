...
+ (_Bool)isSmartCoverSupported;	// IMP=0x000000010004c8e8
- (void).cxx_destruct;	// IMP=0x000000010004c75c
...
- (id)addSmartCoverObserver:(id)arg1;	// IMP=0x000000010004c61c
- (long long)processEvent:(inout struct __IOHIDEvent **)arg1 sender:(id)arg2 dispatcher:(id)arg3;	// IMP=0x000000010004bf90
@property(readonly, nonatomic, getter=isSmartCoverClosed) _Bool smartCoverClosed;
- (int)_smartCoverSensorsDidDisengage:(unsigned long long)arg1;	// IMP=0x000000010004bef8
- (int)_smartCoverSensorsDidEngage:(unsigned long long)arg1;	// IMP=0x000000010004bebc
- (id)initWithContext:(id)arg1;	// IMP=0x000000010004bc70
- (unsigned long long)_currentMaskForUsage:(unsigned int)arg1 HIDSystem:(id)arg2 mask:(unsigned long long *)arg3 maskIfEngaged:(unsigned long long *)arg4;	// IMP=0x000000010004bb1c
- (id)initWithSupportedHES:(unsigned long long)arg1 disengagedHES:(unsigned long long)arg2 attached:(_Bool)arg3 unknownState:(_Bool)arg4;	// IMP=0x000000010004b8f0
