...
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x000000010004431c
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x00000001000442c8
- (id)succinctDescriptionBuilder;	// IMP=0x0000000100044220
- (id)succinctDescription;	// IMP=0x00000001000441cc
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000100044170
- (id)initWithConnection:(id)arg1;	// IMP=0x00000001000440d4
