...
- (void).cxx_destruct;	// IMP=0x000000010004b49c
- (void)listener:(id)arg1 didReceiveConnection:(id)arg2 withContext:(id)arg3;	// IMP=0x000000010004b228
- (void)activate;	// IMP=0x000000010004b218
- (id)initWithObservationManager:(id)arg1;	// IMP=0x000000010004b128
