...
- (void).cxx_destruct;	// IMP=0x000000010001f0b8
...
- (_Bool)isAlive;	// IMP=0x000000010001f080
- (void)registerClientsForMonitoring;	// IMP=0x000000010001f070
- (id)init;	// IMP=0x000000010001efd0
