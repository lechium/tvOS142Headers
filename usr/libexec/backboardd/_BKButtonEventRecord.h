...
- (void).cxx_destruct;	// IMP=0x0000000100016630
...
- (void)applyEventPhase:(unsigned short)arg1 down:(_Bool)arg2;	// IMP=0x000000010001657c
- (id)conciseDescription;	// IMP=0x0000000100016448
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x0000000100016314
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x00000001000162c0
- (id)succinctDescriptionBuilder;	// IMP=0x00000001000162a8
- (id)succinctDescription;	// IMP=0x0000000100016254
