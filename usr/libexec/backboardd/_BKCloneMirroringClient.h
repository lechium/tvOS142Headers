...
+ (id)defaultClient;	// IMP=0x000000010004db34
- (void).cxx_destruct;	// IMP=0x000000010004dabc
...
- (id)initWithMode:(unsigned long long)arg1 port:(id)arg2 auditToken:(id)arg3;	// IMP=0x000000010004d938
