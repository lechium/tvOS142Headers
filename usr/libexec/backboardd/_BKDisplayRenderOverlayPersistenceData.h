...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010001fb7c
+ (id)classesRequiredToDecode;	// IMP=0x000000010001faf0
- (void).cxx_destruct;	// IMP=0x000000010001f9b0
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010001f830
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010001f64c
- (void)dealloc;	// IMP=0x000000010001f5b0
- (id)_initWithDescriptor:(id)arg1 overlayType:(long long)arg2 imageData:(id)arg3 level:(float)arg4;	// IMP=0x000000010001f3ec
