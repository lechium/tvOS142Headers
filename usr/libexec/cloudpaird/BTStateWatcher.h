...
+ (id)monitorFirstUnlockWithAction:(CDUnknownBlockType)arg1;	// IMP=0x00000001000230dc
+ (id)monitorBuddyStateWithAction:(CDUnknownBlockType)arg1;	// IMP=0x0000000100022f10
+ (id)monitorURL:(id)arg1 action:(CDUnknownBlockType)arg2;	// IMP=0x0000000100022df8
- (void).cxx_destruct;	// IMP=0x00000001000238fc
...
- (void)cancel;	// IMP=0x00000001000236fc
- (void)fileDiscovered;	// IMP=0x00000001000235fc
- (void)directoryChanged;	// IMP=0x0000000100023294
- (_Bool)start;	// IMP=0x000000010002273c
- (void)dealloc;	// IMP=0x00000001000226f0
- (id)initWithURL:(id)arg1 action:(CDUnknownBlockType)arg2;	// IMP=0x000000010002253c
