...
- (void)accountDidChange:(id)arg1;	// IMP=0x0000000100086e0c
- (void)onIdentityUpdateNotification;	// IMP=0x0000000100084964
@property(nonatomic, retain) OS_dispatch_queue *pushDelegateQueue;
@property(nonatomic, readonly) NSString *debugDescription;
@property(nonatomic, readonly) NSString *description;
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x0000000100052698
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x0000000100052690
- (_Bool)isMemberOfClass:(Class)arg1;	// IMP=0x0000000100052688
- (_Bool)isKindOfClass:(Class)arg1;	// IMP=0x0000000100052680
- (_Bool)isProxy;	// IMP=0x0000000100052678
- (id *)performSelector:(SEL)arg1 withObject:(id)arg2 withObject:(id)arg3;	// IMP=0x000000010005259c
- (id *)performSelector:(SEL)arg1 withObject:(id)arg2;	// IMP=0x000000010005250c
- (id *)performSelector:(SEL)arg1;	// IMP=0x00000001000524c8
- (id)self;	// IMP=0x00000001000524b4
@property(nonatomic, readonly) Class superclass;
@property(nonatomic, readonly) long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000523bc
- (void)didReceiveWithMessage:(id)arg1;	// IMP=0x000000010008e34c
- (void)didReceiveWithToken:(id)arg1 forTopic:(id)arg2 identifier:(id)arg3;	// IMP=0x000000010008d114
- (void)didReceiveWithPublicToken:(id)arg1;	// IMP=0x000000010008cfe0
