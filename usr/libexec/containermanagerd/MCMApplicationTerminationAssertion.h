...
- (void).cxx_destruct;	// IMP=0x00000001000835d4
@property(retain, nonatomic) RBSTerminationAssertion *termAssertion; // @synthesize termAssertion=_termAssertion;
- (void)dealloc;	// IMP=0x0000000100083544
- (void)invalidate;	// IMP=0x00000001000834c4
- (id)initWithBundleIdentifier:(id)arg1;	// IMP=0x0000000100082fc8
