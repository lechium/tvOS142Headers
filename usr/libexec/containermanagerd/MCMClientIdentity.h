...
+ (id)privilegedClientIdentityWithUserIdentity:(id)arg1 kernel:(_Bool)arg2;	// IMP=0x000000010001fe40
+ (id)anonymousPrivilegedClientIdentity;	// IMP=0x000000010001fdd4
+ (id)_clientIdentityWithXPCConnection:(id)arg1 personaUniqueString:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x0000000100020950
+ (id)clientIdentityWithXPCConnection:(id)arg1 error:(unsigned long long *)arg2;	// IMP=0x0000000100020890
+ (id)clientIdentityWithClient:(struct container_client *)arg1;	// IMP=0x0000000100020794
- (void).cxx_destruct;	// IMP=0x000000010001f8bc
...
- (id)shortDescription;	// IMP=0x000000010001f7f8
- (id)description;	// IMP=0x000000010001f788
- (void)dealloc;	// IMP=0x000000010001f740
- (_Bool)boolValueOfEntitlement:(id)arg1;	// IMP=0x000000010001f67c
- (id)initWithClient:(struct container_client *)arg1 userIdentity:(id)arg2 entitlements:(id)arg3 sandboxed:(_Bool)arg4 kernel:(_Bool)arg5;	// IMP=0x000000010001f3f0
- (id)init;	// IMP=0x000000010001f2d4
- (id)clientIdentityWithXPCConnection:(id)arg1 xpcMessage:(id)arg2;	// IMP=0x000000010001ff98
