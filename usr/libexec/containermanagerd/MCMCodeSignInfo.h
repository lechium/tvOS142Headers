...
- (void).cxx_destruct;	// IMP=0x000000010000f5a8
...
- (id)initWithAuditToken:(CDStruct_4c969caf)arg1;	// IMP=0x000000010000f284
- (id)initWithURL:(id)arg1 error:(unsigned long long *)arg2;	// IMP=0x000000010000f230
