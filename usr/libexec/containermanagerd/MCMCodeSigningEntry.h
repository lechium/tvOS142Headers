...
- (void).cxx_destruct;	// IMP=0x0000000100066b8c
...
- (id)description;	// IMP=0x0000000100066a94
- (unsigned long long)hash;	// IMP=0x0000000100066944
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000665e8
- (id)serialize;	// IMP=0x000000010006631c
- (id)initWithSerializedDictionary:(id)arg1;	// IMP=0x0000000100066108
- (id)initWithCodeSigningInfo:(id)arg1;	// IMP=0x00000001000660f8
- (id)initWithCodeSigningInfo:(id)arg1 andDataContainerClass:(unsigned long long)arg2;	// IMP=0x0000000100066064
