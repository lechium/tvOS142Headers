...
+ (Class)incomingMessageClass;	// IMP=0x0000000100019c90
+ (unsigned long long)command;	// IMP=0x0000000100019c88
- (void).cxx_destruct;	// IMP=0x000000010001a584
@property(retain, nonatomic) MCMClientConnection *clientConnection; // @synthesize clientConnection=_clientConnection;
- (_Bool)fromQueue:(id)arg1 executeWithError:(unsigned long long *)arg2;	// IMP=0x0000000100019c9c
