...
+ (id)_baseURLForUserIdentity:(id)arg1 containerClass:(unsigned long long)arg2;	// IMP=0x000000010003d3d0
+ (id)_baseURLForUserIdentity:(id)arg1;	// IMP=0x000000010003d36c
+ (id)_classComponentForContainerClass:(unsigned long long)arg1;	// IMP=0x000000010003d2c8
+ (id)_categoryComponentForContainerClass:(unsigned long long)arg1;	// IMP=0x000000010003d268
+ (unsigned short)_modeForContainerClass:(unsigned long long)arg1;	// IMP=0x000000010003d260
+ (_Bool)_inLibraryRepairBlock_createURLIfNecessary:(id)arg1 mode:(unsigned short)arg2 owner:(id)arg3 dataProtectionClass:(int)arg4 error:(id *)arg5;	// IMP=0x000000010003ce90
+ (id)posixOwnerForContainerClass:(unsigned long long)arg1 user:(id)arg2;	// IMP=0x000000010003cd88
+ (id)containerPathForUserIdentity:(id)arg1 containerClass:(unsigned long long)arg2;	// IMP=0x000000010003cc14
+ (id)containerPathForContainerIdentity:(id)arg1;	// IMP=0x000000010003cb7c
+ (id)containerPathTypeClasses;	// IMP=0x000000010003cb3c
- (void).cxx_destruct;	// IMP=0x000000010003c8c8
...
- (_Bool)_createURLIfNecessary:(id)arg1 mode:(unsigned short)arg2 owner:(id)arg3 dataProtectionClass:(int)arg4 error:(id *)arg5;	// IMP=0x000000010003c744
- (_Bool)_obj1:(id)arg1 isEqualToObj2:(id)arg2;	// IMP=0x000000010003c6e0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010003c5e4
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010003c56c
- (_Bool)isEqualToContainerClassPath:(id)arg1;	// IMP=0x000000010003c4a8
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithBaseURL:(id)arg1 categoryComponent:(id)arg2 classComponent:(id)arg3 containerClass:(unsigned long long)arg4 POSIXOwner:(id)arg5 POSIXMode:(unsigned short)arg6 userIdentity:(id)arg7;	// IMP=0x000000010003bf64
...
- (_Bool)createIfNecessaryWithError:(id *)arg1;	// IMP=0x000000010003b92c
