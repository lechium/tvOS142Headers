...
+ (id)contextWithHomeDirectoryURL:(id)arg1 containerPath:(id)arg2 POSIXMode:(unsigned short)arg3 POSIXOwner:(id)arg4 containerClass:(unsigned long long)arg5 dataProtectionClass:(int)arg6 libraryRepair:(id)arg7 identifier:(id)arg8;	// IMP=0x000000010001a768
- (void).cxx_destruct;	// IMP=0x000000010001a714
...
- (id)initWithHomeDirectoryURL:(id)arg1 containerPath:(id)arg2 POSIXMode:(unsigned short)arg3 POSIXOwner:(id)arg4 containerClass:(unsigned long long)arg5 dataProtectionClass:(int)arg6 libraryRepair:(id)arg7 identifier:(id)arg8;	// IMP=0x000000010001a598
