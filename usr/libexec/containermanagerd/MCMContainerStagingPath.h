...
+ (id)stagingContainerPathForDestinationContainerPath:(id)arg1 stagingPathIdentifier:(id)arg2;	// IMP=0x0000000100089988
+ (Class)_containerClassPathClass;	// IMP=0x000000010008997c
- (void).cxx_destruct;	// IMP=0x0000000100089968
