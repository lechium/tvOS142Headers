...
- (void).cxx_destruct;	// IMP=0x0000000100050850
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000506ac
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100050630
- (_Bool)isEqualToManagedPath:(id)arg1;	// IMP=0x000000010005061c
@property(readonly) unsigned long long hash;
- (id)managedPathByAppendingPathComponent:(id)arg1 flags:(unsigned long long)arg2 ACLConfig:(unsigned long long)arg3 mode:(unsigned short)arg4 dpClass:(int)arg5 owner:(id)arg6;	// IMP=0x0000000100050500
- (id)initWithURL:(id)arg1 flags:(unsigned long long)arg2 ACLConfig:(unsigned long long)arg3 mode:(unsigned short)arg4 dpClass:(int)arg5 owner:(id)arg6 parent:(id)arg7;	// IMP=0x0000000100050400
