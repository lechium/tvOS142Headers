...
- (void).cxx_destruct;	// IMP=0x0000000100063a08
...
- (void)_initPathPropertiesWithDaemonUser:(id)arg1;	// IMP=0x00000001000636b0
- (void)_addPaths:(id)arg1;	// IMP=0x0000000100063670
- (id)managedPathForURL:(id)arg1;	// IMP=0x00000001000634d0
- (id)orderedPathsFromPaths:(id)arg1;	// IMP=0x00000001000631c0
- (id)initWithDaemonUser:(id)arg1;	// IMP=0x0000000100063098
