...
- (void)_initPathPropertiesWithUserHomeDirectoryURL:(id)arg1 clientUser:(id)arg2;	// IMP=0x0000000100063c38
- (id)initWithUserIdentity:(id)arg1 daemonUser:(id)arg2;	// IMP=0x0000000100063ab0
