...
- (void).cxx_destruct;	// IMP=0x00000001000822a8
...
- (_Bool)canBeHandledLocally;	// IMP=0x00000001000821ec
- (id)initWithXPCObject:(id)arg1 clientConnection:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x0000000100082050
