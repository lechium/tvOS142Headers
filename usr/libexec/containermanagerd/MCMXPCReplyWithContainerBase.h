...
- (void).cxx_destruct;	// IMP=0x000000010002c78c
...
- (void)dealloc;	// IMP=0x000000010002c6fc
- (id)initWithMetadata:(id)arg1 sandboxToken:(const char *)arg2;	// IMP=0x000000010002c52c
- (id)initWithUUID:(id)arg1 existed:(_Bool)arg2 url:(id)arg3 containerPathIdentifier:(id)arg4 identifier:(id)arg5 containerClass:(unsigned long long)arg6 personaUniqueString:(id)arg7 sandboxToken:(const char *)arg8;	// IMP=0x000000010002c3e0
- (_Bool)encodeReplyOntoXPCObject:(id)arg1;	// IMP=0x000000010002c160
