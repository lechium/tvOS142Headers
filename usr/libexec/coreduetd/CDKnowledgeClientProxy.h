...
- (id)description;	// IMP=0x00000001000238e4
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x0000000100023888
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x000000010002383c
- (void)forwardInvocation:(id)arg1;	// IMP=0x0000000100023714
- (void)_logInvocationForSelector:(id)arg1;	// IMP=0x00000001000236fc
- (void)dealloc;	// IMP=0x0000000100023620
- (id)initWithDaemon:(id)arg1 connection:(id)arg2;	// IMP=0x000000010002339c
