...
- (void).cxx_destruct;	// IMP=0x000000010000b160
...
- (void)evictRandom;	// IMP=0x000000010000b048
- (void)setObject:(id)arg1 forKeyedSubscript:(id)arg2;	// IMP=0x000000010000ad3c
- (id)objectForKeyedSubscript:(id)arg1;	// IMP=0x000000010000ab6c
- (void)flush;	// IMP=0x000000010000aa30
- (id)initWithCapacity:(unsigned long long)arg1;	// IMP=0x000000010000a970
