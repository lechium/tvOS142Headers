...
- (void).cxx_destruct;	// IMP=0x000000010000ec90
...
- (void)analyzeValues:(id)arg1 currentContext:(id)arg2;	// IMP=0x000000010000e8a4
- (double)getReferenceTemperatureForContext:(id)arg1 reader:(id)arg2;	// IMP=0x000000010000e7a8
- (void)recordValue;	// IMP=0x000000010000e6f8
- (void)stop;	// IMP=0x000000010000e68c
- (void)start;	// IMP=0x000000010000e5fc
- (id)initWithQueueLimit:(unsigned long long)arg1 reader:(id)arg2 monitoringInterval:(unsigned long long)arg3 analyzeToMonitorRatio:(unsigned long long)arg4;	// IMP=0x000000010000e3b4
