...
+ (id)sharedInstance;	// IMP=0x000000010003726c
- (void).cxx_destruct;	// IMP=0x0000000100037c44
...
- (long long)roundedTemperature:(long long)arg1;	// IMP=0x0000000100037b24
- (_Bool)storeBatteryTemperatureEvent:(long long)arg1 metaData:(id)arg2;	// IMP=0x0000000100037948
- (id)getBatteryStatus;	// IMP=0x0000000100037790
- (void)handleBatteryNotification;	// IMP=0x0000000100037480
- (void)startRecording;	// IMP=0x00000001000372f0
- (id)init;	// IMP=0x00000001000371ac
