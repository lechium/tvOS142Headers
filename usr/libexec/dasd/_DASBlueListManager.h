...
+ (id)managerWithContext:(id)arg1;	// IMP=0x000000010003e378
+ (long long)nextHoursBudgetWithPreviousBudget:(long long)arg1;	// IMP=0x000000010003e35c
- (void).cxx_destruct;	// IMP=0x000000010003f380
...
- (void)registerForBlueListNotifications;	// IMP=0x000000010003eca8
- (_Bool)shouldBlueListPushes;	// IMP=0x000000010003e9ec
- (void)updateBlueListStatus:(_Bool)arg1;	// IMP=0x000000010003e948
- (void)setupResetTimer;	// IMP=0x000000010003e7fc
- (_Bool)overBudget;	// IMP=0x000000010003e7b8
- (void)decrementPushBudgetRemaining;	// IMP=0x000000010003e758
- (void)updateBudgetsForNextSlot;	// IMP=0x000000010003e718
- (void)updateGlobalBudget:(long long)arg1;	// IMP=0x000000010003e660
- (id)initWithContext:(id)arg1;	// IMP=0x000000010003e3c8
