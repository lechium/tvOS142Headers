...
+ (id)getDeviceBootTime;	// IMP=0x0000000100020700
+ (id)policyInstance;	// IMP=0x000000010002064c
- (void).cxx_destruct;	// IMP=0x0000000100020a6c
...
- (id)responseForActivity:(id)arg1 withState:(id)arg2;	// IMP=0x00000001000207b4
- (double)weightForActivity:(id)arg1;	// IMP=0x00000001000206f4
- (_Bool)appliesToActivity:(id)arg1;	// IMP=0x00000001000206c0
- (_Bool)shouldIgnoreTrigger:(id)arg1 withState:(id)arg2;	// IMP=0x00000001000206b8
- (id)init;	// IMP=0x00000001000205bc
