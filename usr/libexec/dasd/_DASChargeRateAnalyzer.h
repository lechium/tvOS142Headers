...
- (void).cxx_destruct;	// IMP=0x000000010000f988
...
- (void)analyzeValues:(id)arg1 currentContext:(id)arg2;	// IMP=0x000000010000f3a8
- (double)getReferenceChargeRateForContext:(id)arg1 reader:(id)arg2;	// IMP=0x000000010000f204
- (void)recordValue;	// IMP=0x000000010000f154
- (void)stop;	// IMP=0x000000010000f0e8
- (void)start;	// IMP=0x000000010000f058
- (id)initWithQueueLimit:(unsigned long long)arg1 reader:(id)arg2 monitoringInterval:(unsigned long long)arg3 analyzeToMonitorRatio:(unsigned long long)arg4;	// IMP=0x000000010000ee00
