...
- (void).cxx_destruct;	// IMP=0x000000010000d10c
...
- (id)startChargeRateLoop;	// IMP=0x000000010000ce50
- (void)recordSessionAnalytics;	// IMP=0x000000010000cc3c
- (id)currentStatus;	// IMP=0x000000010000cae8
- (void)resetAnalyticsState;	// IMP=0x000000010000ca90
- (void)resetState;	// IMP=0x000000010000ca1c
- (id)startBatteryTemperatureLoop;	// IMP=0x000000010000c95c
- (void)resetDutyCyclingEffort;	// IMP=0x000000010000c8a4
- (void)executeDutyCyclingWithEffort:(unsigned long long)arg1;	// IMP=0x000000010000c7a4
- (unsigned long long)dutyCycleTimeFromEffort:(unsigned long long)arg1;	// IMP=0x000000010000c798
- (void)resetSFIEffort;	// IMP=0x000000010000c718
- (void)executeSFIWithEffort:(unsigned long long)arg1;	// IMP=0x000000010000c510
- (unsigned long long)SFITimeFromEffort:(unsigned long long)arg1;	// IMP=0x000000010000c4e8
- (void)resetInitialAction;	// IMP=0x000000010000c4c4
- (void)invokeInitialActionWithValue:(long long)arg1;	// IMP=0x000000010000c3c4
- (void)updateControlAction:(id)arg1 withEffort:(long long)arg2;	// IMP=0x000000010000c1bc
- (void)checkControlAction:(id)arg1;	// IMP=0x000000010000bb80
- (void)saveControlEffort:(long long)arg1;	// IMP=0x000000010000b828
- (void)saveTLCState:(_Bool)arg1;	// IMP=0x000000010000b448
- (id)intializeAnalyzerTimerWithCadence:(double)arg1 forAction:(id)arg2;	// IMP=0x000000010000b2b0
- (void)registerTriggers;	// IMP=0x000000010000aef8
- (id)status;	// IMP=0x000000010000aea8
- (void)intializeAnalyzers;	// IMP=0x000000010000a920
- (void)loadTrialParameters;	// IMP=0x000000010000a38c
- (id)init;	// IMP=0x000000010000a028
