...
+ (id)sharedInstance;	// IMP=0x000000010001794c
...
- (void)deregisterStateChangeHandler:(id)arg1;	// IMP=0x0000000100018950
- (id)registerStateChangeHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000187e4
- (_Bool)isDataAvailableFor:(id)arg1;	// IMP=0x0000000100018698
- (_Bool)isDataAvailableForClassA;	// IMP=0x0000000100018650
- (_Bool)isDataAvailableForClassC;	// IMP=0x0000000100018608
- (_Bool)deviceIsLocked;	// IMP=0x00000001000185bc
- (_Bool)deviceIsPasswordConfigured;	// IMP=0x0000000100018570
- (_Bool)deviceHasBeenUnlockedSinceBoot;	// IMP=0x0000000100018554
- (void)handleKeyBagLockNotification;	// IMP=0x0000000100017dd4
- (id)init;	// IMP=0x00000001000179e8
