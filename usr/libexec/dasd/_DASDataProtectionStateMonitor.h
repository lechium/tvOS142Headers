...
+ (id)dataProtectionClassD;	// IMP=0x0000000100018a84
+ (id)dataProtectionClassC;	// IMP=0x0000000100018a74
+ (id)dataProtectionClassA;	// IMP=0x0000000100018a64
- (void).cxx_destruct;	// IMP=0x0000000100018c38
...
- (_Bool)unnotifiedIsDataAvailableForClassC;	// IMP=0x0000000100018c14
- (_Bool)isDataAvailableFor:(id)arg1;	// IMP=0x0000000100018c04
- (void)dealloc;	// IMP=0x0000000100018b20
- (id)init;	// IMP=0x0000000100018a94
