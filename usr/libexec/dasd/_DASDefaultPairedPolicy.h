...
+ (id)policyInstance;	// IMP=0x00000001000234e8
- (void).cxx_destruct;	// IMP=0x0000000100023c00
...
- (double)predictedScoreForActivity:(id)arg1 atDate:(id)arg2;	// IMP=0x0000000100023b38
- (id)responseForActivity:(id)arg1 withState:(id)arg2;	// IMP=0x000000010002386c
- (double)scoreForActivity:(id)arg1 atDate:(id)arg2;	// IMP=0x0000000100023584
- (double)weightForActivity:(id)arg1;	// IMP=0x00000001000234e0
- (_Bool)appliesToActivity:(id)arg1;	// IMP=0x0000000100023470
- (_Bool)shouldIgnoreTrigger:(id)arg1 withState:(id)arg2;	// IMP=0x0000000100023398
- (id)predictionForDeviceNearby;	// IMP=0x00000001000231cc
- (id)init;	// IMP=0x00000001000230c8
- (id)initializeTriggers;	// IMP=0x0000000100022f70
