...
+ (id)persistence;	// IMP=0x000000010000590c
...
- (id)convertNameFromCompactToFull:(id)arg1;	// IMP=0x00000001000064fc
- (id)convertNameFromFullToCompact:(id)arg1;	// IMP=0x0000000100006458
- (void)saveModulationDate:(id)arg1;	// IMP=0x0000000100006258
- (void)updateBudget:(id)arg1;	// IMP=0x0000000100006108
- (void)saveBudgets:(id)arg1;	// IMP=0x0000000100005e44
- (id)loadBudgetsWithExpectedNames:(id)arg1;	// IMP=0x00000001000059b0
- (id)init;	// IMP=0x000000010000578c
