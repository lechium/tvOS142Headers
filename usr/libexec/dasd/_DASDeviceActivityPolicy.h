...
+ (_Bool)isDeviceInUse:(id)arg1;	// IMP=0x000000010002478c
+ (id)policyInstance;	// IMP=0x0000000100024198
+ (void)printLowLikelihoodRegions;	// IMP=0x0000000100023c54
- (void).cxx_destruct;	// IMP=0x0000000100024e4c
...
- (double)predictedScoreForActivity:(id)arg1 atDate:(id)arg2;	// IMP=0x0000000100024d60
- (id)responseForActivity:(id)arg1 withState:(id)arg2;	// IMP=0x0000000100024978
- (_Bool)backgroundTaskAllowedWithType:(id)arg1 withRationale:(id)arg2 withState:(id)arg3;	// IMP=0x0000000100024838
- (double)scoreForActivity:(id)arg1 atDate:(id)arg2;	// IMP=0x0000000100024404
- (double)weightForActivity:(id)arg1;	// IMP=0x0000000100024394
- (_Bool)appliesToActivity:(id)arg1;	// IMP=0x000000010002430c
- (_Bool)shouldIgnoreTrigger:(id)arg1 withState:(id)arg2;	// IMP=0x0000000100024234
- (_Bool)shouldLogScoreToPowerLog;	// IMP=0x0000000100024190
- (id)predictionForDeviceActivity;	// IMP=0x0000000100024124
- (id)init;	// IMP=0x0000000100023f30
- (id)initializeTriggers;	// IMP=0x0000000100023e00
