...
- (void)addRationaleWithCondition:(id)arg1;	// IMP=0x0000000100030034
- (void)addRationaleForCondition:(id)arg1 withRequiredValue:(double)arg2 withCurrentValue:(double)arg3;	// IMP=0x000000010002ffa8
- (id)initWithPolicyName:(id)arg1;	// IMP=0x000000010002ff04
- (id)description;	// IMP=0x000000010002fcec
