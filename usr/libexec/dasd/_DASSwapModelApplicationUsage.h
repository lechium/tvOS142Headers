...
- (void).cxx_destruct;	// IMP=0x00000001000418a0
...
- (void)updateScores;	// IMP=0x0000000100041830
- (id)scoresForAllApplicationsAtDate:(id)arg1;	// IMP=0x0000000100041784
- (double)scoreForApplication:(id)arg1 atDate:(id)arg2;	// IMP=0x0000000100041678
- (void)updateTimeline;	// IMP=0x0000000100041410
- (void)convertTimelineToApplicationDictionaries:(id)arg1;	// IMP=0x000000010004140c
- (id)init;	// IMP=0x0000000100041364
