...
- (void).cxx_destruct;	// IMP=0x00000001000408b8
...
- (double)scoreForApplication:(id)arg1 atDate:(id)arg2;	// IMP=0x00000001000405f0
- (id)scoresForAllApplicationsAtDate:(id)arg1;	// IMP=0x000000010003fdd8
- (id)initWithAlgorithms:(id)arg1;	// IMP=0x000000010003fc68
