...
+ (id)sharedInstance;	// IMP=0x00000001000410d0
- (void).cxx_destruct;	// IMP=0x0000000100041310
...
- (void)stop;	// IMP=0x0000000100041294
- (void)start;	// IMP=0x0000000100041238
- (void)updateSwapScoresWithDictionary:(id)arg1;	// IMP=0x0000000100040bf4
- (void)updateScores;	// IMP=0x0000000100040b44
- (id)initWithAlgorithms:(id)arg1;	// IMP=0x00000001000408cc
