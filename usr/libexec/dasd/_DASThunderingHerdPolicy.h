...
+ (id)policyInstance;	// IMP=0x000000010002e194
- (void).cxx_destruct;	// IMP=0x000000010002e680
...
- (id)responseForActivity:(id)arg1 withState:(id)arg2;	// IMP=0x000000010002e404
- (double)weightForActivity:(id)arg1;	// IMP=0x000000010002e3fc
- (_Bool)shouldIgnoreTrigger:(id)arg1 withState:(id)arg2;	// IMP=0x000000010002e348
- (void)handleTriggerEvent;	// IMP=0x000000010002e2b4
- (_Bool)appliesToActivity:(id)arg1;	// IMP=0x000000010002e200
- (id)init;	// IMP=0x000000010002dd08
- (id)initializeTriggers;	// IMP=0x000000010002d9bc
