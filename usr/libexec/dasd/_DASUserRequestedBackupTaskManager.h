...
+ (id)userRequestedBackupKeyPath;	// IMP=0x0000000100068fd0
+ (id)managerWithContext:(id)arg1;	// IMP=0x0000000100068f7c
...
- (void)syncRequested;	// IMP=0x0000000100069a10
- (void)_queue_obtainPendingBackupTasks;	// IMP=0x0000000100069860
- (_Bool)activityEligibleForRunning:(id)arg1;	// IMP=0x0000000100069784
- (void)reportActivityNoLongerRunning:(id)arg1;	// IMP=0x00000001000692e4
- (void)reportActivityRunning:(id)arg1;	// IMP=0x0000000100069180
- (void)activitySubmitted:(id)arg1;	// IMP=0x0000000100069054
- (id)initWithContext:(id)arg1;	// IMP=0x0000000100068e20
