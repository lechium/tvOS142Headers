...
+ (id)sharedInstance;	// IMP=0x0000000100008b74
...
- (double)stopTrackingActivity:(id)arg1;	// IMP=0x0000000100009e34
- (void)startTrackingActivity:(id)arg1;	// IMP=0x0000000100009d9c
- (int)allocateBudgetForViews:(int)arg1;	// IMP=0x0000000100009d60
- (id)getAverageWidgetViewsPerDayWithStore:(id)arg1;	// IMP=0x0000000100009664
- (void)invalidateComputedBudgetCache;	// IMP=0x0000000100009620
- (void)computeBudgetFromHistoryForAllWidgets;	// IMP=0x00000001000090a8
- (id)dailyBudgetsForAllWidgets;	// IMP=0x0000000100008f10
- (id)dailyBudgetForWidget:(id)arg1;	// IMP=0x0000000100008ea0
- (void)setBudgetMaximums;	// IMP=0x0000000100008d70
- (id)init;	// IMP=0x0000000100008c10
