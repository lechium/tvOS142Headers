...
+ (id)sharedInstance;	// IMP=0x000000010004427c
- (void).cxx_destruct;	// IMP=0x00000001000452c0
...
- (_Bool)installProvisioningProfiles;	// IMP=0x0000000100044df4
- (id)namesForBackupsOfRange:(struct _NSRange)arg1;	// IMP=0x0000000100044c58
- (_Bool)updateBackup:(struct _NSRange)arg1 error:(id *)arg2;	// IMP=0x00000001000443b0
- (id)init;	// IMP=0x00000001000442e8
