...
+ (id)sharedInstance;	// IMP=0x0000000100055d48
...
- (void)URLSession:(id)arg1 task:(id)arg2 didReceiveChallenge:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000100057df0
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x00000001000579bc
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x0000000100057580
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000100057340
- (void)invalidate;	// IMP=0x0000000100057300
- (_Bool)directDownload:(id)arg1 withCredential:(id)arg2 to:(id)arg3 localSource:(_Bool)arg4 error:(id *)arg5 retry:(long long)arg6;	// IMP=0x0000000100056358
- (id)init;	// IMP=0x0000000100055db4
