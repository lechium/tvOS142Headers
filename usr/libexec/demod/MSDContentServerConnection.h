...
+ (id)contentServerConnection:(id)arg1 port:(id)arg2;	// IMP=0x0000000100052314
- (void).cxx_destruct;	// IMP=0x0000000100055c44
...
- (void)URLSession:(id)arg1 task:(id)arg2 willPerformHTTPRedirection:(id)arg3 newRequest:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000100055880
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x0000000100055458
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000010005516c
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x00000001000549b8
- (void)URLSession:(id)arg1 task:(id)arg2 didReceiveChallenge:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000100054654
- (_Bool)addAuthenticationHeadersToRequest:(id)arg1 withBody:(id)arg2 error:(id *)arg3;	// IMP=0x00000001000543ac
- (void)cancelDownloading;	// IMP=0x0000000100054058
- (void)runRunLoopUntilDone;	// IMP=0x000000010005401c
- (_Bool)startDownloadingFile;	// IMP=0x00000001000532cc
- (void)invalidate;	// IMP=0x000000010005328c
- (void)enableAuthenticationWithHMACKey:(id)arg1;	// IMP=0x0000000100053280
- (_Bool)downloadTo:(id)arg1 byPosting:(id)arg2 toPath:(id)arg3 retry:(int)arg4 error:(id *)arg5;	// IMP=0x0000000100052f90
- (id)postDataForEnrolment:(id)arg1 to:(id)arg2 retry:(int)arg3 error:(id *)arg4;	// IMP=0x0000000100052ea0
- (id)postData:(id)arg1 to:(id)arg2 retry:(int)arg3 error:(id *)arg4;	// IMP=0x0000000100052d3c
- (_Bool)downloadFile:(id)arg1 to:(id)arg2 retry:(long long)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000001000528d4
- (id)downloadFileToNSData:(id)arg1 retry:(long long)arg2 error:(id *)arg3;	// IMP=0x0000000100052790
- (void)dealloc;	// IMP=0x0000000100052650
- (void)setupServer:(id)arg1 port:(id)arg2;	// IMP=0x00000001000525d8
- (id)initWithCellularAccess:(_Bool)arg1;	// IMP=0x00000001000523a8
