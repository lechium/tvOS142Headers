...
+ (id)sharedInstance;	// IMP=0x000000010003764c
- (void).cxx_destruct;	// IMP=0x000000010003b34c
...
- (void)setAutomatedDeviceGroupStoreID;	// IMP=0x000000010003aebc
- (void)setMacSpecificSettings;	// IMP=0x000000010003aeb8
- (void)setTVSpecificSettings;	// IMP=0x000000010003ad88
- (_Bool)migrateDataWithBlockingUI:(int)arg1;	// IMP=0x000000010003a91c
- (_Bool)PLHasCompletedMomentAnalysis;	// IMP=0x000000010003a870
- (_Bool)PLHasCompletedRestorePostProcessing;	// IMP=0x000000010003a7c4
- (_Bool)removeLowerPriorityAppsTillFreeSpace:(long long)arg1;	// IMP=0x000000010003a2d4
- (void)loadInstallationOrder:(id)arg1;	// IMP=0x0000000100039f04
- (void)checkWithTimeKeeper:(id)arg1;	// IMP=0x0000000100039d08
- (_Bool)continueToUpdateDemoContentWithServer:(id)arg1;	// IMP=0x0000000100039ad8
- (_Bool)updateDemoContentWithServer:(id)arg1;	// IMP=0x00000001000380c8
- (_Bool)enrollWithServer:(id)arg1 name:(id)arg2 pairingCredential:(id)arg3 error:(id *)arg4;	// IMP=0x00000001000379d8
- (_Bool)enrolledWith:(id)arg1;	// IMP=0x00000001000378cc
- (void)getDemoUpdateInProgress:(_Bool *)arg1 operationAllowed:(_Bool *)arg2;	// IMP=0x0000000100037828
- (id)init;	// IMP=0x00000001000376b8
