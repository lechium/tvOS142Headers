...
+ (id)sharedInstance;	// IMP=0x0000000100058e14
- (void).cxx_destruct;	// IMP=0x000000010005a7f8
...
- (_Bool)compareSavedHubHostsWithNewHosts;	// IMP=0x000000010005a394
- (_Bool)compareSavedHubHostNameWithNewHostName;	// IMP=0x000000010005a100
- (_Bool)enrollAndSetup:(id *)arg1;	// IMP=0x0000000100059d64
- (_Bool)askFindMyHubForHubInfoAndDeviceOptions;	// IMP=0x0000000100059284
- (unsigned long long)queryFindMyHubAndDetermineLogicSyncResult;	// IMP=0x0000000100058f84
- (_Bool)discoverAndEnrollWithHub:(id *)arg1;	// IMP=0x0000000100058ec4
