...
- (void).cxx_destruct;	// IMP=0x000000010004b4b4
...
- (void)coordinator:(id)arg1 canceledWithReason:(id)arg2 client:(unsigned long long)arg3;	// IMP=0x000000010004b314
- (void)coordinatorDidCompleteSuccessfully:(id)arg1;	// IMP=0x000000010004b2c8
- (id)init;	// IMP=0x000000010004b25c
