...
+ (id)sharedInstance;	// IMP=0x000000010003213c
- (void).cxx_destruct;	// IMP=0x0000000100035ad8
...
- (_Bool)saveOperationRequestIfNeeded:(id)arg1 server:(id)arg2 port:(id)arg3 completeBy:(int)arg4;	// IMP=0x00000001000358b4
- (void)lostClientConnection:(id)arg1;	// IMP=0x00000001000357bc
- (void)sendRebootTimeoutMessageToPricing:(int)arg1;	// IMP=0x00000001000356e8
- (void)handleMessage:(id)arg1 from:(id)arg2;	// IMP=0x0000000100032c44
- (void)start;	// IMP=0x000000010003270c
- (_Bool)checkEntitlementsWithRequest:(id)arg1 from:(id)arg2;	// IMP=0x0000000100032400
- (id)getEntitlementsFrom:(id)arg1;	// IMP=0x00000001000321a8
