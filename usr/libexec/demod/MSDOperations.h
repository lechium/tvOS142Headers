...
- (void).cxx_destruct;	// IMP=0x000000010002f5a4
...
- (_Bool)restoreAllAttributesFromManifest;	// IMP=0x000000010002f310
- (_Bool)processAlreadyHaveList:(id)arg1;	// IMP=0x000000010002e974
- (_Bool)downloadAndVerifyFile:(id)arg1 to:(id)arg2 withError:(id *)arg3;	// IMP=0x000000010002e474
- (_Bool)downloadCreationList:(id)arg1;	// IMP=0x000000010002da38
- (_Bool)processCreationList:(id)arg1;	// IMP=0x000000010002c478
- (_Bool)verify;	// IMP=0x000000010002bcec
- (_Bool)process:(id *)arg1;	// IMP=0x000000010002b87c
- (id)initWithMasterManifest:(id)arg1 andDeviceManifest:(id)arg2 forSection:(id)arg3;	// IMP=0x000000010002b184
