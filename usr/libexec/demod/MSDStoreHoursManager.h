...
+ (id)sharedInstance;	// IMP=0x0000000100026b1c
- (void).cxx_destruct;	// IMP=0x000000010002890c
...
- (void)storeHourSettingsExpirationHandler:(id)arg1;	// IMP=0x00000001000287b0
- (void)setupStoreHourSettingsExpirationTimer:(id)arg1;	// IMP=0x000000010002845c
- (void)populateStoreHourFromHubSuppliedSettingsForDate:(id)arg1;	// IMP=0x00000001000280a8
- (void)populateStoreHourFromDefaultSettingsForDate:(id)arg1;	// IMP=0x0000000100027d1c
- (id)parseRawStoreHours:(id)arg1;	// IMP=0x0000000100027770
- (void)evaluateStoreStatusAgainstPointInTime:(id)arg1;	// IMP=0x0000000100027220
- (void)evaluateStoreStatusAgainstCurrentTime;	// IMP=0x00000001000271cc
- (void)updateStoreHours:(id)arg1 lastSettingsUpdatedDate:(id)arg2;	// IMP=0x0000000100026dd0
- (id)init;	// IMP=0x0000000100026b88
