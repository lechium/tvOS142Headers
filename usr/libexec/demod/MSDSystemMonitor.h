...
+ (id)sharedInstance;	// IMP=0x000000010000e1a0
...
- (void)processCoreDuetCallBack;	// IMP=0x000000010000e958
- (void)startPowerForegroundAppMonitoring;	// IMP=0x000000010000e628
- (void)monitorDiskSpace;	// IMP=0x000000010000e500
- (void)startSystemIdleDetection;	// IMP=0x000000010000e32c
- (void)stopSystemIdleDetection;	// IMP=0x000000010000e20c
