...
+ (id)sharedInstance;	// IMP=0x000000010000ce30
- (void).cxx_destruct;	// IMP=0x000000010000d93c
...
- (id)sanitizeTestLog:(id)arg1;	// IMP=0x000000010000d7d8
- (void)pushTestLog:(id)arg1;	// IMP=0x000000010000d740
- (void)sendCommandsToDemod:(id)arg1 replyFromDemod:(CDUnknownBlockType)arg2;	// IMP=0x000000010000d49c
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000010000d234
- (void)sendTestEvents:(id)arg1;	// IMP=0x000000010000d0f8
- (void)pushTestEvent:(id)arg1 ofType:(id)arg2;	// IMP=0x000000010000d028
- (id)getTimeStamp;	// IMP=0x000000010000cfcc
- (void)start;	// IMP=0x000000010000ceb4
