...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010000b8d4
- (void).cxx_destruct;	// IMP=0x000000010001b784
...
- (id)newAttachWithError:(id *)arg1;	// IMP=0x000000010001b364
- (_Bool)reOpenIfWritableWithError:(id *)arg1;	// IMP=0x000000010001aa40
- (id)initWithURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000010001a964
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010001a798
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010001a5c4
