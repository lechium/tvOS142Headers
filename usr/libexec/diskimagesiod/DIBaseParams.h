...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100021e0c
- (void).cxx_destruct;	// IMP=0x0000000100022fc8
...
- (id)copyInstanceID;	// IMP=0x0000000100022e14
- (void)invalidate;	// IMP=0x0000000100022e04
- (_Bool)hasCryptoBackend;	// IMP=0x0000000100022d5c
- (_Bool)getPassphraseFromUserWithXpcHandler:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100022c60
- (_Bool)getPassphraseFromConsoleWithUseStdin:(_Bool)arg1 error:(id *)arg2;	// IMP=0x000000010002292c
- (id)description;	// IMP=0x0000000100022864
- (id)copyEncryptionUUID;	// IMP=0x00000001000227f0
- (_Bool)setPassphrase:(const char *)arg1 error:(id *)arg2;	// IMP=0x00000001000223c8
- (id)initWithURL:(id)arg1 fileOpenMode:(unsigned short)arg2 error:(id *)arg3;	// IMP=0x00000001000221e0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100022054
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100021e9c
