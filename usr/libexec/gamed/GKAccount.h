...
- (_Bool)isEnabledForDataClass:(id)arg1;	// IMP=0x000000010013113c
...
- (void)dealloc;	// IMP=0x00000001001310c4
- (id)initWithInternalAccount:(id)arg1;	// IMP=0x000000010013106c
