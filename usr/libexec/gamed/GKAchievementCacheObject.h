...
+ (id)entityName;	// IMP=0x00000001000505d8
- (id)internalRepresentation;	// IMP=0x00000001000505d0
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x00000001000503c4
