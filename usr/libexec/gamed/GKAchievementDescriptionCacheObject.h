...
+ (id)entityName;	// IMP=0x000000010004fd2c
- (id)internalRepresentation;	// IMP=0x000000010004faac
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010004f7dc
