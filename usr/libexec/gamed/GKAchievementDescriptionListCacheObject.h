...
+ (id)entityName;	// IMP=0x000000010004f6b4
- (_Bool)isValid;	// IMP=0x000000010004f774
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010004f6c0
