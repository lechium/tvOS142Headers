...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100135438
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100135230
...
- (id)descriptionSubstitutionMap;	// IMP=0x00000001001358e0
...
- (unsigned long long)hash;	// IMP=0x00000001001357d0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100135700
- (id)serverRepresentation;	// IMP=0x00000001001355a0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001001354dc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100135440
- (void)dealloc;	// IMP=0x0000000100135170
- (void)mergePropertiesFromDescription:(id)arg1;	// IMP=0x00000001001359ec
