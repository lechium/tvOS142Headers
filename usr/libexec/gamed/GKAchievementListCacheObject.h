...
+ (id)entityName;	// IMP=0x000000010004fd38
- (id)internalRepresentation;	// IMP=0x000000010004ff64
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010004fdac
- (_Bool)isValid;	// IMP=0x000000010004fd44
