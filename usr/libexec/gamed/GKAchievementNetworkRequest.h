...
+ (long long)coalescingDelay;	// IMP=0x00000001001d894c
+ (id)bagKey;	// IMP=0x00000001001d8940
- (void).cxx_destruct;	// IMP=0x00000001001d9b90
...
- (id)taskInfo;	// IMP=0x00000001001d9878
- (void)removeFromStore:(id)arg1;	// IMP=0x00000001001d9564
- (id)postBody;	// IMP=0x00000001001d94cc
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00000001001d945c
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3 previousKnownPendingAmount:(long long)arg4;	// IMP=0x00000001001d93e8
- (void)addInRequestData:(id *)arg1 additional:(id)arg2;	// IMP=0x00000001001d901c
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00000001001d8d68
@property(readonly) long long numberOfRequests; // @dynamic numberOfRequests;
- (id)initWithAchievements:(id)arg1 bundleID:(id)arg2;	// IMP=0x00000001001d8a10
- (id)initWithTask:(id)arg1;	// IMP=0x00000001001d8954
