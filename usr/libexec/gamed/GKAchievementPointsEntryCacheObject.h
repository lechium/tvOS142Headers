...
+ (id)entityName;	// IMP=0x000000010005ba70
- (id)internalRepresentation;	// IMP=0x000000010005bbdc
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010005ba7c
