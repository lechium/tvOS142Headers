...
+ (id)metadataForBundleURL:(id)arg1;	// IMP=0x0000000100094ba4
...
- (id)bundleURL;	// IMP=0x0000000100094d9c
...
- (void)dealloc;	// IMP=0x0000000100094c7c
- (id)initWithBundleID:(id)arg1;	// IMP=0x0000000100094b64
- (id)initWithProxy:(id)arg1;	// IMP=0x0000000100094b04
