...
- (void)startObservingStateChangesForBundleID:(id)arg1;	// IMP=0x0000000100083d3c
- (_Bool)observingStateChangesForBundleID:(id)arg1;	// IMP=0x0000000100083d04
@property(copy, nonatomic) CDUnknownBlockType handler;
- (void)dealloc;	// IMP=0x0000000100083c8c
- (id)init;	// IMP=0x0000000100083c20
