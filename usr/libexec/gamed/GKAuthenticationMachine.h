...
+ (void)migratePreSundanceAccountInformation;	// IMP=0x000000010008fb14
+ (void)migratePreBlacktailAccountInformation;	// IMP=0x000000010008f718
+ (id)authMachineForEnvironment:(long long)arg1;	// IMP=0x000000010008f55c
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010008f554
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010008f670
- (void)dealloc;	// IMP=0x000000010008f628
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010008f564
