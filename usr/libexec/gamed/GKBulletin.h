...
+ (void)performAsync:(CDUnknownBlockType)arg1;	// IMP=0x00000001000e9dd8
+ (_Bool)shouldProcessNotification;	// IMP=0x00000001000e9b30
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000e9760
+ (void)loadBulletinsForPushNotification:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000e8df4
+ (void)bulletinsForPushNotification:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000e87a0
+ (id)syncQueue;	// IMP=0x00000001000e872c
...
- (id)description;	// IMP=0x00000001000ea068
- (void)handleAction:(id)arg1;	// IMP=0x00000001000e9f30
- (void)executeBulletinWithBulletinController:(id)arg1;	// IMP=0x00000001000e9c84
- (void)dealloc;	// IMP=0x00000001000e9a88
- (id)initWithPushNotification:(id)arg1;	// IMP=0x00000001000e98cc
- (id)dataFrom64String:(id)arg1;	// IMP=0x00000001000e9768
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000e9344
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000e8f18
