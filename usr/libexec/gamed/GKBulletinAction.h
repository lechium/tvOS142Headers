...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100086a38
...
- (id)description;	// IMP=0x0000000100086cc8
@property(readonly) NSDictionary *actionDictionary;
- (void)dealloc;	// IMP=0x0000000100086aac
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100086a40
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100086798
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010008650c
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000100086484
- (id)init;	// IMP=0x0000000100086444
