...
- (void)handleAction:(id)arg1;	// IMP=0x00000001000ffe60
- (void)dealloc;	// IMP=0x00000001000ffe10
- (id)initWithPlayer:(id)arg1 localizedGameName:(id)arg2 inviteDictionary:(id)arg3;	// IMP=0x00000001000ff880
