...
+ (id)entityName;	// IMP=0x0000000100060c4c
- (id)internalRepresentation;	// IMP=0x0000000100060c58
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100060c48
