...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010009a828
...
- (void)loadGoalTextForGameDescriptor:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000010009b05c
- (void)loadDetailsWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010009a8e0
- (id)initWithChallenge:(id)arg1;	// IMP=0x000000010009a888
- (id)challengeInternalObject;	// IMP=0x000000010009a880
- (id)description;	// IMP=0x000000010009a830
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010009a73c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010009a590
- (void)dealloc;	// IMP=0x000000010009a508
