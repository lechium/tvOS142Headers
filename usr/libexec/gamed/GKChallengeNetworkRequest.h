...
+ (id)bagKey;	// IMP=0x00000001001d9bf0
- (void).cxx_destruct;	// IMP=0x00000001001dac3c
...
- (id)taskInfo;	// IMP=0x00000001001da944
- (void)removeFromStore:(id)arg1;	// IMP=0x00000001001da630
- (id)postBody;	// IMP=0x00000001001da598
- (id)initWithTask:(id)arg1;	// IMP=0x00000001001da3a4
- (id)initWithChallenges:(id)arg1 bundleID:(id)arg2;	// IMP=0x00000001001da26c
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00000001001d9bfc
