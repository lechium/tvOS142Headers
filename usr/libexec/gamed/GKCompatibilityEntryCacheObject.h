...
+ (id)entityName;	// IMP=0x0000000100055f98
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x00000001000563d4
- (id)internalRepresentation;	// IMP=0x0000000100055fa4
