...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100141790
...
- (unsigned long long)hash;	// IMP=0x0000000100141ac4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100141958
- (void)dealloc;	// IMP=0x0000000100141710
