...
+ (id)customTournamentRequestWithTournamentDefinition:(id)arg1 player:(id)arg2;	// IMP=0x00000001000fd74c
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001000fd550
- (void).cxx_destruct;	// IMP=0x00000001000fdb08
