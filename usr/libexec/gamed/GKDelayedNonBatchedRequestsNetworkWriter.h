...
+ (id)writerWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x000000010017a97c
...
- (void)writeResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000010017aa9c
- (void)dealloc;	// IMP=0x000000010017aa3c
- (id)initWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x000000010017a9bc
