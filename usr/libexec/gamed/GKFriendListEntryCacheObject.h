...
+ (id)entityName;	// IMP=0x0000000100055b24
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100055b30
- (id)internalRepresentation;	// IMP=0x00000001000559ac
