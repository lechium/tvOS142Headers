...
+ (id)entityName;	// IMP=0x00000001000582b0
- (id)internalRepresentation;	// IMP=0x00000001000580c8
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100057e6c
