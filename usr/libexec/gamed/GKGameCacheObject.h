...
+ (id)entityName;	// IMP=0x000000010004f6a8
+ (id)_gamesForFullGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x000000010004dc14
+ (id)gamesForGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x000000010004dad4
+ (id)gamesForBundleIDs:(id)arg1 context:(id)arg2;	// IMP=0x000000010004d994
+ (id)gameForBundleID:(id)arg1 context:(id)arg2;	// IMP=0x000000010004d7e4
+ (id)gameForGameDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x000000010004d748
+ (id)fetchSortDescriptors;	// IMP=0x000000010004d69c
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x000000010004d690
+ (id)uniqueAttributeName;	// IMP=0x000000010004d684
- (id)gameDescriptor;	// IMP=0x000000010004f3f0
- (id)leaderboardSetWithIdentifier:(id)arg1;	// IMP=0x000000010004f374
- (id)internalRepresentation;	// IMP=0x000000010004f24c
- (_Bool)storePiecesExpired;	// IMP=0x000000010004f21c
- (_Bool)storePiecesValid;	// IMP=0x000000010004f1d8
- (void)updateStorePiecesWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010004ec34
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010004e5cc
- (void)updateWithGameDescriptor:(id)arg1;	// IMP=0x000000010004dfd4
- (_Bool)isValid;	// IMP=0x000000010004df58
- (void)invalidate;	// IMP=0x000000010004d630
