...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010012b694
+ (id)propertiesToFetch;	// IMP=0x000000010014284c
...
- (id)description;	// IMP=0x000000010012b984
- (id)serverRepresentation;	// IMP=0x000000010012b978
- (void)dealloc;	// IMP=0x000000010012b604
- (unsigned long long)hash;	// IMP=0x000000010012b5e0
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010012b55c
- (id)defaultCategory;	// IMP=0x000000010012bfec
- (unsigned short)numberOfCategories;	// IMP=0x000000010012bfe0
- (void)updateWithProperties:(id)arg1;	// IMP=0x00000001001428a0
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x0000000100142244
