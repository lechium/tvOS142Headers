...
+ (id)entityName;	// IMP=0x000000010005254c
+ (id)ratingForGameDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x00000001000521c4
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x00000001000523ac
