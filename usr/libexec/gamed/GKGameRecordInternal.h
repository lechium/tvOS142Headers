...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010012c93c
+ (id)gameRecordForGame:(id)arg1;	// IMP=0x000000010012c7a8
+ (id)_gameProperties;	// IMP=0x0000000100143264
+ (id)propertiesToFetch;	// IMP=0x0000000100142f84
...
- (void)updateWithGame:(id)arg1;	// IMP=0x000000010012c7f0
- (void)dealloc;	// IMP=0x000000010012c738
- (void)updateWithProperties:(id)arg1;	// IMP=0x0000000100143348
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x0000000100142d30
