...
- (void).cxx_destruct;	// IMP=0x000000010003ab00
...
- (void)cancelBackgroundTimer;	// IMP=0x000000010003a960
- (void)clientEnteredForegroundState:(id)arg1;	// IMP=0x000000010003a8a0
- (void)clientEnteredBackgroundState:(id)arg1;	// IMP=0x000000010003a524
- (void)handleIDSSessionStatusChangeWhileDisconnecting;	// IMP=0x000000010003a2c0
- (void)handleIDSSessionStatusChange;	// IMP=0x000000010003a0f8
- (void)sessionEnded:(id)arg1 withReason:(unsigned int)arg2 error:(id)arg3;	// IMP=0x0000000100039c88
- (void)handleDisconnectForClient:(id)arg1 reason:(long long)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x000000010003986c
- (void)cancelConnectTimeoutTimer;	// IMP=0x0000000100039828
- (void)cancelHeartbeatTimer;	// IMP=0x00000001000397e4
- (void)receivedHeartbeatFromID:(id)arg1;	// IMP=0x0000000100039768
- (void)sendHeartbeatToConnections;	// IMP=0x00000001000391a4
- (_Bool)shouldSaveConnectionStateForLostConnectionWithCKID:(id)arg1;	// IMP=0x0000000100038fc4
- (void)startHeartbeatToMonitorConnections;	// IMP=0x0000000100038e78
- (void)processInternalMessage:(id)arg1;	// IMP=0x0000000100038b58
- (void)connectionWrapper:(id)arg1 didReceiveData:(id)arg2;	// IMP=0x0000000100038980
- (void)_sendData:(id)arg1 usingConnections:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x00000001000386b8
- (void)sendData:(id)arg1 reliably:(_Bool)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100038408
- (id)clientPacketWithData:(id)arg1 isReliable:(_Bool)arg2 error:(id *)arg3;	// IMP=0x0000000100038290
- (id)internalPacketWithMessage:(long long)arg1 error:(id *)arg2;	// IMP=0x000000010003813c
- (void)connectionWrapper:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x0000000100037ed0
- (void)setupDatagramForIDSSession:(id)arg1 fromID:(id)arg2;	// IMP=0x0000000100037c38
- (void)setupStreamForIDSSession:(id)arg1 fromID:(id)arg2;	// IMP=0x00000001000379a0
- (void)acceptUnreliableInviteForIDSSession:(id)arg1 fromID:(id)arg2 withData:(id)arg3;	// IMP=0x00000001000378a0
- (void)sendUnreliableIDSSessionInviteToIdentifier:(id)arg1;	// IMP=0x0000000100037604
- (void)acceptReliableInviteForIDSSession:(id)arg1 fromID:(id)arg2 context:(id)arg3;	// IMP=0x0000000100037504
- (void)sessionStarted:(id)arg1;	// IMP=0x0000000100037348
- (_Bool)shouldAllowAddingAnotherConnection;	// IMP=0x00000001000372d4
- (void)invitationAcceptedForIDSSession:(id)arg1 fromID:(id)arg2 withData:(id)arg3;	// IMP=0x00000001000370b0
- (void)session:(id)arg1 receivedInvitationCancelFromID:(id)arg2 withData:(id)arg3;	// IMP=0x0000000100036ec8
- (void)session:(id)arg1 receivedInvitationDeclineFromID:(id)arg2 withData:(id)arg3;	// IMP=0x0000000100036ce0
- (void)session:(id)arg1 receivedInvitationAcceptFromID:(id)arg2 withData:(id)arg3;	// IMP=0x0000000100036ac4
- (void)connectToPlayersWithIdentifiers:(id)arg1;	// IMP=0x0000000100036224
- (void)connectToGameSessionUsingDelegateQueue:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000010003586c
- (_Bool)isBusyChangingConnectionState;	// IMP=0x00000001000357fc
- (void)updateCloudGameSession:(id)arg1;	// IMP=0x00000001000357f0
- (void)dealloc;	// IMP=0x00000001000352c8
- (id)initWithClient:(id)arg1 gameSession:(id)arg2 account:(id)arg3;	// IMP=0x00000001000350e4
