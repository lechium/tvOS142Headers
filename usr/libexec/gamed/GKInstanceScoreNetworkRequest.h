...
+ (id)bagKey;	// IMP=0x00000001001daca8
- (void).cxx_destruct;	// IMP=0x00000001001db480
...
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00000001001db2c0
- (void)removeFromStore:(id)arg1;	// IMP=0x00000001001db2bc
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00000001001db260
- (id)taskInfo;	// IMP=0x00000001001db0f0
- (id)postBody;	// IMP=0x00000001001db0e4
- (id)initWithInstanceScore:(id)arg1 bundleID:(id)arg2 challenges:(id)arg3;	// IMP=0x00000001001dae58
- (id)initWithTask:(id)arg1;	// IMP=0x00000001001dacb4
