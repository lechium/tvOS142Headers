...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100141130
+ (id)nearbyInviteIDForPlayerID:(id)arg1 deviceID:(id)arg2 bundleID:(id)arg3;	// IMP=0x0000000100140f80
+ (id)inviteFromNearbyPlayer:(id)arg1 participantID:(id)arg2 deviceID:(id)arg3 bundleID:(id)arg4 connectionData:(id)arg5;	// IMP=0x0000000100140e48
+ (id)inviteWithBulletin:(id)arg1;	// IMP=0x00000001001409ac
...
- (id)descriptionSubstitutionMap;	// IMP=0x00000001001414d8
@property(readonly, nonatomic) _Bool isNearby; // @dynamic isNearby;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010014143c
- (unsigned long long)hash;	// IMP=0x0000000100141418
- (void)dealloc;	// IMP=0x0000000100141020
- (id)init;	// IMP=0x0000000100140fbc
