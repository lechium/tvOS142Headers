...
+ (id)sharedManager;	// IMP=0x000000010010aaa0
- (void).cxx_destruct;	// IMP=0x000000010010afb8
...
- (_Bool)isRecordEqualToMostRecentInviteShare:(id)arg1;	// IMP=0x000000010010ad10
- (id)init;	// IMP=0x000000010010ac58
