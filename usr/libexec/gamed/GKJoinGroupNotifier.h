...
- (void).cxx_destruct;	// IMP=0x000000010009dc60
...
- (void)setResult:(CDUnknownBlockType)arg1 error:(id)arg2;	// IMP=0x000000010009da9c
@property(retain) NSError *error; // @synthesize error=_error;
- (oneway void)release;	// IMP=0x000000010009d960
- (id)retain;	// IMP=0x000000010009d8c4
- (void)dealloc;	// IMP=0x000000010009d860
- (id)init;	// IMP=0x000000010009d7f8
