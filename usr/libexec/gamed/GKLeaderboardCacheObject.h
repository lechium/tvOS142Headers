...
+ (id)entityName;	// IMP=0x00000001000596e0
- (id)internalRepresentation;	// IMP=0x0000000100059374
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100058da0
