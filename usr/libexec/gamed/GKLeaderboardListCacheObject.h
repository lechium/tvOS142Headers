...
+ (id)entityName;	// IMP=0x000000010005314c
- (_Bool)isValid;	// IMP=0x000000010005320c
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0000000100053158
