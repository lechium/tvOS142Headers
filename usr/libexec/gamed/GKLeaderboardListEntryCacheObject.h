...
+ (id)entityName;	// IMP=0x0000000100052e6c
- (id)internalRepresentation;	// IMP=0x0000000100053020
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100052e78
