...
+ (id)entityName;	// IMP=0x0000000100052cdc
- (id)internalRepresentation;	// IMP=0x0000000100052ad0
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010005268c
