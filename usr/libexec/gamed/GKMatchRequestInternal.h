...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001001403a4
...
- (_Bool)hasGuestPlayers;	// IMP=0x00000001001406c4
- (unsigned long long)hash;	// IMP=0x0000000100140330
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013ff10
- (void)dealloc;	// IMP=0x000000010013fe60
- (id)init;	// IMP=0x000000010013fde0
