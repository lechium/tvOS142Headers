...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100093c34
...
- (_Bool)transitionToState:(long long)arg1;	// IMP=0x0000000100093e74
- (_Bool)isNetworkError;	// IMP=0x0000000100093e34
- (_Bool)isTimeout;	// IMP=0x0000000100093df4
- (_Bool)isCancelled;	// IMP=0x0000000100093db4
- (_Bool)isFinished;	// IMP=0x0000000100093d74
- (int)_incrementSequence;	// IMP=0x0000000100093d64
- (void)dealloc;	// IMP=0x0000000100093b84
