...
- (void).cxx_destruct;	// IMP=0x00000001000ca974
...
- (void)cancelConnection;	// IMP=0x00000001000ca8f4
- (void)readData;	// IMP=0x00000001000ca8f0
- (void)_sendData:(id)arg1;	// IMP=0x00000001000ca8ec
- (_Bool)sendData:(id)arg1;	// IMP=0x00000001000ca880
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000001000ca654
- (void)dealloc;	// IMP=0x00000001000ca5b8
- (id)initWithConnection:(id)arg1 delegate:(id)arg2 delegateQueue:(id)arg3;	// IMP=0x00000001000ca4c0
