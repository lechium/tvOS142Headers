...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010012d6d4
...
- (id)description;	// IMP=0x000000010012d5d0
@property(readonly) NSString *scopeAsString;
- (void)dealloc;	// IMP=0x000000010012d444
- (unsigned long long)hash;	// IMP=0x000000010012d420
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010012d2c8
