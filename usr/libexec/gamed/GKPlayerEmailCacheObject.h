...
+ (id)entityName;	// IMP=0x000000010004d624
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010004d3fc
- (id)internalRepresentation;	// IMP=0x000000010004d23c
