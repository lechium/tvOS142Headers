...
+ (Class)classForFamiliarity:(int)arg1;	// IMP=0x0000000100131e44
+ (id)displayNameWithOptions:(unsigned char)arg1 alias:(id)arg2 composite:(id)arg3;	// IMP=0x0000000100131dc4
+ (id)compositeNameForFirstName:(id)arg1 lastName:(id)arg2;	// IMP=0x0000000100131c84
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100131408
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100131400
+ (id)propertiesToFetch;	// IMP=0x0000000100144458
+ (int)familiarity;	// IMP=0x0000000100144450
+ (unsigned char)piecesToLoad;	// IMP=0x0000000100144414
...
- (id)debugDescription;	// IMP=0x00000001001320b4
...
- (void)setAllowNearbyMultiplayer:(_Bool)arg1;	// IMP=0x0000000100132084
- (_Bool)allowNearbyMultiplayer;	// IMP=0x000000010013207c
...
- (int)defaultFamiliarity;	// IMP=0x0000000100131ea4
- (id)displayNameWithOptions:(unsigned char)arg1;	// IMP=0x0000000100131d20
- (id)minimalInternal;	// IMP=0x00000001001319ec
- (unsigned long long)hash;	// IMP=0x00000001001319c8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013192c
- (id)serverRepresentation;	// IMP=0x000000010013183c
- (id)conciseDescription;	// IMP=0x00000001001317b4
- (id)cacheKey;	// IMP=0x00000001001317a8
- (void)dealloc;	// IMP=0x00000001001312b0
- (void)updateWithProperties:(id)arg1;	// IMP=0x00000001001444ac
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x000000010014401c
