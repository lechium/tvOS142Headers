...
+ (id)readerWithLocalPlayer:(id)arg1 language:(id)arg2 readerConnection:(id)arg3 writerConnection:(id)arg4 transport:(id)arg5;	// IMP=0x000000010013d228
...
- (void)readResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000010013d5c4
- (id)poolName;	// IMP=0x000000010013d570
- (int)familiarityForPlayer:(id)arg1;	// IMP=0x000000010013d3c8
- (void)dealloc;	// IMP=0x000000010013d360
- (id)initWithLocalPlayer:(id)arg1 language:(id)arg2 readerConnection:(id)arg3 writerConnection:(id)arg4 transport:(id)arg5;	// IMP=0x000000010013d290
