...
+ (id)displayNameForEnvironment:(long long)arg1;	// IMP=0x0000000100081dd0
+ (id)hostNameForEnvironment:(long long)arg1;	// IMP=0x0000000100081da4
+ (id)shared;	// IMP=0x0000000100080cd4
...
- (void)removeOverrideForKey:(id)arg1;	// IMP=0x0000000100081194
- (void)setStringValue:(id)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x000000010008117c
- (id)stringValueForKey:(struct __CFString *)arg1 defaultValue:(id)arg2;	// IMP=0x000000010008114c
- (void)setTimeInterval:(double)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x00000001000810f0
- (double)timeIntervalForKey:(struct __CFString *)arg1 defaultValue:(double)arg2;	// IMP=0x00000001000810ac
- (void)setUnsignedIntegerValue:(long long)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x0000000100081050
- (long long)unsignedIntegerValueForKey:(struct __CFString *)arg1 defaultValue:(long long)arg2;	// IMP=0x000000010008100c
- (void)setIntegerValue:(long long)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x0000000100080fb0
- (long long)integerValueForKey:(struct __CFString *)arg1 defaultValue:(long long)arg2;	// IMP=0x0000000100080f6c
- (void)setBooleanValue:(_Bool)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x0000000100080f0c
- (_Bool)booleanValueForKey:(struct __CFString *)arg1;	// IMP=0x0000000100080efc
- (_Bool)booleanValueForKey:(struct __CFString *)arg1 defaultValue:(_Bool)arg2;	// IMP=0x0000000100080eb8
- (id)preferencesValueForKey:(id)arg1;	// IMP=0x0000000100080e68
- (void)_didWriteKey:(struct __CFString *)arg1;	// IMP=0x0000000100080e40
- (void)synchronize;	// IMP=0x0000000100080e04
- (void)invalidate;	// IMP=0x0000000100080df4
- (_Bool)isInternalBuild;	// IMP=0x0000000100080d78
- (void)dealloc;	// IMP=0x0000000100080c8c
- (id)init;	// IMP=0x0000000100080c80
- (id)initWithoutUIKitNotifications;	// IMP=0x0000000100080c00
- (id)initWithUIKitNotifications;	// IMP=0x0000000100080bf4
- (void)profileConnectionDidReceiveEffectiveSettingsChangedNotification:(id)arg1 userInfo:(id)arg2;	// IMP=0x00000001000ea708
- (id)valueRestrictionForKey:(id)arg1;	// IMP=0x00000001000ea6cc
- (_Bool)restrictionEnabledForKey:(id)arg1;	// IMP=0x00000001000ea684
