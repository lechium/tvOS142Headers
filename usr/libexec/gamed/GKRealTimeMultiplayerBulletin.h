...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010003ac18
...
- (id)description;	// IMP=0x000000010003c340
- (id)customInviteSoundPathForBundleID:(id)arg1;	// IMP=0x000000010003c1d0
- (void)declineInviteWithReason:(int)arg1;	// IMP=0x000000010003c008
- (void)updateDeclineInviteTrackingForReason:(long long)arg1;	// IMP=0x000000010003be80
- (id)clientNotification;	// IMP=0x000000010003bb04
- (id)clientNotificationWithiCloudID:(id)arg1;	// IMP=0x000000010003ba98
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010003b75c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010003b388
- (id)initWithPushNotification:(id)arg1;	// IMP=0x000000010003b028
- (void)parseClientData:(id)arg1;	// IMP=0x000000010003aeac
- (long long)inviteVersionFromMessage:(id)arg1;	// IMP=0x000000010003ad34
- (void)dealloc;	// IMP=0x000000010003ac54
- (id)init;	// IMP=0x000000010003ac20
