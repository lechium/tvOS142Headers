...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010012cfb4
...
- (unsigned long long)hash;	// IMP=0x000000010012d1f8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010012d0b8
- (void)dealloc;	// IMP=0x000000010012cf44
