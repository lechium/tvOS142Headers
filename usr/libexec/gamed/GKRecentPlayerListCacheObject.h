...
+ (Class)entryClass;	// IMP=0x00000001000596f8
+ (id)entityName;	// IMP=0x00000001000596ec
- (id)internalRepresentation;	// IMP=0x00000001000598bc
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0000000100059704
