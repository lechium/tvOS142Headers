...
+ (id)entityName;	// IMP=0x0000000100059ba8
- (id)internalRepresentation;	// IMP=0x0000000100059d70
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100059bb4
