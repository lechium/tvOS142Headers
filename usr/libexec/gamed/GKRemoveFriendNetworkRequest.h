...
+ (id)bagKey;	// IMP=0x00000001001db4e0
- (void).cxx_destruct;	// IMP=0x00000001001dc880
...
- (void)removeFromStore:(id)arg1;	// IMP=0x00000001001dc640
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00000001001db938
- (id)taskInfo;	// IMP=0x00000001001db804
- (id)initWithFriendPlayerID:(id)arg1;	// IMP=0x00000001001db700
- (id)initWithTask:(id)arg1;	// IMP=0x00000001001db598
- (id)postBody;	// IMP=0x00000001001db4ec
