...
+ (id)deduperForPool:(id)arg1;	// IMP=0x0000000100146684
+ (id)deduper;	// IMP=0x0000000100146668
...
- (void)notifyOnQueue:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x0000000100147670
- (void)openRequestForResources:(id)arg1 processCallback:(CDUnknownBlockType)arg2;	// IMP=0x0000000100146a38
- (void)getTransactionPool:(CDUnknownBlockType)arg1;	// IMP=0x00000001001467fc
- (void)dealloc;	// IMP=0x00000001001467a4
- (id)initWithPool:(id)arg1;	// IMP=0x00000001001466cc
- (id)init;	// IMP=0x00000001001466bc
