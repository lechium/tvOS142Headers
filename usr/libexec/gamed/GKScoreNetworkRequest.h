...
+ (id)bagKey;	// IMP=0x00000001001d7de0
- (void).cxx_destruct;	// IMP=0x00000001001d88d4
...
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00000001001d850c
- (id)taskInfo;	// IMP=0x00000001001d830c
- (void)removeFromStore:(id)arg1;	// IMP=0x00000001001d8308
- (id)postBody;	// IMP=0x00000001001d81fc
- (id)initWithScores:(id)arg1 bundleID:(id)arg2 eligibleChallenges:(id)arg3;	// IMP=0x00000001001d7f04
- (id)initWithTask:(id)arg1;	// IMP=0x00000001001d7e48
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00000001001d7dec
