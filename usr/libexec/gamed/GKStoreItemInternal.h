...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010012c0a8
...
- (void)storeItemURLForGamePlatform:(long long)arg1 withContext:(id)arg2 withHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010012c380
- (id)storeItemURLForURL:(id)arg1 gamePlatform:(long long)arg2 extraQueryParams:(id)arg3;	// IMP=0x000000010012c320
- (_Bool)isValid;	// IMP=0x000000010012c2fc
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010012c278
- (unsigned long long)hash;	// IMP=0x000000010012c260
- (void)dealloc;	// IMP=0x000000010012bff8
- (void)updateWithProperties:(id)arg1;	// IMP=0x0000000100143d6c
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010014398c
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x0000000100143674
