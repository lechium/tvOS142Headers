...
+ (id)defaultCustomTournamentForTournamentDefinition:(id)arg1;	// IMP=0x00000001000fe9e0
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001000fe674
- (void).cxx_destruct;	// IMP=0x00000001000feedc
