...
+ (id)entityName;	// IMP=0x000000010005dc20
- (id)internalRepresentation;	// IMP=0x000000010005e27c
- (void)updateWithServerRepresentation:(id)arg1 participants:(id)arg2;	// IMP=0x000000010005dc2c
