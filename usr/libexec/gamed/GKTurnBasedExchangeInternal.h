...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010013f71c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013f9e4
- (unsigned long long)hash;	// IMP=0x000000010013f9cc
- (void)dealloc;	// IMP=0x000000010013f64c
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x0000000100145fc4
