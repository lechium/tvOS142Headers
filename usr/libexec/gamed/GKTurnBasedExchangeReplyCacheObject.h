...
+ (id)entityName;	// IMP=0x000000010005e284
- (id)internalRepresentation;	// IMP=0x000000010005e4cc
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010005e290
