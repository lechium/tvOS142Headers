...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010013e004
...
- (id)descriptionSubstitutionMap;	// IMP=0x000000010013ed38
@property(nonatomic) unsigned int state; // @synthesize state=_state;
- (long long)activeExchangeCount;	// IMP=0x000000010013e710
- (long long)previousParticipantIndex;	// IMP=0x000000010013e588
- (long long)localPlayerParticipantIndex;	// IMP=0x000000010013e534
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013e420
- (unsigned long long)hash;	// IMP=0x000000010013e3fc
- (void)dealloc;	// IMP=0x000000010013dea4
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x0000000100145540
