...
+ (id)entityName;	// IMP=0x000000010005d920
- (id)internalRepresentation;	// IMP=0x000000010005dc18
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010005d92c
