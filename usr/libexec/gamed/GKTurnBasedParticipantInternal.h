...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010013f08c
...
- (id)descriptionSubstitutionMap;	// IMP=0x000000010013f4a8
- (id)serverRepresentation;	// IMP=0x000000010013f318
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013f248
- (unsigned long long)hash;	// IMP=0x000000010013f22c
- (void)dealloc;	// IMP=0x000000010013efdc
@property(readonly, nonatomic) NSString *playerID;
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x0000000100145dc4
