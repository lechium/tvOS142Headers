...
- (void).cxx_destruct;	// IMP=0x0000000100137d24
...
- (void)addUpdatesFromGroup:(id)arg1;	// IMP=0x0000000100137bd4
- (void)addUpdate:(CDUnknownBlockType)arg1 error:(id)arg2;	// IMP=0x0000000100137a48
- (void)updateError:(id)arg1;	// IMP=0x00000001001379c4
- (oneway void)release;	// IMP=0x0000000100137914
- (id)retain;	// IMP=0x0000000100137878
- (void)dealloc;	// IMP=0x0000000100137814
- (id)init;	// IMP=0x00000001001377ac
