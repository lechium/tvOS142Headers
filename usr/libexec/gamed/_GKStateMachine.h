...
- (void).cxx_destruct;	// IMP=0x000000010010852c
...
- (void)_performTransitionFromState:(id)arg1 toState:(id)arg2;	// IMP=0x000000010010828c
- (id)_validateTransitionFromState:(id)arg1 toState:(id)arg2;	// IMP=0x0000000100107db4
- (id)missingTransitionFromState:(id)arg1 toState:(id)arg2;	// IMP=0x0000000100107d70
- (_Bool)_setCurrentState:(id)arg1;	// IMP=0x0000000100107b44
@property(retain) NSString *currentState; // @synthesize currentState=_currentState;
- (_Bool)applyState:(id)arg1;	// IMP=0x0000000100107b2c
- (void)dealloc;	// IMP=0x0000000100107a9c
- (id)init;	// IMP=0x0000000100107a60
