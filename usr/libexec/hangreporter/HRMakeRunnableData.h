...
- (void).cxx_destruct;	// IMP=0x000000010001271c
...
- (long long)findBlockingThreadForTailspin:(id)arg1 sampleStore:(id)arg2 mainThread:(id)arg3 hangStartTime:(unsigned long long)arg4 hangEndTime:(unsigned long long)arg5 hangDuration:(int)arg6;	// IMP=0x0000000100011008
- (id)init;	// IMP=0x0000000100010f28
