...
+ (id)bundleForURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000010002b1dc
+ (_Bool)bundleIsBlacklisted:(id)arg1;	// IMP=0x000000010002a810
+ (id)bundlesInParentBundle:(id)arg1 subDirectory:(id)arg2 matchingPredicate:(CDUnknownBlockType)arg3 error:(id *)arg4;	// IMP=0x0000000100028d88
+ (id)_URLOfFirstBundleInDirectory:(id)arg1 withExtension:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100027498
- (void).cxx_destruct;	// IMP=0x000000010002cbe8
...
- (_Bool)sdkBuildVersionIsAtLeast:(id)arg1;	// IMP=0x000000010002cad4
@property(readonly, copy, nonatomic) NSString *sdkBuildVersion;
- (_Bool)validateAppMetadataWithError:(id *)arg1;	// IMP=0x000000010002c7c4
@property(readonly, nonatomic) NSSet *siriIntents;
- (id)description;	// IMP=0x000000010002c450
- (_Bool)thinningMatchesCurrentDeviceWithError:(id *)arg1;	// IMP=0x000000010002c02c
@property(readonly, copy, nonatomic) NSArray *supportedDevices;
- (_Bool)isApplicableToCurrentDeviceCapabilitiesWithError:(id *)arg1;	// IMP=0x000000010002bcc8
- (_Bool)isApplicableToOSVersionEarlierThan:(id)arg1;	// IMP=0x000000010002bc3c
- (_Bool)isApplicableToOSVersion:(id)arg1 error:(id *)arg2;	// IMP=0x000000010002bad8
- (_Bool)isApplicableToCurrentOSVersionWithError:(id *)arg1;	// IMP=0x000000010002b9f4
- (_Bool)isApplicableToCurrentDeviceFamilyWithError:(id *)arg1;	// IMP=0x000000010002b6e4
- (_Bool)isCompatibleWithDeviceFamily:(int)arg1;	// IMP=0x000000010002b584
...
- (id)xpcServiceBundlesWithError:(id *)arg1;	// IMP=0x000000010002ab5c
- (id)frameworkBundlesWithError:(id *)arg1;	// IMP=0x000000010002a964
- (_Bool)validatePluginMetadataWithError:(id *)arg1;	// IMP=0x0000000100029a30
- (id)pluginKitBundlesWithError:(id *)arg1;	// IMP=0x0000000100029a1c
- (id)pluginKitBundlesSkippingPlatformValidation:(_Bool)arg1 withError:(id *)arg2;	// IMP=0x00000001000292b8
- (_Bool)setIsPlaceholderWithError:(id *)arg1;	// IMP=0x0000000100028cd4
...
- (id)_infoPlistKeysToLoad;	// IMP=0x0000000100027834
- (id)initWithBundleInDirectory:(id)arg1 withExtension:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100027768
- (id)initWithBundleURL:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000273e4
- (id)initWithParentBundle:(id)arg1 parentSubdirectory:(id)arg2 bundleName:(id)arg3 error:(id *)arg4;	// IMP=0x0000000100027290
- (id)initWithBundleParentURL:(id)arg1 parentSubdirectory:(id)arg2 bundleName:(id)arg3 error:(id *)arg4;	// IMP=0x0000000100027180
- (_Bool)_validateWithError:(id *)arg1;	// IMP=0x0000000100026e5c
- (id)_extraInfoPlistLogging;	// IMP=0x00000001000266b4
