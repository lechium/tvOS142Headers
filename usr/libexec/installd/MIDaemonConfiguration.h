...
+ (id)sharedInstance;	// IMP=0x00000001000248b8
...
- (id)diskImageMountPoints;	// IMP=0x0000000100024da8
- (id)diskImageAppBundleIDToInfoMap;	// IMP=0x0000000100024c28
...
- (id)init;	// IMP=0x000000010002443c
