...
- (void).cxx_destruct;	// IMP=0x000000010001a5dc
...
- (id)gatherUsageInfoWithError:(id *)arg1;	// IMP=0x000000010001a360
- (id)_gatherForIdentifier:(id)arg1;	// IMP=0x0000000100019db0
- (id)initWithIdentifiers:(id)arg1 options:(id)arg2;	// IMP=0x0000000100019c74
