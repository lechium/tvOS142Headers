...
- (void).cxx_destruct;	// IMP=0x000000010003a138
...
- (_Bool)applyPatchWithError:(id *)arg1;	// IMP=0x0000000100039d04
- (_Bool)_applyParallelPatchWithError:(id *)arg1;	// IMP=0x0000000100039888
- (_Bool)_applyDeltaPatchWithError:(id *)arg1;	// IMP=0x000000010003927c
@property(readonly, nonatomic) NSString *patchTypeName; // @dynamic patchTypeName;
- (id)initWithBundle:(id)arg1 inStagingRoot:(id)arg2 packageFormat:(unsigned char)arg3 userOptions:(id)arg4 manifestURL:(id)arg5 existingBundleContainer:(id)arg6 patchType:(unsigned char)arg7 error:(id *)arg8;	// IMP=0x0000000100038dc4
