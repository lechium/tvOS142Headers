...
- (void).cxx_destruct;	// IMP=0x000000010001ef48
...
- (id)launchServicesDictionaryWithError:(id *)arg1;	// IMP=0x000000010001bbc0
- (id)_staticDiskUsage;	// IMP=0x000000010001b894
- (id)_groupContainersDictionary;	// IMP=0x000000010001b64c
- (id)_sandboxEnvironment;	// IMP=0x000000010001b464
- (id)_determineApplicationType;	// IMP=0x000000010001b38c
- (id)initWithWatchKitAppBundle:(id)arg1 inBundle:(id)arg2;	// IMP=0x000000010001b2ac
- (id)initWithPluginBundle:(id)arg1 inBundleIdentifier:(id)arg2 dataContainer:(id)arg3;	// IMP=0x000000010001b1dc
- (id)initWithBundleContainer:(id)arg1 dataContainer:(id)arg2;	// IMP=0x000000010001b100
- (id)initWithBundleContainer:(id)arg1;	// IMP=0x000000010001b050
- (id)initWithBundle:(id)arg1 dataContainer:(id)arg2;	// IMP=0x000000010001af9c
- (void)_fixUpForBuiltInAppParallelPlaceholder;	// IMP=0x000000010001a5e8
