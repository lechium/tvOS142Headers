...
+ (id)installerForURL:(id)arg1 withOptions:(id)arg2 forClient:(id)arg3;	// IMP=0x000000010000fc28
- (void).cxx_destruct;	// IMP=0x0000000100015474
...
- (_Bool)performInstallationWithError:(id *)arg1;	// IMP=0x00000001000137d4
- (_Bool)_installProvisioningProfilesAtStagingRootWithError:(id *)arg1;	// IMP=0x0000000100013380
- (_Bool)_installProvisioningProfilesFromUserOptionsWithError:(id *)arg1;	// IMP=0x000000010001300c
- (_Bool)_discoverInstallablesWithError:(id *)arg1;	// IMP=0x0000000100011ff0
- (void)_writeLockBundles:(id)arg1;	// IMP=0x0000000100011dd0
- (void)_acquireTerminationAssertionsForBundles:(id)arg1;	// IMP=0x0000000100011bcc
- (id)_bundlesAtURL:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100011818
- (id)_manifestPathForBase:(id)arg1 withIdentifier:(id)arg2 patchType:(unsigned char *)arg3 error:(id *)arg4;	// IMP=0x000000010001139c
- (_Bool)_extractPackageContainedSymlink:(_Bool *)arg1 withError:(id *)arg2;	// IMP=0x0000000100010bdc
- (_Bool)_setupPackageStateWithError:(id *)arg1;	// IMP=0x0000000100010004
- (_Bool)_takeOwnershipOfInstallableContainingSymlink:(_Bool *)arg1 error:(id *)arg2;	// IMP=0x000000010000fd9c
- (void)_fireCallbackWithStatus:(id)arg1;	// IMP=0x000000010000fd30
- (void)_fireCallbackWithStatus:(id)arg1 percentComplete:(unsigned int)arg2;	// IMP=0x000000010000fcbc
- (void)dealloc;	// IMP=0x000000010000fa4c
- (id)initWithURL:(id)arg1 options:(id)arg2 forClient:(id)arg3;	// IMP=0x000000010000f97c
- (id)init;	// IMP=0x000000010000f970
