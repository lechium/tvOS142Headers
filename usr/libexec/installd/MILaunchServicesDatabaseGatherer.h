...
+ (id)fetchInfoForBundle:(id)arg1 inContainer:(id)arg2 withError:(id *)arg3;	// IMP=0x0000000100005828
+ (id)entryForBundle:(id)arg1 inContainer:(id)arg2 withError:(id *)arg3;	// IMP=0x0000000100005574
+ (_Bool)enumeratePluginKitPluginsInBundle:(id)arg1 updatingPluginParentID:(_Bool)arg2 ensurePluginsAreExecutable:(_Bool)arg3 installProfiles:(_Bool)arg4 error:(id *)arg5 enumerator:(CDUnknownBlockType)arg6;	// IMP=0x0000000100004eb0
- (void).cxx_destruct;	// IMP=0x00000001000066d4
...
- (_Bool)performGatherWithError:(id *)arg1;	// IMP=0x00000001000064d8
- (void)errorOccurred:(id)arg1;	// IMP=0x000000010000644c
- (_Bool)scanExecutableBundle:(id)arg1 inContainer:(id)arg2 withError:(id *)arg3;	// IMP=0x00000001000060f0
- (id)_setForEntry:(id)arg1;	// IMP=0x0000000100005ec8
- (_Bool)_scanBundle:(id)arg1 inBundleContainer:(id)arg2 withError:(id *)arg3;	// IMP=0x0000000100005c34
- (id)initWithEnumerator:(CDUnknownBlockType)arg1;	// IMP=0x0000000100004cf4
