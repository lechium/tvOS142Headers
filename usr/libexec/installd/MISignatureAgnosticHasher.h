...
+ (void)unpackPackedCpuTypeAndSubType:(id)arg1 cputype:(int *)arg2 subtype:(int *)arg3;	// IMP=0x000000010005e2dc
+ (id)packedNumberForCPUType:(int)arg1 subtype:(int)arg2;	// IMP=0x000000010005e2bc
- (void).cxx_destruct;	// IMP=0x000000010005e358
...
- (_Bool)performHashWithError:(id *)arg1;	// IMP=0x000000010005da34
- (id)_hashSliceAtOffset:(long long)arg1 withSize:(long long)arg2 machHeaderAndCommands:(const struct mach_header *)arg3 dictionaryKey:(id *)arg4 error:(id *)arg5;	// IMP=0x000000010005c888
- (void)dealloc;	// IMP=0x000000010005c824
- (id)initWithExecutable:(id)arg1 searchForSectionNamed:(id)arg2;	// IMP=0x000000010005c778
