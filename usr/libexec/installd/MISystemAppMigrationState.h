...
+ (id)defaultManager;	// IMP=0x0000000100025898
- (void).cxx_destruct;	// IMP=0x0000000100025eb4
...
- (void)waitForSystemAppMigrationToComplete:(CDUnknownBlockType)arg1;	// IMP=0x0000000100025c60
@property(nonatomic) _Bool systemAppMigrationComplete; // @synthesize systemAppMigrationComplete=_systemAppMigrationComplete;
- (id)init;	// IMP=0x000000010002575c
