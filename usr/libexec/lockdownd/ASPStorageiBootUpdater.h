...
- (void)dealloc;	// IMP=0x000000010002c6a8
- (_Bool)updateBootFirmwareWithCallback:(struct ramrod_update_callbacks *)arg1 context:(struct firmware_update_context *)arg2 error:(id *)arg3;	// IMP=0x000000010002c698
- (_Bool)updateBootFirmwareWithError:(id *)arg1;	// IMP=0x000000010002bf1c
- (id)initWithApNonce:(id)arg1;	// IMP=0x000000010002be78
