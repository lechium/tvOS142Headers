...
- (void).cxx_destruct;	// IMP=0x0000000100042ae8
...
- (void)dealloc;	// IMP=0x0000000100042a38
- (void)_endSession;	// IMP=0x00000001000428ec
- (id)eventOccurance;	// IMP=0x00000001000426e4
- (id)eventDurations;	// IMP=0x00000001000423ec
- (void)recordEvent:(id)arg1;	// IMP=0x0000000100042370
- (void)recordEvent:(id)arg1 occuredAt:(id)arg2;	// IMP=0x0000000100042134
- (id)initForType:(id)arg1 withMetadata:(id)arg2;	// IMP=0x000000010004206c
