...
- (void)schedule;	// IMP=0x0000000100009f64
- (void)invalidate;	// IMP=0x0000000100009f18
- (void)checkIn;	// IMP=0x0000000100009dec
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0000000100009d18
