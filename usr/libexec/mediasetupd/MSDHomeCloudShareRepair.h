...
+ (id)repairTokenForUser:(id)arg1;	// IMP=0x0000000100018b08
- (void).cxx_destruct;	// IMP=0x0000000100018e24
...
- (void)performRepairRequest:(CDUnknownBlockType)arg1;	// IMP=0x0000000100018c80
- (id)initWithUser:(id)arg1 repairInfo:(id)arg2 containerID:(id)arg3;	// IMP=0x0000000100018bb0
