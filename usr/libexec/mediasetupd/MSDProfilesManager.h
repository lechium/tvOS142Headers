...
+ (id)fetchInstalledAgoraProfilesManagedDefaults;	// IMP=0x0000000100019a74
...
- (void)profileConnectionDidReceiveProfileListChangedNotification:(id)arg1 userInfo:(id)arg2;	// IMP=0x0000000100019e48
- (void)syncStatusOfInstalledProfiles;	// IMP=0x000000010001980c
- (void)dealloc;	// IMP=0x0000000100019794
- (id)init;	// IMP=0x0000000100019714
