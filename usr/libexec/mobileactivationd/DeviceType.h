...
+ (id)sharedInstance;	// IMP=0x0000000100013b38
...
- (_Bool)runningInRAMDisk;	// IMP=0x00000001000145c4
- (id)copyDeviceTreeInt:(id)arg1 key:(id)arg2 defaultValue:(int)arg3;	// IMP=0x0000000100014474
- (id)copyBootArgs;	// IMP=0x00000001000143d0
- (id)copyBootSessionUUID;	// IMP=0x0000000100014320
- (id)copyDeviceTreeProperty:(id)arg1 key:(id)arg2;	// IMP=0x000000010001426c
- (id)init;	// IMP=0x0000000100013ba4
