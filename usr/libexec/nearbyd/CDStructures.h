...
struct Session {
    ...
    struct weak_ptr<rose::objects::Session> _field2;
    struct RoseServiceRequest _field3;
    struct function<void (rose::ServiceRequestStatusUpdate)> _field4;
    struct function<void (const rose::RoseSolution &)> _field5;
    struct function<void (const rose::RemoteSessionData &)> _field6;
    struct function<void (rose::objects::Session *, rose::objects::InvalidationReason)> _field7;
    struct function<void (rose::objects::ReturnCode, float, float, int)> _field8;
    id _field9;
    struct optional<unsigned short> _field10;
    struct optional<rose::RoseStartRangingOptions> _field11;
    struct optional<rose::ServiceRequestStatusUpdate> _field12;
    struct optional<rose::RoseServiceStateUpdate> _field13;
    struct atomic<bool> _field14;
    struct atomic<unsigned char> _field15;
};
...
struct function<void (const rose::RemoteSessionData &)> {
    struct __value_func<void (const rose::RemoteSessionData &)> {
        struct type _field1;
        struct __base<void (const rose::RemoteSessionData &)> *_field2;
    } _field1;
};

struct function<void (const rose::RoseSolution &)> {
    struct __value_func<void (const rose::RoseSolution &)> {
        struct type _field1;
        struct __base<void (const rose::RoseSolution &)> *_field2;
    } _field1;
};

struct function<void (rose::ServiceRequestStatusUpdate)> {
    struct __value_func<void (rose::ServiceRequestStatusUpdate)> {
        struct type _field1;
        struct __base<void (rose::ServiceRequestStatusUpdate)> *_field2;
    } _field1;
};

struct function<void (rose::objects::ReturnCode, float, float, int)> {
    struct __value_func<void (rose::objects::ReturnCode, float, float, int)> {
        struct type _field1;
        struct __base<void (rose::objects::ReturnCode, float, float, int)> *_field2;
    } _field1;
};

struct function<void (rose::objects::Session *, rose::objects::InvalidationReason)> {
    struct __value_func<void (rose::objects::Session *, rose::objects::InvalidationReason)> {
        struct type _field1;
        struct __base<void (rose::objects::Session *, rose::objects::InvalidationReason)> *_field2;
    } _field1;
};
...
struct optional<rose::RoseServiceStateUpdate> {
    union {
        char _field1;
        struct RoseServiceStateUpdate _field2;
    } _field1;
    _Bool _field2;
};
...
struct optional<rose::RoseStartRangingOptions> {
    union {
        char _field1;
        struct RoseStartRangingOptions _field2;
    } _field1;
    _Bool _field2;
};

struct optional<rose::ServiceRequestStatusUpdate> {
    union {
        char _field1;
        struct ServiceRequestStatusUpdate _field2;
    } _field1;
    _Bool _field2;
};
...
struct unique_ptr<nearby::algorithms::region_monitoring::MonitorManager, std::__1::default_delete<nearby::algorithms::region_monitoring::MonitorManager>> {
    struct __compressed_pair<nearby::algorithms::region_monitoring::MonitorManager *, std::__1::default_delete<nearby::algorithms::region_monitoring::MonitorManager>> {
        struct MonitorManager *__value_;
    } __ptr_;
};
...
struct weak_ptr<rose::objects::Session> {
