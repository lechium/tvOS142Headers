...
- (id).cxx_construct;	// IMP=0x000000010001d6e0
- (void).cxx_destruct;	// IMP=0x000000010001d6a4
- (void)submitAnalytics;	// IMP=0x000000010001cfac
- (void)saveAnalytics:(long long)arg1 value1:(double)arg2 value2:(double)arg3;	// IMP=0x000000010001ce5c
- (void)_getDirectionMetricFromPointingCoordinates:(double)arg1 el:(double)arg2;	// IMP=0x000000010001ca1c
- (id)init;	// IMP=0x000000010001c908
