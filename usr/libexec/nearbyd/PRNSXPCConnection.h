...
- (void).cxx_destruct;	// IMP=0x0000000100191c90
...
- (void)invalidate;	// IMP=0x0000000100191bfc
- (void)actOnRemoteObjectAndScheduleBarrierBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000100191848
- (id)initWithConnection:(id)arg1;	// IMP=0x00000001001917a8
