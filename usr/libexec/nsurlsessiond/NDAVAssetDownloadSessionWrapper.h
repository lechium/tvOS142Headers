...
- (void).cxx_destruct;	// IMP=0x000000010000dca4
...
- (void)assetDownloadSession:(id)arg1 didResolveMediaSelection:(id)arg2;	// IMP=0x000000010000db78
- (void)assetDownloadSession:(id)arg1 didFinishDownloadForMediaSelection:(id)arg2;	// IMP=0x000000010000daa4
- (void)assetDownloadSession:(id)arg1 didLoadTimeRange:(CDStruct_3c1748cc)arg2 totalTimeRangesLoaded:(id)arg3 timeRangeExpectedToLoad:(CDStruct_3c1748cc)arg4 forMediaSelection:(id)arg5;	// IMP=0x000000010000d9b0
- (void)assetDownloadSession:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x000000010000d8dc
- (void)assetDownloadSessionDidFinishDownload:(id)arg1;	// IMP=0x000000010000d83c
- (void)startLoadingMetadata;	// IMP=0x000000010000d7e4
- (void)cancelAndDeliverError:(id)arg1;	// IMP=0x000000010000d750
- (void)cancel;	// IMP=0x000000010000d6e4
- (void)suspend;	// IMP=0x000000010000d634
- (void)resume;	// IMP=0x000000010000d4bc
- (void)releasePowerAssertion;	// IMP=0x000000010000d3b4
- (void)takePowerAssertion;	// IMP=0x000000010000d15c
- (void)sendProgressUpdate;	// IMP=0x000000010000d02c
- (void)didReceiveMediaSelectionResolutionNotification:(id)arg1;	// IMP=0x000000010000cfd4
- (void)didReceiveTimeRangesChangedNotification:(id)arg1;	// IMP=0x000000010000cf50
- (void)didReceiveFileSizeAvailableNotification:(id)arg1;	// IMP=0x000000010000cf4c
- (void)didReceiveFailedNotification:(id)arg1;	// IMP=0x000000010000cef4
- (void)didReceiveSucceededNotification:(id)arg1;	// IMP=0x000000010000ce9c
- (void)disavowSession;	// IMP=0x000000010000cd98
- (void)removeSessionObservers;	// IMP=0x000000010000cc60
- (void)addSessionObservers;	// IMP=0x000000010000cb00
- (id)initWithURLAsset:(id)arg1 destinationURL:(id)arg2 options:(id)arg3 delegate:(id)arg4 queue:(id)arg5;	// IMP=0x000000010000c12c
- (id)initWithURL:(id)arg1 destinationURL:(id)arg2 options:(id)arg3 delegate:(id)arg4 queue:(id)arg5;	// IMP=0x000000010000bf04
- (_Bool)doesAVAssetDownloadSessionSupportMultipleDownloads;	// IMP=0x000000010000bedc
