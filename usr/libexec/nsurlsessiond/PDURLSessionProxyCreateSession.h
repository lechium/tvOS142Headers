...
- (void).cxx_destruct;	// IMP=0x0000000100007f7c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100007d58
- (unsigned long long)hash;	// IMP=0x0000000100007c28
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100007a28
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100007880
- (void)copyTo:(id)arg1;	// IMP=0x000000010000771c
- (void)writeTo:(id)arg1;	// IMP=0x00000001000075d0
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100006f10
- (id)dictionaryRepresentation;	// IMP=0x0000000100006c58
- (id)description;	// IMP=0x0000000100006ba4
