...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100041698
- (unsigned long long)hash;	// IMP=0x00000001000415f0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000414c4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000413c8
- (void)copyTo:(id)arg1;	// IMP=0x00000001000412fc
- (void)writeTo:(id)arg1;	// IMP=0x0000000100041238
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100040e34
- (id)dictionaryRepresentation;	// IMP=0x0000000100040c90
- (id)description;	// IMP=0x0000000100040bdc
