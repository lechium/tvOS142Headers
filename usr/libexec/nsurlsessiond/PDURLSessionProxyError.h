...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000451c8
- (unsigned long long)hash;	// IMP=0x0000000100045110
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100044fd4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100044ed4
- (void)copyTo:(id)arg1;	// IMP=0x0000000100044e10
- (void)writeTo:(id)arg1;	// IMP=0x0000000100044d5c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100044d54
- (id)dictionaryRepresentation;	// IMP=0x0000000100044c0c
- (id)description;	// IMP=0x0000000100044b58
