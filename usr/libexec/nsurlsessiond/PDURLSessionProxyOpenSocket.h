...
- (void).cxx_destruct;	// IMP=0x0000000100005b8c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100005a40
- (unsigned long long)hash;	// IMP=0x0000000100005998
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100005864
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100005760
- (void)copyTo:(id)arg1;	// IMP=0x00000001000056a8
- (void)writeTo:(id)arg1;	// IMP=0x0000000100005600
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100005308
- (id)dictionaryRepresentation;	// IMP=0x00000001000051d0
- (id)description;	// IMP=0x000000010000511c
