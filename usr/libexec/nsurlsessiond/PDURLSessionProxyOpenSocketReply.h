...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100036254
- (unsigned long long)hash;	// IMP=0x0000000100036200
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010003612c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010003609c
- (void)copyTo:(id)arg1;	// IMP=0x0000000100036028
- (void)writeTo:(id)arg1;	// IMP=0x0000000100035fac
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100035cc4
- (id)dictionaryRepresentation;	// IMP=0x0000000100035bc0
- (id)description;	// IMP=0x0000000100035b0c
