...
- (void).cxx_destruct;	// IMP=0x000000010004e244
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010004e0dc
- (unsigned long long)hash;	// IMP=0x000000010004e014
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010004deb4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010004dd8c
- (void)copyTo:(id)arg1;	// IMP=0x000000010004dcb0
- (void)writeTo:(id)arg1;	// IMP=0x000000010004dbe0
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010004dbd8
- (id)dictionaryRepresentation;	// IMP=0x000000010004da6c
- (id)description;	// IMP=0x000000010004d9b8
