...
- (void).cxx_destruct;	// IMP=0x00000001000422ec
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100042228
- (unsigned long long)hash;	// IMP=0x00000001000421c0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000420e4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010004203c
- (void)copyTo:(id)arg1;	// IMP=0x0000000100041fc4
- (void)writeTo:(id)arg1;	// IMP=0x0000000100041f54
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100041f4c
- (id)dictionaryRepresentation;	// IMP=0x0000000100041e5c
- (id)description;	// IMP=0x0000000100041da8
