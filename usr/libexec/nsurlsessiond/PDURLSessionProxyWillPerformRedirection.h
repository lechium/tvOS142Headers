...
- (void).cxx_destruct;	// IMP=0x000000010005f654
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010005f514
- (unsigned long long)hash;	// IMP=0x000000010005f4a0
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010005f3a0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010005f2c8
- (void)copyTo:(id)arg1;	// IMP=0x000000010005f23c
- (void)writeTo:(id)arg1;	// IMP=0x000000010005f1bc
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010005ef34
- (id)dictionaryRepresentation;	// IMP=0x000000010005ee10
- (id)description;	// IMP=0x000000010005ed5c
