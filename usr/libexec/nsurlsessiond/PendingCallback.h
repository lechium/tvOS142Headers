...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010005124c
- (void).cxx_destruct;	// IMP=0x0000000100051240
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000510e4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100050ff0
- (id)initWithCallbackType:(int)arg1 taskIdentifier:(unsigned long long)arg2 args:(id)arg3;	// IMP=0x0000000100050f0c
