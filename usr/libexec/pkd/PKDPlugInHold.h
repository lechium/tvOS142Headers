...
- (void).cxx_destruct;	// IMP=0x0000000100019a44
...
- (id)description;	// IMP=0x00000001000198b8
- (unsigned long long)hash;	// IMP=0x000000010001986c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000197ac
- (id)initWithPlugIns:(id)arg1 forClient:(id)arg2;	// IMP=0x0000000100019634
