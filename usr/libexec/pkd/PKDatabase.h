...
- (void).cxx_destruct;	// IMP=0x0000000100015edc
...
- (void)pluginsWillUninstall:(id)arg1;	// IMP=0x0000000100015904
- (void)pluginsDidInstall:(id)arg1;	// IMP=0x0000000100015610
- (void)autoElect:(id)arg1;	// IMP=0x0000000100015498
- (void)notifyAnnotationChange;	// IMP=0x000000010001541c
- (id)setAnnotation:(id)arg1 forPlugIn:(id)arg2;	// IMP=0x00000001000152e8
- (id)annotationForPlugIn:(id)arg1;	// IMP=0x0000000100015154
- (id)removePlugIn:(id)arg1;	// IMP=0x0000000100014fcc
- (id)addPlugIn:(id)arg1;	// IMP=0x0000000100014e44
- (id)plugInsWithinApplication:(id)arg1;	// IMP=0x0000000100014ba8
- (id)findPlugInAtPath:(id)arg1;	// IMP=0x0000000100014ab8
- (id)findPlugIn:(id)arg1;	// IMP=0x0000000100014708
- (id)findPlugIns:(id)arg1 discoveryInstanceUUID:(id)arg2;	// IMP=0x000000010001376c
- (void)purgeCachesToLimit:(long long)arg1;	// IMP=0x00000001000135e0
- (id)createPlugInForProxy:(id)arg1 knowledgeUUID:(id)arg2 discoveryInstanceUUID:(id)arg3 extensionPointCache:(id)arg4;	// IMP=0x0000000100013398
- (id)plugInForProxy:(id)arg1 knowledgeUUID:(id)arg2 discoveryInstanceUUID:(id)arg3 extensionPointCache:(id)arg4;	// IMP=0x0000000100012f48
- (id)initWithDatabase:(const char *)arg1;	// IMP=0x0000000100012bd8
