...
+ (id)sharedDaemon;	// IMP=0x000000010002c528
- (void).cxx_destruct;	// IMP=0x000000010002f544
...
- (void)_xpcPublisherStateChangedForToken:(unsigned long long)arg1 state:(_Bool)arg2;	// IMP=0x000000010002f310
- (void)_xpcPublisherTriggeredReply:(id)arg1 token:(unsigned long long)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010002efb4
- (void)_xpcPublisherTriggeredToken:(unsigned long long)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010002ecd4
- (void)_xpcPublisherRemoveToken:(unsigned long long)arg1;	// IMP=0x000000010002eb54
- (void)_xpcPublisherAddToken:(unsigned long long)arg1 event:(id)arg2;	// IMP=0x000000010002e6b0
- (void)_xpcPublisherAction:(unsigned int)arg1 token:(unsigned long long)arg2 event:(id)arg3;	// IMP=0x000000010002e5c8
- (void)_updateErrorFlags;	// IMP=0x000000010002e468
- (void)_prefsChanged;	// IMP=0x000000010002e34c
- (void)postDaemonInfoChanges:(unsigned long long)arg1;	// IMP=0x000000010002e170
- (id)keychainStateString;	// IMP=0x000000010002df1c
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000010002dca8
- (_Bool)diagnosticCommand:(id)arg1 params:(id)arg2;	// IMP=0x000000010002db70
- (void)invalidate;	// IMP=0x000000010002d818
- (void)activate;	// IMP=0x000000010002cdec
- (id)descriptionWithLevel:(int)arg1;	// IMP=0x000000010002c75c
- (id)init;	// IMP=0x000000010002c594
