...
- (void).cxx_destruct;	// IMP=0x000000010004cd34
...
- (void)xpcPeopleDiscoveryUpdate:(id)arg1;	// IMP=0x000000010004caf0
- (void)xpcPeopleDiscoveryActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010004c78c
- (void)xpcPeopleRemoveAppleID:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010004c36c
- (void)xpcPeopleAddAppleID:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010004c28c
- (void)clientPeopleStatusChanged:(unsigned int)arg1;	// IMP=0x000000010004c240
- (void)clientDeviceChanged:(id)arg1 changes:(unsigned int)arg2;	// IMP=0x000000010004bf5c
- (void)clientDeviceLost:(id)arg1;	// IMP=0x000000010004bb94
- (void)clientDeviceFound:(id)arg1 report:(_Bool)arg2;	// IMP=0x000000010004b780
- (_Bool)_entitledAndReturnError:(id *)arg1;	// IMP=0x000000010004b640
- (void)connectionInvalidated;	// IMP=0x000000010004b55c
- (id)initWithDaemon:(id)arg1 xpcCnx:(id)arg2;	// IMP=0x000000010004b4a8
