...
- (void).cxx_destruct;	// IMP=0x000000010004f130
...
- (void)xpcPrivateDiscoveryUpdate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010004efac
- (void)xpcPrivateDiscoveryActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010004ee84
- (void)xpcPrivateAdvertiserUpdate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010004ed6c
- (void)xpcPrivateAdvertiserActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010004ec44
- (void)xpcConnectionInvalidated;	// IMP=0x000000010004eabc
- (_Bool)_entitledAndReturnError:(id *)arg1;	// IMP=0x000000010004e97c
