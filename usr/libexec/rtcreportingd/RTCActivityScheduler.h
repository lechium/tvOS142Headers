...
- (void)oldestFilePruned:(id)arg1;	// IMP=0x00000001000158a4
- (void)postURLRequest:(id)arg1 isRealtime:(_Bool)arg2;	// IMP=0x00000001000155e8
- (void)releaseXPCTransaction;	// IMP=0x00000001000155a8
- (void)retainXPCTransaction;	// IMP=0x0000000100015570
- (_Bool)taskDispatched;	// IMP=0x0000000100015224
- (_Bool)performTask:(id)arg1;	// IMP=0x0000000100014924
- (void)dispatchedWorker;	// IMP=0x0000000100014788
- (void)dispatchedStop;	// IMP=0x0000000100014584
- (void)dispatchedStart;	// IMP=0x00000001000141ec
- (id)xpcActivityState:(long long)arg1;	// IMP=0x000000010001417c
- (int)randomizedDelay;	// IMP=0x0000000100013f8c
- (id)activityDescription;	// IMP=0x0000000100013f30
- (void)processSuspendActivity:(id)arg1;	// IMP=0x0000000100013e44
- (void)processStartActivity:(id)arg1;	// IMP=0x0000000100013d1c
- (void)prepareNextActivity:(int)arg1;	// IMP=0x0000000100013a88
- (void)stop;	// IMP=0x0000000100013a20
- (void)start;	// IMP=0x0000000100013968
- (void)dealloc;	// IMP=0x0000000100013894
- (id)initWithOptions:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000100013724
