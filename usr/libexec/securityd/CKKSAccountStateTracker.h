...
+ (id)stringFromAccountStatus:(long long)arg1;	// IMP=0x0000000100037c84
+ (id)getCircleStatus;	// IMP=0x0000000100037b5c
+ (void)fetchCirclePeerID:(CDUnknownBlockType)arg1;	// IMP=0x0000000100037ab8
- (void).cxx_destruct;	// IMP=0x0000000100035db0
...
- (void)setHSA2iCloudAccountStatus:(long long)arg1;	// IMP=0x0000000100035b64
- (void)triggerOctagonStatusFetch;	// IMP=0x0000000100035988
- (id)checkForAllDeliveries;	// IMP=0x0000000100035868
- (void)notifyCircleStatusChangeAndWaitForSignal;	// IMP=0x0000000100035828
- (void)notifyCKAccountStatusChangeAndWaitForSignal;	// IMP=0x0000000100035818
- (_Bool)notifyCKAccountStatusChangeAndWait:(unsigned long long)arg1;	// IMP=0x00000001000357b4
- (void)_onqueueDeliverCurrentCloudKitState:(id)arg1 listenerQueue:(id)arg2 oldStatus:(id)arg3 group:(id)arg4;	// IMP=0x0000000100035670
- (void)_onqueueDeliverCloudKitStateChanges:(id)arg1 dispatchGroup:(id)arg2;	// IMP=0x00000001000354d4
- (void)_onqueueUpdateAccountState:(id)arg1 dispatchGroup:(id)arg2;	// IMP=0x00000001000351d8
- (void)_onqueueUpdateAccountState:(id)arg1 deliveredSemaphore:(id)arg2;	// IMP=0x000000010003504c
- (void)_onqueueUpdateCirclePeerID:(id)arg1;	// IMP=0x0000000100034e40
- (id)notifyCircleChange:(id)arg1;	// IMP=0x0000000100034d38
- (void)_onqueueUpdateCKDeviceID:(id)arg1;	// IMP=0x0000000100034b9c
- (id)notifyCKAccountStatusChange:(id)arg1;	// IMP=0x0000000100034a74
- (id)registerForNotificationsOfCloudKitAccountStatusChange:(id)arg1;	// IMP=0x0000000100034980
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
- (id)descriptionInternal:(id)arg1;	// IMP=0x00000001000347cc
- (void)dealloc;	// IMP=0x0000000100034750
- (void)performInitialDispatches;	// IMP=0x00000001000346c0
- (id)init:(id)arg1 nsnotificationCenterClass:(Class)arg2;	// IMP=0x00000001000342e4
