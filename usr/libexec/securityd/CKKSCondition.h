...
- (void).cxx_destruct;	// IMP=0x0000000100180444
...
- (long long)wait:(unsigned long long)arg1;	// IMP=0x0000000100180388
- (void)fulfill;	// IMP=0x0000000100180308
- (id)initToChain:(id)arg1;	// IMP=0x0000000100180278
- (id)init;	// IMP=0x0000000100180268
