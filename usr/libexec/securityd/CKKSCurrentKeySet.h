...
+ (id)loadForZone:(id)arg1;	// IMP=0x000000010008e140
- (void).cxx_destruct;	// IMP=0x000000010008e0b0
...
- (id)asKeychainBackedSet:(id *)arg1;	// IMP=0x000000010008dd54
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010008dab8
- (id)description;	// IMP=0x000000010008d82c
- (id)initForZoneName:(id)arg1;	// IMP=0x000000010008d7b4
