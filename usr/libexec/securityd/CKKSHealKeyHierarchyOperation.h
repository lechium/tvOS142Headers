...
- (void).cxx_destruct;	// IMP=0x0000000100081f2c
...
- (void)cancel;	// IMP=0x0000000100081e20
- (_Bool)ensureKeyPresent:(id)arg1;	// IMP=0x000000010008193c
- (void)groupStart;	// IMP=0x00000001000816b8
- (id)initWithDependencies:(id)arg1 ckks:(id)arg2 intending:(id)arg3 errorState:(id)arg4;	// IMP=0x00000001000815a4
- (id)init;	// IMP=0x000000010008158c
