...
+ (id)decryptCKKSItemToAttributes:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100067a28
- (void).cxx_destruct;	// IMP=0x0000000100065cf4
...
- (void)_onqueueHandleIQEDelete:(id)arg1 class:(const struct SecDbClass *)arg2;	// IMP=0x0000000100065170
- (void)_onqueueHandleIQEChange:(id)arg1 item:(struct SecDbItem *)arg2 sortedForThisView:(_Bool)arg3;	// IMP=0x000000010006425c
- (void)_onqueueHandleIQEChange:(id)arg1 attributes:(id)arg2 class:(const struct SecDbClass *)arg3 sortedForThisView:(_Bool)arg4;	// IMP=0x00000001000640bc
- (_Bool)fixMismatchedViewItems;	// IMP=0x0000000100063e0c
- (_Bool)loadAndProcessEntriesWithActionFilter:(id)arg1;	// IMP=0x0000000100063b30
- (void)main;	// IMP=0x00000001000631ac
- (_Bool)_onqueueUpdateIQE:(id)arg1 withState:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100063000
- (void)_onqueueHandleMismatchedViewItem:(id)arg1 secDbClass:(const struct SecDbClass *)arg2 attributes:(id)arg3 intendedView:(id)arg4;	// IMP=0x0000000100062944
- (_Bool)processQueueEntries:(id)arg1;	// IMP=0x00000001000614ac
- (_Bool)processNewCurrentItemPointers:(id)arg1;	// IMP=0x00000001000610f8
- (id)initWithDependencies:(id)arg1 ckks:(id)arg2 intending:(id)arg3 errorState:(id)arg4 errorOnClassAFailure:(_Bool)arg5 handleMismatchedViewItems:(_Bool)arg6;	// IMP=0x0000000100060eb0
- (id)init;	// IMP=0x0000000100060e98
