...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100172b34
- (void).cxx_destruct;	// IMP=0x0000000100172af8
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100172970
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100172850
- (id)description;	// IMP=0x000000010017276c
- (id)initWithTLK:(id)arg1 classA:(id)arg2 classC:(id)arg3 newUpload:(_Bool)arg4;	// IMP=0x0000000100172694
