...
- (void).cxx_destruct;	// IMP=0x000000010018c6cc
...
- (id)eventsByTime;	// IMP=0x000000010018c318
- (id)eventsRelativeTime;	// IMP=0x000000010018c134
- (void)launch;	// IMP=0x000000010018bf78
- (void)reportMetric;	// IMP=0x000000010018bca8
- (void)addEvent:(id)arg1;	// IMP=0x000000010018bb00
- (void)addAttribute:(id)arg1 value:(id)arg2;	// IMP=0x000000010018b9ac
- (void)addDependantLaunch:(id)arg1 child:(id)arg2;	// IMP=0x000000010018b830
@property _Bool firstLaunch;
- (id)initWithRocketName:(id)arg1;	// IMP=0x000000010018b658
