...
- (void).cxx_destruct;	// IMP=0x0000000100093aec
...
- (void)cancel;	// IMP=0x000000010009393c
- (void)_onqueueTrigger:(unsigned long long)arg1 maximumDelay:(unsigned long long)arg2;	// IMP=0x00000001000933e4
- (void)trigger;	// IMP=0x0000000100093318
- (void)_onqueueTimerTick;	// IMP=0x0000000100092fe8
- (void)triggerAt:(unsigned long long)arg1;	// IMP=0x0000000100092f0c
- (void)waitUntil:(unsigned long long)arg1;	// IMP=0x0000000100092e84
@property(readonly) NSDate *nextFireTime;
- (id)description;	// IMP=0x0000000100092ca0
- (id)makeOperationDependency;	// IMP=0x0000000100092bc4
- (void)changeDelays:(unsigned long long)arg1 continuingDelay:(unsigned long long)arg2;	// IMP=0x0000000100092b34
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 expontialBackoff:(double)arg3 maximumDelay:(unsigned long long)arg4 keepProcessAlive:(_Bool)arg5 dependencyDescriptionCode:(long long)arg6 block:(CDUnknownBlockType)arg7;	// IMP=0x0000000100092950
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 continuingDelay:(unsigned long long)arg3 keepProcessAlive:(_Bool)arg4 dependencyDescriptionCode:(long long)arg5 block:(CDUnknownBlockType)arg6;	// IMP=0x00000001000928a8
- (id)initWithName:(id)arg1 delay:(unsigned long long)arg2 keepProcessAlive:(_Bool)arg3 dependencyDescriptionCode:(long long)arg4 block:(CDUnknownBlockType)arg5;	// IMP=0x0000000100092828
