...
- (void).cxx_destruct;	// IMP=0x0000000100087920
...
- (void)provideKeySet:(id)arg1;	// IMP=0x00000001000875cc
- (id)currentTrustStates;	// IMP=0x0000000100087384
- (id)initWithZoneID:(id)arg1 zoneModifier:(id)arg2 ckoperationGroup:(id)arg3 flagHandler:(id)arg4 launchSequence:(id)arg5 lockStateTracker:(id)arg6 reachabilityTracker:(id)arg7 peerProviders:(id)arg8 databaseProvider:(id)arg9 notifyViewChangedScheduler:(id)arg10 savedTLKNotifier:(id)arg11;	// IMP=0x0000000100087144
