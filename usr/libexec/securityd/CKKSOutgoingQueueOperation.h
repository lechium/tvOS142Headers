...
- (void).cxx_destruct;	// IMP=0x000000010006930c
...
- (_Bool)_onqueueIsErrorBadEtagOnKeyPointersOnly:(id)arg1;	// IMP=0x0000000100068ed8
- (_Bool)_onqueueIsErrorMissingSyncKey:(id)arg1;	// IMP=0x0000000100068bfc
- (void)_onqueueModifyAllRecords:(id)arg1 as:(id)arg2;	// IMP=0x00000001000685f8
- (void)_onqueueModifyRecordAsError:(id)arg1 recordError:(id)arg2;	// IMP=0x0000000100068148
- (void)groupStart;	// IMP=0x0000000100067e54
- (id)initWithDependencies:(id)arg1 ckks:(id)arg2 intending:(id)arg3 errorState:(id)arg4 ckoperationGroup:(id)arg5;	// IMP=0x0000000100067c64
