...
- (void).cxx_destruct;	// IMP=0x000000010015a874
...
- (void)setStorage:(id)arg1;	// IMP=0x000000010015a710
- (id)storage;	// IMP=0x000000010015a6a4
- (id)initWithStoragePath:(id)arg1 storageClass:(Class)arg2;	// IMP=0x000000010015a508
