...
+ (id)createFromProvider:(id)arg1;	// IMP=0x0000000100106040
+ (id)noPeersState:(id)arg1;	// IMP=0x0000000100105f0c
- (void).cxx_destruct;	// IMP=0x0000000100105eac
...
- (_Bool)unwrapKey:(id)arg1 fromShares:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100105180
- (id)findPeersMissingTLKSharesFor:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100103be4
- (id)description;	// IMP=0x0000000100103aa4
- (id)initWithPeerProviderID:(id)arg1 essential:(_Bool)arg2 selfPeers:(id)arg3 selfPeersError:(id)arg4 trustedPeers:(id)arg5 trustedPeersError:(id)arg6;	// IMP=0x000000010010382c
