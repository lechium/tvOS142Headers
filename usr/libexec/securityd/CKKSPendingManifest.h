...
+ (id)sqlTable;	// IMP=0x0000000100100d54
- (void).cxx_destruct;	// IMP=0x0000000100100d40
...
- (id)commitToDatabaseWithError:(id *)arg1;	// IMP=0x0000000100100998
- (_Bool)isReadyToCommit;	// IMP=0x000000010010079c
