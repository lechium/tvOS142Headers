...
+ (_Bool)isNetworkFailureError:(id)arg1;	// IMP=0x00000001000e5374
+ (_Bool)isNetworkError:(id)arg1;	// IMP=0x00000001000e5238
- (void).cxx_destruct;	// IMP=0x00000001000e4eb0
...
- (_Bool)isNetworkError:(id)arg1;	// IMP=0x00000001000e4e24
- (void)setNetworkReachability:(_Bool)arg1;	// IMP=0x00000001000e4d98
- (void)_onqueueSetNetworkReachability:(_Bool)arg1;	// IMP=0x00000001000e4ccc
- (void)_onQueueResetReachabilityDependency;	// IMP=0x00000001000e4994
- (void)_onQueueRunReachabilityDependency;	// IMP=0x00000001000e484c
@property(readonly) _Bool currentReachability;
- (id)description;	// IMP=0x00000001000e4714
- (id)init;	// IMP=0x00000001000e44f4
