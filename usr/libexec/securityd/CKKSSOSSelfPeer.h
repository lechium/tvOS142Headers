...
- (void).cxx_destruct;	// IMP=0x0000000100098c00
...
- (_Bool)shouldHaveView:(id)arg1;	// IMP=0x0000000100098b40
- (_Bool)matchesPeer:(id)arg1;	// IMP=0x0000000100098a38
@property(readonly) NSString *peerID;
@property(readonly) _SFECPublicKey *publicSigningKey;
@property(readonly) _SFECPublicKey *publicEncryptionKey;
- (id)initWithSOSPeerID:(id)arg1 encryptionKey:(id)arg2 signingKey:(id)arg3 viewList:(id)arg4;	// IMP=0x00000001000987b8
