...
+ (id)op:(unsigned long long)arg1 column:(unsigned long long)arg2;	// IMP=0x000000010002ccb0
...
- (id)initWithOperation:(unsigned long long)arg1 columnName:(unsigned long long)arg2;	// IMP=0x000000010002cc44
