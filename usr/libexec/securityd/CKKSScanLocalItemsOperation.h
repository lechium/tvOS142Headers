...
- (void).cxx_destruct;	// IMP=0x00000001000a3978
...
- (_Bool)areEquivalent:(struct SecDbItem *)arg1 ckksItem:(id)arg2;	// IMP=0x00000001000a33d0
- (void)main;	// IMP=0x00000001000a2bb8
- (void)retriggerMissingMirrorEntires:(id)arg1 ckks:(id)arg2 databaseProvider:(id)arg3;	// IMP=0x00000001000a29f8
- (void)fixUUIDlessItemsWithPrimaryKeys:(id)arg1 databaseProvider:(id)arg2;	// IMP=0x00000001000a2824
- (void)onboardItemsWithUUIDs:(id)arg1 itemClass:(id)arg2 databaseProvider:(id)arg3;	// IMP=0x00000001000a2584
- (_Bool)onboardItemToCKKS:(struct SecDbItem *)arg1 error:(id *)arg2;	// IMP=0x00000001000a21ac
- (_Bool)executeQuery:(id)arg1 readWrite:(_Bool)arg2 error:(id *)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x00000001000a1df0
- (id)queryPredicatesForViewMapping;	// IMP=0x00000001000a1260
- (id)initWithDependencies:(id)arg1 ckks:(id)arg2 intending:(id)arg3 errorState:(id)arg4 ckoperationGroup:(id)arg5;	// IMP=0x00000001000a1100
- (id)init;	// IMP=0x00000001000a10e8
