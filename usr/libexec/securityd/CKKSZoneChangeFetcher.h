...
- (void).cxx_destruct;	// IMP=0x000000010017c6ec
...
- (void)cancel;	// IMP=0x000000010017c568
- (void)holdFetchesUntil:(id)arg1;	// IMP=0x000000010017c55c
- (id)createSuccesfulFetchDependency;	// IMP=0x000000010017c4f0
- (void)_onqueueCreateNewFetch;	// IMP=0x000000010017bd6c
- (void)maybeCreateNewFetch;	// IMP=0x000000010017bcf0
- (void)maybeCreateNewFetchOnQueue;	// IMP=0x000000010017bb60
- (id)inflightFetch;	// IMP=0x000000010017ba6c
- (id)requestSuccessfulFetchForManyReasons:(id)arg1;	// IMP=0x000000010017b944
- (id)requestFetchDueToAPNS:(id)arg1;	// IMP=0x000000010017b664
- (void)notifyZoneChange:(id)arg1;	// IMP=0x000000010017b56c
- (id)requestSuccessfulFetch:(id)arg1;	// IMP=0x000000010017b504
- (id)clients;	// IMP=0x000000010017b338
- (void)registerClient:(id)arg1;	// IMP=0x000000010017b25c
@property(readonly, copy) NSString *description;
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 reachabilityTracker:(id)arg3;	// IMP=0x000000010017adcc
