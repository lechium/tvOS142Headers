...
+ (id)fromDatabaseRow:(id)arg1;	// IMP=0x0000000100075b64
+ (id)sqlColumns;	// IMP=0x0000000100075b58
+ (id)sqlTable;	// IMP=0x0000000100075b4c
+ (id)tryFromDatabase:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100075a24
+ (id)fromDatabase:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000758fc
+ (id)state:(id)arg1;	// IMP=0x0000000100075794
- (void).cxx_destruct;	// IMP=0x0000000100075718
...
- (id)sqlValues;	// IMP=0x000000010007512c
- (id)whereClauseToFindSelf;	// IMP=0x0000000100075080
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000747dc
- (id)initWithCKZone:(id)arg1 zoneCreated:(_Bool)arg2 zoneSubscribed:(_Bool)arg3 changeToken:(id)arg4 moreRecordsInCloudKit:(_Bool)arg5 lastFetch:(id)arg6 lastScan:(id)arg7 lastFixup:(unsigned long long)arg8 encodedRateLimiter:(id)arg9;	// IMP=0x0000000100074638
