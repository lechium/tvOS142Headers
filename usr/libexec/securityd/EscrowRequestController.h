...
- (void).cxx_destruct;	// IMP=0x0000000100033998
...
- (void)storePrerecordsInEscrowRPC:(CDUnknownBlockType)arg1;	// IMP=0x0000000100033780
- (void)triggerEscrowUpdateRPC:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000100032f7c
- (id)_onqueueNextStateMachineTransition:(id)arg1 flags:(id)arg2 pendingFlags:(id)arg3;	// IMP=0x00000001000325c0
- (id)initWithLockStateTracker:(id)arg1;	// IMP=0x0000000100032384
