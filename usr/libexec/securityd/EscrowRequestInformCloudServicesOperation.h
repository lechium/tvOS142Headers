...
+ (id)triggerCloudServicesPasscodeRequest:(id)arg1 error:(id *)arg2;	// IMP=0x000000010018b270
- (void).cxx_destruct;	// IMP=0x000000010018b21c
...
- (void)main;	// IMP=0x000000010018a9f8
- (id)initWithIntendedState:(id)arg1 errorState:(id)arg2 lockStateTracker:(id)arg3;	// IMP=0x000000010018a910
