...
- (void).cxx_destruct;	// IMP=0x0000000100044e94
...
- (void)handleRepairSuggestions:(_Bool)arg1 postEscrowCFU:(_Bool)arg2 resetOctagon:(_Bool)arg3 leaveTrust:(_Bool)arg4;	// IMP=0x0000000100044b34
- (void)groupStart;	// IMP=0x00000001000440f8
- (_Bool)checkIfPasscodeIsSetForDevice;	// IMP=0x00000001000440cc
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 deviceInfo:(id)arg4 skipRateLimitedCheck:(_Bool)arg5;	// IMP=0x0000000100043fa4
