...
- (void).cxx_destruct;	// IMP=0x000000010012cea8
...
- (void)proceedWithKeys:(id)arg1;	// IMP=0x000000010012c9bc
- (void)groupStart;	// IMP=0x000000010012c764
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 deviceInfo:(id)arg4 peerID:(id)arg5 permanentInfo:(id)arg6 permanentInfoSig:(id)arg7 stableInfo:(id)arg8 stableInfoSig:(id)arg9;	// IMP=0x000000010012c570
