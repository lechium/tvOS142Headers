...
- (void).cxx_destruct;	// IMP=0x0000000100139c7c
...
- (void)groupStart;	// IMP=0x00000001001396e8
- (id)initWithDependencies:(id)arg1 stateIfHSA2:(id)arg2 stateIfNotHSA2:(id)arg3 stateIfNoAccount:(id)arg4 errorState:(id)arg5;	// IMP=0x00000001001395a0
