...
- (void).cxx_destruct;	// IMP=0x0000000100079b2c
...
- (void)groupStart;	// IMP=0x0000000100078e90
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x0000000100078da8
