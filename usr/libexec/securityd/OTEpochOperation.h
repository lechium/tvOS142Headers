...
- (void)groupStart;	// IMP=0x0000000100159614
- (id)init:(id)arg1 contextID:(id)arg2 intendedState:(id)arg3 errorState:(id)arg4 cuttlefishXPCWrapper:(id)arg5;	// IMP=0x00000001001594cc
