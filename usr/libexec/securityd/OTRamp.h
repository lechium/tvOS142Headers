...
- (void).cxx_destruct;	// IMP=0x0000000100107fdc
...
- (_Bool)checkRampStateWithError:(id *)arg1;	// IMP=0x0000000100107298
- (void)fetchRampRecord:(unsigned long long)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000100106f68
- (id)initWithRecordName:(id)arg1 localSettingName:(id)arg2 container:(id)arg3 database:(id)arg4 zoneID:(id)arg5 accountTracker:(id)arg6 lockStateTracker:(id)arg7 reachabilityTracker:(id)arg8 fetchRecordRecordsOperationClass:(Class)arg9;	// IMP=0x0000000100106d58
