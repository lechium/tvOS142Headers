...
- (void).cxx_destruct;	// IMP=0x00000001001315e8
...
- (void)groupStart;	// IMP=0x0000000100131284
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 peerIDs:(id)arg4;	// IMP=0x0000000100131144
