...
- (void).cxx_destruct;	// IMP=0x00000001000af664
...
- (void)resetViews:(id)arg1;	// IMP=0x00000001000af1ec
- (void)proceedWithKeys:(id)arg1 incompleteKeySets:(id)arg2 pendingTLKShares:(id)arg3;	// IMP=0x00000001000aed40
- (void)groupStart;	// IMP=0x00000001000aea7c
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x00000001000ae994
