...
- (void).cxx_destruct;	// IMP=0x000000010018d1ec
...
- (void)groupStart;	// IMP=0x000000010018cf18
- (id)init:(id)arg1 contextID:(id)arg2 reason:(long long)arg3 intendedState:(id)arg4 errorState:(id)arg5 cuttlefishXPCWrapper:(id)arg6;	// IMP=0x000000010018cdbc
