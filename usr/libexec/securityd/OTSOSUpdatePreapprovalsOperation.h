...
- (void).cxx_destruct;	// IMP=0x00000001000b1414
...
- (void)groupStart;	// IMP=0x00000001000b0e4c
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 sosNotPresentState:(id)arg3 errorState:(id)arg4;	// IMP=0x00000001000b0d30
