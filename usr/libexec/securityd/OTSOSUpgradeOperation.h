...
- (void).cxx_destruct;	// IMP=0x00000001000f5804
...
- (void)proceedWithKeys:(id)arg1 pendingTLKShares:(id)arg2;	// IMP=0x00000001000f5438
- (void)afterSuccessfulAllowList;	// IMP=0x00000001000f5244
- (void)requestSilentEscrowUpdate;	// IMP=0x00000001000f5008
- (void)afterUpdate;	// IMP=0x00000001000f4e64
- (void)handlePrepareErrors:(id)arg1 nextExpectedState:(id)arg2;	// IMP=0x00000001000f4cec
- (void)afterPreflight;	// IMP=0x00000001000f4ac0
- (void)afterPrepare;	// IMP=0x00000001000f48ec
- (void)groupStart;	// IMP=0x00000001000f3724
- (id)persistentKeyRef:(struct __SecKey *)arg1 error:(id *)arg2;	// IMP=0x00000001000f366c
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 ckksConflictState:(id)arg3 errorState:(id)arg4 deviceInfo:(id)arg5 policyOverride:(id)arg6;	// IMP=0x00000001000f34f8
