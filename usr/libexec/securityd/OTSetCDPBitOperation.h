...
- (void).cxx_destruct;	// IMP=0x000000010008e9d0
...
- (void)groupStart;	// IMP=0x000000010008e7d8
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x000000010008e6f0
