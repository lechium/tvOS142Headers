...
- (void).cxx_destruct;	// IMP=0x0000000100096158
...
- (void)proceedWithKeys:(id)arg1 salt:(id)arg2;	// IMP=0x0000000100095e4c
- (void)groupStart;	// IMP=0x0000000100095968
- (id)initWithDependencies:(id)arg1 recoveryKey:(id)arg2;	// IMP=0x00000001000958b4
