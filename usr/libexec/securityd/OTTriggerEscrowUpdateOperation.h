...
- (void).cxx_destruct;	// IMP=0x0000000100059ed8
...
- (void)groupStart;	// IMP=0x0000000100059a6c
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x0000000100059984
