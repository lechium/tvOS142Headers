...
- (void).cxx_destruct;	// IMP=0x00000001000afee4
...
- (void)groupStart;	// IMP=0x00000001000afa80
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 peerUnknownState:(id)arg3 errorState:(id)arg4 retryFlag:(id)arg5;	// IMP=0x00000001000af938
