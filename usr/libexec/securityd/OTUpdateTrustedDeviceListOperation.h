...
- (void).cxx_destruct;	// IMP=0x0000000100076aac
...
- (void)afterAuthKitFetch:(id)arg1 accountIsDemo:(_Bool)arg2;	// IMP=0x0000000100076814
- (void)fetchCurrentDeviceListAfterCuttlefishUpdate:(_Bool)arg1;	// IMP=0x00000001000765f4
- (void)groupStart;	// IMP=0x00000001000762a8
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 listUpdatesState:(id)arg3 errorState:(id)arg4 retryFlag:(id)arg5;	// IMP=0x0000000100076160
