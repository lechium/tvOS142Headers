...
- (void).cxx_destruct;	// IMP=0x0000000100120a9c
...
- (void)proceedWithKeys:(id)arg1 pendingTLKShares:(id)arg2 viewsToUpload:(id)arg3;	// IMP=0x000000010012075c
- (void)groupStart;	// IMP=0x000000010012020c
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 ckksConflictState:(id)arg3 peerMissingState:(id)arg4 errorState:(id)arg5;	// IMP=0x00000001001200c4
