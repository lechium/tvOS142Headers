...
- (void).cxx_destruct;	// IMP=0x000000010006fe90
...
- (void)proceedWithKeys:(id)arg1 filteredTLKShares:(id)arg2;	// IMP=0x000000010006fab8
- (void)noteMetric:(id)arg1 count:(long long)arg2;	// IMP=0x000000010006f92c
- (void)proceedWithPeerID:(id)arg1 refetchWasNeeded:(_Bool)arg2;	// IMP=0x000000010006f75c
- (void)groupStart;	// IMP=0x000000010006f0dc
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 bottleID:(id)arg4 entropy:(id)arg5 bottleSalt:(id)arg6 saveVoucher:(_Bool)arg7;	// IMP=0x000000010006ef50
