...
- (void).cxx_destruct;	// IMP=0x00000001000c7a74
...
- (void)proceedWithKeys:(id)arg1 tlkShares:(id)arg2 salt:(id)arg3;	// IMP=0x00000001000c7720
- (void)proceedWithRecoveryKeyID:(id)arg1;	// IMP=0x00000001000c7554
- (void)groupStart;	// IMP=0x00000001000c6fe4
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 recoveryKey:(id)arg4 saveVoucher:(_Bool)arg5;	// IMP=0x00000001000c6eb8
