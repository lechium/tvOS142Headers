...
- (void).cxx_destruct;	// IMP=0x00000001000438b8
...
- (id)currentState;	// IMP=0x0000000100043834
- (void)sendTrustedPeerSetChangedUpdate;	// IMP=0x00000001000437b0
- (void)sendSelfPeerChangedUpdate;	// IMP=0x000000010004372c
- (void)registerForPeerChangeUpdates:(id)arg1;	// IMP=0x00000001000436c0
- (id)fetchTrustedPeers:(id *)arg1;	// IMP=0x00000001000434bc
- (id)fetchSelfPeers:(id *)arg1;	// IMP=0x0000000100043170
- (id)fetchIdentity:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100042fac
@property(readonly, copy) NSString *description;
- (id)initWithPeerID:(id)arg1 containerName:(id)arg2 contextID:(id)arg3 cuttlefishXPC:(id)arg4;	// IMP=0x0000000100042db0
