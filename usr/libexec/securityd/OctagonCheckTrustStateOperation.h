...
- (void).cxx_destruct;	// IMP=0x000000010013b250
...
- (void)afterTPHTrustState:(id)arg1 trustedPeers:(id)arg2;	// IMP=0x000000010013a0ac
- (void)groupStart;	// IMP=0x0000000100139e9c
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x0000000100139db4
