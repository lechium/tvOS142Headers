...
- (void).cxx_destruct;	// IMP=0x0000000100042d74
...
- (_Bool)matchesPeer:(id)arg1;	// IMP=0x0000000100042c94
...
- (id)initWithPeerID:(id)arg1 signingIdentity:(id)arg2 encryptionIdentity:(id)arg3;	// IMP=0x0000000100042a00
