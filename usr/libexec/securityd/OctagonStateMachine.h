...
- (void).cxx_destruct;	// IMP=0x00000001000ee2bc
...
- (id)doWatchedStateMachineRPC:(id)arg1 sourceStates:(id)arg2 path:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x00000001000edc80
- (void)setWatcherTimeout:(unsigned long long)arg1;	// IMP=0x00000001000edc74
- (void)doSimpleStateMachineRPC:(id)arg1 op:(id)arg2 sourceStates:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x00000001000ed900
- (void)registerMultiStateArrivalWatcher:(id)arg1;	// IMP=0x00000001000ed850
- (void)registerStateTransitionWatcher:(id)arg1;	// IMP=0x00000001000ed7a0
- (void)handleExternalRequest:(id)arg1;	// IMP=0x00000001000ed6f0
- (void)haltOperation;	// IMP=0x00000001000ed644
- (void)startOperation;	// IMP=0x00000001000ed5c8
- (_Bool)isPaused;	// IMP=0x00000001000ed4f8
- (void)_onqueueSendAnyPendingFlags;	// IMP=0x00000001000ecd58
- (void)_onqueueRecheckConditions;	// IMP=0x00000001000ec8f0
- (id)possiblePendingFlags;	// IMP=0x00000001000ec89c
- (id)dumpPendingFlags;	// IMP=0x00000001000ec780
- (void)disablePendingFlags;	// IMP=0x00000001000ec704
- (void)_onqueueHandlePendingFlag:(id)arg1;	// IMP=0x00000001000ec480
- (void)handlePendingFlag:(id)arg1;	// IMP=0x00000001000ec3d0
- (void)_onqueueHandleFlag:(id)arg1;	// IMP=0x00000001000ec32c
- (void)handleFlag:(id)arg1;	// IMP=0x00000001000ec27c
- (void)_onqueuePokeStateMachine;	// IMP=0x00000001000ec22c
- (void)pokeStateMachine;	// IMP=0x00000001000ec1b0
- (id)createOperationToFinishAttempt:(id)arg1;	// IMP=0x00000001000ec038
- (void)_onqueueStartNextStateMachineOperation:(_Bool)arg1;	// IMP=0x00000001000ebc5c
- (id)_onqueueNextStateMachineTransition;	// IMP=0x00000001000eb854
- (id)waitForState:(id)arg1 wait:(unsigned long long)arg2;	// IMP=0x00000001000eb79c
@property(retain) NSString<OctagonStateString> *currentState;
@property(readonly) id <OctagonFlagContainer> flags;
- (id)description;	// IMP=0x00000001000eb470
- (id)pendingFlagsString;	// IMP=0x00000001000eb3ec
- (id)initWithName:(id)arg1 states:(id)arg2 flags:(id)arg3 initialState:(id)arg4 queue:(id)arg5 stateEngine:(id)arg6 lockStateTracker:(id)arg7;	// IMP=0x00000001000eaea8
