...
+ (id)pathFromDictionary:(id)arg1;	// IMP=0x00000001000acf10
- (void).cxx_destruct;	// IMP=0x00000001000acee0
...
- (id)asPathStep;	// IMP=0x00000001000acda8
- (id)initWithState:(id)arg1 pathStep:(id)arg2;	// IMP=0x00000001000acd04
