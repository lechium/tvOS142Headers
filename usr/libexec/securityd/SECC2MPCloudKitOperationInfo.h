...
- (void).cxx_destruct;	// IMP=0x000000010012c1ec
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010012c0c8
- (unsigned long long)hash;	// IMP=0x000000010012c018
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010012bee0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010012bde0
- (void)copyTo:(id)arg1;	// IMP=0x000000010012bd24
- (void)writeTo:(id)arg1;	// IMP=0x000000010012bc70
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010012bc68
- (id)dictionaryRepresentation;	// IMP=0x000000010012bb20
- (id)description;	// IMP=0x000000010012ba6c
