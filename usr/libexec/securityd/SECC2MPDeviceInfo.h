...
+ (Class)internalTestConfigType;	// IMP=0x000000010017a0c8
- (void).cxx_destruct;	// IMP=0x0000000100179bec
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100179830
- (unsigned long long)hash;	// IMP=0x00000001001796f8
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001794b0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001791cc
- (void)copyTo:(id)arg1;	// IMP=0x0000000100178fcc
- (void)writeTo:(id)arg1;	// IMP=0x0000000100178d98
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100178d90
- (id)dictionaryRepresentation;	// IMP=0x0000000100178a24
- (id)description;	// IMP=0x0000000100178970
- (id)internalTestConfigAtIndex:(unsigned long long)arg1;	// IMP=0x0000000100178958
- (unsigned long long)internalTestConfigsCount;	// IMP=0x0000000100178940
- (void)addInternalTestConfig:(id)arg1;	// IMP=0x00000001001788cc
- (void)clearInternalTestConfigs;	// IMP=0x00000001001788b4
