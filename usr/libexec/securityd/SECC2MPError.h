...
- (void).cxx_destruct;	// IMP=0x0000000100125798
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010012564c
- (unsigned long long)hash;	// IMP=0x00000001001255a8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100125470
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010012536c
- (void)copyTo:(id)arg1;	// IMP=0x00000001001252b4
- (void)writeTo:(id)arg1;	// IMP=0x000000010012520c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100125204
- (id)dictionaryRepresentation;	// IMP=0x00000001001250cc
- (id)description;	// IMP=0x0000000100125018
