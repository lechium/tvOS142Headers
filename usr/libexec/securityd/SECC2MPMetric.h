...
- (void).cxx_destruct;	// IMP=0x000000010009028c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010008ffb8
- (unsigned long long)hash;	// IMP=0x000000010008fe78
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010008fc68
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010008fa9c
- (void)copyTo:(id)arg1;	// IMP=0x000000010008f924
- (void)writeTo:(id)arg1;	// IMP=0x000000010008f7d0
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010008f1a4
- (id)dictionaryRepresentation;	// IMP=0x000000010008ee50
- (id)description;	// IMP=0x000000010008ed9c
...
- (int)StringAsMetricType:(id)arg1;	// IMP=0x000000010008eb70
- (id)metricTypeAsString:(int)arg1;	// IMP=0x000000010008eaf8
