...
- (void).cxx_destruct;	// IMP=0x000000010016a66c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100169ca8
- (unsigned long long)hash;	// IMP=0x0000000100169780
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100168ff0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010016892c
- (void)copyTo:(id)arg1;	// IMP=0x00000001001682ec
- (void)writeTo:(id)arg1;	// IMP=0x0000000100167d50
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100167d48
- (id)dictionaryRepresentation;	// IMP=0x00000001001671b8
- (id)description;	// IMP=0x0000000100167104
