...
+ (id)urlForSOSAccountSettings;	// IMP=0x0000000100194880
+ (unsigned int)ghostBustGetRampSettings;	// IMP=0x0000000100194878
+ (id)accountFromData:(id)arg1 factory:(struct SOSDataSourceFactory *)arg2 error:(id *)arg3;	// IMP=0x00000001001a2954
+ (id)accountFromDER:(const char **)arg1 end:(const char *)arg2 factory:(struct SOSDataSourceFactory *)arg3 error:(id *)arg4;	// IMP=0x00000001001a1c20
+ (void)performOnQuietAccountQueue:(CDUnknownBlockType)arg1;	// IMP=0x00000001001a5c38
- (void).cxx_destruct;	// IMP=0x000000010019147c
...
- (id)_onqueueNextStateMachineTransition:(id)arg1 flags:(id)arg2 pendingFlags:(id)arg3;	// IMP=0x0000000100190f58
- (id)performRingUpdate;	// IMP=0x0000000100190e70
- (id)performBackup;	// IMP=0x0000000100190d88
- (void)triggerRingUpdate;	// IMP=0x0000000100190cbc
- (void)triggerBackupForPeers:(id)arg1;	// IMP=0x0000000100190b64
- (void)addRingUpdateFlag;	// IMP=0x0000000100190ae8
- (void)addBackupFlag;	// IMP=0x0000000100190a6c
- (void)setupStateMachine;	// IMP=0x0000000100190520
- (void)_onQueueRecordRetiredPeersInCircle;	// IMP=0x00000001001903b8
- (_Bool)_onQueueEnsureInBackupRings;	// IMP=0x000000010018ff4c
- (_Bool)isInCircle:(struct __CFError **)arg1;	// IMP=0x000000010018fefc
- (int)getCircleStatus:(struct __CFError **)arg1;	// IMP=0x000000010018fe50
- (void)flattenToSaveBlock;	// IMP=0x000000010018fd90
- (void)setWatchdogParmeters:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x000000010018fc0c
- (void)getWatchdogParameters:(CDUnknownBlockType)arg1;	// IMP=0x000000010018fa74
- (void)rpcTriggerRingUpdate:(CDUnknownBlockType)arg1;	// IMP=0x000000010018fa1c
- (void)rpcTriggerBackup:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x000000010018f940
- (void)rpcTriggerSync:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x000000010018f758
- (void)importInitialSyncCredentials:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x000000010018f68c
- (void)initialSyncCredentials:(unsigned int)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x000000010018f248
- (void)joinCircleWithBlob:(id)arg1 version:(int)arg2 complete:(CDUnknownBlockType)arg3;	// IMP=0x000000010018f0e4
- (void)circleJoiningBlob:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x000000010018ee68
- (void)iCloudIdentityStatus_internal:(CDUnknownBlockType)arg1;	// IMP=0x000000010018ee54
- (void)iCloudIdentityStatus:(CDUnknownBlockType)arg1;	// IMP=0x000000010018ee40
- (_Bool)ghostBustCheckDate;	// IMP=0x000000010018ee38
- (void)ghostBustInfo:(CDUnknownBlockType)arg1;	// IMP=0x000000010018ee24
- (void)ghostBustTriggerTimed:(unsigned int)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x000000010018ee10
- (void)ghostBustPeriodic:(unsigned int)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x000000010018edfc
- (void)ghostBust:(unsigned int)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x000000010018ede8
- (void)ghostBustSchedule;	// IMP=0x000000010018ede4
- (void)ghostBustFollowup;	// IMP=0x000000010018ede0
- (id)ghostBustGetDate;	// IMP=0x000000010018edd8
- (void)circleHash:(CDUnknownBlockType)arg1;	// IMP=0x000000010018ecd8
- (void)myPeerInfo:(CDUnknownBlockType)arg1;	// IMP=0x000000010018eb9c
- (void)stashAccountCredential:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x000000010018eac8
- (void)validatedStashedAccountCredential:(CDUnknownBlockType)arg1;	// IMP=0x000000010018e9d0
- (_Bool)syncWaitAndFlush:(struct __CFError **)arg1;	// IMP=0x000000010018e714
- (void)assertStashedAccountCredential:(CDUnknownBlockType)arg1;	// IMP=0x000000010018e660
- (void)stashedCredentialPublicKey:(CDUnknownBlockType)arg1;	// IMP=0x000000010018e5ac
- (void)rateLimitingPerformanceCounters:(CDUnknownBlockType)arg1;	// IMP=0x000000010018e520
- (void)kvsPerformanceCounters:(CDUnknownBlockType)arg1;	// IMP=0x000000010018e47c
- (void)userPublicKey:(CDUnknownBlockType)arg1;	// IMP=0x000000010018e3c8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010018e110
- (void)startStateMachine;	// IMP=0x000000010018e0d0
- (id)initWithGestalt:(struct __CFDictionary *)arg1 factory:(struct SOSDataSourceFactory *)arg2;	// IMP=0x000000010018dca8
- (void)ensureOctagonPeerKeys;	// IMP=0x000000010018dbcc
- (_Bool)ensureFactoryCircles;	// IMP=0x000000010018d8a0
...
- (void)dealloc;	// IMP=0x000000010018d534
- (id)encodedData:(id *)arg1;	// IMP=0x00000001001a1ae8
- (void)performTransaction:(_Bool)arg1 action:(CDUnknownBlockType)arg2;	// IMP=0x00000001001a5af8
- (void)performTransaction:(CDUnknownBlockType)arg1;	// IMP=0x00000001001a5ae4
- (void)performTransaction_Locked:(_Bool)arg1 action:(CDUnknownBlockType)arg2;	// IMP=0x00000001001a5a50
- (void)performTransaction_Locked:(CDUnknownBlockType)arg1;	// IMP=0x00000001001a5a3c
