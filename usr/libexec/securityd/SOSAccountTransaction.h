...
- (void).cxx_destruct;	// IMP=0x00000001001a52d8
...
- (void)requestSyncWithPeers:(id)arg1;	// IMP=0x00000001001a514c
- (void)requestSyncWith:(id)arg1;	// IMP=0x00000001001a5084
- (void)finish;	// IMP=0x00000001001a3840
- (void)restart;	// IMP=0x00000001001a380c
- (void)start;	// IMP=0x00000001001a33e4
- (id)initWithAccount:(id)arg1 quiet:(_Bool)arg2;	// IMP=0x00000001001a3350
@property(readonly) NSString *description;
- (void)updateSOSCircleCachedStatus;	// IMP=0x00000001001a3080
- (unsigned long long)currentTrustBitmask;	// IMP=0x00000001001a2f78
