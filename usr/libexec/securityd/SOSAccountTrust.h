...
+ (id)trust;	// IMP=0x00000001001c5bfc
- (void).cxx_destruct;	// IMP=0x00000001001c5bc0
...
- (void)dealloc;	// IMP=0x00000001001c5984
- (id)initWithRetirees:(id)arg1 fpi:(struct __OpaqueSOSFullPeerInfo *)arg2 circle:(struct __OpaqueSOSCircle *)arg3 departureCode:(int)arg4 peerExpansion:(id)arg5;	// IMP=0x00000001001c588c
- (id)init;	// IMP=0x00000001001c5790
