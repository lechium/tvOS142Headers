...
- (id)initWithDefaults:(id)arg1 dateDescription:(id)arg2 earliest:(double)arg3 latest:(double)arg4;	// IMP=0x00000001001bf34c
- (void)schedule;	// IMP=0x00000001001bf300
- (void)followup;	// IMP=0x00000001001bf2b8
- (_Bool)checkDate;	// IMP=0x00000001001bf254
- (id)getDate;	// IMP=0x00000001001bf240
