...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001001b43b4
- (void).cxx_destruct;	// IMP=0x00000001001b4384
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001001b42f0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001001b420c
