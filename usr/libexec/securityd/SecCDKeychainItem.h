...
- (id)secretsFromEncryptedData:(id)arg1 withKeybag:(int)arg2 error:(id *)arg3;	// IMP=0x0000000100040614
- (id)encryptedSecretDataWithAttributeData:(id)arg1 keybag:(int)arg2 error:(id *)arg3;	// IMP=0x000000010003ff80
- (id)primaryKeyStringRepresentationWithError:(id *)arg1;	// IMP=0x000000010003fba8
- (id)primaryKeys;	// IMP=0x000000010003fb98
...
- (id)description;	// IMP=0x000000010003f9c4
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010003f8d4
- (id)initWithManagedItem:(id)arg1 keychain:(id)arg2 error:(id *)arg3;	// IMP=0x000000010003f5cc
- (id)initItemType:(id)arg1 withPersistentID:(id)arg2 attributes:(id)arg3 lookupAttributes:(id)arg4 secrets:(id)arg5 owner:(id)arg6 keyclass:(int)arg7;	// IMP=0x000000010003f464
