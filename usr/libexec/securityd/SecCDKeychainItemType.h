...
+ (id)itemTypeForVersion:(int)arg1;	// IMP=0x00000001000429f4
+ (id)itemType;	// IMP=0x00000001000429ec
- (void).cxx_destruct;	// IMP=0x00000001000429a4
...
- (id)managedItemTypeWithContext:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000427a8
@property(readonly, copy) NSArray *syncableKeys;
@property(readonly, copy) NSArray *primaryKeys;
- (id)debugDescription;	// IMP=0x00000001000426e4
- (id)description;	// IMP=0x00000001000426a0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000425ac
- (id)_initWithName:(id)arg1 version:(int)arg2 primaryKeys:(id)arg3 syncableKeys:(id)arg4;	// IMP=0x0000000100042488
