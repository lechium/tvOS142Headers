...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100039f8c
- (void).cxx_destruct;	// IMP=0x0000000100039f50
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100039ea8
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100039c48
- (id)initWithCiphertext:(id)arg1 wrappedKeyData:(id)arg2 refKeyBlob:(id)arg3;	// IMP=0x0000000100039b58
