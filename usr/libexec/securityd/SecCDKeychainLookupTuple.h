...
+ (id)lookupTupleWithManagedLookupEntry:(id)arg1;	// IMP=0x000000010003ead8
+ (id)lookupTupleWithKey:(id)arg1 value:(id)arg2;	// IMP=0x000000010003ea64
- (void).cxx_destruct;	// IMP=0x000000010003ea28
...
- (id)description;	// IMP=0x000000010003e8e4
- (unsigned long long)hash;	// IMP=0x000000010003e888
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010003e778
- (id)initWithKey:(id)arg1 value:(id)arg2;	// IMP=0x000000010003e5d4
