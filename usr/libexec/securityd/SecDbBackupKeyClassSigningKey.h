...
- (void).cxx_destruct;	// IMP=0x000000010009add4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010009ac5c
- (unsigned long long)hash;	// IMP=0x000000010009aba0
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010009aa3c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010009a910
- (void)copyTo:(id)arg1;	// IMP=0x000000010009a838
- (void)writeTo:(id)arg1;	// IMP=0x000000010009a774
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010009a4b0
- (id)dictionaryRepresentation;	// IMP=0x000000010009a378
- (id)description;	// IMP=0x000000010009a2c4
