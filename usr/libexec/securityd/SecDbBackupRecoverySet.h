...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010008bc38
- (unsigned long long)hash;	// IMP=0x000000010008bb7c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010008ba18
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010008b8ec
- (void)copyTo:(id)arg1;	// IMP=0x000000010008b814
- (void)writeTo:(id)arg1;	// IMP=0x000000010008b750
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010008b434
- (id)dictionaryRepresentation;	// IMP=0x000000010008b2d8
- (id)description;	// IMP=0x000000010008b224
