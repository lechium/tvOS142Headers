...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000b202c
- (void).cxx_destruct;	// IMP=0x00000001000b1ffc
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000b1ef0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000b1e38
