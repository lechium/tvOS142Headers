...
- (void).cxx_destruct;	// IMP=0x00000001000e0f34
...
- (id)initWithData:(id)arg1;	// IMP=0x00000001000e0dd8
- (id)initRefKeyWrappedKeyWithData:(id)arg1 refKeyBlob:(id)arg2;	// IMP=0x00000001000e0d00
- (id)initRegularWrappedKeyWithData:(id)arg1;	// IMP=0x00000001000e0c5c
