...
- (void).cxx_destruct;	// IMP=0x00000001000e14f4
...
- (id)initWithData:(id)arg1;	// IMP=0x00000001000e1134
- (id)initWithCiphertext:(id)arg1 wrappedKey:(id)arg2 tamperCheck:(id)arg3 error:(id *)arg4;	// IMP=0x00000001000e0f40
