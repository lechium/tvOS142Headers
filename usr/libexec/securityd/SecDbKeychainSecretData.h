...
- (void).cxx_destruct;	// IMP=0x00000001000e1a58
...
- (id)initWithData:(id)arg1;	// IMP=0x00000001000e1768
- (id)initWithCiphertext:(id)arg1 wrappedKey:(id)arg2 tamperCheck:(id)arg3 backupWrappedKey:(id)arg4 error:(id *)arg5;	// IMP=0x00000001000e1500
