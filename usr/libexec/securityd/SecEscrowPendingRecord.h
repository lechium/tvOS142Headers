...
+ (id)loadAllFromKeychain:(id *)arg1;	// IMP=0x000000010012729c
+ (id)loadFromKeychain:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100126fb0
- (void).cxx_destruct;	// IMP=0x0000000100182f2c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100182cdc
- (unsigned long long)hash;	// IMP=0x0000000100182b88
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010018296c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001827a4
- (void)copyTo:(id)arg1;	// IMP=0x0000000100182620
- (void)writeTo:(id)arg1;	// IMP=0x00000001001824c0
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100181eb8
- (id)dictionaryRepresentation;	// IMP=0x0000000100181c04
- (id)description;	// IMP=0x0000000100181b50
...
- (_Bool)escrowAttemptedWithinLastSeconds:(double)arg1;	// IMP=0x0000000100126efc
- (_Bool)deleteFromKeychain:(id *)arg1;	// IMP=0x0000000100126d04
- (_Bool)saveToKeychain:(id *)arg1;	// IMP=0x0000000100126720
