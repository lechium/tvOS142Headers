...
+ (id)managerObject;	// IMP=0x0000000100122b58
+ (id)c2MetricsEndpoint;	// IMP=0x00000001001229c4
- (void).cxx_destruct;	// IMP=0x0000000100122988
...
- (id)generateDeviceInfo;	// IMP=0x000000010012277c
- (id)gzipEncode:(id)arg1;	// IMP=0x00000001001225b8
- (id)requestForGenericEvent:(id)arg1;	// IMP=0x0000000100122344
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x0000000100121eec
- (id)getEvent:(id)arg1;	// IMP=0x0000000100121dec
- (void)sendEvent:(id)arg1 pushTopic:(id)arg2;	// IMP=0x0000000100121a74
- (void)submitEvent:(id)arg1;	// IMP=0x0000000100121a60
- (id)init;	// IMP=0x0000000100121954
