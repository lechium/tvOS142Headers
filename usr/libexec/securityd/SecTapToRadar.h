...
+ (_Bool)askUserIfTTR:(id)arg1;	// IMP=0x000000010001e654
+ (void)triggerTapToRadar:(id)arg1;	// IMP=0x000000010001e540
+ (void)disableTTRsEntirely;	// IMP=0x000000010001e53c
+ (_Bool)isRateLimited:(id)arg1;	// IMP=0x000000010001e534
+ (id)keyname:(id)arg1;	// IMP=0x000000010001e4b4
...
- (void)trigger;	// IMP=0x000000010001e1e8
- (void)clearRetryTimestamp;	// IMP=0x000000010001e164
- (void)updateRetryTimestamp;	// IMP=0x000000010001e084
- (_Bool)isRateLimited;	// IMP=0x000000010001df5c
- (id)initTapToRadar:(id)arg1 description:(id)arg2 radar:(id)arg3;	// IMP=0x000000010001ddf0
