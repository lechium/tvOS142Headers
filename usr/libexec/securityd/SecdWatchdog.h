...
+ (_Bool)triggerOSFaults;	// IMP=0x000000010000a930
+ (_Bool)watchdogrusage:(struct rusage_info_v5 *)arg1;	// IMP=0x000000010000a8fc
+ (id)watchdog;	// IMP=0x000000010000a888
- (void).cxx_destruct;	// IMP=0x000000010000a564
@property(readonly) _Bool diskUsageHigh; // @synthesize diskUsageHigh=_diskUsageHigh;
- (_Bool)setWatchdogParameters:(id)arg1 error:(id *)arg2;	// IMP=0x000000010000a2e0
- (id)watchdogParameters;	// IMP=0x000000010000a14c
- (void)activateTimer;	// IMP=0x0000000100009f7c
- (void)runWatchdog;	// IMP=0x0000000100009ca8
- (unsigned long long)secondsFromMachTime:(unsigned long long)arg1;	// IMP=0x0000000100009c3c
- (id)init;	// IMP=0x0000000100009bbc
