...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100174838
- (void).cxx_destruct;	// IMP=0x00000001001747fc
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100174600
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100174270
- (id)description;	// IMP=0x00000001001741fc
- (id)initWithEgoPeerID:(id)arg1 status:(unsigned long long)arg2 viablePeerCountsByModelID:(id)arg3 peerCountsByMachineID:(id)arg4 isExcluded:(_Bool)arg5 isLocked:(_Bool)arg6;	// IMP=0x0000000100173ffc
