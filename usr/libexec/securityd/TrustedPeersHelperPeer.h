...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100173ff4
- (void).cxx_destruct;	// IMP=0x0000000100173fac
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100173e2c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100173c2c
- (id)description;	// IMP=0x0000000100173b28
- (id)initWithPeerID:(id)arg1 signingSPKI:(id)arg2 encryptionSPKI:(id)arg3 viewList:(id)arg4;	// IMP=0x0000000100173a2c
