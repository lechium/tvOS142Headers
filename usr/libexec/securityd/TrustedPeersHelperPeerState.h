...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100173a24
- (void).cxx_destruct;	// IMP=0x00000001001739f4
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010017381c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001001736b4
- (id)description;	// IMP=0x000000010017356c
- (id)initWithPeerID:(id)arg1 isPreapproved:(_Bool)arg2 status:(unsigned long long)arg3 memberChanges:(_Bool)arg4 unknownMachineIDs:(_Bool)arg5 osVersion:(id)arg6;	// IMP=0x0000000100173498
