...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000862d0
- (unsigned long long)hash;	// IMP=0x0000000100086120
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100085e98
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100085c54
- (void)copyTo:(id)arg1;	// IMP=0x0000000100085a54
- (void)writeTo:(id)arg1;	// IMP=0x0000000100085884
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010008587c
- (id)dictionaryRepresentation;	// IMP=0x0000000100084ce0
- (id)description;	// IMP=0x0000000100084c2c
