...
- (void).cxx_destruct;	// IMP=0x00000001001d1ac8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001001d1878
- (unsigned long long)hash;	// IMP=0x00000001001d1724
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001d1500
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001d1338
- (void)copyTo:(id)arg1;	// IMP=0x00000001001d11b4
- (void)writeTo:(id)arg1;	// IMP=0x00000001001d1054
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001001d104c
- (id)dictionaryRepresentation;	// IMP=0x00000001001d0780
- (id)description;	// IMP=0x00000001001d06cc
