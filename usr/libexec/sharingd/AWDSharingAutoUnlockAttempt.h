...
- (void).cxx_destruct;	// IMP=0x00000001000f4acc
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000f41d0
- (unsigned long long)hash;	// IMP=0x00000001000f3ccc
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000f35d4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000f2f48
- (void)copyTo:(id)arg1;	// IMP=0x00000001000f2920
- (void)writeTo:(id)arg1;	// IMP=0x00000001000f2390
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000f2388
- (id)dictionaryRepresentation;	// IMP=0x00000001000efce0
- (id)description;	// IMP=0x00000001000efc2c
