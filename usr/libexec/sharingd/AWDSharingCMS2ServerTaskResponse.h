...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001001727b8
- (unsigned long long)hash;	// IMP=0x0000000100172704
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001725b8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001724a8
- (void)copyTo:(id)arg1;	// IMP=0x00000001001723b4
- (void)writeTo:(id)arg1;	// IMP=0x00000001001722c4
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001001722bc
- (id)dictionaryRepresentation;	// IMP=0x0000000100171bd8
