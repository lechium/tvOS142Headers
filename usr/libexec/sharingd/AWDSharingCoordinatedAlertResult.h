...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010015d404
- (unsigned long long)hash;	// IMP=0x000000010015d310
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010015d15c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010015cffc
- (void)copyTo:(id)arg1;	// IMP=0x000000010015ceb8
- (void)writeTo:(id)arg1;	// IMP=0x000000010015cd80
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010015cd78
- (id)dictionaryRepresentation;	// IMP=0x000000010015c478
- (id)description;	// IMP=0x000000010015c3c4
