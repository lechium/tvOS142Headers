...
- (void)service:(id)arg1 nearbyDevicesChanged:(id)arg2;	// IMP=0x000000010008465c
- (void)service:(id)arg1 devicesChanged:(id)arg2;	// IMP=0x00000001000844dc
- (void)nearbyServiceDevicesChanged:(id)arg1;	// IMP=0x0000000100084020
- (void)activityServiceDevicesChanged:(id)arg1;	// IMP=0x000000010008401c
- (id)idsDeviceFromBTIdentifier:(id)arg1;	// IMP=0x0000000100083cdc
- (void)stop;	// IMP=0x0000000100083cd8
- (_Bool)restart;	// IMP=0x0000000100083cd0
- (void)start;	// IMP=0x0000000100083ccc
- (id)init;	// IMP=0x0000000100083c30
