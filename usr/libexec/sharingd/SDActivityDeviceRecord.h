...
- (void).cxx_destruct;	// IMP=0x000000010004b5f4
...
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 isReplay:(_Bool)arg3 newAdvertisementHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000010004a6dc
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 newAdvertisementHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010004a680
- (id)description;	// IMP=0x000000010004a590
- (id)initWithDevice:(id)arg1;	// IMP=0x000000010004a4f4
