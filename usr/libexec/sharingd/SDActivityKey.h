...
- (void).cxx_destruct;	// IMP=0x00000001001211d8
...
- (unsigned long long)hash;	// IMP=0x0000000100120fdc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100120f04
- (id)description;	// IMP=0x0000000100120e00
- (void)dealloc;	// IMP=0x0000000100120d48
- (id)initWithDictRepresentation:(id)arg1;	// IMP=0x0000000100120b54
