...
- (void).cxx_destruct;	// IMP=0x00000001000b378c
...
- (void)dealloc;	// IMP=0x00000001000b3690
- (void)stop;	// IMP=0x00000001000b3638
- (void)start;	// IMP=0x00000001000b35b4
- (void)networkOperation:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x00000001000b32bc
- (id)init;	// IMP=0x00000001000b3268
