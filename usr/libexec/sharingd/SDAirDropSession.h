...
- (void).cxx_destruct;	// IMP=0x0000000100038370
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000100037f7c
- (void)handleConversionProgress:(id)arg1;	// IMP=0x0000000100037e8c
- (void)startProgress;	// IMP=0x0000000100037be0
- (void)postNotificationForTransferStatus:(long long)arg1 progress:(double)arg2;	// IMP=0x0000000100037bdc
- (void)airDropClient:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x000000010003746c
- (void)removeClientAlerts;	// IMP=0x0000000100037344
- (void)dealloc;	// IMP=0x00000001000372b8
- (void)stop;	// IMP=0x0000000100037124
- (void)addClientForNode:(struct __SFNode *)arg1 shouldPublishProgress:(_Bool)arg2;	// IMP=0x0000000100036e18
- (void)serversChanged:(id)arg1;	// IMP=0x0000000100036b40
- (_Bool)send;	// IMP=0x0000000100036a14
- (void)start;	// IMP=0x0000000100036824
- (void)releaseSandboxExtensions;	// IMP=0x0000000100036710
- (void)consumeSandboxExtensions;	// IMP=0x00000001000364a4
- (void)setProperty:(id)arg1 forKey:(id)arg2;	// IMP=0x000000010003643c
- (id)initWithPerson:(struct __SFNode *)arg1 items:(id)arg2 sandboxExtensions:(id)arg3;	// IMP=0x0000000100036248
