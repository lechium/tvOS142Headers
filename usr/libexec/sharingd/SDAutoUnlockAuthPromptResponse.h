...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010005454c
- (unsigned long long)hash;	// IMP=0x0000000100054498
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010005435c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100054264
- (void)copyTo:(id)arg1;	// IMP=0x000000010005419c
- (void)writeTo:(id)arg1;	// IMP=0x00000001000540e4
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000540dc
- (id)dictionaryRepresentation;	// IMP=0x0000000100053b98
- (id)description;	// IMP=0x0000000100053ae4
