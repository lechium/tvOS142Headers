...
- (void).cxx_destruct;	// IMP=0x000000010015f080
...
- (id)peerListFromAWDLInfo:(id)arg1;	// IMP=0x000000010015e714
- (void)sendData:(id)arg1 bleDevice:(id)arg2 direct:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000010015e224
- (void)sendData:(id)arg1 bleDevice:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010015e1b4
- (void)sendAWDLInfo:(_Bool)arg1;	// IMP=0x000000010015da84
- (void)sendAWDLInfo;	// IMP=0x000000010015da74
- (void)sendData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010015d9ac
- (void)sendData:(id)arg1 type:(unsigned short)arg2 errorHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010015d890
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010015d838
- (void)_start;	// IMP=0x000000010015d82c
- (void)start;	// IMP=0x000000010015d7a0
- (id)getAppName;	// IMP=0x000000010015d798
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x000000010015d794
- (void)connectionActivated;	// IMP=0x000000010015d790
- (void)invalidate;	// IMP=0x000000010015d680
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x000000010015d5b8
