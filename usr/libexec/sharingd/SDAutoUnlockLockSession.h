...
- (void).cxx_destruct;	// IMP=0x00000001001ce328
...
- (void)sendUnlockConfirmation:(_Bool)arg1 withError:(id)arg2;	// IMP=0x00000001001cd418
- (void)sendKeyExchangeResponseWithData:(id)arg1;	// IMP=0x00000001001cd118
- (void)sendAuthPromptImageDataIfReady:(id)arg1;	// IMP=0x00000001001cc980
- (void)sendAuthPromptRequestWithImageHash:(id)arg1 appName:(id)arg2;	// IMP=0x00000001001cc560
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000001001cc258
- (void)consumeAuthTokenIfReady;	// IMP=0x00000001001cbcdc
- (void)startAWDL;	// IMP=0x00000001001cb148
- (void)handleConfirmationACK;	// IMP=0x00000001001caee8
- (void)handleSessionAuthToken:(id)arg1;	// IMP=0x00000001001caab4
- (void)handleSessionKeyExchangeRequest:(id)arg1;	// IMP=0x00000001001ca2b0
- (void)handleAuthPromptResponse:(id)arg1;	// IMP=0x00000001001c9f44
- (void)handleAWDLInfo:(id)arg1;	// IMP=0x00000001001c98bc
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x00000001001c9418
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x00000001001c91c8
- (void)handleWiFiRequestInvalidated;	// IMP=0x00000001001c915c
- (void)handleRangingStarted;	// IMP=0x00000001001c90bc
- (void)handlePeerFound:(_Bool)arg1;	// IMP=0x00000001001c8ff4
- (void)handleAWDLUp;	// IMP=0x00000001001c8e20
- (void)handlePeerOutOfRange;	// IMP=0x00000001001c8b48
- (void)handlePeerInRange;	// IMP=0x00000001001c89f0
- (_Bool)peerInRange:(id)arg1;	// IMP=0x00000001001c873c
- (void)handleRangingResults:(id)arg1 errorCode:(long long)arg2;	// IMP=0x00000001001c82dc
- (void)invalidateConfirmationTimer;	// IMP=0x00000001001c8204
- (void)restartConfirmationTimer:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x00000001001c7f80
- (void)handleTimerFired;	// IMP=0x00000001001c7a18
- (void)invalidateTimerIfReady;	// IMP=0x00000001001c79c0
- (id)aksPeerAvailable;	// IMP=0x00000001001c77b8
- (void)deviceConnected:(id)arg1;	// IMP=0x00000001001c73d0
- (_Bool)handleFoundBLEDevice:(id)arg1 available:(_Bool)arg2 lockedOnWrist:(_Bool)arg3;	// IMP=0x00000001001c70d8
- (_Bool)handleFoundBLEDevice:(id)arg1;	// IMP=0x00000001001c706c
- (void)connectionActivated;	// IMP=0x00000001001c6d50
- (void)updateImageData:(id)arg1 imageHash:(id)arg2;	// IMP=0x00000001001c6734
- (id)getAppName;	// IMP=0x00000001001c672c
@property(readonly, nonatomic) _Bool usingProxy;
- (id)hintToken;	// IMP=0x00000001001c65f8
- (_Bool)isAcceptor;	// IMP=0x00000001001c65f0
- (id)attemptResults;	// IMP=0x00000001001c5a28
- (void)logResults;	// IMP=0x00000001001c4c10
- (void)displayConfigChanged:(id)arg1;	// IMP=0x00000001001c4b6c
- (void)clamshellStateChanged:(id)arg1;	// IMP=0x00000001001c4ac8
- (void)removeObservers;	// IMP=0x00000001001c4a78
- (void)addObservers;	// IMP=0x00000001001c4970
- (void)handleDecryptionFailure:(long long)arg1;	// IMP=0x00000001001c4808
- (void)_handleCanceledAfterSuccess;	// IMP=0x00000001001c4700
- (void)handleCanceledAfterSuccess;	// IMP=0x00000001001c4674
- (void)lockKeyBagIfNeeded;	// IMP=0x00000001001c4590
- (void)_cancel;	// IMP=0x00000001001c421c
- (void)cancel;	// IMP=0x00000001001c4190
- (void)invalidateNoDisconnect;	// IMP=0x00000001001c415c
- (void)invalidate;	// IMP=0x00000001001c3f58
- (id)initWithAutoUnlockDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x00000001001c3b64
