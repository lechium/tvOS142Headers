...
- (void).cxx_destruct;	// IMP=0x0000000100048f88
...
- (void)transport:(id)arg1 didReceivePayload:(id)arg2 type:(unsigned short)arg3 deviceID:(id)arg4;	// IMP=0x0000000100048cd0
- (void)sendSetupCreateEscrowRecordStepData:(id)arg1 error:(id)arg2;	// IMP=0x00000001000489d8
- (void)sendSetupSessionCreatedWithLocalKey:(id)arg1 stepData:(id)arg2 error:(id)arg3 failureReason:(unsigned int)arg4 ltkSyncing:(id)arg5;	// IMP=0x0000000100048308
- (void)sendKeyDeviceLocked;	// IMP=0x000000010004817c
- (void)handleCreateEscrowSecret:(id)arg1;	// IMP=0x0000000100047bc0
- (void)handleSetupRequest;	// IMP=0x0000000100047bbc
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x0000000100047a80
- (void)watchLTKsChanged:(id)arg1;	// IMP=0x00000001000475ac
- (void)keyBagLockStateChange:(id)arg1;	// IMP=0x00000001000475a8
- (void)addObservers;	// IMP=0x00000001000474e4
- (void)handleTimerFired;	// IMP=0x00000001000472e4
- (_Bool)ltkHashMatches;	// IMP=0x0000000100047180
- (_Bool)canCreatePairing;	// IMP=0x0000000100047178
- (void)onqueue_cancel;	// IMP=0x0000000100047058
- (void)cancel;	// IMP=0x0000000100046fcc
- (void)onqueue_start;	// IMP=0x0000000100046f34
- (void)start;	// IMP=0x0000000100046ea8
- (void)invalidate;	// IMP=0x0000000100046d60
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x0000000100046cdc
