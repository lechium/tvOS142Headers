...
- (void).cxx_destruct;	// IMP=0x0000000100052fb4
...
- (id)userInfoForNewProtocol;	// IMP=0x0000000100052a70
- (id)userInfoForOldProtocol;	// IMP=0x0000000100052978
- (id)userInfoForNoCommunincation;	// IMP=0x0000000100052880
- (id)userInfoForNoPasscode;	// IMP=0x0000000100052788
- (id)userInfoForNoWristDetection;	// IMP=0x0000000100052690
- (id)userInfoForNoWristDetectionNoPasscode;	// IMP=0x0000000100052598
- (id)userInfoCompanionViewNotSyncing;	// IMP=0x00000001000524a0
- (id)userInfoForWatchLocked;	// IMP=0x00000001000523a8
- (id)userInfoForNotCloudPaired;	// IMP=0x00000001000522f8
- (id)userInfoForMacNotSignedIn;	// IMP=0x0000000100052200
- (id)userInfoForWatchNotSignedIn;	// IMP=0x0000000100052108
- (id)userInfoForMissingLTK;	// IMP=0x0000000100052010
- (id)userInfoForInternetSharing;	// IMP=0x0000000100051f18
- (id)userInfoForKeychainMismatch;	// IMP=0x0000000100051e20
- (id)userInfoForiPhoneNeedsUnlock;	// IMP=0x0000000100051d28
- (void)transport:(id)arg1 didReceiveMessageACKForIdentifier:(id)arg2;	// IMP=0x0000000100051b14
- (void)transport:(id)arg1 didReceivePayload:(id)arg2 type:(unsigned short)arg3 deviceID:(id)arg4;	// IMP=0x0000000100051804
- (void)sendCreateEscrowSecretWithStepData:(id)arg1 sessionID:(unsigned int)arg2;	// IMP=0x0000000100051428
- (void)sendSetupRequest;	// IMP=0x0000000100050f2c
- (void)handleSuccessfulPairing;	// IMP=0x00000001000508c4
- (void)handleSetupCreateRecord:(id)arg1;	// IMP=0x0000000100050184
- (void)handleEscrowSessionRequest;	// IMP=0x000000010004f80c
- (void)handleSetupSessionCreated:(id)arg1;	// IMP=0x000000010004eed8
- (void)handleKeyDeviceLocked;	// IMP=0x000000010004edcc
- (_Bool)ltkHashMatches;	// IMP=0x000000010004eca4
- (void)handleLTKTimerFired;	// IMP=0x000000010004ea00
- (void)invalidateLTKTimer;	// IMP=0x000000010004e928
- (void)restartLTKTimer;	// IMP=0x000000010004e718
- (void)notifyDelegateKeyDeviceIsLocked;	// IMP=0x000000010004e674
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x000000010004df04
- (_Bool)validatePasscode:(id)arg1;	// IMP=0x000000010004dd84
- (void)handleTimerFired;	// IMP=0x000000010004db9c
- (id)generatedError;	// IMP=0x000000010004da40
- (void)invalidate;	// IMP=0x000000010004d930
- (void)onqueue_updateForCloudPairing;	// IMP=0x000000010004d8c4
- (void)updateForCloudPairing;	// IMP=0x000000010004d838
- (void)onqueue_cancel;	// IMP=0x000000010004d708
- (void)cancel;	// IMP=0x000000010004d67c
- (void)onqueue_start;	// IMP=0x000000010004d05c
- (void)start;	// IMP=0x000000010004cfd0
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x000000010004cc0c
