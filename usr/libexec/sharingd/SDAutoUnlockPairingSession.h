...
- (void).cxx_destruct;	// IMP=0x000000010003a348
...
- (void)handleTimerFired;	// IMP=0x000000010003a168
- (void)invalidateResponseTimer;	// IMP=0x000000010003a090
- (void)restartResponseTimer:(unsigned long long)arg1;	// IMP=0x0000000100039e94
- (id)dataFromUUID:(id)arg1;	// IMP=0x0000000100039e14
- (id)wrapPayload:(id)arg1 withType:(unsigned short)arg2 useProxy:(_Bool)arg3 senderID:(id)arg4;	// IMP=0x0000000100039c44
- (id)wrapPayload:(id)arg1 withType:(unsigned short)arg2;	// IMP=0x0000000100039c30
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x0000000100039c2c
- (void)start;	// IMP=0x0000000100039c28
- (void)invalidate;	// IMP=0x0000000100039aa4
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x00000001000399a8
- (id)init;	// IMP=0x0000000100039940
