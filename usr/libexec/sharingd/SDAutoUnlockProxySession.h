...
- (void).cxx_destruct;	// IMP=0x00000001000c2ed4
...
- (void)sendProxyTrigger;	// IMP=0x00000001000c29e8
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x00000001000c2914
- (void)handleFoundBLEDevice:(id)arg1;	// IMP=0x00000001000c26a4
- (void)deviceConnected:(id)arg1;	// IMP=0x00000001000c252c
- (id)results;	// IMP=0x00000001000c23ac
- (void)removeObservers;	// IMP=0x00000001000c235c
- (void)addObservers;	// IMP=0x00000001000c22f4
- (void)invalidate;	// IMP=0x00000001000c220c
- (void)_start;	// IMP=0x00000001000c2154
- (void)start;	// IMP=0x00000001000c20c8
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x00000001000c1ffc
