...
- (void).cxx_destruct;	// IMP=0x00000001000df590
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000df2ac
- (unsigned long long)hash;	// IMP=0x00000001000df130
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000deebc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000deca4
- (void)copyTo:(id)arg1;	// IMP=0x00000001000deae8
- (void)writeTo:(id)arg1;	// IMP=0x00000001000de958
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000de950
- (id)dictionaryRepresentation;	// IMP=0x00000001000de0d8
- (id)description;	// IMP=0x00000001000de024
