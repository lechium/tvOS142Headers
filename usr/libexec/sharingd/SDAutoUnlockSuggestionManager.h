...
- (void).cxx_destruct;	// IMP=0x000000010017f380
...
- (void)_systemHasPoweredOn;	// IMP=0x000000010017f1ec
- (void)_systemWillSleep;	// IMP=0x000000010017f184
- (_Bool)alwaysShowSetupRetry;	// IMP=0x000000010017f15c
- (id)testDeviceID;	// IMP=0x000000010017f140
- (_Bool)ignoreBackOff;	// IMP=0x000000010017f118
- (_Bool)suggestionsEnabled;	// IMP=0x000000010017f0f0
- (void)setRetriedSetup;	// IMP=0x000000010017f09c
- (_Bool)retriedSetup;	// IMP=0x000000010017efa4
- (void)loadSuggestedPeers;	// IMP=0x000000010017eed4
- (void)setFeatureSuggestedForDeviceID:(id)arg1;	// IMP=0x000000010017ed20
- (_Bool)featureSuggestedForDeviceID:(id)arg1;	// IMP=0x000000010017eca8
- (void)updateDefaultsForDeviceID:(id)arg1;	// IMP=0x000000010017e934
- (_Bool)canSuggestForDeviceID:(id)arg1;	// IMP=0x000000010017e6d4
- (_Bool)shouldSendRequestsForDeviceID:(id)arg1;	// IMP=0x000000010017e588
- (void)watchAvailableForUnlockWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010017e578
- (void)transport:(id)arg1 didReceivePayload:(id)arg2 type:(unsigned short)arg3 deviceID:(id)arg4;	// IMP=0x000000010017e200
- (void)sendStartAdvertisingToDeviceID:(id)arg1;	// IMP=0x000000010017e024
- (void)invalidateScanTimer;	// IMP=0x000000010017df4c
- (void)restartScanTimer:(unsigned long long)arg1;	// IMP=0x000000010017dd60
- (void)invalidateScanner;	// IMP=0x000000010017dc1c
- (void)handleFoundPeer:(id)arg1;	// IMP=0x000000010017d804
- (void)startScanningForIDSDeviceIDs:(id)arg1;	// IMP=0x000000010017d008
- (void)invalidateServiceTimer;	// IMP=0x000000010017cf30
- (void)restartServiceTimer:(unsigned long long)arg1;	// IMP=0x000000010017cd2c
- (void)invalidateSuggestionService;	// IMP=0x000000010017ccc8
- (void)updateSuggestionService;	// IMP=0x000000010017cc58
- (void)invalidateSuggestedDeviceTimer;	// IMP=0x000000010017cb80
- (void)restartSuggestedDeviceTimer:(long long)arg1;	// IMP=0x000000010017c958
- (void)postSuggestionNotification;	// IMP=0x000000010017c7cc
- (void)postNotificationIfNeeded;	// IMP=0x000000010017c5d8
- (void)invalidateSetupRetryDeviceTimer;	// IMP=0x000000010017c500
- (void)restartSetupRetryDeviceTimer:(long long)arg1;	// IMP=0x000000010017c2d8
- (void)setupRetryNotificationDismissed;	// IMP=0x000000010017c1ec
- (void)setupRetryNotificationSetUpSelected;	// IMP=0x000000010017c1e8
- (void)setupRetryIfNeeded;	// IMP=0x000000010017bfa4
- (void)screenLockUnlocked:(id)arg1;	// IMP=0x000000010017bee0
- (void)triggerDevicesIfNeeded;	// IMP=0x000000010017bedc
- (void)handleTestSuggestion;	// IMP=0x000000010017bde4
- (void)addObservers;	// IMP=0x000000010017bd48
- (id)init;	// IMP=0x000000010017bc2c
