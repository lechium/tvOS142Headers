...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100056460
- (unsigned long long)hash;	// IMP=0x0000000100056374
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000561f4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010005609c
- (void)copyTo:(id)arg1;	// IMP=0x0000000100055f88
- (void)writeTo:(id)arg1;	// IMP=0x0000000100055e84
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100055e7c
- (id)dictionaryRepresentation;	// IMP=0x0000000100055808
- (id)description;	// IMP=0x0000000100055754
