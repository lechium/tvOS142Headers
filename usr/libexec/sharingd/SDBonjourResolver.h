...
- (void).cxx_destruct;	// IMP=0x00000001001c394c
...
- (void)cancel;	// IMP=0x00000001001c3850
- (void)resolve;	// IMP=0x00000001001c33e0
- (void)parseResults:(const char *)arg1 port:(unsigned short)arg2 txtLen:(unsigned short)arg3 txtRecord:(const char *)arg4 interface:(unsigned int)arg5;	// IMP=0x00000001001c3028
- (void)notifyClient:(int)arg1;	// IMP=0x00000001001c2fd8
- (void)dealloc;	// IMP=0x00000001001c2f8c
- (id)initWithName:(id)arg1 type:(id)arg2 domain:(id)arg3 path:(id)arg4 timeout:(_Bool)arg5;	// IMP=0x00000001001c2e4c
