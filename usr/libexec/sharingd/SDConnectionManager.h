...
+ (id)sharedManager;	// IMP=0x00000001000daa78
- (void).cxx_destruct;	// IMP=0x00000001000dbc2c
...
- (void)unlockSessionDidFinish:(id)arg1;	// IMP=0x00000001000dbad0
- (void)companionStreamClosedStreams:(id)arg1;	// IMP=0x00000001000dbac0
- (void)appleAccountSignedOut;	// IMP=0x00000001000dba40
- (void)appleAccountSignedIn;	// IMP=0x00000001000db9c0
- (void)createUnlockManagerWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000001000db938
- (void)createStreamsForMessage:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000001000db670
- (void)createCompanionServiceManagerWithIdentifier:(id)arg1 clientProxy:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x00000001000db2f8
- (void)cleanUpConnections;	// IMP=0x00000001000db058
- (void)start;	// IMP=0x00000001000dac3c
- (id)initWithXPCConnection:(id)arg1;	// IMP=0x00000001000daae4
