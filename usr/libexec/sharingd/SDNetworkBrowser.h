...
- (void).cxx_destruct;	// IMP=0x000000010005a508
...
- (void)invalidate;	// IMP=0x000000010005a2fc
- (int)closeNode:(struct __SFNode *)arg1;	// IMP=0x000000010005a274
- (int)removeNode:(struct __SFNode *)arg1;	// IMP=0x000000010005a20c
- (int)addNode:(struct __SFNode *)arg1;	// IMP=0x000000010005a1a4
@property(copy) NSDictionary *options;
@property long long mode;
- (id)sidebarChildren;	// IMP=0x000000010005a070
- (id)childrenForNode:(struct __SFNode *)arg1;	// IMP=0x000000010005a000
- (struct __SFNode *)copyRootNode;	// IMP=0x0000000100059ff0
- (int)openNode:(struct __SFNode *)arg1 forProtocol:(id)arg2 flags:(unsigned long long)arg3;	// IMP=0x0000000100059e70
- (void)nodeBrowser:(id)arg1 nodesChangedForParent:(struct __SFNode *)arg2 protocol:(id)arg3 error:(int)arg4;	// IMP=0x0000000100059df8
- (void)dealloc;	// IMP=0x0000000100059d94
- (id)initWithKind:(id)arg1 rootNode:(struct __SFNode *)arg2;	// IMP=0x0000000100059cb4
