...
- (void).cxx_destruct;	// IMP=0x0000000100104eb4
...
- (void)stop;	// IMP=0x0000000100104e20
- (int)start;	// IMP=0x0000000100104d70
- (void)eject;	// IMP=0x0000000100104b3c
- (void)ejectMountPoints:(id)arg1 useAssistant:(_Bool)arg2;	// IMP=0x0000000100104b38
- (void)notifyClientAboutEject:(int)arg1;	// IMP=0x00000001001049b8
- (void)dealloc;	// IMP=0x0000000100104970
- (id)initWithNode:(struct __SFNode *)arg1;	// IMP=0x00000001001048fc
