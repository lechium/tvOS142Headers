...
- (void).cxx_destruct;	// IMP=0x00000001000c9738
...
- (void)invalidate;	// IMP=0x00000001000c9454
- (void)resume;	// IMP=0x00000001000c89e4
- (void)notifyClientWithPosixError:(long long)arg1;	// IMP=0x00000001000c8884
- (void)airDropConnection:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x00000001000c881c
- (void)networkResolver:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x00000001000c87b4
- (void)networkEjecter:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x00000001000c874c
- (void)airDropServer:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x00000001000c86e4
- (void)airDropSession:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x00000001000c867c
- (void)airDropController:(id)arg1 didChange:(id)arg2;	// IMP=0x00000001000c8618
- (void)airDropInformation:(id)arg1 didChange:(id)arg2;	// IMP=0x00000001000c85b4
- (void)airDropStatus:(id)arg1 didChange:(id)arg2;	// IMP=0x00000001000c8550
- (const void *)copyPropertyForKey:(id)arg1;	// IMP=0x00000001000c84d4
- (void)setProperty:(void *)arg1 forKey:(id)arg2;	// IMP=0x00000001000c83fc
- (void)dealloc;	// IMP=0x00000001000c83b0
- (id)initWithKind:(id)arg1;	// IMP=0x00000001000c82e0
