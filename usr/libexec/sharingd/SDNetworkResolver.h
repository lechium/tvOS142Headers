...
- (void).cxx_destruct;	// IMP=0x00000001000c6a9c
...
- (void)stop;	// IMP=0x00000001000c69f8
- (int)start;	// IMP=0x00000001000c6710
- (void)mount;	// IMP=0x00000001000c670c
- (void)bonjourResolverDidChange:(id)arg1;	// IMP=0x00000001000c6454
- (void)mountDiskImageAsync;	// IMP=0x00000001000c6450
- (void)notifyClientAboutResolve:(int)arg1;	// IMP=0x00000001000c631c
- (void)dealloc;	// IMP=0x00000001000c62d4
- (id)initWithNode:(struct __SFNode *)arg1;	// IMP=0x00000001000c6254
