...
- (void).cxx_destruct;	// IMP=0x000000010015afc8
...
- (void)companionStreamClosedStreams:(id)arg1;	// IMP=0x000000010015af48
- (void)manager:(id)arg1 connectedToService:(id)arg2 withFileHandle:(id)arg3 acceptHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000010015ad28
- (void)disableService:(id)arg1;	// IMP=0x000000010015aca0
- (void)enableService:(id)arg1;	// IMP=0x000000010015ac1c
- (id)streamHandlerForService:(id)arg1;	// IMP=0x000000010015abb8
- (void)stop;	// IMP=0x000000010015a9cc
- (void)start;	// IMP=0x000000010015a97c
- (id)initWithClientProxy:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x000000010015a874
