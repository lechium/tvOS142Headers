...
- (void).cxx_destruct;	// IMP=0x0000000100127c7c
...
- (id)trimHeader:(id)arg1;	// IMP=0x0000000100127a04
- (unsigned int)parseHeader:(id)arg1;	// IMP=0x0000000100127964
- (void)handleMessageWritten:(id)arg1;	// IMP=0x000000010012787c
- (void)handleSpaceForMessage;	// IMP=0x0000000100127398
- (void)resetReadState;	// IMP=0x0000000100127354
- (void)handleMessageRead;	// IMP=0x00000001001272e4
- (void)handleHeaderRead;	// IMP=0x00000001001271b0
- (void)handleBytesForMessage;	// IMP=0x0000000100126ed8
- (id)headerWithLength:(unsigned int)arg1;	// IMP=0x0000000100126e64
- (id)messageWithData:(id)arg1;	// IMP=0x0000000100126de8
- (void)sendMessage:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100126aec
- (void)sendMessage:(id)arg1 withErrorHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100126aa4
- (void)handleSpaceForStream;	// IMP=0x000000010012678c
- (void)handleBytesForStream;	// IMP=0x00000001001264f4
- (void)writeToStreamWithData:(id)arg1;	// IMP=0x0000000100126364
- (void)handleSpaceAvailable;	// IMP=0x0000000100126240
- (void)handleBytesAvailable;	// IMP=0x000000010012611c
- (void)handleOpenedStream:(id)arg1;	// IMP=0x0000000100125f20
- (void)setTCPProperties:(id)arg1;	// IMP=0x0000000100125e2c
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x0000000100125cc8
- (_Bool)evaluateCert;	// IMP=0x0000000100125a0c
- (void)applySSLSettings:(id)arg1;	// IMP=0x00000001001256e0
- (void)invalidateOpenTimer;	// IMP=0x000000010012564c
- (void)openTimerFired:(id)arg1;	// IMP=0x0000000100125478
- (void)startOpenTimer;	// IMP=0x000000010012538c
- (void)logTransfer;	// IMP=0x00000001001251c4
@property _Bool shouldReadNetwork; // @synthesize shouldReadNetwork=_shouldReadNetwork;
- (void)_stop;	// IMP=0x0000000100124e98
- (void)stopIfReady;	// IMP=0x0000000100124e48
- (void)stop;	// IMP=0x0000000100124df8
- (void)start;	// IMP=0x0000000100124af0
- (void)dealloc;	// IMP=0x0000000100124a1c
- (id)initWithInputStream:(id)arg1 outputStream:(id)arg2 isClient:(_Bool)arg3;	// IMP=0x0000000100124878
