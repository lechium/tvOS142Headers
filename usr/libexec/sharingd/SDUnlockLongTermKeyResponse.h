...
- (void).cxx_destruct;	// IMP=0x000000010017b930
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010017b804
- (unsigned long long)hash;	// IMP=0x000000010017b74c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010017b614
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010017b514
- (void)copyTo:(id)arg1;	// IMP=0x000000010017b450
- (void)writeTo:(id)arg1;	// IMP=0x000000010017b39c
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010017b394
- (id)dictionaryRepresentation;	// IMP=0x000000010017af08
- (id)description;	// IMP=0x000000010017ae54
