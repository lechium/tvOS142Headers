...
- (void).cxx_destruct;	// IMP=0x00000001000dcbb0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000dca50
- (unsigned long long)hash;	// IMP=0x00000001000dc978
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000dc810
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000dc6ec
- (void)copyTo:(id)arg1;	// IMP=0x00000001000dc604
- (void)writeTo:(id)arg1;	// IMP=0x00000001000dc530
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000dc528
- (id)dictionaryRepresentation;	// IMP=0x00000001000dbfa4
- (id)description;	// IMP=0x00000001000dbef0
