...
- (void).cxx_destruct;	// IMP=0x0000000100160c24
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010016099c
- (unsigned long long)hash;	// IMP=0x000000010016082c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001605f4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100160404
- (void)copyTo:(id)arg1;	// IMP=0x0000000100160258
- (void)writeTo:(id)arg1;	// IMP=0x00000001001600d4
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001001600cc
- (id)dictionaryRepresentation;	// IMP=0x000000010015f728
- (id)description;	// IMP=0x000000010015f674
