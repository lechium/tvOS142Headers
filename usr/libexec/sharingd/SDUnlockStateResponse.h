...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000f5c80
- (unsigned long long)hash;	// IMP=0x00000001000f5c0c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000f5b10
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000f5a50
- (void)copyTo:(id)arg1;	// IMP=0x00000001000f59ac
- (void)writeTo:(id)arg1;	// IMP=0x00000001000f5904
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000f58fc
- (id)dictionaryRepresentation;	// IMP=0x00000001000f5404
- (id)description;	// IMP=0x00000001000f5350
