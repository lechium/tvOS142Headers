...
- (void).cxx_destruct;	// IMP=0x0000000100133d00
...
- (void)stop;	// IMP=0x0000000100133c78
- (void)start;	// IMP=0x0000000100133b78
- (void)bonjourNodesDidChange:(id)arg1;	// IMP=0x0000000100133b3c
@property(readonly, copy) NSArray *nodes;
- (void)dealloc;	// IMP=0x0000000100133ae0
- (id)initWithWorkgroup:(id)arg1;	// IMP=0x0000000100133a5c
