...
+ (id)sharedSession;	// IMP=0x00000001000ccf28
- (void).cxx_destruct;	// IMP=0x00000001000cd1f4
...
- (void)connectionManagerDidInvalidate:(id)arg1;	// IMP=0x00000001000cd1bc
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00000001000cd11c
- (void)stop;	// IMP=0x00000001000cd0c4
- (void)start;	// IMP=0x00000001000cd004
- (id)init;	// IMP=0x00000001000ccf94
