...
- (void).cxx_destruct;	// IMP=0x000000010009d814
...
- (_Bool)stateIsNearby;	// IMP=0x000000010009d498
- (_Bool)stateIsMedium;	// IMP=0x000000010009d454
- (_Bool)stateIsClose;	// IMP=0x000000010009d440
- (void)resetTicks;	// IMP=0x000000010009d294
@property(readonly, copy, nonatomic) NSString *name;
@property(readonly, copy, nonatomic) NSString *effectiveID;
@property(readonly, nonatomic) _Bool isReady;
- (_Bool)_canTransition:(int)arg1;	// IMP=0x000000010009cf50
- (_Bool)canTransition:(int)arg1;	// IMP=0x000000010009ce54
- (id)description;	// IMP=0x000000010009cab8
