...
- (void).cxx_destruct;	// IMP=0x0000000100011d40
@property(readonly, getter=isManaging) _Bool managing; // @synthesize managing=_managing;
@property(readonly) NSData *state;
- (id)isApplicationIdentifierEligibleForManagedMode:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100011950
- (id)serviceSpecifiersForApplicationIdentifier:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100011770
- (id)init;	// IMP=0x00000001000116a0
- (void)_loadEnterpriseData;	// IMP=0x0000000100011d7c
