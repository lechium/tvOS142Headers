...
- (_Bool)isMachTimeValid:(unsigned long long)arg1;	// IMP=0x0000000100012894
...
- (void)montonicTimeForMachTime:(unsigned long long)arg1 toQueue:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100012110
- (void)dealloc;	// IMP=0x00000001000120c8
- (id)initWithSyncInterval:(double)arg1;	// IMP=0x0000000100012014
- (id)init;	// IMP=0x0000000100011fb4
