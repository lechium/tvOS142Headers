...
- (id)description;	// IMP=0x0000000100016ae8
- (void)setAccurateThresholds:(_Bool)arg1;	// IMP=0x0000000100016868
...
- (id)init;	// IMP=0x000000010001675c
- (id)initWithDefaults:(id)arg1;	// IMP=0x000000010001616c
