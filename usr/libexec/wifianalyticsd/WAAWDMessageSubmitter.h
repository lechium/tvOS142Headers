...
- (void).cxx_destruct;	// IMP=0x00000001000255c4
...
- (id)submitMessage:(id)arg1;	// IMP=0x0000000100025000
@property(retain, nonatomic) NSArray *configuredMetricIDs;
@property(retain, nonatomic) NSArray *interestedMetricIDs;
- (void)iterateConfigChange;	// IMP=0x0000000100024978
- (id)initWithMessageGroupType:(long long)arg1 andConfigChangeDelegate:(id)arg2 onQueue:(id)arg3;	// IMP=0x00000001000244a4
- (id)init;	// IMP=0x00000001000243f4
