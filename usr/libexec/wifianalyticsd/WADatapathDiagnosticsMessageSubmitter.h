...
- (void).cxx_destruct;	// IMP=0x00000001000575e4
...
- (id)submitDPSRMessage:(id)arg1;	// IMP=0x0000000100051b94
- (id)submitSlowWiFiMessage:(id)arg1;	// IMP=0x0000000100051608
- (id)submitMessage:(id)arg1;	// IMP=0x000000010005137c
- (id)initWithMessageGroupType:(long long)arg1;	// IMP=0x000000010005126c
