...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100061eec
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100061fa4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100061ef4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100061e48
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x0000000100061dc8
- (id)description;	// IMP=0x0000000100061c1c
- (void)dealloc;	// IMP=0x0000000100061bbc
