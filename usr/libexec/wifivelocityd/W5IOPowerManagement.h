...
- (unsigned int)caps;	// IMP=0x0000000100061bac
- (void)stopEventMonitoring;	// IMP=0x0000000100061b08
- (void)startEventMonitoring;	// IMP=0x0000000100061870
- (void)dealloc;	// IMP=0x000000010006181c
- (id)init;	// IMP=0x00000001000616c0
