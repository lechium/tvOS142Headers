...
- (int)batteryWarningLevel;	// IMP=0x00000001000198d4
- (long long)powerSourceType;	// IMP=0x000000010001979c
- (double)estimatedTimeRemaining;	// IMP=0x00000001000196d8
- (double)internalBatteryLevel;	// IMP=0x0000000100019578
- (void)stopEventMonitoring;	// IMP=0x00000001000194c8
- (void)startEventMonitoring;	// IMP=0x0000000100018edc
- (void)dealloc;	// IMP=0x0000000100018e80
- (id)init;	// IMP=0x0000000100018c48
