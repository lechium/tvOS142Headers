...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100039348
- (unsigned long long)hash;	// IMP=0x0000000100039338
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000392d0
- (_Bool)isEqualToLogItemRequestInternal:(id)arg1;	// IMP=0x0000000100039294
- (id)description;	// IMP=0x0000000100039054
- (void)dealloc;	// IMP=0x0000000100038fe4
