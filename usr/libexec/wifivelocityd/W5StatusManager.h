...
- (void)__setupCallbacks;	// IMP=0x0000000100032374
- (void)addEvent:(id)arg1;	// IMP=0x00000001000322e4
- (void)__addEvent:(id)arg1;	// IMP=0x0000000100032284
- (void)__updateStatus;	// IMP=0x0000000100031698
- (id)__queryStatusIncludingWiFiScanCache:(_Bool)arg1;	// IMP=0x00000001000315a0
- (id)__queryWiFiStatusIncludingScanCache:(_Bool)arg1;	// IMP=0x00000001000310a4
- (id)__queryNetworkStatus;	// IMP=0x0000000100030eb8
- (id)__queryBluetoothStatus;	// IMP=0x0000000100030d9c
- (id)__queryAWDLStatus;	// IMP=0x0000000100030b20
- (id)__queryPowerStatus;	// IMP=0x0000000100030a60
- (long long)__airDropDiscoverableMode;	// IMP=0x000000010003099c
- (void)__updateStatusCoalesce;	// IMP=0x0000000100030740
- (void)__forceUpdateTrigger;	// IMP=0x00000001000304fc
- (void)stopEventMonitoring;	// IMP=0x0000000100030400
- (void)startEventMonitoring;	// IMP=0x0000000100030318
- (id)eventHistory;	// IMP=0x0000000100030208
- (void)clearCachedStatusWithUUID:(id)arg1;	// IMP=0x000000010003016c
- (id)cachedStatusWithUUID:(id)arg1;	// IMP=0x0000000100030008
- (id)powerStatus;	// IMP=0x000000010002fef8
- (id)networkStatus;	// IMP=0x000000010002fde8
- (id)bluetoothStatus;	// IMP=0x000000010002fcd8
- (id)awdlStatus;	// IMP=0x000000010002fbc8
- (id)wifiStatus;	// IMP=0x000000010002fab4
- (id)status;	// IMP=0x000000010002f9a0
- (void)queryStatusAndReply:(CDUnknownBlockType)arg1;	// IMP=0x000000010002f8e8
- (void)dealloc;	// IMP=0x000000010002ef34
- (id)init;	// IMP=0x000000010002ee04
@property(readonly, retain) W5BluetoothController *bluetooth; // @dynamic bluetooth;
- (id)__bluetooth;	// IMP=0x000000010002ec84
@property(readonly, retain) W5WiFiInterface *wifi; // @dynamic wifi;
- (id)__wifi;	// IMP=0x000000010002eae0
