...
- (void)resumeMonitoringAfterDelay:(double)arg1;	// IMP=0x0000000100018b0c
- (void)pauseMonitoring;	// IMP=0x0000000100018a64
- (void)stopMonitoring;	// IMP=0x00000001000189b8
- (void)startMonitoring;	// IMP=0x0000000100018908
- (id)__followupTests;	// IMP=0x00000001000187d4
- (id)__initialTests;	// IMP=0x00000001000186b8
- (void)__runDiagnosticsTests:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000100018398
- (void)dealloc;	// IMP=0x0000000100018244
- (id)init;	// IMP=0x000000010001820c
- (id)initWithStatusManager:(id)arg1 diagnosticsManager:(id)arg2;	// IMP=0x0000000100017ba8
